...
The use of broken plurals is a little complicated, and their use in poetry and rhetorical style can be somewhat different from normal usage. Here we will describe whether they are found, and how to use them for the different noun categories according to the most normal usage.
...
+ [عَالِمٌ]{.ar} [eAlimun]{.trn} can be pluralized using the sound [Un]{.trn} plural as [عَالِمُونَ]{.ar} [eAlimUna]{.trn} as well as with the broken plural [عُلَمَاءُة]{.ar} [eulamAEu]{.trn}.\
+ [طَيِّبٌ]{.ar} [Tayyibun]{.trn} can be pluralized using the sound [Un]{.trn} plural as [طَيِّبُونَ]{.ar} [TayyibUna]{.trn} as well as with the broken plural 
