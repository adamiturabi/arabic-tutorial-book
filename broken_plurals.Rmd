...
## Pronouns for plural non-rational doers

In the previous chapter we gave the rule of using doer pronouns with verbs for plural doers that are rational beings. The rule is repeated here:

1. If the doer noun is placed before the verb or is not mentioned, then the plural doer pronoun suffix is employed.
...
Note that this rule is only for the verb doer pronouns. Detached and attached pronouns for rational beings always match the noun they refer to in number. For example,
...
In this section we will give a rule for using pronouns with non-rational beings. This rule encompasses detached pronouns, verb doer pronouns, and attached pronouns. Here is the rule:

1. If the non-rational plural noun is mentioned then the feminine singular doer pronoun [هِيَ]{.ar} [hiya]{.trn}/[ـَتْ]{.ar} [-at]{.trn}/[ـهَا]{.ar} [-hA]{.trn} is used. This is true for a non-rational plural verb doer as well, no matter whether it comes before or after the verb.
2. If the non-rational plural doer is not mentioned, then the feminine plural pronoun [هُنَّ]{.ar} [hunna]{.trn}/[ـنَ]{.ar} [-na]{.trn}/[ـهُنَّ]{.ar} [-hunna]{.trn} is used.

Note that this rule of using the feminine pronoun is for both masculine and feminine plural non-rational beings. Here are some examples to help clarify this rule:
