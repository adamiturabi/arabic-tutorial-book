...
In the previous chapter we gave the rule of using doer-modifications with verbs for plural doers that are rational beings. The rule is repeated here:

1. If the doer noun is placed before the verb or is not mentioned, then the plural doer-modification is employed.
...
In this section we will give a rule for using pronouns with non-rational beings. This rule encompasses detached pronouns, verb doer-modifications, and attached pronouns. Here is the rule:

1. If the non-rational plural noun is mentioned then the feminine singular doer-modification [هِيَ]{.ar} [hiya]{.trn}/[ـَتْ]{.ar} [-at]{.trn}/[ـهَا]{.ar} [-hA]{.trn} is used. This is true for a non-rational plural verb doer as well, no matter whether it comes before or after the verb.
