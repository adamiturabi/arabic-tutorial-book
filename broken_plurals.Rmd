...
The use of broken plurals is a little complicated. Here we will describe whether they are found, and how to use them for the different noun categories according to the most common usage.
...
1. Non-descriptive nouns:
   ...
   b. Female rational beings: Very uncommon but, they do exist. Examples:
      ...
      Typically, though, female rational beings will use the [At]{.trn} sound plural.
...
2. Descriptive nouns:
   ...
   b. Female rational beings: Apart from a few exceptions, this is almost unused in normal usage. The [At]{.trn} plural is used instead.
   c. Non-rational beings: also unused. The feminine singular is used for describers in a noun-phrase or for descrptive nouns in the information of a sentence. The [At]{.trn} plural is used otherwise. Examples:
      + [ٱَلْكُتُبُ ٱلْكَبِيرَةُ ثَقِيلَةٌ.]{.ar}
