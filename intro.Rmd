...
All languages evolve naturally over time. For example, the Old English language spoken 1400 years ago would be unintelligible to us today. But as part of preserving His religion, [#allAh]{.trn2} preserved the language of His revelation as well. This was by means of efforts of the Arab grammarians who recorded the Arabic language of the time of the revelation and developed rules for its grammar.

In the process of preserving Arabic, the Arab grammarians described in detail a literary form, called Classical Arabic, from among the various dialects of Old Arabic. However, even Classical Arabic, as described by the Arab grammarians, contained some minor linguistic variations within it. As time went by, a standard variety emerged from this Classical Arabic and came to be used the language of science and literature in the Islamic world. As scholars developed new branches of religious and secular sciences, new terms and meanings were added to this "Standard Arabic". A few words were also borrowed from foreign languages as needed by the different scientific disciplines. These additions were, by and large, deliberate, done by scholars who were experts in their field and also well versed in Standard Arabic, and validated by subsequent generations of scholarly discourse. Besides these justified additions, the grammar and base language remained remarkably unchanged.
