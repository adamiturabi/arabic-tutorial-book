...
The Arabic alphabet traditionally has 28 letters. There is also one additional letter called [hamzah]{.trn}.
...
Sometimes the [A]{.trn} vowel is written as a small small [Ealif]{.trn} above the letter instead of a regular [Ealif]{.trn} after the letter. This is done only for a few commonly used words. Here are some examples:

+ [هٰذَا]{.ar} [hApA]{.trn}
+ [ذٰلِكَ]{.ar} [pAlika]{.trn}
...
In Arabic writing hamza can either be written by itself ء or it can be written “sitting” on alif, waw or ي thus [أ]{.ar} ؤ ئ . It can also be written under an alif إ. In this case the ا و or ي are called the seat of the hamza. Note that when sitting on ي the dots of the yaa will not be written so depending on position, it can appear ئ ئـ ـئ ـئـ.
...
[لِ + لِ + ٱ + نْتِقَالِ]{.ar}| [لِلِٱنْتِقَالِ]{.ar}| [lili -ntiqAli]{.trn}
