...
2. If [hamzah]{.trn} occurs in the middle of a word:
   ...
   b. If the letter before the [hamzah]{.trn} has a null-vowel mark and is not [wAw]{.trn} or [yAE]{.trn}, then:
      ...
      ii. Otherwise, if the [hamzah]{.trn} is originally at the middle of the word, then it is written seated on [alif]{.trn} if it has an [a]{.trn}-mark, [wAw]{.trn} if it has an [u]{.trn}-mark, and [yAE]{.trn} if it has an [i]{.trn}-mark. Examples: [مَسْأَلَةُ]{.ar} [masEalatu]{.trn}, [مَسْؤُولُ]{.ar} [masEUlu]{.trn}, [تَرْئِيسُ]{.ar} [tarEIsu]{.trn}, [مَرْأَةُ]{.ar} [marEatu]{.trn}. (Some of these can also be written standalone but the rule we have given is more commonly used in Standard Arabic.)
   ...
   d. Otherwise, only if the above conditions are not satisfied, then compare the vowel marks of the [hamzah]{.trn} and the letter before it:
      ...
      iii. Otherwise, if both of the vowel marks are [a]{.trn}-marks, then:  
           If the [hamzah]{.trn} is followed by a long-[A]{.trn} vowel represented by an [alif]{.trn}, the [hamzah]{.trn} is written stanalone. Examples: qirAEAt canaEAnu  
