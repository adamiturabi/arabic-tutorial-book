...
Looped taa ة is called a taa ت but it is written a ه with two dots above it. It only occurs at the end of a word so it has only an end form and an isolated form (in case the letter before it is a no-end-join letter). Looped taa ة is pronounced exactly as a ت except if it is at the end of a sentence in which case it is pronounced as a ه.
