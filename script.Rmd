...
The letters ف and ق are similar in the initial and middle positions except for the dots. But in the isolated and final positions, the tail of [ق]{.ar} goes lower than that of [ف]{.ar}.
...
These two letters []{.ar} and []{.ar} also take a special form when [ا]{.ar} follows right after [ل]{.ar}. Instead of looking like this [لــا]{.ar}, they will be written like this [لا]{.ar}.
...
1.  [A]{.trn} generally written with an unmarked [ا]{.ar} [alif]{.trn} and with the preceding letter having an [a]{.trn}-mark. Example [مَا]{.ar} [mA]{.trn}. This vowel is mostly pronounced like the vowel in English “man”. If however, it comes after these letters [خ،ر،ص،ض،ط،ظ،غ،ق]{.ar} it is pronounced like English "awe".
1.  [I]{.trn} like in English “been” written with an unmarked [ي]{.ar} [yA']{.trn} with the preceding letter having an [i]{.trn}-mark. Example [فِي]{.ar} [fI]{.trn}.
...
#### [A]{.trn} vowel written with a small [alif]{.trn}

Sometimes the long-a vowel is written as a small alif above the letter instead of a regular alif after the letter. This is done only for a few commonly used words. Here are some examples:

+ [هٰذَا]{.ar} [hApA]{.trn}
+ [ذٰلِكَ]{.ar} [pAlika]{.trn}

#### [A]{.trn} vowel written with a [yA']{.trn}

The [A]{.trn} vowel is generally written with an [alif]{.trn} as we have seen above. But for some words, instead of an [alif]{.trn}, it is written with a [yA']{.trn}. This only occurs for certain words and even then only at the end of the word. When this happens, we will write the [yA']{.trn} without its dots and write a small [alif]{.trn} above it, like this [ىٰ]{.ar}. Here are some examples:
...
2. [ay]{.trn} like in English “bait”. This is written with a [yA']{.trn} with a round-mark on it and a [A]{.trn} vowel before it. Example [كَيْ]{.ar} [kay]{.trn}. 
...
2. [Ay]{.trn} like in English “bye”. This is written with a [yA']{.trn} with a round-mark on it and a [A]{.trn} vowel before it. Example [شَايْ]{.ar} [cAy]{.trn}.
...
Looped taa ة is a special letter which is merged from two letters of the alphabet. It is a taa ت but it is written a ه with two dots above it. Looped taa ة is pronounced exactly as a ت except if it is at the end of a sentence in which case it is pronounced as a ه. It only occurs at the end of a word so it has only an end form and an isolated form (in case the letter before it is a no-end-join letter). 
...
As a spelling rule, if a word ends with an [an]{.trn} mark, we will generally add a silent ['alif]{.trn} after it, except if the word ends with a looped [tA']{.trn} [ة]{.ar} or an ['alif]{.trn} followed by an unseated [hamzah]{.trn} [اء]{.ar}.
