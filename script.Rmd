...
2. If the word ends with a [hamzao]{.trn}. In this case, we might or might not write a silent [Ealif]{.trn}, depending on the following rules:
   ...
   b. Otherwise, we add a silent [Ealif]{.trn} after the [hamzao]{.trn}. However, this may affect the writing of the [hamzao]{.trn}, for example [مُبْتَدَأ]{.ar} becomes [مُبْتَدَءًا]{.ar} [mubtadaEan]{.trn}. This is discussed further in Appendix \@ref(hamzarules).
