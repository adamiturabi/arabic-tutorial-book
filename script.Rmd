...
1. [Aw]{.trn} like in English “goal”. This is written with a [wAw]{.trn} with a round-mark on it and a [A]{.trn} vowel before it. Example [وَاوْ]{.ar} [wAw]{.trn}. 
...
+ [دُعَاءً]{.ar} [dueA'an]{.trn}
+ [شَيْئًا]{.ar} [cay'an]{.trn}
+ [سُوءًا]{.ar} [sU'an]{.trn}
