...
:-|:--|:--|:---|:---------------------------
 ...
 2|[ب]{.ar}|[b]{.trn}| [bAE]{.trn} |Equivalent to English "b" in "boy".
 3|[ت]{.ar}|[t]{.trn}| [tAE]{.trn} |Similar to English "t" in "tall" but softer. Touch the tongue against the back of the top front teeth instead of just the gum.
 4|[ث]{.ar}|[v]{.trn}| [vAE]{.trn} |Similar to to English "th" in "think" but softer. Have your lips and cheek in a wide grin. Loosely bite the tip of your tongue between your front teeth and then force air out trying to hiss "ssss". Keep your tongue touching the top and bottom teeth and the hiss should come out like a "th" sound.
 5|[ج]{.ar}|[j]{.trn}| [jIm]{.trn} |Equivalent to English "j" in "just".
 6|[ح]{.ar}|[H]{.trn}| [HAE]{.trn} |Similar to English "h" in "hat" but pronounced from the bottom of the throat.
 7|[خ]{.ar}|[x]{.trn}| [xAE]{.trn} |Similar to "ch" in Scottish "loch". Try saying "kh" but with a scraping sound.
 8|[د]{.ar}|[d]{.trn}| [dAl]{.trn} |Similar to to English "d" in "dog" but softer. Just like with [ت]{.ar}, touch the tongue against the back of the top front teeth instead of just the gum.
 9|[ذ]{.ar}|[p]{.trn}| [pAl]{.trn} |Place your tongue as in [ث]{.ar} and force air out. But this time instead of trying to hiss "ssss" try to buzz "zzzz" and again keep your tongue touching the top and bottom teeth.
10|[ر]{.ar}|[r]{.trn}| [rAE]{.trn} |Equivalent to English "r" in "rat".
11|[ز]{.ar}|[z]{.trn}| [zAE]{.trn} |Equivalent to English "z" in "zoo".
12|[س]{.ar}|[s]{.trn}| [sIn]{.trn} |Equivalent to English "s" in "see".
13|[ش]{.ar}|[c]{.trn}| [cIn]{.trn} |Equivalent to English "sh" in "show".
14|[ص]{.ar}|[S]{.trn}| [SAd]{.trn} |An emphatic [س]{.ar} that will be described later.
15|[ض]{.ar}|[D]{.trn}| [DAd]{.trn} |An sound unique to Arabic that will be described later.
...
18|[ع]{.ar}|[e]{.trn}| [eayn]{.trn} |Another unique sound. Try to sound "a" from the bottom of the throat.
19|[غ]{.ar}|[g]{.trn}| [gayn]{.trn} |Somewhat like a "gh" sound but much softer. Try pronouncing [خ]{.ar} but without any scraping.
20|[ف]{.ar}|[f]{.trn}| [fA ]{.trn}| Equivalent to English "f" in "fox".
21|[ق]{.ar}|[q]{.trn}| [qAf]{.trn}| Similar to English "k" in "kite" but sounded from the top back of the mouth.
22|[ك]{.ar}|[k]{.trn}| [kAf]{.trn}| Equivalent to English "k" in "kite".
23|[ل]{.ar}|[l]{.trn}| [lAm]{.trn}| Equivalent to English "l" in "light".
24|[م]{.ar}|[m]{.trn}| [mIm]{.trn}| Equivalent to English "m" in "man".
25|[ن]{.ar}|[n]{.trn}| [nUn]{.trn}| Equivalent to English "n" in "nut".
26|[ه]{.ar}|[h]{.trn}| [hAE]{.trn}| Equivalent to English "h" in "hat". Much softer than [ح]{.ar}
27|[و]{.ar}|[w]{.trn}/[U]{.trn}| [wAw ]{.trn} |As a consonant it is equivalent to English "w" in "water". It is also a vowel equivalent to English "oo" in "moon".
28|[ي]{.ar}|[y]{.trn}/[I]{.trn}| [yAE]{.trn} |As a consonant it is equivalent to English "y" in "yellow". It is also a vowel equivalent to English "ee" in "meek".

In addition to the traditional 28 letters, there is also one additional letter called [hamzah]{.trn}, that was originally only sounded and not written. Together with [hamzah]{.trn} there are 29 letters.

No.|Arabic letter|Tran-scrip-tion|Name |Description
:-|:--|:--|:----|:---------------------------
 29|[ء]{.ar}|[E]{.trn}| [hamzah]{.trn} | Technically called a glottal stop, it is the sound of of the breath stopping between in the utterance "oh-oh".
...
[ض]{.ar} [DAd]{.trn} is thought to be unique to Arabic. There are two ways to pronounce it. The first is similar to an emphatic [د]{.ar}. The second is almost similar to [ظ]{.ar}. Unfortunately we are not able to give a better verbal description of it. We reiterate that it is best to use audio training to help with pronouncing these sounds.
...
2. After a letter. This has two sub cases:
   a. Unseated after a partially-joining letter or at the end of a word. Examples: [تساءل]{.ar}, [توءم]{.ar}, [عبء]{.ar}.
   a. Inline in the middle of a word after a fully-joining letter. In this case [hamzah]{.trn} is written above the horizontal line that connects the letters. Examples: [خطيـٔة]{.ar}, [شيـٔا]{.ar}, [بريـٔين]{.ar}.
...
As we have seen above if an Arabic letter has a vowel after it it will take one of the three pronunciation marks: [◌َ]{.ar}, [◌ِ]{.ar}, [◌ُ]{.ar}. If, however, there is no vowel after the letter we will put a "null-vowel-mark" on it [◌ْ]{.ar}. This mark can only occur if there is a short vowel before the letter. Examples:
...
1. [aw]{.trn} like in English “show”. This is written with a [wAw]{.trn} with a rest-mark on it and a [A]{.trn} vowel before it. Example [لَوْ]{.ar} [law]{.trn}. 
...
Some words in arabic begin with a null-vowel-mark. When this occurs a connecting [hamzah]{.trn} [ٱ]{.ar} (written as a tiny [صـ]{.ar} on an [Ealif]{.trn}) is put before it. If this word comes in the beginning of the sentence the connecting alif is pronounced as a [hamzah]{.trn}. Otherwise this connecting [hamzah]{.trn} is not pronounced and the word is connected to the final vowel of the previous word in pronunciation. In this tutorial we will transcribe the connecting [hamzah]{.trn} with a hyphen "-". Examples of connecting [hamzah]{.trn}:
...
When a word is at the end of a sentence and it ends with a long vowel, then the final long vowel is pronounced normally. However, when a word at the end of a sentence does not end with a long vowel, then the final letter's pronunciation mark is pronounced as a null-vowel mark when vocalizing the sentence. If the final letter is a looped [tAE]{.trn} [ة]{.ar} then it is pronounced as a [ه]{.ar} [hAE]{.trn} with a null-vowel mark. 
...
In printed [#qurEAn]{.trn2} volumes, which are called [muSHaf]{.trn}s, some words will be written a little differently than how they are written in non-[#qurEAn]{.trn2}ic Standard Arabic. The reasons for this are beyond the scope of this tutorial. Here we’ll just give a few examples and note that these differences are only found in [muSHaf]{.trn}s. For standard written Arabic, the writing explained in this chapter is used instead.

Standard Arabic | [#qurEAn]{.trn2}ic Arabic
:---------|:---------
[ٱلصَّلَاةُ]{.ar}| [ٱلصَّلَوٰةُ]{.ar}
[سَمَاوَاتٌ]{.ar}| [سَمَـٰوَ ٰتٌ]{.ar}
