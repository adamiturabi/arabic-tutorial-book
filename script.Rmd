...
18|[ع]{.ar}|[e]{.trn}| [eayn]{.trn} |A sound similar to strangulation. Try to sound "a" from the bottom of the throat.
...
In addition to the traditional 28 letters, there is also a sound called [hamzah]{.trn} that, although ought to be considered a full letter in its own right, was originally only pronounced and not written. It is now written as a pronunciation mark, rather than a full-fledged letter.

No.|Arabic letter|Tran-scrip-tion|Name |Description
:-|:--|:--|:----|:---------------------------
--|[ء]{.ar}|[E]{.trn}| [hamzah]{.trn} | Technically called a glottal stop, it is the sound of of the breath stopping between the syllables in the utterance "oh-oh".
...
In printed [#qurEAn]{.trn2}s, the spelling is a little different from non-[#qurEAn]{.trn2}ic Standard Arabic. The reasons for this are beyond the scope of this book. Here we’ll just give a few examples and note that these differences are only found in printed [#qurEAn]{.trn2}s.
