...
2. If the word ends with a [hamzao]{.trn}. In this case, we might or might not write a silent [Ealif]{.trn}, depending on the following rules:
   ...
   b. Otherwise, we add a silent [Ealif]{.trn} after the [hamzao]{.trn}. However, this may affect the writing of the [hamzao]{.trn} and this is discussed further in Appendix \@ref(hamzarules).
