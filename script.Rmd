...
In Arabic writing hamza can either be written "standalone" by itself [ء]{.ar} or it can be written “seated” on [alif]{.trn} [أ]{.ar} (also under [alif]{.trn} [إ]{.ar}), [wAw]{.trn} [ؤ]{.ar} or [yAE]{.trn} [ئ]{.ar}. 

In these cases the [alif]{.trn}, [wAw]{.trn}, and [yAE]{.trn} are called the seat of the hamza. Note that when seated on [yAE]{.trn} [ئ]{.trn} the dots of the [yAE]{.trn} are no longer written. Here's how it will appear in different positions:
...
1. If [hamzah]{.trn} occurs in the beginning of a word:
   a. If the [hamzah]{.trn} carries a long-[A]{.trn} vowel, it is written standalone followed by an [alif]{.trn} [ءَا]{.ar}.
   b. If the [hamzah]{.trn} carries any other vowel, it is written seated on an [alif]{.trn}, and is marked with the appropriated vowel mark.
