...
These two letters []{.ar} and []{.ar} also take a special form when [ا]{.ar} follows right after [ل]{.ar}. Instead of looking like this [لـا]{.ar}, they will be written like this [لا]{.ar}.
...
## Joining [lAm]{.trn} and ['alif]{.trn}

When the letter ['alif]{.trn} follows [lAm]{.trn} we would expect them to be joined like this [ل-ا]{.ar} = [لـا]{.ar}. But actually, they are joined in a special way 

[ل-ا]{.ar} = [لا]{.ar}

If we add [hamzah]{.trn} to the ['alif]{.trn} or add another [lAm]{.trn}, here is how they will be joined:

Disjoint | Joined | Transcription
:--------|:-------|:-------------
[لَ-ا]{.ar}| [لَا]{.ar}| [lA]{.trn}
[ٱَ-لْ-إِ]{.ar}| [ٱَلْإِ]{.ar}| [al'i]{.trn}
[ٱَ-لْ-آ]{.ar}| [ٱَلْآ]{.ar}| [al'A]{.trn}
[أَ-لَّ-ا]{.ar}| [أَلَّا]{.ar}| ['allA]{.trn}
[لِ-لِ-ٱ]{.ar}| [لِلِٱ]{.ar}| [lili]{.trn}
...
As a spelling rule, if a word ends with an [an]{.trn} mark, we will generally add a silent [Ealif]{.trn} after it, except if the word ends with a looped [tAE]{.trn} [ة]{.ar} or an [Ealif]{.trn} followed by an unseated [hamzah]{.trn} [اء]{.ar}.
