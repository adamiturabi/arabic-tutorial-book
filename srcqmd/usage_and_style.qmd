...
(@ex000140) [مِنَ الْغَيْرَةِ مَا يُحِبُّ اللَّهُ وَمِنْهَا مَا يَكْرَهُ اللَّهُ]{.ar}
    [@https://sunnah.com/ibnmajah/9@]{.citex}  
...
These sentences can be expressed in Arabuc without indefinite ;mubtada;s. For example:
...
As for "why" sentences, Arabic has a native expression using [مَا لِ]{.ar} followed by a noun or pronoun in the ;istate; and then an adjective in the ;astate;.
For example:
