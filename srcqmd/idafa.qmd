...
The ;mudaf; [كِتَاب]{.ar} is annexed to, and belongs to, the base noun [ٱَلْغُلَام]{.ar}. 
...
The base noun in an annexation is always in the i-state. The ;mudaf; may be in any state, depending on its function in the sentence. For example,
<!--
...
Because the base noun [ٱَلْغُلَام]{.ar} is definite, therefore the ;mudaf; [كِتَاب]{.ar} is also definite.
The entire annexation is definite.
<!--If the base noun is definite (as it is above) then the ;mudaf; shall also be definite.
And if the base noun is indefinite (as below) then the ;mudaf; shall also be indefinite.-->
...
Because the base noun [غُلَامٍ]{.ar} is indefinite, therefore the ;mudaf; [كِتَاب]{.ar} is also indefinite.
...
As we mentioned earlier, the definiteness of the ;mudaf; in Arabic depends only on the definiteness of the base noun. 
If the base noun is definite then the ;mudaf; shall be considered definite as well.
And if the base noun is indefinite then the ;mudaf; shall be considered indefinite as well.

The need to maintain this distinction will become apparent in the next section.

If the base noun is definite, and it is desired to make the ;mudaf; grammatically indefinite, then it is necassary to break the annexation, and use a prepositional phrase instead, usually with the preposition [لِ]{.ar}, which, here, will mean "of". Example:
...
Say, now, that we want to describe the ;mudaf; [كِتَاب]{.ar} "book" with the adjectival noun [صَغِير]{.ar} "a small one". Normally, nothing can come between the ;mudaf; and the base noun in an annexation. So, the describer needs to be placed, again, after the base noun.
However, this time it will match the ;mudaf;, not the base noun, in state, definiteness, gender, and number. So we get:
...
The ;mudaf; [كِتَاب]{.ar} is definite, not with [ٱَلْ]{.ar}, but rather because of the definite base noun [ٱَلْجَارِيَةِ]{.ar} "the girl".
...
This is because 
the ;mudaf; [كِتَابُ]{.ar} is indefinite. It is indefinite because base noun [جَارِيَةٍ]{.ar} "a girl" is indefinite.

Now, you might be foreseeing a problem. What if the ;mudaf; and the base noun have the same gender, and the annexe too is in the i-state? For example, in the sentence:
...
How do we know whether the describer [كَبِير]{.ar} is meant to describe the ;mudaf; [بَيْتِ]{.ar} or the base noun [ٱَلرَّجُل]{.ar}?
The ;mudaf; [بَيْتِ]{.ar} and the base noun [ٱَلرَّجُل]{.ar} are both masculine, singular, definite, and in the i-state.
...
If, however, the context is not clear, and the meaning of the describer can apply to both the ;mudaf; and the base noun, then the describer is likely to apply to the base noun and not to the ;mudaf;. So then, this interpretation is more likely:
...
^2^[صَحْرَاء]{.ar} "a desert" is indefinite because it is the ;mudaf; to an indefinite base noun [أَرْض]{.ar} "a land". 
...
i. [مِفْتَاحُ بَابِ]{.ar} "door's key". Its ;mudaf; $a_1$\ is [مِفْتَاح]{.ar} and its base noun\ $b_1$ is [بَابِ]{.ar}.
i. [بَابِ ٱلْبَيْتِ]{.ar} "the house's door". Its ;mudaf; $a_2$\ is [بَابِ]{.ar} and its base noun\ $b_2$ is [ٱلْبَيْتِ]{.ar}.
...
The ;mudaf; is [كِتَاب]{.ar} and the base noun is the pronoun [ه]{.ar}.
...
When duals and [Un]{.trn} sound plurals are ;mudaf;s, then their final [ن]{.ar} is treated as a sort of [nUn]{.trn2}ation and is, therefore, deleted before annexing them to a base noun. For example:
...
The definiteness, however, is the same in the two expressions because the ;mudaf; has the same definiteness as the base noun.
...
### Multiple ;mudaf;s and one base noun

In English we can have an expression like "the pen and the book of the boy" = "the boy's pen and book". In this sentence there are two ;mudaf;s and one base noun.
...
### One ;mudaf; and multiple base nouns

We can also have expressions like "the house of the boy and the girl". In this sentence there is one ;mudaf; and two base nouns.
...
So far we have studied the annexation of an ;mudaf; to a base noun.
