...
The word ";idafa;" means the addition of a new _annexed_ item to an existing _base_ item. We use the term _;idafa;_ in Arabic grammar when an _annexe_ noun is annexed to a _base_ noun by being placed right before it. Here is an example of an ;idafa;:
...
1. The _annexe_ noun: This is the first noun in the ;idafa;.
1. The _base_ noun: This is the second noun in the ;idafa;.
...
+ The ;mudaf; in an ;idafa; shall neither have an [n]{.trn}-mark nor the prefix [ٱَلْ]{.ar}.
...
-->
## State of the annexe and ;mudafil;s
...
The ;mudaf; in an ;idafa; can have neither an [n]{.trn} mark, nor an [ٱَلْ]{.ar}. 
The ;mudafil; is permitted to have an [n]{.trn} mark or an [ٱَلْ]{.ar} prefix. 
The definiteness of the ;mudafil; then determines the definiteness of the ;idafa;. If the second noun is definite, then both the annexe and the ;mudafil;s be definite. And if the ;mudafil; is indefinite, then both the nouns in the chain will be indefinite. 
...
Now, you might be foreseeing a problem. What if the ;mudaf; and the ;mudafil; have the same gender, and the annexe too is in the i-state? For example, in the sentence:
...
Contrary from expected behavior, a semi-flexible ;mudaf;, even when indefinite, takes an [i]{.trn}-mark\ [◌ِ]{.ar} in the i-state instead of an [a]{.trn}-mark\ [◌َ]{.ar}. Example,
...
if a semi-flexible noun is any of the ;mudaf;s and is in the i-state, then its i-state is indicated by an [a]{.trn}-mark [◌َ]{.ar}. Example:
...
If the dual ;mudaf; were in the i-state then the final [ي]{.ar} gets an [i]{.trn}-mark [◌ِ]{.trn} if there is following connecting [hamzah]{.trn2}. Example:
