...
+ The ;mudafil; in an annexation shall always be in the i-state.
+ The state of the ;mudaf; is variable and shall depend on its function in the sentence.
+ The ;mudaf; in an annexation shall neither have an [n]{.trn}-mark nor the prefix [ٱَلْ]{.ar}.
...
The ;mudafil; in an annexation is always in the i-state. The ;mudaf; may be in any state, depending on its function in the sentence. For example,
<!--
...
The ;mudaf; in an annexation can have neither an [n]{.trn} mark, nor an [ٱَلْ]{.ar}. 
The ;mudafil; is permitted to have an [n]{.trn} mark or an [ٱَلْ]{.ar} prefix. 
The definiteness of the ;mudafil; then determines the definiteness of the annexation. If the second noun is definite, then both the annexe and the ;mudafil;s be definite. And if the ;mudafil; is indefinite, then both the nouns in the chain will be indefinite. 
...
If the ;mudafil; is definite, and it is desired to make the ;mudaf; grammatically indefinite, then it is necassary to break the annexation, and use a prepositional phrase instead, usually with the preposition [لِ]{.ar}, which, here, will mean "of". Example:
...
Say, now, that we want to describe the ;mudaf; [كِتَاب]{.ar} "book" with the adjectival noun [صَغِير]{.ar} "a small one". Normally, nothing can come between the ;mudaf; and the ;mudafil; in an annexation. So, the describer needs to be placed, again, after the ;mudafil;.
...
Similarly, if we describe the ;mudaf; [كِتَاب]{.ar} in an indefinite annexation, we get:
...
In order to apply a describer to the ;mudaf; in such a case, it is better to break the annexation and form a prepositional phrase instead, usually with the preposition [لِ]{.ar}, which, here, will mean "of". Example:
...
Here are examples of the semi-flexible noun ^2^[صَحْرَاء]{.ar} "a desert" as the ;mudafil; in an annexation:
...
The noun [بَاب]{.ar} "door" is common to both sub-annexations. It is the ;mudafil; of the first sub-annexation
[مِفْتَاحُ بَابِ]{.ar} "door's key".
At the same time, it is also the ;mudaf; of the second sub-annexation
[بَابِ ٱلْبَيْتِ]{.ar} "the house's door".

Only the final ;mudafil; may have [ٱَلْ]{.ar} or be [nUn]{.trn2}ated. If the final ;mudafil; has [ٱَلْ]{.ar} (as above) then all the nouns in the annexation are definite. 

And if the final ;mudafil; is indefinite, as in the example below, then all the nouns in the annexation are indefinite.
...
So, any describers for the annexation must necessarily only describe the ;mudaf;, not the base pronoun. Example:
...
If the ;mudafil; in the first annexation is replaced with a pronoun then only the first method is allowed. For example,
...
Note that both 
[ٱلْغُلَامِ]{.ar} [EalgulAmi]{.trn} and [ٱَلْجَارِيَةِ]{.ar} [EaljAriyati]{.trn} are in the i-state because they are both ;mudafil;s in the annexation.

#### With pronouns

If one or both of the ;mudafil;s in the annexation is replaced with a pronoun then the first noun must be repeated. For example,
...
So far we have studied the annexation of an ;mudaf; to a ;mudafil;.
