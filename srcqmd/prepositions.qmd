...
In Arabic prepositions, when placed before a noun, put it in the ;icase;. For example the preposition [فِي]{.ar} [fI]{.trn} means "in". We can put it before the noun [بَيْت]{.ar} [bayt]{.trn} "a house":

[فِي بَيْتٍ]{.ar}  
[fI baytin]{.trn}  
"in a house"

Note how the noun [بَيْتٍ]{.ar} [baytin]{.trn} "a house" is in the ;icase; because of the preposition [فِي]{.ar} [fI]{.trn} "in" before it. The ;icase; is indicated by the ;tanwin;ed ;imark; [◌ٍ]{.ar} on the final letter of [بَيْت]{.ar}.

Arabic has two types of prepositions: _true_ prepositions and _pseudo_-prepositions.

## True prepositions

True prepositions are _particles_. Particles are a class of words, like nouns and verbs. Particles don't have the properties of nouns. Thus, they cannot be definite or indefinite. They cannot be preceded by [ٱَلْ]{.ar} [al]{.trn} nor may they be ;tanwin;ed. And they don't have state (;ucase;, ;acase;, ;icase;). 
...
Detached pronouns are the equivalent of "he", "she", and "I", etc. They are used in place of nouns that are in the ;ucase;.

Now we will learn about _attached pronouns_. Attached pronouns are, more or less, the equivalent of "him", "her", and "me", etc.
They are used in place of nouns that are in the ;acase; and the ;icase;. One place where attached pronouns are used is when the replace the noun directly following a preposition.
...
Note that the preposition [فِي]{.ar} [fI]{.trn} "in" only puts the noun after it ([ٱلْبَيْتِ]{.ar} [Ealbayti]{.trn} "the house") in the ;icase;. It has no effect on the state of the noun before it ([رَجُلٌ]{.ar} [rajulun]{.trn} "a man"). In this case, it is in the ;ucase;.
...
Note that when you don't repeat the preposition, the second noun is still in the ;icase;.
