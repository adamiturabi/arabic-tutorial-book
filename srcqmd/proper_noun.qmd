...
As usual, the ;mudafil; shall always be in the ;icase;. And the state of the ;mudaf; [عَبْد]{.ar} is variable, depending on it's function in the sentence. Example:
...
(Note that the second [بْنِ]{.ar} is in the ;icase; to match the state of the ;mudaf; [عَبْدِ]{.ar} in [عَبْدِ ٱللّـٰه]{.ar}.)
