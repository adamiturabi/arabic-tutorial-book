...
+ [مُحَمَّدٍ]{.ar} is fully-flexible so it has a ;tanwin;ed ;imark; [◌ٍ]{.ar} in the ;icase;.
+ [زَيْنَبَ]{.ar} is semi-flexible so it is not ;tanwin;ed, and instead has an ;amark; [◌َ]{.ar} in the ;icase;.
+ The proper nouns [مُحَمَّد]{.ar} and [زَيْنَب]{.ar} are ;manut;s in descriptive noun phrases.
+ Their ;na3t;s ([ٱلْكَرِيمِ]{.ar} and [ٱلطَّيِّبَةِ.]{.ar}, respectively) have [ٱَلْ]{.ar} to match the definiteness of the definite proper noun ;manut;s. Furthermore, they both end with [◌ِ]{.ar} because they match the ;icase; of their ;manut;s.
...
This is because noun beginning with with [ٱَلْ]{.ar} display their ;case; fully, regardless of whether or not they are semi-flexible without the [ٱَلْ]{.ar}. Examples:
...
Sentence word order is usually pretty flexible. For stylistic reasons, it is permissible for a ;mafulb; to precede the ;faa3il;.
For example,

[سَأَلَتْ دَرْدَاءَ أَسْمَاءُ.]{.ar}  
"[#asmAE]{.trn2} asked [#dardAE]{.trn2}"

But because words that end with [ىٰ]{.ar} never display any ;case;, then for these words the sentence word order becomes more rigid. So the following sentence:
...
<!--
Interestingly, the fully-flexible name [#eamr]{.trn2} is written with a silent [و]{.ar} at its end: [عَمْرو]{.ar} when in the ;ucase; and ;icase; in order to distinguish it from the more common name [#eumar]{.trn2}. Otherwise, both names would appear identical when written without vowel marks, thus: [عمر]{.ar}.

Name|;ucase;|;acase;|;icase;
:-|:--|:--|:--
...
Irregularly, the fully-flexible name [#eamr]{.trn2} is written with a unpronounced [و]{.ar} at its end: [عَمْرو]{.ar} when in the ;ucase; and ;icase;.
In the ;acase;, the [و]{.ar} is not added.
...
Or it could be the remnant of an older (pre-Islāmic) practice of appending a final [و]{.ar} to personal names.^[@jallad_wawation@]
...
A _replacement_ is a word that follows another word, the _replacee_, and replaces it from the perspective of the grammar of the sentence. The replacement is put in the same ;case; as the replacee.
...
[شَيْـًٔا]{.ar} "something". Therefore, it is put in the same ;acase;.
...
In this sentence, the name [عَلِيّ]{.ar} [#ealI]{.trn2} is the replacement of the replacee [عَمّ]{.ar} "uncle". Note, again, that the replacement comes after the replacee and matches it in ;case;. However, the replacement does not need to come directly after the replacee. We can see that there is the pronoun [ه]{.ar} "his" between them.
...
So far we have only dealt with proper nouns that are single words. There are some proper nouns that may be formed from two words that are in an ;idaafah;. These belong to different categories:
...
As usual, the ;mudafil; shall always be in the ;icase;. And the ;case; of the ;mudaf; [عَبْد]{.ar} is variable, depending on it's function in the sentence. Example:
...
(Note how [زَيْدٍ]{.ar} has a ;tanwin;ed ;imark; [◌ٍ]{.ar} in the ;icase; because it is fully-flexible.)
...
(Note how [رُقَيَّةَ]{.ar} has an ;amark; [◌َ]{.ar} in the ;icase; because it is semi-flexible.)
...
(Note that the second [بْنِ]{.ar} is in the ;icase; to match the ;case; of the ;mudaf; [عَبْدِ]{.ar} in [عَبْدِ ٱللّـٰه]{.ar}.)
...
^2^[بَنُو إِسْرَائِيل]{.ar} [#banU #isrAEIl]{.trn2} "the children of [#isrAEIl]{.trn2}". In the ;acase; and ;icase;, this becomes
...
If the tribe name is the ;faa3il; of a verb then it is usually treated as singular feminine.
...
Some titles are formed from ;idaafah;s. Examples:
...
In Arabic, the titles for these objects usually don't occur as replacees as they do for persons. Rather, the title is annexed to the proper noun in an ;idaafah;. Examples:
...
"[#sulaymAn]{.trn2} the weak-sighted read the ;quran;."
...
(Note how the second [بْنِ]{.ar} is in the ;icase; because it is a replacement of [عُمَرَ]{.ar} which is in the ;icase; because it is a ;mudafil; of the first [بْنُ]{.ar}.)
