...
+ Their ;na3t;s ([ٱلْكَرِيمِ]{.ar} and [ٱلطَّيِّبَةِ.]{.ar}, respectively) have [ٱَلْ]{.ar} to match the definiteness of the definite proper noun ;manut;s. Furthermore, they both end with [◌ِ]{.ar} because they match the ;istate; of their ;manut;s.
...
^2^[بَنُو إِسْرَائِيل]{.ar} [#banU #isrAEIl]{.trn2} "the children of [#isrAEIl]{.trn2}". In the ;astate; and ;istate;, this becomes
