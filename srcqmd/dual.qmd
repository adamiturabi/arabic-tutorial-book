...
## Dual ;na3t;s and ;manut;s in descriptive noun-phrases

We learned that when an ;sifah; is a ;na3t; in an descriptive noun-phrase, then it matches the ;manut; in definiteness, state, and gender.  For example:

[ذَهَبْتُ إِلَى ٱلْمَدِينَةِ ٱلْقَدِيمَةِ.]{.ar}  
[pahabtu Eila -lmadInati -lqadImah.]{.trn}  
"I went to the old city."

To this we add that the ;na3t; shall also match the ;manut; in number. So if the ;manut; is a dual then the ;sifah; ;na3t; shall be dualzed to match it. Examples:
