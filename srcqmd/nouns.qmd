...
1. u-state: indicated by a ;umark; [◌ُ]{.ar} (for definite nouns) and a ;tanwin;ed ;umark; [◌ٌ]{.ar} (for indefinite nouns) on the final letter of the word.
...
The choice of which state a noun is in depends on its function in a sentence. For example, if the noun is a ;mubtada; of a sentence, it will usually be in the u-state. And if it is used adverbially, it will often be in the a-state. And if it occurs after a preposition, it will be in the i-state. We will learn more about putting nouns in their different states throughout this book. 
