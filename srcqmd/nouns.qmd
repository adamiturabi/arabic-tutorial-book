...
Some nouns begin with a connecting [hamzah]{.trn2}, for example: [ٱِبْن]{.ar} [Eibn]{.trn} "son". When in the beginning of a sentence, the connecting [hamzah]{.trn2} will be pronounced with an ;imark; [◌ِ]{.ar}.
...
1. ;ustate;: indicated by a ;umark; [◌ُ]{.ar} (for definite nouns) and a ;tanwin;ed ;umark; [◌ٌ]{.ar} (for indefinite nouns) on the final letter of the word.
2. ;astate;: indicated by an ;amark; [◌َ]{.ar} (for definite nouns) and a ;tanwin;ed ;amark; [◌ً]{.ar} (for indefinite nouns) on the final letter of the word.
3. ;istate;: indicated by an ;imark; [◌ِ]{.ar} (for definite nouns) and a ;tanwin;ed ;imark; [◌ٍ]{.ar} (for indefinite nouns) on the final letter of the word.
-->

1. the ;ustate;, indicated, for most nouns, by a ;umark; on the final letter of the noun.
1. the ;astate;, indicated, for most nouns, by a ;amark; on the final letter of the noun.
1. the ;istate;, indicated, for most nouns, by a ;imark; on the final letter of the noun.

When a noun is indefinite, then, for most nouns, it<!--s final (state-indicating) vowel--> is also ;tanwin;ed.
...
The ;ustate; is a noun's normal state in a sentence, and there needs to be a reason to take the noun out of this state into another state.
...
+ "He talked to the man." The word "he" is used here because it is the ;mubtada;.
