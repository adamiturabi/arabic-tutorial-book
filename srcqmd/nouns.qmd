...
2. a-state: indicated by an ;amark; [◌َ]{.ar} (for definite nouns) and a ;tanwin;ed ;amark; [◌ً]{.ar} (for indefinite nouns) on the final letter of the word.
3. i-state: indicated by an ;imark; [◌ِ]{.ar} (for definite nouns) and a ;tanwin;ed ;imark; [◌ٍ]{.ar} (for indefinite nouns) on the final letter of the word.
-->
...
The choice of which state a noun is in depends on its function in a sentence. For example, if the noun is a ;mubtada; of a sentence, it will usually be in the ;ustate;. And if it is used adverbially, it will often be in the a-state. And if it occurs after a preposition, it will be in the i-state. We will learn more about putting nouns in their different states throughout this book. 
Generally speaking, the ;ustate; is the normal state. And there needs to be a reason to take the noun out of the ;ustate; and into one of the other states.
-->
