...
If the definite article [ٱَلْ]{.ar} [Eal]{.trn} is with prefixed to nouns that have an initial connecting [hamzah]{.trn2}, then the [ل]{.ar} shall no longer have an 0-mark [◌ْ]{.ar}. Instead it shall have an ;imark; [◌ِ]{.ar}. Example:
...
1. u-state: indicated by a ;umark; [◌ُ]{.ar} (for definite nouns) and a [nUn]{.trn2}ated ;umark; [◌ٌ]{.ar} (for indefinite nouns) on the final letter of the word.
2. a-state: indicated by an ;amark; [◌َ]{.ar} (for definite nouns) and a [nUn]{.trn2}ated ;amark; [◌ً]{.ar} (for indefinite nouns) on the final letter of the word.
3. i-state: indicated by an ;imark; [◌ِ]{.ar} (for definite nouns) and a [nUn]{.trn2}ated ;imark; [◌ٍ]{.ar} (for indefinite nouns) on the final letter of the word.
-->
