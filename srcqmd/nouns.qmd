...
The choice of which state a noun is in depends on its function in a sentence. For example, if the noun is a ;mubtada; of a sentence, it will usually be in the ;ustate;. And if it is used adverbially, it will often be in the ;astate;. And if it occurs after a preposition, it will be in the ;istate;. We will learn more about putting nouns in their different states throughout this book. 
