...
Even in these nouns you can see that the feminine noun usually ends with a [ة]{.ar} feminine marker. There are only a few commonly used feminine nouns that don't end with a feminine marker like [ة]{.ar}. [أُمٌّ]{.ar} [Eummun]{.trn} "mother" is one of these exceptions.
...
Note also that [نَفْس]{.ar} [nafsun]{.trn} "self" is a feminine noun but it does not end in a [ة]{.ar}. It is one of the small number of feminine nouns that don't have a female marker, like [أُمٌّ]{.ar} [Eummun]{.trn} (fem.) "mother".
