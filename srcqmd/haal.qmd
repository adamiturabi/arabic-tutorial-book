...
##### A verb as the governor of the ;hal; {.unnumbered}

The verb is the typical governor of the ;hal;.
For example:

(@) [طَلَعَتِ ٱلشَّمْسُ صَافِيَةً]{.ar}
    [@nahw_arabi@ 2/51]{.citex}  
    "The sun rose clear."

##### A ;masdar; as the governor of the ;hal; {.unnumbered}

(@) [رُكُوبُكَ ٱلسَّيَارَةَ مُسْرِعَةً خَطَرٌ عَلَيْكَ]{.ar}
    [@nahw_arabi@ 2/51]{.citex}  
    "Your riding the car speeding is a danger for you."

##### A ;shibh_fi3l; as the governor of the ;hal; {.unnumbered}

A ;shibh_fi3l; is a ;mushtaqq; noun like an ;ism_fail; or an ;ism_maful;, etc.
For example:
...
* the governor is the implied existential verb "is".
