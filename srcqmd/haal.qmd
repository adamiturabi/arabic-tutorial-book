...
A ;shibh_fi3l; is a ;mushtaqq; verbal noun like an ;ism_fail; or an ;ism_maful;, etc.
For example:
...
The former sentence is describing the horse, but not necessarily at the time when the speaker is pointing to it.
