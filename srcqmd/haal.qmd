...
<!--
In such cases it is better that the ;sahib_hal; be the one that is closest to the ;hal;.^[@nahw_wafi@ 2/386]
-->
...
(@) [مَا لَكِ يَا عَائِشُ حَشْيَا رَابِيَةً]{.ar}
    ...
    "Why are you, O [#eAEicah]{.trn2}, panting, short of breath?"  
...
### One ;hal;s for multiple ;sahibs_hal;
