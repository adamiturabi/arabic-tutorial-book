...
However, the preposition causes the noun following it to remain in the i-state. So the ;naib; doer is not indicated by an apparent ;umark; (or by the other indicators of the ;ustate;).
...
The ;ustate;, the a-state, and the 0-state.
