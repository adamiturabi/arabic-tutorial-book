...
And the ;passive; ;mudarie; verb has the same three ;case;s as the ;active; ;mudarie; verb.
For example:

+ [فُعِلُوا]{.ar} [fueilU]{.trn} "they~3m~" (;madi;)
+ [تُفْعَلَانِ]{.ar} [tufealAni]{.trn} "you~2~" or "they~2f~" (;ucase; ;mudarie;)
+ [أُفْعَلَ]{.ar} [Eufeala]{.trn} "I" (;acase; ;mudarie;)
+ etc.
...
Note that the noun [ٱَلْمَاءُ]{.ar} [EalmAEu]{.trn} "the water" is in the ;ucase;. This is because, in the absence of the doer, the ;mafulb; of the ;active; verb ([ٱَلْمَاءَ]{.ar}) is deputized to take doer's place in the ;ucase;. It is then known as the _;naib; doer_.
...
When such verbs are converted to the ;passive; verb construction, then one, and only one, ;mafulb; shall be chosen to be the ;naib; doer. It is generally preferred to make the first ;mafulb; the ;naib;-doer, and leave the second ;mafulb;, as is, in the ;acase;.
...
However, the preposition causes the noun following it to remain in the ;icase;. So the ;naib; doer is not indicated by an apparent ;umark; (or by the other indicators of the ;ucase;).
...
Other verbs don't take a ;mafulb; but may be used with an adverb of time or place in the ;acase;. 
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, below] {\scriptsize ;acase; adverb of time};
...
When this sentence is converted to an ;passive; construction then the adverb of time or place can be taken as the ;naib; doer in the ;ucase;:

[سُهِرَتْ لَيلَةُ ٱلْقَدْرِ.]{.ar}  
"The Night of Power was stayed up [in]."

Note the ;ucase; of [لَيْلَةُ]{.ar} [laylatu]{.trn} as the ;naib; doer.
...
When such sentences are converted to the ;passive; verb construction, then the ;masdar; may be taken as the ;naib; doer in the ;ucase;.
...
In the above sentence the prepositional phrase [فِي ٱلْمَسْجِدِ]{.ar} was chosen as the ;naib; doer, and the adverb of time [لَيْلَةَ]{.ar} remains, as is, in the ;acase;.

## #;case;s of the ;passive; ;mudarie; verb

The 
;passive; ;mudarie; verb
has three ;case;s, just like the
;active; ;mudarie; verb:
the ;ucase;, the ;acase;, and the ;0case;.
The three ;case;s are used in the same circumstances, and with the same rules that we have already learned.

So the ;ucase; verb is used for making plain statements:
...
The ;acase; verb is used for expressing wish or purpose:
...
Similarly, the ;0case; verb is used in the following cases:
