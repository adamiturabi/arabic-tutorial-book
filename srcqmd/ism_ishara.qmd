...
;#ism_isharah;s are different from pronouns in this regard. It is allowed to describe a ;ism_isharah; with a ;naat; in a noun phrase.
...
Just like an ;sifah;, a ;ism_isharah; can be a ;naat; in a noun-phrase. But remember from 
section\ \@ref(definiteness-of-;ism_isharah;s)
above that ;ism_isharah;s are definite.
So, if a ;ism_isharah; is a ;naat; in a noun-phrase, the ;manut; has to be definite too.
Example:
...
The ;ism_isharah; [هَـٰذَيْنِ]{.ar} is its ;naat;. It follows the ;manut; and matches it being dual, in the ;astate;, masculine, and dual.
...
<!--The ;ism_isharah; can be the ;manut;, and the ;mushar_il; noun can be the ;naat;.-->
...
In addition to being the ;mudafil;,
[ٱَلرَّجُل]{.ar}
is also a ;manut;, whose ;naat; is the ;ism_isharah;
[هَـٰذَا]{.ar}.
The literal, word-for-word, translation of this phrase is:
...
Because the ;mudafil; [زَيْد]{.ar} does not begin with [ٱَلْ]{.ar}, any ;ism_isharah;s can come only after the entire ;idafa;, thus:
...
So if we want to add the ;ism_isharah; [هَـٰذَا]{.ar} to this ;idafa; to form a ;ism_isharah; phrase,
then we have to place it at the end, after the ;idafa;, thus:

[كِتَابُهُ هَـٰذَا]{.ar}  

The ;ism_isharah; [هَـٰذَا]{.ar}, here, is a ;manut;. But what is its ;naat;?
