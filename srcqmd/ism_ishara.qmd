...
If the ;xabar; is a noun that begins with [ٱَلْ]{.ar} then it may be placed after the pointing noun subject in the same manner:
...
we insert a detached pronoun between the subject and the ;xabar;, thus:
...
Note that the second sentence's subject and ;xabar; mismatch: 
