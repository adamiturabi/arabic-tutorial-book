...
or the base noun
[ٱلرَّجُلِ]{.ar}
only exists because the ;mudaf; and the base noun match each other in gender and number: singular masculine.
If the ;mudaf; and the base noun were different in gender and number, then there would be no ambiguity. Examples:
...
We can apply the preceding discussion of pointing to the ;mudaf; and base noun to this annexation as well. So we get:
