# 0-state incomplete-action verbs
...
## Forming the 0-state incomplete-action verb
...
|Participant|Incomplete-action verb doer pronoun|u-state incomplete-action verb | 0-state incomplete-action verb|
|:---|:--|:---|:---|
...
<!--
## Uses of the 0-state incomplete-action verb
...
## Other uses of the 0-state incomplete-action verb

The 0-state incomplete-action verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
