...
a-state of ;mudarie; verbs to
chapter\ \@ref(a-state-;mudarie;-verbs).
...
## Forming the 0-state ;mudarie; verb
...
|Participant|;_mudarie; verb ;fail; pronoun|u-state ;mudarie; verb | 0-state ;mudarie; verb|
|:---|:--|:---|:---|
...
+ The ;ustate; and 0-state verbs are the same for the feminine plural absentee and addressee participants: 
  + [يَفْعَلْنَ]{.ar} (they~3+,f~)
  + [تَفْعَلْنَ]{.ar} (you~3+,f~)
+ The ;ustate; and 0-state verbs for the masculine plural absentee and addressee participants have a final silent [alif]{.trn2}: 
...
<!--
## Uses of the 0-state ;mudarie; verb
...
## Other uses of the 0-state ;mudarie; verb

The 0-state ;mudarie; verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
