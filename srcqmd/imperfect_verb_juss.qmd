...
|Participant|;_mudarie; verb ;fail; pronoun|;ustate; ;mudarie; verb | ;0state; ;mudarie; verb|
|:---|:--|:---|:---|
...
<!--
FIXME: Use with the addressee is exceedingly rare. Rather the verb of command should be used (below). See [كتاب شرح المفصل لابن يعيش]{.ar} vol 4 p. 691. Add (perhaps in passive verbs chapter), how [لام الأمر]{.ar} can be used with passive verbs for all three ;naib; ;fail;s, including addressee, and is infact the only way to command the ;naib; ;fail;.
...
for the singular masculine addressee ;fail; "he":
