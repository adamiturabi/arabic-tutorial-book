...
We introduced the u-state ;mudarie; verb in
chapter\ \@ref(u-state-;mudarie;-verbs).
In this chapter we will study the 
a-state
;mudarie; verb.

The u-state ;mudarie; verb makes a plain statement.
...
Here is the u-state ;mudarie; verb for the singular masculine absentee participant ;fail; "he":

[يَفْعَلُ]{.ar}  
[yafealu]{.trn}  
"he does"

Note that, because it is in the u-state, the its final letter ends with a ;umark; [◌ُ]{.ar}.
...
This is done for all participants whose ;fail; pronoun is invisible and u-state verb ends with a ;umark; [◌ُ]{.ar}.

For participants whose ;fail; pronoun is followed by an extra [ن]{.ar} in the u-state verb, this final [ن]{.ar} is dropped in order to form the 
a-state
;mudarie; verb.
...
Now
[رَأْس]{.ar}
is in the u-state because it is actually the ;mubtada; of a new sentence, whose ;xabar; is (an either expressed or implied) [أَكَلْتُهَا]{.ar} "I ate it".
[حَتَّىٰ]{.ar},
...
When used with a following ;mudarie; verb, the verb is put in the u-state and the meaning is that the action of the verb _before_
[حَتَّىٰ]{.ar}
...
<!--The preposition 
[حَتَّىٰ]{.ar} [HattA]{.trn}
is unusual in that the ;mudarie; verb following it may either be in the a-state or the u-state, with slightly different meanings.
When the ;mudarie; verb following it is in the u-state then
