...
3. Quite similar to what we learned in section\ \@ref(the-direct-doee-in-i-state-preceded-by-the-preposition-%D9%84-li) for doing verbal-nouns, the ;mafulb; can follow the doer verbal-noun in the i-state preceded by the preposition [لِ]{.ar} [li]{.trn}.
