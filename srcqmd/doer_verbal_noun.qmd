...
The ;ismfail; gives the meaning of the doer, that is the person doing the action of the verb. For example, for the verb [قَرَأَ يَقْرَأُ قِرَاءَةً]{.ar}  "to read", the ;ismfail; is [قَارِئ]{.ar} [qAriE]{.trn} "a reader".
...
Like the ;masdar;, the ;ismfail; occupies a place that is between a noun and a verb. The basic, most essential, meaning of the ;ismfail; is that of a noun which denotes the doer of the verb.

So, for example, consider the verb [سَأَلَ يَسْأَلُ سُؤَالًا]{.ar}  "to question". Its ;ismfail; is [سَائِل]{.ar}. Since it refers to the doer of this verb, we can translate it as "a questioner~m.~".
...
The ;ismfail; may be used in place of the verb it is derived from to indicate an intent on the part of the doer, or to indicate that the action will occur in the future.
...
In this sentence, [زَيْدٌ]{.ar} [zaydun]{.trn} "Zayd" is the doer. The corresponding ;ismfail; that refers to him is [سَائِل]{.ar} [sAEil]{.trn} "a questioner~m.~".
...
## Doer and ;ismmaful;s re-used as adjectival-nouns

Doer and ;ismmaful;s are often re-used as adjectival-nouns with meanings that are directly formed from their doer and ;ismmaful; meanings respectively. Here are some examples:

|Verb | Doer/;ismmaful; | Adjectival-noun meaning|
|:------|:-|:--|
...
### Genderizability of doer and ;ismmaful;s when re-used as adjectival-nouns

When a doer or ;ismmaful; is re-used as an adjectival-noun, then it generally retains its genderizability. For example,
...
## Doer and ;ismmaful;s re-used as common nouns
...
The re-use of a ;ismfail; or ;ismmaful; as a common noun does not prevent it from continuing to be used with its doer/;mafulb; or verbal meaning.
...
|Verb | Doer/;ismmaful; | Plural | Common noun meaning|
|:------|:-|:-|:--|
...
### Genderizability of doer and ;ismmaful;s when re-used as common nouns

When a doer or ;ismmaful; is re-used as a common noun, then it loses its genderizability. For example, if we wish to say "The building is a university." we will say:
...
once a doer or ;ismmaful; is re-used as a common noun, it loses its genderizability. 
