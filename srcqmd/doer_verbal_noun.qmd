...
We have learned that the essential meaning of the ;ismfail; is the doer of the action of the verb from which it is derived. In addition to this essential meaning, the ;ismfail; can also be used in place of the verb from which it is derived. This is only done when the verb to be replaced is the incomplete-action verb. The ;ismfail; does not replace the ;madi; verb. We will now explain this usage.
