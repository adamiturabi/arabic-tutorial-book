...
Like the ;masdar;, the doer verbal noun occupies a place that is between a noun and a verb. The basic, most essential, meaning of the doer verbal noun is that of a noun which denotes the doer of the verb.
...
Here is an example of the usage of the doer verbal-noun as a future tense verb with an ;indir_mafulb;:
...
If a verb takes a ;mafulb;, and we wish to use the ;mafulb; with the verb's doer verbal-noun when the doer verbal-noun is acting as a verb, then we may deal with it in one of three ways:

1. The ;mafulb; in a-state following the doer verbal-noun

   The most basic method of dealing with a ;mafulb; of a doer verbal noun is by placing it in the a-state right after the doer verbal-noun. Here is an example,
...
2. The ;mafulb; in i-state annexed to the doer verbal-noun

   The combination of the doer verbal-noun and following ;mafulb; in the a-state is often replaced with an ;idafa; of the doer verbal-noun to the i-state ;mafulb;. So, for example, instead of the above example, we can say:
   ...
   Note that [قَاتِلُ سُكَّانِهَا]{.ar} [qAtilu sukkAnihA.]{.trn} can also support the non-verbal meaning of the doer verbal-noun: "killer of its residents", i.e., he has already killed its residents in the past. So, when an ;idafa; is used with a doer verbal-noun, we will often need surrounding context to tell us whether the verbal (incomplete-action) meaning is intended, or the noun  meaning.

   This usage of annexing the doer verbal-noun to the i-state ;mafulb; instead of employing the more basic usage of the doer verbal-noun and a following a-state ;mafulb; is optional, but fairly common. In fact, when the doer-verbal noun is indefinite and [nUn]{.trn2}ated, and the ;mafulb; begins with [ٱَلْ]{.ar} [Eal]{.trn}, then the ;idafa; usage becomes predominant over the basic a-state usage. So we will be more likely to see:
   ...
   The ;idafa; of a doer verbal-noun to its ;mafulb; in the i-state is not the kind of "proper" ;idafa; that we have learned so far. In fact, it is called an _improper ;idafa;_ and we shall study it in more detail in chapter [TODO], if [#allAh]{.trn2} wills.

3. Quite similar to what we learned in section\ \@ref(the-direct-doee-in-i-state-preceded-by-the-preposition-%D9%84-li) for ;masdar;s, the ;mafulb; can follow the doer verbal-noun in the i-state preceded by the preposition [لِ]{.ar} [li]{.trn}.
   ...
   Using [لِ]{.ar} [li]{.trn} in this manner is also a technique to move the ;mafulb; before the doer verbal-noun for effect, if desired. For example,
