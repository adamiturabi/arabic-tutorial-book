...
## Definition of Standard Classical Arabic
...
[sca]{.smallcaps}.^[See also @faysal_mansoor_articles@ 93--95]
...
As we will learn
in this book ;ia;,
there are very exact rules for properly pronuncing and pausing in 
[sca]{.smallcaps}.

Practically, however, most native Arabic speakers today rarely adhere exactly to these rules in extemporaneous speech.
Furthermore, speakers may sometimes mix in their vernacular dialect within their
[sca]{.smallcaps}
speech.
This is done in a natural manner which is familiar to the audience.
In fact,
a strict adherence to all [sca]{.smallcaps} grammar and enunciation rules in informal spoken settings may, today, come across as turgid or pedantic.^[@hallberg_thesis@ 54--55, 86]
