...
In modern times, many new words and meanings were been added to Standard Arabic, often via translation from Western languages, to keep up with technological advancements and modern media. 
...
% TIMELINE - simple test
  ...
  % label
  \yearLabel(300,\textsc{sca})
  \yearLabel(1330,\textsc{msa})
