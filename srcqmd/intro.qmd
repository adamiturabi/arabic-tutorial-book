...
In this book, we will study the grammar of Standard Classical Arabic. If [#allAh]{.trn2} wills, this will help you to begin to understand the language of the ;quran;, the [#HadIv]{.trn2}, and [#islAm]{.trn2}ic literature.
...
<!--
Blah Blah [see @Jamii2005]
-->

See that @radiy_kafiyah@ says^[@wright@ 2/45A]

Some example [@nahw_wafi@ 4/234]{.citex}

Some example [@fischer@ 4/234]{.citex}
