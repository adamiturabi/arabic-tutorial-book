...
speech.
In fact,
a strict adherence to all [sca]{.smallcaps} grammar and pronunciation rules in informal spoken settings may, today, come across as pretentious or overly formal.^[@hallberg_thesis@ 54--55. see also p.\ 86]

Our advice to the learner who wishes to speak his newly learned Arabic
is to learn to
be comfortable with different spheres of Arabic,
each with its sociolinguistic norms.
...
Then the scholar will begin the instructional part of his lecture.
...
and then more relaxed when elaborating some particular point.
...
from his knowledge of his domain
(even if that domain be
[sca]{.smallcaps} itself).
Within the lecture,
...
perhaps over a meal or refreshments.
The conversation in this setting will almost entirely be in
vernacular dialect(s).

In order to benefit from this society,
it is advisable to conform to its norms.
Therefore, it may not be a bad idea to supplement your learning of
[sca]{.smallcaps}
...
Even the most excellent of people they would not spare!
...
Write some of the examples as you are studying and try to understand how the example is relevant to the discussion.
