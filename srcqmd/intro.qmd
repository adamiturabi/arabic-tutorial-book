...
One such criterion was that the text sample be from native Classical Arabic speech.
...
[sca]{.smallcaps}
was then only an attempt to conform to the standard.
...
[sca]{.smallcaps}.^[@faysal_mansoor_articles@ 93--95]

As a new learner, this exactitude is largely academic,
(though it is good to be aware of such niceties).
