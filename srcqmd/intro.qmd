...
[#allAh]{.trn2}, may He be glorified and exalted, revealed the ;quran; 1400 years ago to the Prophet [#muHammad]{.trn2}, may [#allAh]{.trn2} grant peace and confer blessing upon him.
...
And so, there began to exist two very distinct types of Arabic: the preserved [sca]{.smallcaps} which was taught by formal education and which is primarily a written language, and the vernacular Arabic dialects which Arabs learned as their mother tongue and which are primarily only spoken and not written.
...
Even in religious lectures, the speaker often relaxes his adherence to [sca]{.smallcaps} rules.
...
A strict adherence to all [sca]{.smallcaps} grammar and enunciation rules in informal settings may, today, come across as turgid or pedantic.

In this context, it may be appropriate to say a few words about what constitutes [sca]{.smallcaps} proper.
When the Arab grammarians were first recording and describing Classical Arabic.
they would only accept samples of speech and texts from authoritative sources.
And they had criteria for determining what constituted an authoritative source.
One such criterion was that the text sample be from native Classical Arabic speech.^[@faysal_mansour_articles@ 555]

Once [sca]{.smallcaps} emerged as a standard variety,
Classical Arabic itself had more or less ceased to be a native language.
All literary output produced in
[sca]{.smallcaps}
was then only an attempt to conform to a standard.
...
As a new learner, this exactitude is fairly academic, and you may feel free to emulate the writing of good writers of [sca]{.smallcaps}.
But it is good to be aware of such niceties when reading the works of the scholars.
