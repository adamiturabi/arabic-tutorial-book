...
i. [ٱَلْجَارِيَةُ ٱلصَّغِيرَةُ]{.ar}  
   ...
   In this phrase the definite feminine noun [ٱلْجَارِيَةُ]{.ar} [EaljAriyatu]{.trn} is the ;fail; of the verb [أَخَذَ]{.ar} [Eaxapa]{.trn} "took". Therefore it is in the ;ustate;. It is also the ;manut; in the descriptive noun-phrase. Its ;naat; [ٱَلصَّغِيرَةُ]{.ar} [EaSSagIratu]{.trn} follows the ;manut; and is made to match the ;manut; in state (;ustate;), gender (feminine), and definiteness (definite).

ii. [كِتَابًا جَدِيدًا]{.ar}  
    [kitAban jadIdan]{.trn}  
    "a new book"

    In this phrase the indefinite masculine noun [كِتَابًا]{.ar} [kitAban]{.trn} is the ;mafulb; of the verb [أَخَذَ]{.ar} [Eaxapa]{.trn} "took". Therefore it is in the ;astate;. It is also the ;manut; in the descriptive noun-phrase. Its ;naat; [جَدِيدًا]{.ar} [jadIdan]{.trn} follows the ;manut; and is made to match the ;manut; in state (;astate;), gender (masculine), and definiteness (indefinite).

iii. [ٱَلْأُمِّ ٱلطَّيِّبَةِ]{.ar}  
     [EalEummi -TTayyibati]{.trn}  
     "the good mother"

      In this phrase the definite feminine noun [ٱلْأُمِّ]{.ar} [EalEummi]{.trn} is following the preposition [مِنْ]{.ar} [min]{.trn} "from". Therefore it is in the ;istate;. It is also the ;manut; in the descriptive noun-phrase. Its ;naat; [ٱَلطَيِّبَةِ]{.ar} [EaTTayyibati]{.trn} follows the ;manut; and is made to match the ;manut; in state (;istate;), gender (feminine), and definiteness (definite). 
