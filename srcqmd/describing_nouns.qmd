...
+ The ;sifah; ;naat; [ٱَلصَّغِير]{.ar} [EaSSagIr]{.trn} "the small one~m~" matches the ;manut; [ٱَلْبَيْت]{.ar} [Ealbayt]{.trn} "the house" in state. In this example, they were both in the u-state but we will see examples in the other states as well.
