...
i.  The ;mubtada;: [ٱَلْبَيْتُ]{.ar} [Ealbaytu]{.trn} (masc.) "the house" (u-state)
ii. The ;xabar;: [بِنَاءٌ]{.ar} [binAEun]{.trn} (masc.) "a building" (u-state)
...
i.   The ;mubtada;: [ٱَلْبِنَاءُ]{.ar} [EalbinAEu]{.trn} (masc.) "the building" (u-state)
ii.  The ;xabar;: [مَدْرَسَةٌ]{.ar} [madrasatun]{.trn} (fem.) "a school" (u-state)
...
i.  The ;mubtada;: "the mother": [ٱَلْأُمُّ]{.ar} [EalEummu]{.trn} (fem.) (u-state).
...
As opposed to flexible nouns, there are some nouns whose ending is not determined by their state. They can appear the same no matter if they are in the ;ustate;, a-state, or i-state. We will call them _rigid_ nouns. Pronouns are rigid nouns.
-->
