...
Next we put them both in the u-state. For ;mubtada;-;xabar; sentences, both the ;mubtada; and the ;xabar; shall be in the u-state. Remember that the u-state is formed by putting a [nUn]{.trn2}ated ;umark; [◌ٌ]{.ar} at the end of an indefinite noun, and a ;umark; [◌ُ]{.ar} at the end of a definite noun. Here are the two nouns in the u-state:
...
and "a building" is [بِنَاءٌ]{.ar} [binAEun]{.trn}. In order to say "The house is a building" we put the [;mubtada;]{.syn} first and put its [;xabar;]{.syn} after it. Both the [;mubtada;]{.syn} and the [;xabar;]{.syn} are put in the u-state.
...
Arabic does not normally express the word "is". In order to express this sentence in Arabic we put the [;mubtada;]{.syn} first and then the [;xabar;]{.syn}. For these simple sentences the [;mubtada;]{.syn} and the [;xabar;]{.syn} will be in the u-state.

"The house" is [ٱَلْبَيْتُ]{.ar} [albaytu]{.trn} and "a building" is [بِنَاءٌ]{.ar} [binAEun]{.trn}. In order to say "The house is a building" we put the [;mubtada;]{.syn} first and put its [;xabar;]{.syn} after it. Both the [;mubtada;]{.syn} and the [;xabar;]{.syn} are put in the u-state.
