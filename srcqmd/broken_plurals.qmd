...
If the ;mubtada; of a sentence is a plural denoting intelligent beings then the ;xabar; typically matches it in being a plural. This is especially the case if the ;xabar; is an adjectival noun. For example:
...
By the way, this rule only applies to adjectival nouns in the describee or the ;xabar;. A common noun in the describer or ;xabar; will continue match the describee or ;mubtada; in gender and number.
