...
Most nouns in Arabic are _fully-flexible_. This means that, when indefinite, they are ;tanwin;ed and the indefinite i-state is shown by a ;tanwin;ed ;imark; [◌ٍ]{.ar} at the end of the noun. For example, [رَجُل]{.ar} [rajul]{.trn} "a man" and [بَيْت]{.ar} [bayt]{.trn} "a house" are fully-flexible nouns. So, you can see, below, that they are ;tanwin;ed, and the indefinite i-state is indicated by a ;tanwin;ed ;imark; [◌ٍ]{.ar}:

[ذَهَبَ رَجُلٌ إِلَىٰ بَيْتٍ.]{.ar}  
[pahaba rajulun EilA bayt.]{.trn}  
"A man went to a house."

Some nouns are _semi-flexible_. This means that they are not ;tanwin;ed, and also, the indefinite i-state is indicated by an ;amark; [◌َ]{.ar}. Examples of such nouns are:
...
+ Both common nouns and ;sifah;s form broken plurals.
...
+ The broken plural patterns [فِعْلَان]{.ar} [fielAn]{.trn} and [فُعْلَان]{.ar} [fuelAn]{.trn} are fully-flexible nouns. Although they end with the [ان]{.ar} ending which is extrinsic to the root, they are not semi-flexible nouns. Only singular ;sifah;s that end with an extrinsic [ان]{.ar} on the pattern [فَعْلَان]{.ar}, and that also fulfil the other conitions listed in section\ \@ref(;sifah;-an-diptote), are semi-flexible.
...
+ The letters [ء]{.ar}, [ا]{.ar}, [و]{.ar}, and [ي]{.ar} are considered _weak_ letters. Words that one or more these weak letters in their roots are called _defective_ words. We will discuss defective words more completely in later chapters, if [_allAh]{.trn2} wills. For now, we will note the following:
  ...
  + A [ي]{.ar} at the end of a word, in some states, gets omitted  and replaced by a ;tanwin;ed ;imark; [◌ٍ]{.ar} on the preceding letter. This happens even when the [ي]{.ar} is extrinsic to the root, and even if the word is semi-flexible (and thus would not normally be ;tanwin;ed). Examples:
...
2. Sometimes, the usage of one of the plurals may be restricted. For example, [ضِعَاف]{.ar} and [ضُعَفَاء]{.ar} are both broken plurals of the masculine ;sifah; [ضَعِيف]{.ar} "a weak one~m~". For male intelligent beings, like "weak men", either of the two plurals could be used. But remember that broken plurals that end with an extrinsic [اء]{.ar} ending may only be used for male intelligent beings. So the plural [ضُعَفَاء]{.ar} may only be used for male intelligent beings like "men" or "boys", and not for masculine nouns that denote non-intelligent beings like "lions" or "pens", etc.

   Interestingly, [ضِعَاف]{.ar} is also shared as the broken plural for the feminine ;sifah; [ضَعِيفَة]{.ar} "a weak one~f~". So it can be used for plurals of feminine nouns, both for female intelligent beings like "women" and "girls", and for feminie nouns that denote non-intelligent beings like "trees".
...
+ ;_sifah;s of the pattern ^2^[فَعْلَاء]{.ar} which is the feminine of the masculine ;sifah; pattern ^2^[أَفْعَل]{.ar}. For example, [حور]{.ar} [حَوْرَاء]{.ar} [HawrAE]{.trn} "a beautiful eyed one~f~" uses the broken plural [حُور]{.ar} [HUr]{.trn}

+ ;_sifah;s of the pattern ^2^[فَعْلَىٰ]{.ar} which is the feminine of the masculine ;sifah; pattern ^2^[فَعْلَان]{.ar}. For example, [غضب]{.ar} [غَضْبَىٰ]{.ar} [gaDbA]{.trn} "very angry~f~" uses the broken plural [غِضَاب]{.ar} [giDAb]{.trn}.
...
Consistent with what we have learned so far, when the ;manut; in a noun-phrase is plural, then the ;naat; comes after it, and matches it in state, definiteness, gender, and number.

Either or both of the ;naat; and the ;manut; may be sound plurals or broken plurals.
...
### Plurals of intelligent beings in ;mubtada;-;xabar; sentences

If the ;mubtada; of a sentence is a plural denoting intelligent beings then the ;xabar; typically matches it in being a plural. This is especially the case if the ;xabar; is an ;sifah;. For example:
...
Sometimes the ;xabar; may not match the ;mubtada; in plurality because of the meaning of the sentence. For example:
...
regardless of the grammatical or physical gender of the singular noun, plurals of non-intelligent beings are treated, for the purposes of matching ;sifah;s and pronouns, as
...
For the second option (feminine plural), in addition to the sound feminine plural of ;sifah;s, broken plurals are allowed to be used as well, as long as their meaning allows them to be used for non-intelligent beings.
-->
...
(Note how ^2^[أَشْيَاء]{.ar} is indefinite but is not ;tanwin;ed. This is because it is irregularly semi-flexible.)

By the way, this rule only applies to ;sifah;s in the ;manut; or the ;xabar;. A common noun in the ;naat; or ;xabar; will continue match the ;manut; or ;mubtada; in gender and number.
...
then [حَسَنَة]{.ar} may only be the feminine ;sifah; "a good one".
...
Similarly, if an ;sifah; connoting a non-intelligent being is used not as a ;naat; or an ;xabar; in a sentence, then it should be pluralized to indicate plurality.
