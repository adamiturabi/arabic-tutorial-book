...
### Plurals of intelligent beings in subject-;xabar; sentences

If the subject of a sentence is a plural denoting intelligent beings then the ;xabar; typically matches it in being a plural. This is especially the case if the ;xabar; is an adjectival noun. For example:
...
Sometimes the ;xabar; may not match the subject in plurality because of the meaning of the sentence. For example:
...
regardless of the grammatical or physical gender of the singular noun, plurals of non-intelligent beings are treated, for the purposes of matching adjectival nouns and pronouns, as
...
By the way, this rule only applies to adjectival nouns in the describee or the ;xabar;. A common noun in the describer or ;xabar; will continue match the describee or subject in gender and number.
...
Similarly, if an adjectival noun connoting a non-intelligent being is used not as a describer or an ;xabar; in a sentence, then it should be pluralized to indicate plurality.
