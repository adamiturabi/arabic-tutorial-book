...
We have already studied the ;ucase; of ;mudarie; verbs in 
chapter\ \@ref(;ucase;-;mudarie;-verbs).
And we will defer the study of 
;acase; of ;mudarie; verbs to
chapter\ \@ref(;acase;-;mudarie;-verbs).
...
## Forming the ;0case; ;mudarie; verb
...
|Participant|#;mudarie; verb ;faa3il; pronoun|;ucase; ;mudarie; verb | ;0case; ;mudarie; verb|
|:---|:--|:---|:---|
...
+ The ;ucase; and ;0case; verbs are the same for the feminine plural absentee and addressee participants: 
  + [يَفْعَلْنَ]{.ar} (they~3+,f~)
  + [تَفْعَلْنَ]{.ar} (you~3+,f~)
+ The ;ucase; and ;0case; verbs for the masculine plural absentee and addressee participants have a final silent [alif]{.trn2}: 
...
<!--
## Uses of the ;0case; ;mudarie; verb

The ;ucase; is the default ;case; for ;mudarie; verbs. The 
;0case;
...
The indirect command is only rarely used for the addressee participant.^[[@ibn_ya3ish_mufassal@ 4/291--293](https://shamela.ws/book/13301/1655#p1). See also references to @https://tafsir.app/albahr-almuheet/10/58@ and other [tafsIr]{.trn2}s for the reading [فبذلك فلتفرحوا]{.ar}]
...
Finally, the [لِ]{.ar} before a ;0case; ;mudarie; verb for the indirect command is mandatory.
But it may be dropped by poetic license.^[[@ibn_ya3ish_mufassal@ 4/291--292](https://shamela.ws/book/13301/1655#p1)]
...
By the way, [لَا]{.ar} does not force a verb to be in the ;ucase;
;0case;. We have already seen in 
section\ \@ref(;ucase;-verb-negation-la)
that [لَا]{.ar} can be used to negate a ;ucase; ;mudarie; verb for the present and future tense.
Example:
...
## Other uses of the ;0case; ;mudarie; verb

The ;0case; ;mudarie; verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
...
Instead, the 
;0case; verb is used with [لَا]{.ar}
as described in
