...
We had mentioned that there are approximately 10 commonly used verb forms. And we have already studied the ;madi; verb for form 1. In this chapter we will study incomplete-action form 1 verbs. Incomplete-action verbs are used when the action of a verb is on-going at present or will occur in the future.

## Pattern for form 1

Using the root paradigm [فعل]{.ar}, we have already seen that ;madi; verbs for form 1 occur in the patterns [فَعَلَ]{.ar} [faeala]{.trn}, [فَعِلَ]{.ar} [faeila]{.trn}, and [فَعُلَ]{.ar} [faeula]{.trn}. The patterns for form 1 incomplete-action verbs are [يَفْعَلُ]{.ar} [yafealu]{.trn}, [يَفْعِلُ]{.ar} [yafeilu]{.trn}, and [يَفْعُلُ]{.ar} [yafeulu]{.trn}.
...
1. If the ;madi; verb has an [a]{.trn}-mark on the middle letter, the incomplete-action verb's middle letter can have either an [a]{.trn}-mark, [i]{.trn}-mark, or an [u]{.trn}-mark, depending on the verb. For example,
...
2. If the ;madi; verb has an [i]{.trn}-mark on the middle letter, the incomplete-action verb's middle letter will usually have an [a]{.trn}-mark. Rarely, for a few verbs, it may be an [i]{.trn}-mark instead. For example,
...
3. If the ;madi; verb has an [u]{.trn}-mark on the middle letter, the incomplete-action verb's middle letter shall have a [u]{.trn}-mark. For example,

   + [كَبُرَ يَكْبُرُ]{.ar} [kabura yakburu]{.trn} "he grew big, he grows big"

It is possible for some incomplete-action verbs to have more than option for the vowel mark on the middle letter. Both variants give the same meaning for the verb. For example, the ;madi; verb [حَسِبَ]{.ar} [Hasiba]{.trn} "he deemed" has as its incomplete-verb both [يَحْسِبُ]{.ar} [yaHsibu]{.trn} and [يَحْسَبُ]{.ar} [yaHsabu]{.trn}.
...
As opposed to ;madi; verbs, which don't have any state, incomplete-action verbs do have a state which is determinined by the function of the verb in a sentence. Similar to nouns, the state of an incomplete-action verb is indicated by the vowel mark or suffix at the end of the verb.
...
The ;mafulb; (either as a noun or a pronoun) with incomplete-action verbs work exactly as with ;madi; verbs.
...
The doer pronouns for incomplete-action verbs are different from the doer pronouns for ;madi; verbs.
...
We'll show what all this means in the table below of verbs with doer pronouns. ;#madi; verbs are included as well so that you can contrast them with their incomplete-action counterparts.

|Person|;#madi; doer pronoun|;#madi; verb with doer pronoun|Incomplete-action verb doer pronoun|Incomplete-action verb with doer pronoun in the u-state|
|:---|:--|:----|:--|:----|
...
As with ;madi; verbs, incomplete-action verbs too can be negated by placing the particle [مَا]{.ar} before them. This negates the meaning of the verb usually for the present tense. For example,
