...
For examples 2 through 7 we use a particle before the subject that puts the subject in the ;acase;. The information remains in the ;ucase;. We call these particles "the [إنّ]{.ar} family".

For examples 8 and 9 Arabic uses verbs. The subject is the doer of the verb and the information is the object. And just like all verbs, the doer is in the ;ucase; while the object is in the ;acase;. There are a few other verbs that express a similar meaning of "became". We call these verbs "the [كان]{.ar} family".
...
+ masdar
  ...
  + with iDaafa
    ...
    + with both doer and doee. doee is in the ;acase;
