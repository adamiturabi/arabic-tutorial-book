...
## Duals in subject-;xabar; sentences

In subject-;xabar; sentences, if the subject is a dual, and the ;xabar; is a adjectival noun, then the ;xabar; will typically match the subject in being a dual. For example:
...
<!--Note that both [ٱَلْمَرْأَتَانِ]{.ar} [EalmarEatAni]{.trn} "the two women" and [أُمَّانِ]{.ar}  [EummAni]{.trn}  "two mothers" are in the u-state because, just like for sentences with singulars, the subject and ;xabar; are put in the u-state.-->
...
Sometimes, however, the subject and ;xabar; may not match in number because of the meaning of the sentence. For example,
...
In the above example, the ;xabar; does not match the subject in both number, and, as it happens, in gender.
...
The above verbal sentence can be rearranged to be a subject-;xabar; sentence. This gives more emphasis to the subject. In this case, the verb shall follow the subject and will need a doer pronoun after it.
...
The above verbal sentence can be rearranged to be a subject-;xabar; sentence. In that case, all the verbs shall have doer pronouns. The sentence will have the same translation as above, except for an emphasis on the subject of the sentence.
