...
The dual is formed by appending the dual suffix [◌َانِ]{.ar} [-Ani]{.trn} when the noun is in the ;ustate; and [◌َيْنِ]{.ar} [-ayni]{.trn} when the noun is in the ;astate; or ;istate;. Definite nouns, which have [ٱَلْ]{.ar} in their beginning are dualized the same way. 

For example, when we dualize [بَيْت]{.ar} [bayt]{.trn} "a house" in order to say "houses~2~", we get:

| States | Indefinite | Definite
|:----|:-------|:-------
|;ustate;         | [بَيْتَانِ]{.ar} [baytAni]{.trn}  | [ٱَلْبَيْتَانِ]{.ar} [EalbaytAni]{.trn}
|;astate; and ;istate; | [بَيْتَيْنِ]{.ar} [baytayni]{.trn} | [ٱَلْبَيْتَيْنِ]{.ar} [Ealbaytayni]{.trn}   

Note that indefinite duals are not ;tanwin;ed. The only difference between definite and indefinite duals is the definite article [ٱَلْ]{.ar} "the". 
...
| States | Indefinite | Definite
:----|:-------|:-------
;ustate;         | [شَجَرَتَانِ]{.ar} [cajaratAni]{.trn} | [ٱَلشَّجَرَتَانِ]{.ar} [EaccajaratAni]{.trn}
;astate; and ;istate; | [شَجَرَتَيْنِ]{.ar} [cajaratayni]{.trn}| [ٱَلشَّجَرَتَيْنِ]{.ar} [Eaccajaratayni]{.trn}
...
+ ;ustate;: [أُمَّانِ]{.ar} [EummAni]{.trn}
+ ;astate; and ;istate;: [أُمَّيْنِ]{.ar} [Eummayni]{.trn}
...
|Root|Singular| Dual (;ustate;) |Dual (;astate; and ;istate;)|
|:-|:-----|:--|:--|
...
The word [خِبَاء]{.ar} [xibAE]{.trn} "a tent" is from the root [خبء]{.ar} and is on the pattern [فِعَال]{.ar}. Its duals are [خِبَاءَانِ]{.ar} (;ustate;), and [خِبَاءَيْنِ]{.ar} (;astate; and ;istate;) "tents~2~".
...
## Dual ;naat;s and ;manut;s in descriptive noun-phrases

We learned that when an ;sifah; is a ;naat; in an descriptive noun-phrase, then it matches the ;manut; in definiteness, state, and gender.  For example:

[ذَهَبْتُ إِلَى ٱلْمَدِينَةِ ٱلْقَدِيمَةِ.]{.ar}  
[pahabtu Eila -lmadInati -lqadImah.]{.trn}  
"I went to the old city."

To this we add that the ;naat; shall also match the ;manut; in number. So if the ;manut; is a dual then the ;sifah; ;naat; shall be dualzed to match it. Examples:
...
<!--Just like common nouns, ;sifah;s are also dualized. When a ;sifah; is used to describe a dual noun, the ;sifah; will also be dual. Examples:
...
## Duals in ;mubtada;-;xabar; sentences

In ;mubtada;-;xabar; sentences, if the ;mubtada; is a dual, and the ;xabar; is a ;sifah;, then the ;xabar; will typically match the ;mubtada; in being a dual. For example:
...
<!--Note that both [ٱَلْمَرْأَتَانِ]{.ar} [EalmarEatAni]{.trn} "the two women" and [أُمَّانِ]{.ar}  [EummAni]{.trn}  "two mothers" are in the ;ustate; because, just like for sentences with singulars, the ;mubtada; and ;xabar; are put in the ;ustate;.-->

Such is usually also the case even when the ;xabar; is a common noun, not an ;sifah;. For example,

[ٱَلرَّجُلَانِ مُعَلِّمَانِ.]{.ar}  
[EarrujulAni mueallimAn.]{.trn}  
"The men~2~ are teachers~m,2~."

Sometimes, however, the ;mubtada; and ;xabar; may not match in number because of the meaning of the sentence. For example,
...
In the above example, the ;xabar; does not match the ;mubtada; in both number, and, as it happens, in gender.
...
In the last example, the feminine ;sifah; [قَرِبَتَانِ]{.ar} [qarIbatAni]{.trn} is used because it is referring to the feminine noun [ٱَلْجَارِيَتَيْنِ]{.ar} [EaljAriyatayni]{.trn} "the girls~2~".
...
We learned that the ;madi; verb for a masculine doer is on the pattern [فَعَلَ]{.ar}. And when the doer is feminine, the [ت]{.ar} of femininity is attached to the verb thus: [فَعَلَتْ]{.ar}. We have used these verbs with singular doer nouns. The doer noun always comes after the verb and shall be in the ;ustate;. Examples:
...
The above verbal sentence can be rearranged to be a ;mubtada;-;xabar; sentence. This gives more emphasis to the ;mubtada;. In this case, the verb shall follow the ;mubtada; and will need a doer pronoun after it.
...
The above verbal sentence can be rearranged to be a ;mubtada;-;xabar; sentence. In that case, all the verbs shall have doer pronouns. The sentence will have the same translation as above, except for an emphasis on the ;mubtada; of the sentence.
