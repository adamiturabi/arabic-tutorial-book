...
In ;mubtada;-;xabar; sentences, if the ;mubtada; is a dual, and the ;xabar; is a adjectival noun, then the ;xabar; will typically match the ;mubtada; in being a dual. For example:
...
Such is usually also the case even when the ;xabar; is a common noun, not an adjectival noun. For example,
