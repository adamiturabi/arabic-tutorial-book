...
The above verbal sentences with plural ;faa3il;s can be rearranged to be a ;mubtada;-;xabar; sentences. This gives more emphasis to the ;mubtada;. In this case, the verb shall follow the ;mubtada; and will need a ;faa3il; pronoun after it.
...
The above verbal sentence can be rearranged to be a ;mubtada;-;xabar; sentence. In that case, all the verbs shall have ;faa3il; pronouns. The sentence will have the same translation as above, except for an emphasis on the ;mubtada; of the sentence.
...
The above verbal sentence can be rearranged to be a ;mubtada;-;xabar; sentence. This gives more emphasis to the ;mubtada;. In this case, the verb shall follow the ;mubtada; and will need a ;faa3il; pronoun after it.
...
If the sentence is a ;mubtada;-;xabar; sentence, and the verb is in the ;xabar;, then the ;faa3il; pronoun corresponding to the number of the ;mubtada; is used. Examples:
