...
+ The absentee plural masculine verb doer pronoun "they~3,m~" [و]{.ar} [U]{.trn} is written with a silent [alif]{.trn2} after it which is written only and not pronounced. This [alif]{.trn2} is dropped when a doee pronoun is attached. For example: 
...
+ The final 0-mark on the [مْ]{.ar} in the masculine plural pronouns ([هُمْ]{.ar} [hum]{.trn}, [هُمْ]{.ar} [-hum]{.trn}, [أَنْتُمْ]{.ar} [Eantum]{.trn}, [تُمْ]{.ar} [-tum]{.trn}, [كُمْ]{.ar} [-kum]{.trn}) becomes a [u]{.trn}-mark ([هُمُ]{.ar} [humu]{.trn}, [هُمُ]{.ar} [-humu]{.trn}, [أَنْتُمُ]{.ar} [Eantumu]{.trn}, [تُمُ]{.ar} [-tumu]{.trn}, [كُمُ]{.ar} [-kumu]{.trn} respectively) when followed by a connecting [hamzah]{.trn2}. Examples:
  + [هُمُ ٱلْمُعَلِّمُونَ.]{.ar}  
    ...
    "They~pl.\ masc.~ are the (male) teachers."
+ The plural masculine verb doer pronoun for the absent person "they~pl.\ masc.~" [ـُوا]{.ar} [U]{.trn} has a silent [alif]{.trn2} which is written only and not pronounced. This [alif]{.trn2} is dropped when a doee pronoun is attached. For example: 
  + [ضَرَبُوا ٱلرَّجُلَ.]{.ar}  
    [Darabu -rrajula.]{.trn}  
    "They hit the man.
  + [ضَرَبُوهُ.]{.ar}  
