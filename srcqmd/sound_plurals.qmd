...
1.  If a common noun is of the pattern [فَعْل]{.ar} [fael]{.trn} or [فَعْلَة]{.ar} [faelah]{.trn}, then the 0-mark on the middle letter shall be converted to an ;amark; [◌َ]{.ar} when forming the [At]{.trn} sound plural. For example:
...
2.  If a common noun is of the pattern [فِعْل]{.ar} [fiel]{.trn}, [فِعْلَة]{.ar} [fielah]{.trn}, [فُعْل]{.ar} [fuel]{.trn}, or [فُعْلَة]{.ar} [fuelah]{.trn} then the 0-mark on the middle letter can, optionally, either:
...
+ The final 0-mark on the [مْ]{.ar} in the masculine plural pronouns ([هُمْ]{.ar} [hum]{.trn}, [أَنْتُمْ]{.ar} [Eantum]{.trn}, and [كُمْ]{.ar} [-kum]{.trn}) becomes a ;umark; ([هُمُ]{.ar} [humu]{.trn}, [أَنْتُمُ]{.ar} [Eantumu]{.trn},  and[كُمُ]{.ar} [-kumu]{.trn} respectively) when followed by a connecting [hamzah]{.trn2}. Examples:
...
+ When the speaker plural attached pronoun [نَا]{.ar} is attached to a word that ends with a [نْ]{.ar} with a 0-mark, there is only one [ن]{.ar} written and it is doubled with a doubling mark [◌ّ]{.ar} on it. So we get:
...
+ The final 0-mark on the [مْ]{.ar} in the masculine plural ;fail; pronoun [تُمْ]{.ar} [-tum]{.trn} becomes a ;umark; [تُمُ]{.ar} [-tumu]{.trn} when followed by a connecting [hamzah]{.trn2}. Examples:
...
+ The plural masculine verb ;fail; pronoun for the addressed person "you~3,m~" [تُمْ]{.ar} [-tum]{.trn} becomes [تُمُو]{.ar} [tumU]{.trn} when a ;mafulb; pronoun is attached. For example:
  ...
  + [ضَرَبْتُمُوهُ.]{.ar}  
    [DarabtumUh.]{.trn}  
    "You~pl.\ masc.~ hit him."
+ The plural speaking participant ;fail; pronoun [نَا]{.ar} [-nA]{.trn} is the same as the plural speaking participant attached pronoun [نَا]{.ar} [-nA]{.trn}. But you can tell them apart because the ;fail; pronoun, when attached to the verb, causes the final letter of the verb to have a 0-mark. Consider the following two sentences:
...
+ The [ن]{.ar} in the speaking participant attached pronoun "us" [نَا]{.ar} [-nA]{.trn} is part of the pronoun and is not an intervening [ن]{.ar} as was the case for the singular speaking participant pronouns. So we get:
  ...
  However, when attached to a word that ends with a [نْ]{.ar} with a 0-mark, there is only one [ن]{.ar} written and it is doubled with a doubling mark [◌ّ]{.ar} on it. So we get:
   + [نَا]{.ar} + [مِنْ]{.ar} = [مِنَّا]{.ar} [minnA]{.trn}
   + [نَا]{.ar} + [عَنْ]{.ar} = [عَنَّا]{.ar} [eannA]{.trn}
   + [نَا]{.ar} + [لَدُنْ]{.ar} = [لَدُنَّا]{.ar} [ladunnA]{.trn}
+ The preposition [لِ]{.ar} [li]{.trn} "for" becomes [لَ]{.ar} [la]{.trn} when followed by the plural attached pronouns:
