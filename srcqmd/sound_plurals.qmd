...
Note that this rule of changing the vowel mark is only true for common nouns. ;#sifah;s on these patterns will retain the ;0mark; when forming the [At]{.trn} sound plural. So [صَعْب]{.ar} [Saeb]{.trn} and [صَعْبَة]{.ar} [Saebah]{.trn} "a difficult one" become only [صَعْبَات]{.ar} [SaebAt]{.trn}, not $\times$\ [صَعَبَات]{.ar} [SaeabAt]{.trn}.
...
+ ;#sifah;s of the pattern ^2^[فَعْلَاء]{.ar} which is the feminine of the masculine ;sifah; pattern ^2^[أَفْعَل]{.ar}. For example, [حَمْرَاء]{.ar} [HamrAE]{.trn} "red~f~".

+ ;#sifah;s of the pattern ^2^[فَعْلَىٰ]{.ar} which is the feminine of the masculine ;sifah; pattern ^2^[فَعْلَان]{.ar}. For example, [غَضْبَىٰ]{.ar} [gaDbA]{.trn} "very angry~f~".
...
|Participant | ;#fail; pronoun |Meaning| ;#fail; pronoun with verb|
|:--|:--|:--|:--|
...
|plural participant | ;#fail; pronoun | Meaning |;#fail; pronoun with verb|
|:--|:--|:--|:---|
...
|Person|Detached pronoun|;#madi; verb ;fail; pronoun|;#madi; verb with ;fail; pronoun|Attached pronoun|
|:---|:----|:----|:----|
