...
+ The [At]{.trn} sound plural does not take the ;amark; [◌َ]{.ar} and the [nUn]{.trn2}ated ;amark; [◌ً]{.ar}. Instead the ;imark; [◌ِ]{.ar} and the [nUn]{.trn2}ated ;imark; [◌ٍ]{.ar}-mark are used to indicate both the a-state and the i-state.
...
+ When the speaker plural attached pronoun [نَا]{.ar} is attached to a word that ends with a [نْ]{.ar} with a ;0mark;, there is only one [ن]{.ar} written and it is doubled with a doubling mark [◌ّ]{.ar} on it. So we get:
...
+ The [ن]{.ar} in the speaking participant attached pronoun "us" [نَا]{.ar} [-nA]{.trn} is part of the pronoun and is not an intervening [ن]{.ar} as was the case for the singular speaking participant pronouns. So we get:
  ...
  However, when attached to a word that ends with a [نْ]{.ar} with a ;0mark;, there is only one [ن]{.ar} written and it is doubled with a doubling mark [◌ّ]{.ar} on it. So we get:
   + [نَا]{.ar} + [مِنْ]{.ar} = [مِنَّا]{.ar} [minnA]{.trn}
   + [نَا]{.ar} + [عَنْ]{.ar} = [عَنَّا]{.ar} [eannA]{.trn}
   + [نَا]{.ar} + [لَدُنْ]{.ar} = [لَدُنَّا]{.ar} [ladunnA]{.trn}
+ The preposition [لِ]{.ar} [li]{.trn} "for" becomes [لَ]{.ar} [la]{.trn} when followed by the plural attached pronouns:
