...
The above verbal sentences with plural ;fail;s can be rearranged to be a subject-information sentences. This gives more emphasis to the subject. In this case, the verb shall follow the subject and will need a ;fail; pronoun after it.
...
The above verbal sentence can be rearranged to be a subject-information sentence. In that case, all the verbs shall have ;fail; pronouns. The sentence will have the same translation as above, except for an emphasis on the subject of the sentence.
...
The above verbal sentence can be rearranged to be a subject-information sentence. This gives more emphasis to the subject. In this case, the verb shall follow the subject and will need a ;fail; pronoun after it.
...
If the sentence is a subject information sentence, and the verb is in the information, then the ;fail; pronoun corresponding to the number of the subject is used. Examples:
