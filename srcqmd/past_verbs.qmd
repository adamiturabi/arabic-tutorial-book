...
Here we show how the visible doer pronouns are attached to the verb using the root paradigm [فعل]{.ar}. The middle root letter ([ع]{.ar}) has an [a]{.trn}-vowel [◌َ]{.ar} here but this vowel will vary for other verbs.
...
Note also how the visible singular doer pronouns modify the verb by replacing the [a]{.trn}-mark [◌َ]{.ar} on its final letter by a 0-mark [◌ْ]{.ar}.
