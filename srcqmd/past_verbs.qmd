...
Verbs are action words. Verbs can be either _;madi;_ verbs where the action of the verb has been completed, e.g., "The boy went." or _incomplete-action_ verbs where the action of the verb is on-going or not yet completed, e.g., "The boy goes." In this chapter we will study _;madi;_ verbs.
...
For this we will have to learn a third category of pronoun pronouns called _doer pronouns_ for ;madi; verbs.
...
It is only the doer pronouns for the singular absentee participant that are implied for ;madi; verbs. The doer pronouns for the singular addressee and speaker participants are expressed.
...
So now, when the ;mafulb; noun [ٱلْكِتَابَ]{.ar} [EalkitAba]{.trn} "the book" is replaced with the pronoun "it", the doee pronoun must be attached to the verb, and then the doer noun follows the doee pronoun:
...
Now, consider a sentence with an ;indir_mafulb;. Again, the normal order of words in a sentence is verb, doer noun, preposition, doee noun. For example,
