...
The form 1 verb has variability in the middle ([ع]{.ar}) letter, which can have either an [a]{.trn}, [i]{.trn}, or ;umark;.
It also has variability in the pattern its ;masdar;.
