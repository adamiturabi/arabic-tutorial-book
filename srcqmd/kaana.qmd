...
We have learned that a verb must have a doer in the u-state and can have a ;mafulb; in the a-state.
In this chapter, we will learn about a new type of verb, whose doer is called its subject, and whose ;mafulb; is called its information.
...
[حَتَّىٰ]{.ar}, and
[إِذَنْ]{.ar}.
All this is consistent with what we have learned about a-state ;mudarie; verbs in chapter\ \@ref(a-state-incomplete-action-verbs).
Here are some examples:
