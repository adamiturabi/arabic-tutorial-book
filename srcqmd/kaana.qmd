...
So it is the initial government of the sentence (see section\ (ref)).
...
The ;ism_of; is the hidden pronoun "he" and the ;xabar; is [قَائِمًا]{.ar}.
...
The separating pronoun [هُمْ]{.ar} does not, in this case, serve to disambiguate the ;xabar; [ٱلْفَائزِينَ]{.ar} "the winners", from being a ;na3t;, as it did in sentences without [كَانَ]{.ar} (see section\ \@ref(;ism_of;-;xabar;-sentences-separating-pronoun)).
...
Note, how, in the above examples, [كَانَتْ]{.ar} has a [ت]{.ar} of femininity to match the feminine gender of the ;xabar; [عَادَة]{.ar} "habit", and [هَزِيمَتَهُمْ]{.ar} "their defeat".
...
Like ;astate; ;mudarie; verbs in general, [يَكُونَ]{.ar} "be" expresses the meaning of purpose, wish, or expectation. It occurs after the particles
[أَنْ]{.ar},
[لَنْ]{.ar},
[لِ]{.ar},
[كَيْ]{.ar},
...
Note that [مَلِك]{.ar} "king" is in the ;ustate; as the ;ism_of;.
...
The ;xabar; of [كَانَ]{.ar} is itself a sentence [يَكْتُبُ]{.ar} "he writes", and it is the ;xabar; of the main sentence.
...
[[[المهذب فيما وقع في القرآن من المعرب للسيوطي]{.ar} p.\ 59](https://shamela.ws/book/26097/3)]{.aside}  
"And that they might have been preceded is possible"

[يَشْتَرِطُ فِي ٱلنَّائِبِ أَنْ يَكُونَ قَدْ حَجَّ عَنْ نَفْسِهِ]{.ar}  
"It is conditional for the ;naib; that he be in as state of already having performed the [#Hajj]{.trn2} for himself."
