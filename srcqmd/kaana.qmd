...
We have learned that a verb must have a ;fail; in the ;ustate; and can have a ;mafulb; in the ;astate;.
In this chapter, we will learn about a new type of verb, whose ;fail; is called its ;ismof;, and whose ;mafulb; is called its ;xabar;.
...
## [كَانَ]{.ar}, its ;ismof;, and its ;xabar;
...
The complete table for this verb for all ;fail; pronouns is given below:

|;_fail; pronoun|past verb|;mudarie; verb|
|:----|:----|:----|
...
Together, these verbs are also called _deficient_ verbs, because, besides their ;fail;/;ismof;, they also need an ;xabar; to complete the meaning of the sentence.
That is, without the ;xabar;, the sentence is deficient.

"Is" ;mubtada;-;xabar; sentences can be converted to "was" ;ismof;-;xabar; sentences using the verb [كَانَ]{.ar}. Here are some examples:
...
### Sequence of [كَانَ]{.ar}, its ;ismof;, and its ;xabar;
...
but we may also, for the same meaning, apply the sequence verb, ;xabar;, ;ismof;:

[كَانَ قَائِمًا زَيْدٌ.]{.ar}
[Wright, vol.\ ii, §41, rem.\ a, p.\ 100B]{.aside}  
"Zayd was standing."

and also the sequence ;xabar;, verb, ;ismof;:
...
And the ;xabar; is [كَانَ قَائِمًا]{.ar}, which is itself a [كَانَ]{.ar} ;ismof;-;xabar; sentence in the sequence verb, ;ismof;, ;xabar;.
The ;ismof; is the hidden pronoun "he" and the ;xabar; is [قَائِمًا]{.ar}.
...
when the ;ismof; and ;xabar; are both definite, 
then a separating pronoun, which is a detached pronoun that matches the ;ismof;, can be inserted between them.
For example,

[كَانَ ٱلْمُؤْمِنُونَ هُمُ ٱلْفَائِزِينَ.]{.ar}  
"The believers were the winners."

The separating pronoun [هُمْ]{.ar} does not, in this case, serve to disambiguate the ;xabar; [ٱلْفَائزِينَ]{.ar} "the winners", from being a ;naat;, as it did in sentences without [كَانَ]{.ar} (see section\ \@ref(;ismof;-;xabar;-sentences-separating-pronoun)).
This is because the ;astate; of [ٱلْفَائزِينَ]{.ar} already tells us that it is the ;xabar; of [كَانَ]{.ar}. 
If [ٱلْفَائزِينَ]{.ar} were a ;naat; of the ;ustate; ;ismof; [ٱَلْمُوْمِنُونَ]{.ar}, then it too would be in the ;ustate;, not the ;astate;.
So the separating pronoun serves more, here, to emphasize the ;ismof;.

Most of the time, separating pronouns are used in [كَانَ]{.ar} sentences when the ;ismof; of [كَانَ]{.ar} is itself a pronoun. Examples:
...
[ٱَلْمُوْمِنُونَ]{.ar} is the ;ismof; of [كَانَ]{.ar}.
...
### Gender of a pronoun ;ismof; of [كان]{.ar}
...
This rules carries over to [كَانَ]{.ar} ;ismof;-;xabar; sentences as well. For example:
...
The rules related to [كَانَ]{.ar}, its ;ismof;, and its ;xabar;, that we have given above apply also to its ;mudarie; verb [يَكُونُ]{.ar}.
...
[حَتَّىٰ]{.ar}, and
[إِذَنْ]{.ar}.
All this is consistent with what we have learned about ;astate; ;mudarie; verbs in chapter\ \@ref(a-state-;mudarie;-verbs).
Here are some examples:
...
0-state ;mudarie; verbs in general.
(See chapter\ \@ref(0-state-;mudarie;-verbs).)
...
Note that [مَلِك]{.ar} "king" is in the ;ustate; as the ;ismof;.
...
The order of the ;ismof; and the ;mudarie; verb can be re-arranged for the same meaning thus:

[كَانَ يَكْتُبُ زَيْدٌ.]{.ar}  

Now, two grammatical analyses are possible:

1. [زَيْد]{.ar} is the ;fail; of [يَكْتُبُ]{.ar}, and the ;ismof; of [كَانَ]{.ar} is a hidden pronoun of the fact.
2. [زَيْد]{.ar} is the delayed ;ismof; of [كَانَ]{.ar} and [يَكْتُبُ]{.ar} is the ;xabar; of [كَانَ]{.ar}. The ;fail; of [يَكْتُبُ]{.ar} is a hidden pronoun.

Either way, the meaning, as we have mentioned, is the same.
Here are some more examples for different types of ;fail;s/;ismof;s:
...
[كَانَ]{.ar}
can be omitted, and the ;mudarie; verb is used by itself.^[Wright, vol.\ ii, §9, p.\ 21C] For example:
...
#### [كَانَ]{.ar} followed by a ;ismfail; or ;ismmaful; instead of a ;mudarie; verb

Instead of a ;mudarie; verb after [كَانَ]{.ar}, its ;ismfail; or ;ismmaful; may be used instead. 
...
"It is conditional for the ;naib; that he be in as state of already having performed the [_Hajj]{.trn2} for himself."
...
[مَا كَانَ]{.ar} 
or
[لَمْ يَكُنْ]{.ar} with the appropriate suffixes or prefixes for the ;ismof;)
followed by [لِ]{.ar}
