...
We have learned that a verb must have a ;fail; in the u-state and can have a ;mafulb; in the a-state.
...
[ٱلرَّجُلُ]{.ar} is the ;mubtada; in the u-state, and
[مُعَلِّمٌ]{.ar} is the ;xabar;, also in the u-state.
...
and its ;mafulb;, [مُعَلِّمًا]{.ar}, is in the a-state.
...
One such rule is that when the ;mubtada; of a sentence is a plural of non-rational beings, and the ;xabar; is a adjectival noun, then the feminine singular adjectival noun is often used. (See section\ \@ref(usage-of-plurals-of-non-intelligent-beings).)
For example:
...
The separating pronoun [هُمْ]{.ar} does not, in this case, serve to disambiguate the ;xabar; [ٱلْفَائزِينَ]{.ar} "the winners", from being a describer, as it did in sentences without [كَانَ]{.ar} (see section\ \@ref(;ismof;-;xabar;-sentences-separating-pronoun)).
This is because the a-state of [ٱلْفَائزِينَ]{.ar} already tells us that it is the ;xabar; of [كَانَ]{.ar}. 
If [ٱلْفَائزِينَ]{.ar} were a describer of the u-state ;ismof; [ٱَلْمُوْمِنُونَ]{.ar}, then it too would be in the u-state, not the a-state.
...
Note that [ٱَلْفَائِزُونَ]{.ar} is in the u-state, so it is not, by itself, the ;xabar; of [كَانَ]{.ar}.
So this is, in fact, a ;mubtada;-;xabar; sentence.
[ٱَلْمُوْمِنُونَ]{.ar} is the ;ismof; of [كَانَ]{.ar}.
The ;xabar; of [كَانَ]{.ar} is the ;xabar; [هُمُ ٱلفَائِزُونَ]{.ar}, which is itself a ;mubtada;-;xabar; sentence with a u-state ;mubtada; ([هُمْ]{.ar}) and a u-state ;xabar; ([ٱلْفَائزُونَ]{.ar}).
...
### The u-state ;mudarie; verb [يَكُونُ]{.ar}

We have already mentioned that Arabic does not usually express any word for "is".
So when, then, is the u-state ;mudarie; verb [يَكُونُ]{.ar} used?
...
Habitual [يَكُونُ]{.ar} is negated using [مَا]{.ar} or [لَا]{.ar}, just like other u-state ;mudarie; verbs.
...
### The a-state ;mudarie; verb [يَكُونَ]{.ar}

Like a-state ;mudarie; verbs in general, [يَكُونَ]{.ar} "be" expresses the meaning of purpose, wish, or expectation. It occurs after the particles
[أَنْ]{.ar},
[لَنْ]{.ar},
[لِ]{.ar},
[كَيْ]{.ar},
[حَتَّىٰ]{.ar}, and
[إِذَنْ]{.ar}.
All this is consistent with what we have learned about a-state ;mudarie; verbs in chapter\ \@ref(a-state-;mudarie;-verbs).
Here are some examples:
...
### The 0-state ;mudarie; verb [يَكُنْ]{.ar} {#lam-yakun}

The 0-state ;mudarie; verb [يَكُنْ]{.ar} 
...
for the 0-state ;mudarie; verbs that don't have a [و]{.ar} before them. 
These are:
...
Note that [مَلِك]{.ar} "king" is in the u-state as the ;ismof;.
...
"It is conditional for the deputy that he be in as state of already having performed the [_Hajj]{.trn2} for himself."
...
followed by [لِ]{.ar}
and then an a-state ;mudarie; verb.
...
and then [أَنْ]{.ar} followed by an a-state ;mudarie; verb.
