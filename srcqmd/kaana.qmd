...
In this chapter, we will learn about a new type of verb, whose ;fail; is called its ;ism_of;, and whose ;mafulb; is called its ;xabar;.
...
Together, these verbs are also called _deficient_ verbs, because, besides their ;fail;/;ism_of;, they also need an ;xabar; to complete the meaning of the sentence.
...
The separating pronoun [هُمْ]{.ar} does not, in this case, serve to disambiguate the ;xabar; [ٱلْفَائزِينَ]{.ar} "the winners", from being a ;naat;, as it did in sentences without [كَانَ]{.ar} (see section\ \@ref(;ism_of;-;xabar;-sentences-separating-pronoun)).
This is because the ;astate; of [ٱلْفَائزِينَ]{.ar} already tells us that it is the ;xabar; of [كَانَ]{.ar}. 
If [ٱلْفَائزِينَ]{.ar} were a ;naat; of the ;ustate; ;ism_of; [ٱَلْمُوْمِنُونَ]{.ar}, then it too would be in the ;ustate;, not the ;astate;.
...
1. [زَيْد]{.ar} is the ;fail; of [يَكْتُبُ]{.ar}, and the ;ism_of; of [كَانَ]{.ar} is a hidden pronoun of the fact.
2. [زَيْد]{.ar} is the delayed ;ism_of; of [كَانَ]{.ar} and [يَكْتُبُ]{.ar} is the ;xabar; of [كَانَ]{.ar}. The ;fail; of [يَكْتُبُ]{.ar} is a hidden pronoun.

Either way, the meaning, as we have mentioned, is the same.
Here are some more examples for different types of ;fail;s/;ism_of;s:
