...
In this chapter, we will learn about a new type of verb, whose ;fail; is called its subject, and whose ;mafulb; is called its information.
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, rotate=90, anchor=south, left=0ex, align=left] {\scriptsize ;mafulb;/\\\scriptsize information};
...
and its ;mafulb;, [مُعَلِّمًا]{.ar}, is also called its information.
...
Together, these verbs are also called _deficient_ verbs, because, besides their ;fail;/subject, they also need an information to complete the meaning of the sentence.
...
The rules related to [كَانَ]{.ar}, its subject, and its information, that we have given above apply also to its ;mudarie; verb [يَكُونُ]{.ar}.
...
The order of the subject and the ;mudarie; verb can be re-arranged for the same meaning thus:

[كَانَ يَكْتُبُ زَيْدٌ.]{.ar}  

Now, two grammatical analyses are possible:

1. [زَيْد]{.ar} is the ;fail; of [يَكْتُبُ]{.ar}, and the subject of [كَانَ]{.ar} is a hidden pronoun of the fact.
2. [زَيْد]{.ar} is the delayed subject of [كَانَ]{.ar} and [يَكْتُبُ]{.ar} is the information of [كَانَ]{.ar}. The ;fail; of [يَكْتُبُ]{.ar} is a hidden pronoun.

Either way, the meaning, as we have mentioned, is the same.
Here are some more examples for different types of ;fail;s/subjects:
