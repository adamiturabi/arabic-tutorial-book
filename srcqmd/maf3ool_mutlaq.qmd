...
The ;masdar; may still figure in the expression. It will just not technically be the ;mmutlaq;, because the first ;astate; ;maful; in that position is now its ;naib;.
For example,

When the ;masdar; is substituted with a ;na3t;, then the masculine ;sifah; will be used for the ;na3t;,
...
And that abstract idea is not strongly feminine enough to cause the ;na3t; to match the wording of the ;masdar; in gender.
