...
So we cannot say $\times$\ [وَعَدْتُكَ وُعُودًا]{.ar}^[[النحو الوافي]{.ar} 2/211] ("I promised you promises").
...
[وُعُود]{.ar} here refers to different kinds or occasions of promises, rather than the actions of promising.^[See also <https://tafsir.app/ibn-aashoor/33/10> for [وتظنون بالله الظنونا]{.ar}]
...
So according to them we should be able to say,

(@) [ضَرَبْتُهُ ضُرُوبًا]{.ar}  
    "I beat him (many kinds of) beatings"

Other authorities are more conservative and would only allow using broken plurals for existing words if one has been recorded for them. Following this opinion, we might then say:
