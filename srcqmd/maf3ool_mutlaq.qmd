...
The qualifying ;mmutlaq; that indicates what kind of meaning was intended is frequently used with a describer or in an annexation.
For example,
...
In such a case, we may qualify the ;masdar; with the describer [وَاحِدَة]{.ar} "once".
For example:
...
When the ;masdar; is substituted with a describer, then the masculine ;sifah; will be used for the describer,
...
And that abstract idea is not strongly feminine enough to cause the describer to match the wording of the ;masdar; in gender.
