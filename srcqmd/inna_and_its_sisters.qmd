...
In the basic ;mubtada;-;xabar; sentence, both the ;mubtada; and the ;xabar; are in the u-state. For example:
...
In the above sentence both the ;mubtada; [ٱَلرَّجُلَ]{.ar} "the man", and the ;xabar; [مُعَلِّمٌ]{.ar} "a teacher" are in the u-state. In this chapter we will study a family of particles, called
[إِنَّ]{.ar} and its sisters,
that modify the ;mubtada;-;xabar; sentence by placing the ;mubtada; in the a-state instead of the u-state. For example,

[إِنَّ ٱلرَّجُلَ مُعَلِّمٌ.]{.ar}  
[Einna -rrajula mueallimun.]{.trn}  
"Indeed the man is a teacher."

Note how, in the above example, the ;mubtada; [ٱَلرَّجُلَ]{.ar} "the man" is now in the a-state. The ;xabar; [مُعَلِّمٌ]{.ar} "a teacher" remains in the u-state. 
...
The ;ismof; of
[إِنَّ]{.ar} [Einna]{.trn} 
may be a noun phrase, in which case, any describers or replacements of the ;ismof; are also in the a-state. Examples:
...
If the ;xabar; of the first ;ismof; has been mentioned before the second ;ismof;, then the second ;ismof; may optionally be in the a-state or the u-state. For example:
...
ii. The ;ismof; is not put in the a-state but is rather in the u-state.
...
Whereas the ;mudarie; verb directly after the lightened [أَنْ]{.ar} remains in the u-state.
