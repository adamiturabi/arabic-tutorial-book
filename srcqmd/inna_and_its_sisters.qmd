...
In a similar manner,
[أَنَّ]{.ar}
clauses can be placed where one would expect other noun positions, such as: a subject, an information, a ;fail;, and more. Here are some examples:
...
As you know, [كَانَ]{.ar}'s ;fail; is also its subject, and its ;mafulb; is also its information.
...
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its subject, and its information) is considered equivalent to a ;masdar; (typically in an ;idafa;, and possibly with a ;mafulb; as well). It is this equivalence that allows it to thake the place of a ;fail;, ;mafulb;, and the other categories we have given above.
...
Similarly, in the example
[ٱَلرَّجُلُ كَتَبَ كِتَابًا.]{.ar}
the linker pronoun is the invisible ;fail; pronoun "he" of the verb [كَتَبَ]{.ar} "he wrote" that links back to the topic [ٱَلرَّجُلُ]{.ar} "the man".
