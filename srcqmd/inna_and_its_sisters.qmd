...
The ;ismof; of
[إِنَّ]{.ar} [Einna]{.trn} 
may be a noun phrase, in which case, any ;naat;s or replacements of the ;ismof; are also in the ;astate;. Examples:

[إِنَّ هَـٰؤُلَاءِ ٱلرِّجَالَ ٱلْكِرَامَ أَصْدِقَائِي.]{.ar}  
"Indeed these noble men are my friends."

[إِنَّ]{.ar} [Einna]{.trn} may have multiple ;ismof;s, each in the ;astate;, separated by [وَ]{.ar}. Example,

[إِنَّ ٱلْمُسْلِمِينَ وَٱلْمُسْلِمَاتِ يَعْبُدُونَ ٱللَّـٰهَ.]{.ar}  
"Indeed the Muslim men and Muslim women worship [_allAh]{.trn2}."

If the ;xabar; of the first ;ismof; has been mentioned before the second ;ismof;, then the second ;ismof; may optionally be in the ;astate; or the ;ustate;. For example:
...
By default, the ;ismof; of [إِنَّ]{.ar} [Einna]{.trn} must directly follow it with no intervening words or particles. The only exception is when the ;xabar; consists of a prepositional or adverbial phrase, it is then allowed to precede the ;ismof;. The ;ismof;, in any case, shall be in the ;astate;. For example,
...
[إِنَّ]{.ar},
for example, the ;ismof; being in the ;astate;, the order of the ;ismof; and the ;xabar;, the use of attached pronouns for the ;ismof;, etc.,
...
The [أَنَّ]{.ar} clause can occur in place of an ;istate; ;mudafil; in an ;idafa;. Example:
...
And you have seen this grammatical equivalence before with [أَنْ]{.ar} and ;astate; ;mudarie; verbs in chanpter\ \@ref(a-state-;mudarie;-verbs-verbal-noun).
...
can be used in either of the following ways:
 ...
 i. With the same rules as the heavy [إِنَّ]{.ar}. The ;ismof; is put in the ;astate; and the use of the strengthening [لَ]{.ar} is optional. For example,
...
ii. The ;ismof; is not put in the ;astate; but is rather in the ;ustate;.
...
the heavy [إِنَّ]{.ar}.
Where the ;ismof; is in the ;astate; and the use of the strengthening [لَ]{.ar} is optional. For example,
...
+ If the verb before [أَنْ]{.ar} does not reflect a view of something going to occur then the [أَنْ]{.ar} is typically the ;astate;-verbal [أَنْ]{.ar}. For example,
  ...
  Remember from chapter\ \@ref(chapter-a-state-;mudarie;-verbs)), that the ;astate;-verbal [أَنْ]{.ar} can occur with ;madi; verbs as well. Example:
