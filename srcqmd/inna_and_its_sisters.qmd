...
The [أَنَّ]{.ar} clause can occur in place of an i-state ;mudafil; in an annexation. Example:
...
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its subject, and its information) is considered equivalent to a verbal noun of doing (typically in an annexation, and possibly with a doee as well). It is this equivalalence that allows it to thake the place of a doer, ;mafulb;, and the other categories we have given above.
