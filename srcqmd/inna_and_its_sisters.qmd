...
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its subject, and its information) is considered equivalent to a ;masdar; (typically in an ;idafa;, and possibly with a doee as well). It is this equivalalence that allows it to thake the place of a doer, ;mafulb;, and the other categories we have given above.
