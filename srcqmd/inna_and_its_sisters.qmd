...
In the basic ;j_ism;, both the ;mubtada; and the ;xabar; are in the ;ustate;. For example:
...
that modify the ;j_ism; by placing the ;mubtada; in the ;astate; instead of the ;ustate;. For example,
...
[إِنَّ]{.ar} [Einna]{.trn} is only used to begin ;j_ism;s. Verbal sentences cannot be introduced by [إِنَّ]{.ar} [Einna]{.trn} directly. (Later, in section\ \@ref(damiir-al-shan), we shall see how to overcome this restriction.). For example,
...
[إِنَّ]{.ar} [Einna]{.trn} is only used to begin ;j_ism;s. Verbal sentences cannot be introduced by [إِنَّ]{.ar} [Einna]{.trn} directly. (Later, in section\ \@ref(damiir-al-shan), we shall see how to overcome this restriction.).
...
See [@ibn_aqil_alfiyyah@ 1/349](https://shamela.ws/book/9904/348)
...
## The ;damir_shan; with [إِنَّ]{.ar} and its sisters
...
(@) [يَـٰمُوسَىٰٓ **إِنَّهُۥٓ** أَنَا ٱللَّهُ ٱلْعَزِيزُ ٱلْحَكِيمُ]{.quran}
    [@https://quran.com/27/9@ cited by @nahw_arabi@ 1/89]{.citex}  
...
without having to specify a ;ism_of; for
[إِنَّ]{.ar}.^[@nahw_arabi@ 1/89]
Examples:

(@) [**إِنَّهُۥ** لَا یُفۡلِحُ ٱلظَّـٰلِمُونَ]{.quran}
    [@https://quran.com/6/21@ cited by @nahw_arabi@ 1/89]{.citex}  
...
(@) [**فَإِنَّهَا** لَا تَعۡمَى ٱلۡأَبۡصَـٰرُ وَلَـٰكِن تَعۡمَى ٱلۡقُلُوبُ ٱلَّتِی فِی ٱلصُّدُورِ]{.quran}
    [@https://quran.com/22/46@ cited by @nahw_arabi@ 1/89]{.citex}  
...
We have, in fact, already seen sentences like this in section\ \@ref(past-verbs-order-of-words), when we take a verbal sentence and convert it to a ;j_ism;. This is the example we discussed there:
...
#### #;j_ism;s with [إِنَّ]{.ar} and its sisters

[إِنَّ]{.ar} and its sisters are very often used in ;j_ism;s. (With [أَنَّ]{.ar} it is, as usual, an incomplete sentence.) Here are some examples:
...
#### #;j_ism;s with a pronoun ;ism_of;

The ;ism_of;, in a ;j_ism;, is frequently a pronoun. For example,
...
There is a special pronoun, called the _pronoun of the fact_ that begins ;j_ism;s. This pronoun does not refer to any previously known entity, but rather refers to the ;xabar; that follows it. It is sometimes translated as "the fact is" but is often left untranslated. Here is an example:
...
the heavy [إِنَّ]{.ar}
is that 
the heavy [إِنَّ]{.ar} is only used to introduce ;j_ism;s.
The lightened [إِنْ]{.ar},
...
the lightened [أَنْ]{.ar}
introduces a ;xabar; which is a ;j_ism;.
...
The lightened [كَأَنْ]{.ar} is similar to the lightened [أَنْ]{.ar} in that it introduces a ;j_ism; and the ;ism_of; is usually a deleted pronoun of the fact. For example,
...
The lightened [لَـٰكِنْ]{.ar} has the same meaning as the heavy [لَـٰكِنَّ]{.ar} but it has no grammatical effect on the word or sentence after it. It may introduce either ;j_ism;s or verbal sentences. For example,
