...
The ;ism_of; of
[إِنَّ]{.ar} [Einna]{.trn} 
may be a noun phrase, in which case, any ;naat;s or replacements of the ;ism_of; are also in the ;astate;. Examples:
...
As you know, [كَانَ]{.ar}'s ;fail; is also its ;ism_of;, and its ;mafulb; is also its ;xabar;.
...
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its ;ism_of;, and its ;xabar;) is considered equivalent to a ;masdar; (typically in an ;idafa;, and possibly with a ;mafulb; as well). It is this equivalence that allows it to thake the place of a ;fail;, ;mafulb;, and the other categories we have given above.
...
Similarly, in the example
[ٱَلرَّجُلُ كَتَبَ كِتَابًا.]{.ar}
the linker pronoun is the invisible ;fail; pronoun "he" of the verb [كَتَبَ]{.ar} "he wrote" that links back to the ;ism_of; [ٱَلرَّجُلُ]{.ar} "the man".
