...
As you know, [كَانَ]{.ar}'s doer is also its subject, and its ;mafulb; is also its information.
...
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its subject, and its information) is considered equivalent to a ;masdar; (typically in an ;idafa;, and possibly with a ;mafulb; as well). It is this equivalence that allows it to thake the place of a doer, ;mafulb;, and the other categories we have given above.
