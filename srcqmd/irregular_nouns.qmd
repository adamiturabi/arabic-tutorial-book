...
<!--
We have learned that regular nouns have three states: the ;ustate;, a-state, and i-state. For singular nouns, the ;ustate; is marked by the ;umark; [◌ُ]{.ar}, the a-state is marked by the ;amark; [◌َ]{.ar}, and the i-state is marked by the ;imark; [◌ِ]{.ar}. The ;tanwin;s [◌ٌ]{.ar}, [◌ً]{.ar} and [◌ٍ]{.ar} are only but extensions of [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar} respectively.
...
|Singular |[At]{.trn} sound plural |[Un]{.trn} sound plural (u-state) |[Un]{.trn} sound plural (a-state and i-state)|
|:--|:---|:---|:---|
...
|Singular |[Un]{.trn} sound plural (u-state) |[Un]{.trn} sound plural (a-state and i-state)|
|:--|:---|:---|
