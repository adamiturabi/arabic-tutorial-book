...
<!--
We have learned that regular nouns have three ;case;s: the ;ucase;, ;acase;, and ;icase;. For singular nouns, the ;ucase; is marked by the ;umark; [◌ُ]{.ar}, the ;acase; is marked by the ;amark; [◌َ]{.ar}, and the ;icase; is marked by the ;imark; [◌ِ]{.ar}. The ;tanwin;s [◌ٌ]{.ar}, [◌ً]{.ar} and [◌ٍ]{.ar} are only but extensions of [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar} respectively.
...
Where the nouns behave irregularly is when they are an ;mudaf; in an ;idaafah;. Then instead of indicating their ;case; with [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, they indicate their ;case; using the long vowels [و]{.ar} [U]{.trn}, [ا]{.ar} [A]{.trn}, and [ي]{.ar} [I]{.trn} instead. Here are some examples:
...
[أَخِي]{.ar}  
[EaxI]{.trn}  
"my brother" (;ucase;, ;acase;, and ;icase;).

[أَبِي]{.ar}  
[EabI]{.trn}  
"my father" (;ucase;, ;acase;, and ;icase;).

[حَمِي]{.ar}  
[HamI]{.trn}  
"my father-in-law" (;ucase;, ;acase;, and ;icase;).
...
The above irregular behavior of these three nouns is only when they are ;mudaf;s. When they happen to be ;mudafil;s in ;idaafah;s, then they again they behave like regular nouns and their ;case; is indicated by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by ;tanwin; 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
...
|Word | Dual (;ucase;) | Dual (;acase; and ;icase;)|Plural|
|:-|:--|:---|:---|
...
So, for example, [ذُو ٱلْمَالِ]{.ar} [pu -lmAli]{.trn} means "possessor~m~ of wealth" or "wealthy person~m~". The singular, dual, and plural of [ذُو]{.ar} [pU]{.trn} in all three ;case;s is shown in the table below:

|#;case;|Singular|Dual|Plural|
|:--|:---|:---|:---|
|;ucase;|[ذُو]{.ar} [pU]{.trn} |[ذَوَا]{.ar} [pawA]{.trn}|[ذَوُو]{.ar} [pawU]{.trn}|
|;acase;|[ذَا]{.ar} [pA]{.trn} |[ذَوَيْ]{.ar} [paway]{.trn}|[ذَوِي]{.ar} [pawI]{.trn}|
|;icase;|[ذِي]{.ar} [pI]{.trn} |same as ;acase;|same as ;acase;|

The noun [ذُو]{.ar} [pU]{.trn} and its duals and plurals are only ever used as ;mudaf;s in ;idaafah;s. Furthermore, they may not be annexed to pronouns. Here are some examples:

[ٱَلرَّجُلُ ذُو ٱلْمَالِ.]{.ar}  
[Earrujulu pu -lmAl.]{.trn}  
"The man is the possessor of wealth." = "This man is wealthy."

The word [ذَات]{.ar} is the feminine of [ذُو]{.ar}. When used as an ;mudaf;, its ;case;s, duals, and plurals are as in the table below:

|#;case;|Singular|Dual|Plural|
|:--|:---|:---|:---|
|;ucase;|[ذَاتُ]{.ar} [pAtu]{.trn} |[ذَوَاتَا]{.ar} [pawAtA]{.trn} |[ذَوَاتُ]{.ar} [pawAtu]{.trn}|
|;acase;|[ذَاتَ]{.ar} [pAta]{.trn} |[ذَوَاتَيْ]{.ar} [pawAtay]{.trn}|[ذَوَاتِ]{.ar} [pawAti]{.trn}|
|;icase;|[ذَاتِ]{.ar} [pAti]{.trn} |same as ;acase;|same as ;acase;|
...
It is a ;mudafil; in an ;idaafah; regularly:

[نَطَقَ لِسَانُ ٱلْفَمِ.]{.ar}  
[naTaqa lisAnu -lfam.]{.trn}  
"The mouth's tongue articulated [speech]."

It forms duals regularly, which are used in ;idaafah;s regularly
...
The three ;case;s of the singular [فُو]{.ar} [fU]{.trn} are shown in the table below:
-->

Here is how it will appear as a singular ;mudaf; in the three ;case;s:
...
When the attached pronoun for the speaking person [ي]{.ar} is attached to [فُو]{.ar} [fU]{.trn}, [فَا]{.ar} [fA]{.trn}, or [فِي]{.ar} [fI]{.trn} the combination is always [فِيَّ]{.ar} [fiyya]{.trn} in all three ;case;s. Examples:
...
In addition to the above irregular behavior, it is permissible, but less common, to treat [فَم]{.ar} regularly as an ;mudaf; in an ;idaafah;. So it is permissible to also say:
...
Here is its form in the different ;case;s:
...
|Singular |[At]{.trn} sound plural |[Un]{.trn} sound plural (;ucase;) |[Un]{.trn} sound plural (;acase; and ;icase;)|
|:--|:---|:---|:---|
...
|Singular |[Un]{.trn} sound plural (;ucase;) |[Un]{.trn} sound plural (;acase; and ;icase;)|
|:--|:---|:---|
...
Note that 
[بَنَات]{.ar} [banAt]{.trn}
is not a broken plural from the root [بنت]{.ar}. Therefore, it obeys the rules of [At]{.trn} sound plurals and does not end with [◌َ]{.ar} or [◌ً]{.ar} in the ;acase;.
...
When the definite article [ٱَلْ]{.ar} [Eal]{.trn} is prefixed to a noun which begins with a connecting [hamzah]{.trn2}, the [hamzah]{.trn2} is not pronounced. Instead the [lAm]{.trn} in [ٱَلْ]{.ar} will take an ;imark;. For example, [ٱِبْنٌ]{.ar} [Eibnun]{.trn} "a son" becomes [ٱَلِٱبْنُ]{.ar} [Ealibnu]{.trn} "the son".
-->
...
:-------------|:----------------------------|:----------------------------
;ucase;       |[ٱَلْمَرْءُ]{.ar} [EalmarEu]{.trn}|[ٱَلْمَرْأَةُ]{.ar} [EalmarEatu]{.trn}
;acase;       |[ٱَلْمَرْءَ]{.ar} [EalmarEa]{.trn}|[ٱَلْمَرْأَةَ]{.ar} [EalmarEata]{.trn}
;icase;       |[ٱَلْمَرْءِ]{.ar} [EalmarEi]{.trn}|[ٱَلْمَرْأَةِ]{.ar} [EalmarEati]{.trn}
...
:-------------|:-----------------|:--------------
;ucase;       |[ٱِمْرَأٌ]{.ar} [EimraEun]{.trn} |[ٱِمْرُؤٌ]{.ar} [EimruEun]{.trn}
;acase;       |[ٱِمْرَءًا]{.ar} [EimraEan]{.trn}|[ٱِمْرَءًا]{.ar} [EimraEan]{.trn}
;icase;       |[ٱِمْرَأٍ]{.ar} [EimraEin]{.trn} |[ٱِمْرِئٍ]{.ar} [EimriEin]{.trn}
