...
The above irregular behavior of these three nouns is only when they are ;mudaf;s. When they happen to be ;mudafil;s in annexations, then they again they behave like regular nouns and their state is displayed by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by [nUn]{.trn2}ation 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
...
It is a ;mudafil; in an annexation regularly:
