...
Note, again how the ;naat; [جَمِيلَة]{.ar} [jamIlah]{.trn} is feminine and in the u-state, in order to match the gender and state of the ;manut; ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^.
