...
:------|:-----------|:---------
;ustate;| [رَجُلٌ]{.ar} | [ٱَلرَّجُلُ]{.ar}
;astate;| [رَجُلًا]{.ar}| [ٱَلرَّجُلَ]{.ar}
;istate;| [رَجُلٍ]{.ar} | [ٱَلرَّجُلِ]{.ar}

As you can see, the noun is ;tanwin;ed when it is indefinite, and also, the vowel mark on the last letter changes for each state that the noun is in. These kinds of nouns are called _fully-flexible_ nouns. They are by far the most common type of noun.
...
As you can see, when [صَحْرَاء]{.ar} [SaHrAE]{.trn} is indefinite, it is not ;tanwin;ed. Also, when it is indefinite and in the ;istate;, the vowel mark on its final letter is not [◌ِ]{.ar}, as you might expect but [◌َ]{.ar} . And so the noun looks identical in the ;astate; and ;istate; when it is indefinite.
...
2. When indefinite and in the ;istate;, a semi-flexible noun's final letter does not have an ;imark;. Instead it shall have an ;amark;, just like when it is in the ;astate;.
...
Note that the vowel mark on the final letter of [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} is [◌َ]{.ar}, not [◌ٍ]{.ar}, even though it is indefinite and in the ;istate; (because it is preceded by the preposition [إِلَىٰ]{.ar} [EilA]{.trn} "to"). This is because it is a semi-flexible noun.

^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ in this sentence
is also a ;manut;, whose ;naat; is [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". The final vowel mark [◌َ]{.ar} on the ;manut; [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} has no effect on the final vowel mark on the ;naat; [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". All that matters in this regard is the state of the ;manut;. 

Note, also, that the ;naat; [وَاسِعَة]{.ar} is feminine to match the gender of the ;manut; 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^. 

Note, as well, that the ;naat; [وَاسِعَةٍ]{.ar} is ;tanwin;ed as it is indefinite and fully-flexible. The inability of its ;manut; 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ 
to be ;tanwin;ed (because of its semi-flexibility) does not affect the ;naat;.
...
Since ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^ already ends with the vowel-mark [◌ٰ]{.ar}, the last letter won't have any additional vowel markers and therefore the word will appear the same in all states:
  ...
  State  | Indefinite | Definite
  :------|:-----------|:---------
  ;ustate;| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  ;astate;| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  ;istate;| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
...
Note, again how the ;naat; [جَمِيلَة]{.ar} [jamIlah]{.trn} is feminine and in the ;ustate;, in order to match the gender and state of the ;manut; ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^.
...
### ;_sifah;s that end with an extrinsic [ان]{.ar} {#;sifah;-an-diptote}
