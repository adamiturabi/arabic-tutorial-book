...
<!--
[ibtidAEun]{.trn} "a beginning" whose root is [بدء]{.ar} and which is on the pattern [ٱِفْتِعَالٌ]{.ar} [iftieAlun]{.trn}. Because here the [ء]{.ar} in [ٱبْتِدَاءٌ]{.ar} is part of the word's root, therefore it shall not be a semi-flexible noun. That is why you can see that it has an ;nmark; when it is indefinite. 
-->
