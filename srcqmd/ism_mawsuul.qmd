...
<!--They may occur as a subject, an information, a doer, a doee, following a preposition, and as a ;mudafil; in an annexation.-->
...
(c) When the refer-back pronoun is in the i-state, it is permissible to delete it:
    ...
    (i) When the refer-back pronoun is the ;mudafil; in an annexation whose ;mudaf; is a verbal noun of the doer or the doee implying a present or future meaning. For example:
...
Secondly,
[أيّ]{.ar}
can be, and, in fact, properly is, the ;mudaf; in an annexation.
