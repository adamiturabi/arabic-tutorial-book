...
The same guidelines for deleting the refer-back pronouns, which we learned for the specific connected nouns, apply also to the general connected nouns.
For example:
...
(a) When the refer-back pronoun is the subject of a subject-information sentence, then it may be deleted, and its meaning will be implied.
    In this case, it is preferred that the connecting sentence not be short.
    ...
    If the connecting sentence is short, the deleting if the refer-back pronoun subject is permissible, though rare. For example:

    [جاء الذي قائم]{.ar}  
    "He came who is standing."  
    (instead of [جاء الذي هو قائم]{.ar})
