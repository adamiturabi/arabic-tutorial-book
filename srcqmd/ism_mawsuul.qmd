...
But this pronoun is an essential part of the Arabic connecting sentence and is called the _link-back pronoun_. 
...
## The connecting sentence and the link-back pronoun {#link-back-pronoun}
...
The link-back pronoun may be omitted (and its meaning is then implicit) if some conditions are satisfied.
...
(b) When the link-back pronoun is an attached pronoun for the direct doee it is permissible to omit it. For example:
...
(c) When the refer-back pronoun is in the i-state, it is permissible to omit it:
    ...
    (i) When the link-back pronoun is the base noun in an annexation whose annex noun is a verbal noun of the doer or the doee implying a present or future meaning. For example:
