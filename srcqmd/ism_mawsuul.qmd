...
But this pronoun is an essential part of the Arabic connecting sentence and is called the _;aaid;_. 
...
### Matching the ;aaid; with the connected noun

The ;aaid; matches the specific connected noun in gender and number.
...
There is one circumstance where matching the ;aaid; to the (absent person) connected-noun is mandated.
...
### The ;aaid; for the general connected nouns
...
(a) When the ;aaid; is the ;mubtada; of a ;mubtada;-;xabar; sentence, then it may be deleted, and its meaning will be implied.
    When deleting the ;aaid; in this case, it is preferred that the connecting sentence not be too short.
    <!--In such cases, the incomplete sentence connecting sentence implcitly includes the meaning of a verb which is usually the verb "being", like "is", "are", "am", etc.-->
    ...
    If the connecting sentence is very short, the deleting the ;aaid; ;mubtada; is permissible, though rare. For example:
...
If the ;aaid; is deleted, and the remaining connecting sentence (with the ;aaid; deleted) is valid as a connecting sentence on its own right, then it will give a different meaning (even if slightly) from the original. 
...
### The connected noun [أَيّ]{.ar} with a deleted ;aaid;

Consistent with what we have already learned for the other connected nouns,
the ;aaid; may be deleted in connected sentences for the connected noun
[أيّ]{.ar}.
...
ii. The ;aaid; to [أَيّ]{.ar} is the ;mubtada; of the connecting sentence and it is deleted.
