...
(c) When the refer-back pronoun is in the i-state, it is permissible to delete it:
    ...
    (i) When the refer-back pronoun is the base noun in an annexation whose ;mudaf; is a verbal noun of the doer or the doee implying a present or future meaning. For example:
