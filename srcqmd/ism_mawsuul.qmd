...
^[[[التوبة]{.ar}:34](https://quran.com/9:34)]  
...
^[[[المجادلة]{.ar}:1](https://quran.com/58:1)]  
...
^[[[الترمذي]{.ar}:2134](https://sunnah.com/tirmidhi:2134)]  
...
^[[[الحجر]{.ar}:6](https://quran.com/15:6)]  
...
ii. Or be singular masculine to match the connected noun itself. This is generally more common for [مَا]{.ar}. For example:
    ...
    ^[[[يونس]{.ar}:40](https://quran.com/10:40)]  
...
^[[[البقرة]{.ar}:112](https://quran.com/2:112)]  
...
^[[[البقرة]{.ar}:38](https://quran.com/2:38)]  
...
:::
^[[[النور]{.ar}:45](https://quran.com/24:45)]
...
^[Wright vol. ii, §170 rem. c, p. 314D]  
...
^[[[الرعد]{.ar}:15](https://quran.com/13:15)]  
...
^[[[الجمعة]{.ar}:1](https://quran.com/62:1)]  
...
^[[[آل عمران]{.ar}:35](https://quran.com/3:35)]  
...
^[[[النساء]{.ar}:4](https://quran.com/4:3)]  
...
^[[[الأدب المفرد]{.ar}:153](https://sunnah.com/adab:153)]  
...
^[[[البخاري]{.ar}:668](https://sunnah.com/bukhari:668)]  
"it was done by one who was better than I"  

As a doee:

[اعْمَلُوا مَا شِئْتُمْ]{.ar}
^[[[فصلت]{.ar}:40](https://quran.com/41:40)]  
"Do whatever you will"  

Following a preposition:

[وَأَغْنِنِي بِفَضْلِكَ عَمَّنْ سِوَاكَ]{.ar}
^[[[الترمذي]{.ar}:3563](https://sunnah.com/tirmidhi:3563)]  
...
^[[[ابن ماجه]{.ar}:2634](https://sunnah.com/ibnmajah:2634)]  
"I am the heir of the one who has no heir"
-->

[فَذَلِكَ مَثَلُ مَنْ أَطَاعَنِي]{.ar}
^[[[مسلم]{.ar}:2283](https://sunnah.com/muslim:2283)]  
...
The general connected noun can, however, occur as a replacement.
For example,

[والمسلمون مَن تبع رسول الله صلى الله عليه وسلم كثير]{.ar}
^[Fischer §421.2. Originally, from [السيرة النبوية لابن هشام]{.ar}.]  
...
(a) When the refer-back pronoun is the subject of a subject-information sentence, then it may be deleted, and its meaning will be implied.
    ...
    ^[[[مسلم]{.ar}:2963c](https://sunnah.com/muslim:2963c). See also [[مسلم]{.ar}:2963a](https://sunnah.com/muslim:2963c) and [[ابن ماجه]{.ar}:4142](https://sunnah.com/ibnmajah:4142) for variants with the refer-back pronoun.]  
    ...
    ^[[[الأنبياء]{.ar}:21](https://quran.com/21:19)]  
...
(b) When the refer-back pronoun is an attached pronoun for the direct doee it is permissible to delete it. For example:
    ...
    ^[[[التوبة]{.ar}:35](https://quran.com/9:35)]  
...
(c) When the refer-back pronoun is in the i-state, it is permissible to delete it:
	...
	^[[[طه]{.ar}:72](https://quran.com/20:72)]  
...
^[modified from the example [جاء الذي ضربته في داره]{.ar} in [شرح ابن عقيل على ألفية ابن مالك]{.ar}]  
...
[أَيّ]{.ar} [ِEayy]{.trn} "which/whichever" is a general connected noun similar to [مَا]{.ar} "what" and [مَنْ]{.ar} "who".
But it differs from 
...
Secondly,
[أيّ]{.ar}
can be, and, in fact, properly is, the annex noun in an annexation.
Whereas [مَا]{.ar} and [مَنْ]{.ar} cannot be annex nouns.
For example,

[يُعْجِبُنِي أَيُّ ٱلتَّلَامِذَةِ يَجْتَهِدُ.]{.ar}  
"Whichever of the students strives, pleases me."  
([أيّ]{.ar} is in the u-state)
...
But a feminine version [أَيَّة]{.ar} does exist and can be used with feminine nouns.
It is, however, only really common if its base noun is a feminine pronoun.
For example,

[صَادِقِي أَيَّتَهُنَّ تَنْصَحُكِ.]{.ar}  
"Befriend whichever of them~3,f~ is sincere to you~1,f~."

### The connected noun [أَيّ]{.ar} without a base noun

[أيّ]{.ar}
can sometimes occur without a base noun.
Technically, it will then be indefinite, and thus [nUn]{.trn2}ated.
However, it will carry the meaning of an implied annexation.
For example,

[سَأُقَاتِلُ أَيًّا يُقَاوِمُنِي.]{.ar}  
"I will fight whichever [of them, the enemies, etc.] resists me."

### The connected noun [أَيّ]{.ar} with a deleted refer-back pronoun

Consistent with what we have already learned for the other connected nouns,
the refer-back pronoun may be deleted in connected sentences for the connected noun
[أيّ]{.ar}.
...
This is when both of the following conditions are satisfied:
 ...
 i. [أَيّ]{.ar} is an annex noun.
ii. The refer-back pronoun to [أَيّ]{.ar} is the subject of the connecting sentence and it is deleted.
...
[أَجْزِي أَيًّا صَادِقٌ.]{.ar}^[The examples generally quoted by the grammarians are (1) the verse of poetry [إِذَا مَا لَقِيتَ بَنِي مَالِكٍ … فَسَلِّمْ عَلَى أَيُّهُمْ أَفْضَلُ]{.ar}, and (2) the [Ayah]{.trn2} [ثُمَّ لَنَنْزِعَنَّ مِنْ كُلِّ شِيعَةٍ أَيُّهُمْ أَشَدُّ عَلَى الرَّحْمَنِ عِتِيّاً]{.ar} [[مريم]{.ar}:69]]
...
^[[[البخاري]{.ar}:614](https://sunnah.com/bukhari:614)]  
...
^[[[الهمزة]{.ar}:1--2](https://quran.com/104:1-2)]  
...
^[[[الجمعة]{.ar}:5](https://quran.com/62:5), cited in Wright vol. ii, §172, p. 318C]  
