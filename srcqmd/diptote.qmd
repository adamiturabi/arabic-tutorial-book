...
is also a ;manut;, whose ;na3t; is [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". The final vowel mark [◌َ]{.ar} on the ;manut; [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} has no effect on the final vowel mark on the ;na3t; [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". All that matters in this regard is the state of the ;manut;. 
...
Note, again how the ;na3t; [جَمِيلَة]{.ar} [jamIlah]{.trn} is feminine and in the ;ustate;, in order to match the gender and state of the ;manut; ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^.
