...
Nouns are of two main categories of nouns, with regard to their endings in the different noun ;case;s:
...
:------|:-----------|:---------
;ucase;| [رَجُلٌ]{.ar} | [ٱَلرَّجُلُ]{.ar}
;acase;| [رَجُلًا]{.ar}| [ٱَلرَّجُلَ]{.ar}
;icase;| [رَجُلٍ]{.ar} | [ٱَلرَّجُلِ]{.ar}

As you can see, the noun is ;tanwin;ed when it is indefinite, and also, the vowel mark on the last letter changes for each ;case; that the noun is in. These kinds of nouns are called _fully-flexible_ nouns. They are by far the most common type of noun.
...
As you can see, when [صَحْرَاء]{.ar} [SaHrAE]{.trn} is indefinite, it is not ;tanwin;ed. Also, when it is indefinite and in the ;icase;, the vowel mark on its final letter is not [◌ِ]{.ar}, as you might expect but [◌َ]{.ar} . And so the noun looks identical in the ;acase; and ;icase; when it is indefinite.
...
1. When indefinite, a semi-flexible noun is not ;tanwin;ed.
2. When indefinite and in the ;icase;, a semi-flexible noun's final letter does not have an ;imark;. Instead it shall have an ;amark;, just like when it is in the ;acase;.

The other category of nouns are _rigid_ nouns. Rigid nouns don't change their endings due to their ;case;. They are much fewer in number compared to flexible nouns. Pronouns are an example of rigid nouns.
...
Note that the vowel mark on the final letter of [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} is [◌َ]{.ar}, not [◌ٍ]{.ar}, even though it is indefinite and in the ;icase; (because it is preceded by the preposition [إِلَىٰ]{.ar} [EilA]{.trn} "to"). This is because it is a semi-flexible noun.

^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ in this sentence
is also a ;manut;, whose ;na3t; is [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". The final vowel mark [◌َ]{.ar} on the ;manut; [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} has no effect on the final vowel mark on the ;na3t; [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". All that matters in this regard is the ;case; of the ;manut;. 

Note, also, that the ;na3t; [وَاسِعَة]{.ar} is feminine to match the gender of the ;manut; 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^. 

Note, as well, that the ;na3t; [وَاسِعَةٍ]{.ar} is ;tanwin;ed as it is indefinite and fully-flexible. The inability of its ;manut; 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ 
to be ;tanwin;ed (because of its semi-flexibility) does not affect the ;na3t;.
...
<!--
[ibtidAEun]{.trn} "a beginning" whose root is [بدء]{.ar} and which is on the pattern [ٱِفْتِعَالٌ]{.ar} [iftieAlun]{.trn}. Because here the [ء]{.ar} in [ٱبْتِدَاءٌ]{.ar} is part of the word's root, therefore it shall not be a semi-flexible noun. That is why you can see that it has an ;tanwin; when it is indefinite. 
-->
...
Since ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^ already ends with the vowel-mark [◌ٰ]{.ar}, the last letter won't have any additional vowel markers and therefore the word will appear the same in all ;case;s:

  #;case;  | Indefinite | Definite
  :------|:-----------|:---------
  ;ucase;| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  ;acase;| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  ;icase;| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}

Therefore, the ;case; of such nouns cannot be determined by the vowel mark on their final letter, and has to be deduced otherwise by their function in the sentence.
...
Note, again how the ;na3t; [جَمِيلَة]{.ar} [jamIlah]{.trn} is feminine and in the ;ucase;, in order to match the gender and ;case; of the ;manut; ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^.

Beware also that, just like in the case of [اء]{.ar}, there are some words where [ىٰ]{.ar} may be part of the word's root, e.g. [ٱَلْهُدَىٰ]{.ar} [EalhudA]{.trn} "the guidance" whose root is [هدي]{.ar}. Because here the [ىٰ]{.ar} in [ٱلْهُدَىٰ]{.ar} is part of the word's root, therefore it shall not be a semi-flexible noun. So, when it is indefinite, it will be ;tanwin;ed: [هُدًى]{.ar} [hudan]{.trn} "a guidance". Also, for the same reason, [ىٰ]{.ar} in this word is not a feminine marker, and the word is masculine.
...
Most colors and many physical characteristics fall into this pattern. Colors and physical characteristics are ;sifah;s. The masculine noun for such ;sifah;s is on the pattern [أَفْعَل]{.ar} [Eafeal]{.trn}. And the feminine ;sifah; is on the pattern [فَعْلَاء]{.ar} [faelAE]{.trn} (which is itself a semi-flexible noun pattern because of the extrinsic [اء]{.ar} ending). Here are some examples of such ;sifah;s:
...
### #;sifah;s that end with an extrinsic [ان]{.ar} {#;sifah;-an-diptote}
...
1. The noun must be a ;sifah; on the pattern [فَعْلَان]{.ar}. So the common noun [ثُعْبَان]{.ar} [vuebAn]{.trn} "a serpent" of the root [ثعي]{.ar} is a common noun and therefore, not a semi-flexible noun.
2. The [ان]{.ar} must be extrinsic to the word's root. So [جَبَان]{.ar} [jabAnun]{.trn} "cowardly", an ;sifah; of the root [جبن]{.ar}, is not a semi-flexible noun.
3. The feminine of the ;sifah; shall not be formed by adding [ة]{.ar} to the masculine noun. So [نَدْمَان]{.ar} [nadmAn]{.trn} "regretful", an ;sifah; from the root [ندم]{.ar}, is not a semi-flexible noun, because its feminine is [نَدْمَانَة]{.ar} [nadmAnah]{.trn}.

It is rare that this last condition fails. Most ;sifah;s that end with an extrinsic [ان]{.ar} are of the pattern [فَعْلَان]{.ar} [faelAn]{.trn} and their feminine is of the pattern [فَعْلَىٰ]{.ar} [faelA]{.trn} (which is itself a semi-flexible noun pattern). These ;sifah;s typically have an emphatic meaning. The following are examples of semi-flexible ;sifah;s that fall into this category:
