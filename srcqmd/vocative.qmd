...
In this case, then instead of the u-state, the word is put into the a-state. Furthermore, the ;tanwin;, if any, is preserved. Examples:
...
Note that even when [يَا]{.ar} [yA]{.trn} is ommitted the name [زَيْدُ]{.ar} [zaydu]{.trn} "Zayd" is in the u-state without any ;tanwin;.
