...
In this case, then instead of the ;ustate;, the word is put into the a-state. Furthermore, the ;tanwin;, if any, is preserved. Examples:
...
If an unspecified person or persons are being called out, then the word used to call out is put into the a-state. Furthermore, the ;tanwin;, if any, is preserved. So if you want to address any unspecific Muslim, you will say:
