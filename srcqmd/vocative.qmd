...
If the word would be [nUn]{.trn2}ated, then the ;tanwin; is dropped. So, for example, the name [زَيْدٌ]{.ar} [zaydun]{.trn} "Zayd" usually is [nUn]{.trn2}ated. But when used for being called out to, the ;tanwin; is dropped and it becomes:
