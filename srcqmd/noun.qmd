...
Some nouns begin with a connecting [hamzah]{.trn2}, for example: [ٱِبْن]{.ar} [Eibn]{.trn} _son_. When in the beginning of a sentence, the connecting [hamzah]{.trn2} will be pronounced with an ;imark; [◌ِ]{.ar}.
...
If the definite article [ٱَلْ]{.ar} [Eal]{.trn} is with prefixed to nouns that have an initial connecting [hamzah]{.trn2}, then the [ل]{.ar} shall no longer have an ;0mark; [◌ْ]{.ar}. Instead it shall have an ;imark; [◌ِ]{.ar}. Example:
...
Nouns in Arabic have a property called _;case;_.
...
1. the ;ucase;. By default, it is indicated, by a ;umark; on the final letter of the noun.
1. the ;acase;. By default, it is indicated, by a ;amark; on the final letter of the noun.
1. the ;icase;. By default, it is indicated, by a ;imark; on the final letter of the noun.

When a noun is indefinite, then, for most nouns, it is also ;tanwin;ed.
Here, for example, is the noun [كِتَاب]{.ar} [kitAb]{.trn} "book" in its three states:

|;case;         | Indefinite "a book" | Definite "the book"|
|:-------------|:-----------------|:--------------|
|;ucase;       |[كِتَابٌ]{.ar} [kitAbun]{.trn}  |[ٱَلْكِتَابُ]{.ar} [EalkitAbu]{.trn} |
|;acase;       |[كِتَابًا]{.ar} [kitAban]{.trn} |[ٱَلْكِتَابَ]{.ar} [EalkitAba]{.trn} |
|;icase;       |[كِتَابٍ]{.ar} [kitAbin]{.trn}  |[ٱَلْكِتَابِ]{.ar} [EalkitAbi]{.trn} |

The ;ucase; is a noun's normal ;case;, and there needs to be a reason to take the noun out of this ;case; into another ;case;.
...
Note that the vowel-mark before the [ة]{.ar} is always an ;amark;. 
<!--For example, in the case of [كَلْب]{.ar} [kalb]{.trn} "a male dog", in order to get the feminine noun [كَلْبَة]{.ar} [kalbatun]{.trn} "a female dog", [ب]{.ar} gets an ;amark;.-->
...
such nouns adhere to their fixed grammatical gender when used for either male or female persons.^[[[عضو أم عضوة؟ ومسائل أخر]{.ar}](https://archive.org/details/riga2/page/n399mode/2up) in @faysal_mansoor_articles@ 401--410]
