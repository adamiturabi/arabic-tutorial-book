...
In 
chapter\ \@ref(;ucase;-;mudarie;-verbs)
we mentioned that ;mudarie; verbs have three ;case;s (like nouns). 
These ;case;s are called:

i. The ;ucase;
i. The ;acase;
i. The ;0case;

We introduced the ;ucase; ;mudarie; verb in
chapter\ \@ref(;ucase;-;mudarie;-verbs).
In this chapter we will study the 
;acase;
;mudarie; verb.

The ;ucase; ;mudarie; verb makes a plain statement.
The ;acase; ;mudarie; verb implies a wish or purpose.
The ;acase; ;mudarie; verb is used after the following articles:
...
## Forming the ;acase; ;mudarie; verb

Here is the ;ucase; ;mudarie; verb for the singular masculine absentee participant ;faa3il; "he":

[يَفْعَلُ]{.ar}  
[yafealu]{.trn}  
"he does"

Note that, because it is in the ;ucase;, the its final letter ends with a ;umark; [◌ُ]{.ar}.
...
This is done for all participants whose ;faa3il; pronoun is invisible and ;ucase; verb ends with a ;umark; [◌ُ]{.ar}.

For participants whose ;faa3il; pronoun is followed by an extra [ن]{.ar} in the ;ucase; verb, this final [ن]{.ar} is dropped in order to form the 
;acase;
;mudarie; verb.
So, for example, the ;ucase;
;mudarie; verb:
...
|Participant|#;mudarie; verb ;faa3il; pronoun|;ucase; ;mudarie; verb | ;acase; ;mudarie; verb|
|:---|:--|:---|:---|
...
+ The ;ucase; and ;acase; verbs are the same for the feminine plural absentee and addressee participants: 
  + [يَفْعَلْنَ]{.ar} (they~3f~)
  + [تَفْعَلْنَ]{.ar} (you~3f~)
+ The ;acase; verbs for the masculine plural absentee and addressee participants have a final silent [alif]{.trn2}: 
...
;mudarie; verb to be in the ;acase;.
...
### Basic usage of [أَنْ]{.ar} [Ean]{.trn} with the ;acase; ;mudarie; verb
...
[لَا]{.ar} can be used to negate the following ;acase; ;mudarie; verb.
...
[أَنْ]{.ar} must directly precede the following ;acase; ;mudarie; verb and must not be separated from it.
...
In the ;icase; as the ;mudafil; in an ;idaafah;:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below] {\scriptsize ;icase; ;mudafil;};
...
In the ;icase; after a preposition:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below] {\scriptsize ;icase; after preposition};
...
<!--
By the way, this [لِ]{.ar}, which is used with ;acase; ;mudarie; verbs, is different from 
the [لِ]{.ar} we learned in section\ \@ref(indirect-commands), which is used with the ;0case; ;mudarie; verbs for indirect commands.
-->

By the way, the grammatical equivalence of [أَنْ]{.ar} and a following ;acase; ;mudarie; verb with a ;masdar; applies also to when [لِ]{.ar} is used before (either an expressed or an implied) [أَنْ]{.ar}. So, for example, if we have a sentence:
...
There is a specific [لِ]{.ar}, called the [لِ]{.ar} of denial,  which is used with ;acase; ;mudarie; verbs and the verb [كَانَ]{.ar} that we will discuss in section (TODO in [كَانَ]{.ar} chapter).
...
It is also used before the ;acase; ;mudarie; verb.
The difference from [لِ]{.ar} is that, when [لِ]{.ar} is used with the ;acase; ;mudarie; verb, expressing or dropping the [أَنْ]{.ar} was optional.
...
By the way, 
[كَيْ]{.ar} and a following ;acase; ;mudarie; verb are not _directly_ replaced by
a ;masdar;.
...
Therefore,
[رَأْس]{.ar}
is in the ;icase;, as the noun following a preposition.
...
[رَأْس]{.ar},
here, is in the ;acase; because it is a ;mafulb; of the verb [أَكَلَ]{.ar} "ate".
The particle
[حَتَّىٰ]{.ar} "even",
...
Now
[رَأْس]{.ar}
is in the ;ucase; because it is actually the ;mubtada; of a new sentence, whose ;xabar; is (an either expressed or implied) [أَكَلْتُهَا]{.ar} "I ate it".
[حَتَّىٰ]{.ar},
here, serves as an introductory particle to the second ;mubtada; and does not affect the ;case; of the following noun.
...
#### [حَتَّىٰ]{.ar} with a following ;acase; ;mudarie; verb

When
[حَتَّىٰ]{.ar}
is used with an expectation or purpose of a future action of the verb following it, then 
the verb following it is an ;acase; ;mudarie; verb. 
<!--
When the verb following
[حَتَّىٰ]{.ar}
signifies the expectation or purpose of a future action, then the verb used is an ;acase; ;mudarie; verb. 
-->
...
1. When [حَتَّىٰ]{.ar} is used to indicate an extreme point at which the action of the following verb would occur, or is meant to occur. Here, 
   ...
   It is noteworthy that the use of [حَتَّىٰ]{.ar}, here, implies only that the following action is meant to occur, or is at the point of being expected to occur. It doesn't actually state that the action will actually occur, for something may prevent it from occurring in reality.^[@sadan_subj@ 201]

   Note, also, that [لَا]{.ar} is not attached to [حَتَّىٰ]{.ar} in [حَتَّىٰ لَا]{.ar}.

   Also, similar to the case of [كَيْ]{.ar}, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following ;mudarie; verb being in the ;acase;.
   In fact, 
   [حَتَّىٰ]{.ar},
...
2. When [حَتَّىٰ]{.ar} is used with the meaning "to such a purpose that". This is a similar meaning to [كَيْ]{.ar} "in order that".
   ...
   Again, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following ;mudarie; verb being in the ;acase;.
...
When used with a following ;mudarie; verb, the verb is put in the ;ucase; and the meaning is that the action of the verb _before_
[حَتَّىٰ]{.ar}
...
Compare these examples with the corresponding ones in the previous sub-section that have an ;acase; ;mudarie; verb.


<!--The preposition 
[حَتَّىٰ]{.ar} [HattA]{.trn}
is unusual in that the ;mudarie; verb following it may either be in the ;acase; or the ;ucase;, with slightly different meanings.
When the ;mudarie; verb following it is in the ;ucase; then
[حَتَّىٰ]{.ar} gives the meaning "until".
And when the ;mudarie; verb following it is in the ;acase; then
[حَتَّىٰ]{.ar} gives the meaning "for the result that".
A mandatorily unexpressed [أَنْ]{.ar} is assumed with
[حَتَّىٰ]{.ar} 
when the verb following it is in the ;acase;.
Examples:

[يَأْكُلُ حَتَّىٰ يَشْبَعَ.]{.ar} (;acase;, unexpressed [أَنْ]{.ar} assumed)  
"He eats for the result that he be sated."

[يَأْكُلُ حَتَّىٰ يَشْبَعُ.]{.ar} (;ucase;, no [أَنْ]{.ar})  
...
[لَا]{.ar} and [أَنْ]{.ar} are combined to form [لَنْ]{.ar} [lan]{.trn} with the meaning "shall not". [لَنْ]{.ar} is used with the ;acase; ;mudarie; verb to emphatically negate the future.
...
occur after an ;acase; ;mudarie; verb, then 
a second ;acase; ;mudarie; verb
(that doesn't have its own [أَنْ]{.ar}, etc.)
may be either in the ;acase; or the ;ucase;.
For example,

[أَرْغَبُ أَنْ أَحْضُرَ ٱلْمَجْلِسَ وَأَسْمَعَ.]{.ar} ([أَسْمَعَ]{.ar} in ;acase;)  
"I desire that I attend the session and [that] I listen."

or

[أَرْغَبُ أَنْ أَحْضُرَ ٱلْمَجْلِسَ وَأَسْمَعُ.]{.ar} ([أَسْمَعَ]{.ar} in ;ucase;)  
...
[وَ]{.ar}, [فَ]{.ar}, [أَوْ]{.ar}, and [ثُمَّ]{.ar} also cause the following ;mudarie; verb to be in the ;acase; in their own right, not simply as connectors. This is discussed in more detail in chapter TODO.
