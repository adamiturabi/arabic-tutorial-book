...
As usual, the base noun shall always be in the i-state. And the state of the ;mudaf; [عَبْد]{.ar} is variable, depending on it's function in the sentence. Example:
