...
+ [مُحَمَّدٍ]{.ar} is fully-flexible so it has a [nUn]{.trn2}ated ;imark; [◌ٍ]{.ar} in the i-state.
+ [زَيْنَبَ]{.ar} is semi-flexible so it is not [nUn]{.trn2}ated, and instead has an ;amark; [◌َ]{.ar} in the i-state.
...
This is because [جَمِيلَة]{.ar} is semi-flexible as a proper noun and fully-flexible as an adjectival/common noun. If [جَمِيلَة]{.ar} were intended to be used with its adjectival/common noun meaning then it would have a [nUn]{.trn2}ated ;umark; [◌ٌ]{.ar} and the sentence would be:
...
(Note how [زَيْدٍ]{.ar} has a [nUn]{.trn2}ated ;imark; [◌ٍ]{.ar} in the i-state because it is fully-flexible.)
