...
This is because [جَمِيلَة]{.ar} is semi-flexible as a proper noun and fully-flexible as an adjectival/common noun. If [جَمِيلَة]{.ar} were intended to be used with its adjectival/common noun meaning then it would have a ;tanwin;ed ;umark; [◌ٌ]{.ar} and the sentence would be:
...
In the above example, the name [زَيْدٌ]{.ar} is ;tanwin;ed and [ٱبْن]{.ar} is written with its connecting [hamzah]{.trn2} [ٱ]{.ar}. Therefore this is not an expression of the full name in a replacee-replacement format. Rather, [ٱبْنُ أَحْمَدَ]{.ar} here is the information of the sentence.
