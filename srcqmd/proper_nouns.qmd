...
The only exception to this rule is a masculine name of foreign origin that comprises of only three letters, and whose middle letter has an 0-mark. Such a name will be fully-flexible. Example:
...
The only exception to this rule is a feminine name of native Arabic origin, that comprises of only three letters, and whose middle letter has an 0-mark. Such a name is permitted to be optionally fully-flexible or semi-flexible. Examples:
