...
2. If the verb does not take a direct doee, then:
   a. If the completed-action verb is of the pattern [فَعِلَ]{.ar} [faeila]{.trn}, then the doing verbal-noun tends to be, in general, of the pattern [فَعَلٌ]{.ar} [faealun]{.trn}. Examples:
