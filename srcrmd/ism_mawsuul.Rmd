...
In the above sentence, the connected noun is [ٱَلَّذِي]{.ar}.
It is applied to singular masculine nouns, like [ٱلرََّجُل]{.ar}.
It signifies a specific individual denoted by a singular masculine noun.
By itself it may be translated as "the one~1m~", but in sentences it is usually translated as "who", "whom", "that", or "which".
...
## Position of the connected noun
