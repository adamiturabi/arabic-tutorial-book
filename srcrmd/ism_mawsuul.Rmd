...
The general connected noun can, however, occur as a replacement.^[See Fischer §421.2. The example too is taken from there. Originally, it is from [السيرة النبوية لابن هشام]{.ar}.]
For example,
