...
[مَا]{.ar}, and [مَنْ]{.ar}
but it won't often be as apparent because they are rigid nouns.[^ayy-a-state-question]

[^ayy-a-state-question]: Consider the example:
...
"then let her enter from whichever of the doors of paradise she wishes."[^ayy-question-vs-connected-noun]

[^ayy-question-vs-connected-noun]: For further reading on [أَيّ]{.ar} as a connected noun vs a question noun:
