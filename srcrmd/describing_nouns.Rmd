...
\path [decoration={text effects along path, 
  text={``the small-one house'' = ``the small house''},
  text effects/.cd, 
    path from text, text along path,
    group letters, word count=\w,
    every word/.style={name=word-\w, execute at begin node=\strut}},
  decorate, below=11ex] (0,0);
...
+ The word-for-word equivalence of the above adjectival noun-phrase is "the small-one house" but we will usually give the more natural translation: "the small house"
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, below=0.5ex, left=0.2ex, rotate=90] {\scriptsize information};

\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below=0.5ex, left=0.2ex, rotate=90] {\scriptsize subject};

\path [decoration={text effects along path, 
  text={``The house is a small-one.'' = ``The house is small.''},
  text effects/.cd, 
    path from text, text along path,
    group letters, word count=\w,
    every word/.style={name=word-\w, execute at begin node=\strut}},
...
Usually, adjectival nouns are used as the describer in an adjectival noun-phrase. However, we also often find a common noun used as a describer. For example,
