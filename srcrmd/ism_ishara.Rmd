...
| Participant | Near pointing | noun | Far pointing | noun |
|:--|---:|:----|---:|:----|
|sing. masc.|[هَـٰذَا]{.ar}                           |this one~m~  |[ذَ ٰلِكَ]{.ar}             |that one~m~  |
|sing. fem. |[هَـٰذِهِ]{.ar}                           |this one~f~  |[تِلْكَ]{.ar}              |that one~f~  |
|dual masc. |[هَـٰذَانِ^(u)^]{.ar} / [هَـٰذَيْنِ^(a,i)^]{.ar} |these ones~2,m~|[ذَ ٰنِكَ^(u)^]{.ar} / [ذَيْنِكَ^(a,i)^]{.ar} |those ones~2,m~|
|dual fem.  |[هَاتَانِ^(u)^]{.ar} / [هَاتَيْنِ^(a,i)^]{.ar} |these ones~2,f~|[تَانِكَ^(u)^]{.ar} / [تَيْنِكَ^(a,i)^]{.ar} |those ones~2,f~|
|plural     |[هَـٰؤُلَاءِ]{.ar}                         |these ones~3~  |[أُولَـٰئِكَ]{.ar}           |those ones~3~  |
...
Here is an example of a pointing noun phrase:

```{r,echo=FALSE,engine='tikz', engine.opts = list(template = "srctex/tikz2pdf-lua.tex")}
\usetikzlibrary{decorations.text, decorations.pathreplacing}
\begin{tikzpicture}[nodes={text depth=0.25ex,text height=1.25ex}]
\path [decoration={text effects along path, 
  text=\txarb{ٱلْكِتَابُ} \txarb{هَـٰذَا},
  text effects/.cd, 
    path from text, text along path,
    group letters, word count=\w,
    every word/.style={name=word-\w, execute at begin node=\strut}},
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, below=2ex, left=0.5ex, rotate=90] {\scriptsize replacement};

\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below=2ex, left=0.5ex, rotate=90] {\scriptsize replacee};
