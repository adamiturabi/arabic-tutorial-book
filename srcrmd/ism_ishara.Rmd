...
### The pointed-to noun is definite with [ٱَلْ]{.ar}
...
As a special case, when the pointed-to noun has [ٱَلْ]{.ar} (as in this case), then the order of the pointing noun and the pointed to noun is permitted to be reversed. 
...
Such names may also be part of a pointing noun phrase. But because they don't begin with [ٱَلْ]{.ar} then only the first order (of placing the pointed-to noun first, and following it with the pointing noun).
Example:

[زَيْدٌ هَـٰذَا أَخُو زَيْنَبَ تِلْكَ.]{.ar}  
"This Zayd is that Zaynab's brother."

### Pointing noun phrases with annexations

Consider the following annexation:

[كِتَابَا ٱلرَّجُلِ]{.ar}  
"the man's books~2~"
