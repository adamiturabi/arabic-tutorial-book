...
## The pointing noun phrase with a single pointed-to noun
...
\draw [decoration={brace}, decorate] 
   (word-1.north west) -- (word-1.north east)
      node [midway, above=10ex, left=-0.2ex, rotate=90] {\scriptsize describer};

\draw [decoration={brace}, decorate] 
   (word-2.north west) -- (word-2.north east)
      node [midway, above=10ex, left=-0.2ex, rotate=90] {\scriptsize describee};

\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-2.south east)
      node [midway, below=0.5ex] {\scriptsize descriptive noun-phrase};
...
\draw [decoration={brace}, decorate] 
   (word-1.north west) -- (word-1.north east)
      node [midway, above=12ex, left=-0.2ex, rotate=90] {\scriptsize replacement};

\draw [decoration={brace}, decorate] 
   (word-2.north west) -- (word-2.north east)
      node [midway, above=9ex, left=-0.2ex, rotate=90] {\scriptsize replacee};
...
## The pointing noun phrase with an annexation
...
### Annexations with the definite base noun beginning with [ٱَلْ]{.ar}
...
section\ \@ref(the-pointed-to-noun-is-the-annexe-noun) below.)
...
\draw [decoration={brace}, decorate] 
   (word-2.north west) -- (word-2.north east)
      node [midway, above=10.25ex, left=-0.2ex, rotate=90] {\scriptsize base-noun};

\draw [decoration={brace}, decorate] 
   (word-3.north west) -- (word-3.north east)
      node [midway, above=12.25ex, left=-0.2ex, rotate=90] {\scriptsize annexe-noun};
...
\path (0,0) node [midway, below=18ex, right=0ex, align=left] {``the book of this man''\\(literally: ``the book of this-one: the man'')};

\end{tikzpicture}
```

#### The pointed-to noun is the annexe noun

#### The base noun is a proper noun beginning with [ٱَلْ]{.ar}

### Annexations with the definite base noun not beginning with [ٱَلْ]{.ar}
