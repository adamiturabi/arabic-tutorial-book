...
We can apply the pointing noun "this" to either "the book" or to "the man". So we have two options:
...
In this section we will learn how to construct these expressions in Arabic.

### Annexations with the base noun beginning with [ٱَلْ]{.ar}
