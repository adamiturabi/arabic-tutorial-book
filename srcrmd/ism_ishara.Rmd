...
\path (0,0) node [midway, below=15ex, right=0ex, align=left] {``the book of this man''\\(literally: ``the book of this-one: the man'')};
...
\path (0,0) node [midway, below=12ex, right=0ex, align=left] {``the book of this man''\\(literally: ``the book of the this-one man'')};
