...
When calling someone with the pronoun "my", for example "O my people", it is common to shorten the attached pronoun [ي]{.ar} [I]{.trn} "my" to an [i]{.trn}-mark [◌ِ]{.ar}. So instead of saying:
...
This usage is especially common when supplicating to [#allAh]{.trn} with the phrase [رَبِّ]{.ar} [rabbi]{.trn} "my Lord". In this case, the initial [يَا]{.ar} [yA]{.trn} is dropped too, to emphasize the closeness of [#allAh]{.trn} to the supplicator.
