...
### Doer pronouns for the singular absentee-participant
...
As you can see, all we did was omit the doer-noun [ٱَلرَّجُل]{.ar} [Earrujul]{.trn}, and we didn't add any word to replace it as the doer pronoun. This is because the doer pronoun for "he" is _invisible_ and automatically comes in place when we omit the doer noun.

The doer pronoun for "she" is similarly invisible.
For example, if we replace the doer noun in the sentence:

[قَرَأَتْٱلْجَارِيَةُ كِتَابًا.]{.ar}  
[qaraEati -ljAriyatu kitAban.]{.trn}
