...
[قرء]{.arroot} |[قَزَأَ]{.ar} [qaraEa]{.trn} |"read"
...
[جَلَسَتْ هِرَّةٌ عَلَى ٱلْكُرْسِيِّ.]{.ar}
[jalasat hirratun eala -lkursiyyi.]{.trn}  
...
Doer pronouns are of two types: visible and invisible. When visible, doer pronoun are attached to the verb.

Here we list the singular doer pronouns in Arabic. The root template [فعل]{.arroot} is used to show how the doer pronouns attach the the verb. The middle root letter of [فعل]{.arroot} has an [a]{.trn}-vowel [◌َ]{.ar} here but this vowel will vary for other verbs.

Participant | Doer pronoun | Doer pronoun with verb
:------|:--|:--
Masc. absentee ("he")      | invisible            | [فَعَلَ]{.ar} [faeala]{.trn}
Fem. absentee ("she")      | invisible            | [فَعَلَتْ]{.ar} [faealat]{.trn}
Masc. addressee ("you~m~") | [تَ]{.ar} [-ta]{.trn} | [فَعَلْتَ]{.ar} [faealta]{.trn}
Fem. addressee ("you~f~")  | [تِ]{.ar} [-ti]{.trn} | [فَعَلْتِ]{.ar} [faealti]{.trn}
...
### Doer pronouns for the singular addressee ("you") and speaker ("I") participants

It is only the doer pronouns for the singular absentee participant that is invisible for completed-action verbs. The doer pronouns for the singular addressee and speaker participants are visible, and are listed in the table above.
...
Note also how the visible singular doer pronouns modify the basic verb by replacing the [a]{.trn}-mark [◌َ]{.ar} on the final letter by a $\emptyset$-mark [◌ْ]{.ar}.
...
### Verbs pull doee pronouns toward them
...
When the direct doee noun [ٱلْكِتَابَ]{.ar} [EalkitAba]{.trn} "the book" is replaced with the pronoun "it", the doee pronoun must be attached to the verb, and then the doer noun follows the doee pronoun:
...
[pahaba -lgulAmu Eila -lmadrasati.]{.trn}  
"The boy went to the school."

Now, if we replace the indirect doee noun [ٱلْمَدْرَسَةِ.]{.ar} [Ealmadrasati]{.trn} "the school" with a pronoun "it", the indirect doee pronoun is attached, not to the verb, but to the preposition thus: [إِلَيْهَا]{.ar} [EilayhA]{.trn} "to it". So it possible to preserve the original order of words in the sentence:
