...
The doer in this sentence is the pronoun "I". This same doer is doing the action of multiple words.
...
[دَخَلْتُ ٱلٌُْغُرْفَةَ فَأَكَلْتُ فَشَرِبْتُ فَخَرَجْتُ.]{.ar}  
[daxaltu -lgurfata faEakaltu facaribtu faxarajt.]{.trn}
"I entered the room and then I ate and then I drank and then I exited."

(We also took some liberty in the translation by employing the particle [فَ]{.ar} [fa-]{.trn} "so"/"and then" which implies an order or consequence or subsequence between the individual events.)
...
[دَخَلَتِ ٱلْجَارِيَةُ ٱلٌُْغُرْفَةَ فَأَكَلَتْ فَشَرِبَتْ فَخَرَجَتْ.]{.ar}  
