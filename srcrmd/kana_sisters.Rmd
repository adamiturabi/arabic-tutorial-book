...
## [كَنَ]{.ar} with a non-rational beings' plural subject
...
## [كَنَ]{.ar} with a separating pronoun

Another rule that applies to subject-information sentences, and carries over to 
[كَانَ]{.ar} sentences, is that
when the subject and information are both definite, 
then a separating pronoun, that matches the subject, can be inserted between them.
For example,
