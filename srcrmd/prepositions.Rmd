...
+ When a single letter preposition comes before a definite noun with [ٱَلْ]{.ar} [al]{.trn}, the preposition is generally joined to the [alif]{.trn} in the [ٱَلْ]{.ar} [al]{.trn}. The [alif]{.trn} is now not pronounced (because as we know it has a connecting [hamzah]{.trn}). Example:
  ...
  If the noun begins with a connecting [hamzah]{.trn} then the [ل]{.ar} in [ٱَلْ]{.ar} gets an [i]-mark [◌ِ]{.ar} instead of its usual $\emptyset$-mark [◌ْ]{.ar}. We described this in 
...
There are three different prepositions above that we have translated as "at". They are largely interchangeable but there are some differences in meaning that we will explain later, if [#allAh]{.trn2} wills.
