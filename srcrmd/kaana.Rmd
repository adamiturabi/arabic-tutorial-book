...
Note, how, in the above example, [كَانَتْ]{.ar} has a [ت]{.ar} of femininity to match the feminine gender of the information [عَادَة]{.ar} "habit".
...
[كَانَ]{.ar}
is to indicate a state that had first not begun and then began and remained, possibly up to the present.
It is, in this sense, equivalent to the meaning "became", "has become", or "happened". Examples:
