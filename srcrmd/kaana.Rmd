...
2. [زَيْد]{.ar} is the delayed subject of [كَانَ]{.ar} and [يَكْتُبُ]{.ar} is the information of [كَانَ]{.ar}. The doer of [يَكْتُبُ] is a hidden pronoun.
...
[رِجَالٌ يَكُونُونَ مَعَ ٱلْمُلُوكِ]{.ar}  
...
"[#Hupaifah]{.trn2} said: 'You might have done that.'"  
...
(No [كَانُوا]{.ar} before [تَقْتُلُونَ]{.ar}.)
...
[كَانَتِ ٱلْعُصِيِّ مَرْكُوزَةً فِي ٱلْأَرْضِ.]{.ar}  
"The staffs were sticking in the ground."  
([كَنَتْ تُرْكَزُ]{.ar} would imply that they were being stuck.)
