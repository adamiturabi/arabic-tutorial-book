...
For women, the word [بِنْت]{.ar} is used instead of [بْن]. 
...
The names of multiple forefathers may be strung together separated in this why by [بْن]{.ar}. For example:

[ٱِسْمُ نَبِيِّنَا مُحَمَّدُ بْنُ عَبْدِ ٱلَّـٰهِ بْنِ عَبْدِ ٱلْمُطَّلِبِ.]{.ar}  
...
|[بَغْدَاد^2^]{.ar}  |Baghdad  |[ٱَلْهِنْد]{.ar}     |India |
...
|||||
|--:|:---|--:|:---|
|[نَبِيّ]{.ar}   |Prophet    |[إِمَام]{.ar}  |[#imAm]{.trn2} |
|[مَلِك]{.ar}   |King       |[شَيْخ]{.ar}   |[#cayx]{.trn2} |
|[أَمِير]{.ar}  |Commander  |[أُسْتَاذ]{.ar} |Professor      |

Some Arabic titles are left untranslated in English like
[إِمَام]{.ar}  [#imAm]{.trn2} (a leader) and 
[شَيْخ]{.ar}   [#cayx]{.trn2} (a venerable man).
...
|||||
|--:|:---|--:|:---|
|[خَلِيفَة رَسُول ٱللَّـٰه]{.ar}  | the Successor of the Messenger of [#allAh]{.trn2}  |[سَيْف ٱللَّـٰه]{.ar}         | the Sword of [#allAh]{.trn2}  |
|[أَمِير ٱلْمُؤْمِنِينَ]{.ar}     | the Commander of the Believers                     |[عِمَاد ٱلدِّين]{.ar}        | the Pillar of the Faith  |
|[أُمّ ٱلْمُؤْمِنِينَ]{.ar}       | the Mother of the Believers                        |[صَلَاحُ ٱلدِّين]{.ar}        | the Righteousness of the Faith  |
...
|||||
|--:|:---|--:|:---|
|[جَبَل أُحُد]{.ar}      |Mount [#uHud]{.trn2} |[مَدِينَة دِمَشْق]{.ar}   |the city of Damascus |
|[نَهْر ٱلنِّيل]{.ar}    |the river Nile      |[شَهْر رَمَضَان]{.ar}    |the month of [#ramaDAn]{.trn2} |
|[سُورَة ٱلْفَاتِحَة]{.ar} |the [#sUrah]{.trn2} of [al-#fAtiHah]{.trn2} ||
...
Generally, if the ending [◌ِيّ]{.ar} [-iyy]{.trn} is suffixed to a noun, it forms an affiliate adjectival noun. Sometimes there are other internal changes to the word before this suffix is added.
We will only give some examples here and will treat this topic fully in chapter\ \@ref(the-affiliate-adjective-chapter).

Here are some examples of affiliate adjectival nouns:

|||||
|--:|:---|--:|:---|
|[عِرَاقِيّ]{.ar}    |Iraqi    |[قُرَشِيّ]{.ar}     |[#qurayc]{.trn2}ite |
|[مَكِّي]{.ar}      |Meccan   |[تَمِيمِيّ]{.ar}    |[#tamIm]{.trn2}ian  |
|[دِمَشْقِيّ]{.ar}    |Damascan |[إِسْرَائِيلِيّ]{.ar} |[#isrAEIl]{.trn2}ite|
...
[ٱِبْن كَثِيرٍ ٱلدِّمَشْقِيُّ عَالِمٌ.]{.ar}  
"[#ibn #kavIr]{.trn2} the Damascan is a scholar."
