...
|[أُسَامَة^2^]{.ar}     |[#usAmah^2^]{.trn2}     | [زَيْنَب^2^]{.ar}      |[#zaynab^2^]{.trn2} |
|[عُثْمَان^2^]{.ar}     |[e#uvmAn^2^]{.trn2}     | [مَرْيَم^2^]{.ar}      |[#maryam^2^]{.trn2} |
|[عُمَر^2^]{.ar}       |[e#umar^2^]{.trn2}      | [سُعَاد^2^]{.ar}      |[#sueAd^2^]{.trn2} |
|[إِبْرَاهِيم^2^]{.ar}   |[#ibrAhIm^2^]{.trn2}    | [أَسْمَاء^2^]{.ar}     |[#asmAE^2^]{.trn2} |
|[عَبْد ٱللَّـٰه]{.ar}    |[e#abd #allAh]{.trn2}   | [لَيْلَىٰ^2^]{.ar}      |[#laylA^2^]{.trn2} |
|[أَبُو بَكْر]{.ar}      |[#abU #bakr]{.trn2}     | [أُمّ حَبِيبَة^2^]{.ar}  |[#umm #HabIbah^2^]{.trn2} |

| Place |names | Misc. |names |
|-:|:--|-:|:---|
|[مَكَّة^2^]{.ar}   |Mecca     |[رَمَضَان^2^]{.ar} |[#ramadAn^2^]{.trn2} (a month) |
...
We we explain these and more details regarding proper nouns in this chapter.
...
"I went to the house of the noble [#muHammad]{.trn2} and the good [#zaynab^2^]{.trn2}."
