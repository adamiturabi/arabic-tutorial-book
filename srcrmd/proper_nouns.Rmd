...
|[دِمَشْقِيّ]{.ar}    |a Damascan          |[إِسْرَائِيلِيّ]{.ar} |a [#isrAEIl]{.trn2}ite|
...
+ The affiliate adjectival noun may be formed from any distinctive name of a person or place. For example:
...
The nicknames position is variable.

Here are some examples of full names in varying degrees of completeness:

+ [خَلِيفَةُ رَسُولِ ٱللَّـٰهِ أَبُو بَكْرٍ ٱلصِّدِّيقُ]{.ar}  
  The Successor of the Messenger of [#allAh]{.trn2}, [#abU #bakr]{.trn2}, the steadfast affirmer of the truth

+ [أَمِيرُ ٱلْمُؤْمِنِينَ عُمَرُ بْنُ ٱلْخَطَّابِ]{.ar}  
  The Commander of the Believers, [e#umar] the son of [al-#xaTTAb]{.trn2}
