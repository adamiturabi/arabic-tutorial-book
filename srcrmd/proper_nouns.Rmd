...
+ [عَبْد ٱللَّـٰه]{.ar} [e#abd #allAh]{.trn2} "the Slave of [#allAh]{.trn}"
...
The word [قَبِيلَة]{.ar} in Arabic means "a tribe".
...
|[بَنُو أَسَد]{.ar}        | [#banU #asad]{.trn2}  |[بَنُو إِسْرَائِيل^2^]{.ar} | [#banU #isrAEIl]{.trn2}
...
Arab tribe names are usually based on the name of a remote forefather. For example, [قُرَيْش]{.ar} thought to be a pre-historical man, whose descendents constituted the tribe of that name.

Many tribe names and sub-tribe names are formed from annexations


Arab tribes may optionally be treated either as feminine singular or masculine plural
