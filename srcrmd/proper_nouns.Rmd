...
## Proper nouns formed from annexations
...
Women, too, are similarly called as the mother of one of their children. For example, a woman with a daughter named [حَبِيبَة^2^]{.ar} could be called [أُمّ حَبِيبَة^2^]{.ar} [#umm #HabIbah]{.trn2}.

By the way, a person need not literally be a father or a mother to be called in such a way. These names may also be formed as nicknames.
...
Attributing a son to his father is most common. But attributing him to a mother or a well-known ancestor is also found.
