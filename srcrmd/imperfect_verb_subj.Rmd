...
\path (0,0) node [midway, below=6ex, right=-2ex, align=left] {``That you suceed is the purpose.''};
...
\path (0,0) node [midway, below=6ex, right=-2ex, align=left] {``The purpose is that you suceed.''};

\end{tikzpicture}
```

As the base noun in an annexation:
