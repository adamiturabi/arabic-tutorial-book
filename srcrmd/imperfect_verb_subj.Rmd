...
The difference from [لِ]{.ar} is that, when [لِ]{.ar} is used with the a-state incomplete-action verb, keeping or dropping the [أَنْ]{.ar} was optional.
...
With [لَا]{.ar} the whole combination is written as [لِكَيْلَا]{.ar} [likaylA]{.trn}. [أَنْ]{.ar} must again be dropped.
