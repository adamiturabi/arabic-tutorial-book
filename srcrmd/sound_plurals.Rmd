...
The [Un]{.trn} sound plural is used, with very few exceptions, only for nouns that denote male intelligent beings. These guidelines will help you determine which nouns form the [Un]{.trn} sound plural. We will treat common nouns and adjectival nouns separately.
...
We learned in section\ \@ref(related-nouns-for-male-and-female-animate-beings) that, in terms of their meaning, nouns denote animate beings are of two kinds:

i.  Nouns that have a primitive meaning. That is, their meaning is not derived from a verbal or adjectival meaning. Examples (for male intelligent beings):
...
ii. Nouns that have a meaning that is derived from a verbal or adjectival meaning. Examples (for male intelligent beings):
    Arabic word |Gender | Definition
    :----------------------|:---|:----------------
...
The above condition, as we have explained it, is somewhat imprecise. In later chapters, once we have studied the patterns of the derived nouns, we will try to make this condition more precise, if [#allAh]{.trn2} wills.
...
Another counter-example is the noun [طِفْل]{.ar} [Tifl]{.trn} (masc.) "a child"
