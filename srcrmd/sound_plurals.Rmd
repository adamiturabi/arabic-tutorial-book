...
As mentioned in section\ \@ref(at-plural-for-defective-nouns), we will learn how to form plurals for nouns that end with 
[اء]{.ar}, and [ىٰ]{.ar}
...
+ [صَدِيقَة]{.ar} [SadIqah]{.trn} "a friend~f~" forms the sound plural [صَدِيقَات]{.ar} [SadIqAt]{.trn} "friends~f~".
