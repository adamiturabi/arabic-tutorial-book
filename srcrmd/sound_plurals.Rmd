...
ii. Nouns that have a meaning that is derived from a verbal or adjectival meaning. Examples (for male intelligent beings whose feminine is formed by adding [ة]{.ar} to the masculine noun):
    ...
    Arabic word |Gender | Definition | [Un]{.trn} plural
    :----------------------|:---|:----------------|:------------
    [مُعَلِّم]{.ar}   [mueallim]{.trn}  |masc.|a (male) teacher   |[مُعَلِّمُونَ]{.ar}
    [طَالِب]{.ar}   [TAlib]{.trn}     |masc.|a (male) student   |[طَالِبون]{.ar}
    [صَاحِب]{.ar}   [SAHib]{.trn}     |masc.|a (male) companion |[صَاحِبون]{.ar}
    [صَدِيق]{.ar}   [SadIq]{.trn}     |masc.|a (male) friend    |[صَدِيقون]{.ar}

    Such nouns, in general, can be expected to form [Un]{.trn} sound plurals. For many of these nouns, however, we will see in the next chapter, if [#allAh]{.trn2} wills, that many of them also form broken plurals. Many times, then, the broken plural is preferred to be used over the sound plural.
