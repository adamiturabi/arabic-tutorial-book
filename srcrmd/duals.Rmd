...
If a noun ends with a [ة]{.ar}, then it is converted to a [ت]{.abar} before appending the dual suffix. For example, dualizing [شَجَرَة]{.ar} [cajarah]{.trn} "a tree", we get "trees~2~":
