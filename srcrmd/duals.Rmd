...
Now we will learn the detached pronouns for the dual participant:
...
+ Just like the singular absentee-participant singular attached pronoun [هُ]{.ar} [hu]{.trn} "him", the dual absentee-participant attached pronoun "them~2~" [هُمَا]{.ar} [-humA]{.trn} becomes [هِمَا]{.ar} [-himA]{.trn} when preceded by the vowels [◌ِ]{.ar} [i]{.trn}, [ـِي]{.ar} [I]{.trn}, or the semi-vowel [ـَيْ]{.ar} [ay]{.trn}. Examples:
