...
[إِنَّ]{.ar} [Einna]{.trn} may have multiple subjects separated by [وَ]{.ar}. Example,

[إِنَّ ٱلْمُسْلِمِينَ وَٱلْمُسْلِمَاتِ يَعْمَلُونَ ٱلصَّالِحَاتِ.]{.ar}  
"Indeed the Muslim men and Muslim women do good deeds."
...
+ [إِنَّ]{.ar} [Einna]{.trn} can have multiple
+ By default, the subject of [إِنَّ]{.ar} [Einna]{.trn} must directly follow it with no intervening words or particles. The only exception is when the information consists of a prepositional or adverbial phrase, it is then allowed to precede the subject. The subject is in the a-state in any case.
