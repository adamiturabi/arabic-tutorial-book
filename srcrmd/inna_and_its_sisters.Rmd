...
\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, rotate=90, anchor=south, left=0ex] {\scriptsize pronoun of the matter};
...
Sometimes, one can choose between using the pronoun of the matter and a pronoun matching the participant resulting in different emphasis. For example,

[إِنِّهُ هُمُ ٱلْفَاعِلُونَ]{.ar}  
"Indeed, the matter is: they are the doers."
