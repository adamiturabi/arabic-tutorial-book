...
Remember from section\ \@ref(conditions-for-the-at-plural) that, with very few exceptions, all nouns that end with a feminine marker 
([ة]{.ar}, [اء]{.ar}, and [ىٰ]{.ar}) 
can form the [At]{.trn} sound plural.

There are only a handful of nouns that denote female intelligent beings that only have broken plurals and don't form sound plurals, like: 

+ [ٱِمْرَأَة]{.ar} "a woman", plural: [نِسَاء]{.ar}
+ [أَمَة]{.ar} "a slave~f~", plural: [إِمَاء]{.ar}
+ [أُنْثَىٰ]{.ar} "a female", plural: [إِنَاث]{.ar}

In the case of these nouns we have no choice but to use the broken plural.

For other nouns that denote female intelligent beings, the use of the [At]{.trn} sound plural is preferred over any broken plurals that the noun may have. This applies to both common nouns and adjectival nouns.
...
+ Broken plurals of the pattern [فُعْل]{.ar} [fuel]{.trn} for nouns that denote colors and physical characteristics. For example: the plural of [حَوْرَاء]{.ar} [HawrAE]{.trn} "a beautiful eyed one~f~" is the [At]{.trn} sound plural [حُور]{.ar} [HUr]{.trn}.
...
+ Broken plurals of the patterns:
  ...
  These broken plural patterns are, in fact, predominantly used for female intelligent beings, and non-intelligent beings. So the broken plural [جَوَارٍ^2^]{.ar} "girls" may be used freely as the plural of [جَارِيَة]{.ar} "a girl" and is not preferred over by [جَارِيَات]{.ar}. Similarly, [صَوَاحِب^2^]{.ar} may be used freely as the plural of [صَاحِبَة]{.ar}.
...
So, for example, [حَدَائِق^2^]{.ar} [HadAEiq^2^]{.trn} is preferred over [حَدِيقَات]{.ar} [HadIqAt]{.trn} as the plural of [حَدِيقَة]{.ar}.
