...
+ Some words have roots that have the same letter repeated in the root. These are called _doubled_ roots. 
  ...
  + For example:
    ...
    |Word | Root | Pattern
    |:-----|:-|:-
    |[دُبّ]{.ar} [dubb]{.trn} "a bear"           |[دبّ]{.arroot} | [فُعْل]{.ar}
    |[مَحَلَّة]{.ar} [maHallah]{.trn} "a locality" |[حلّ]{.arroot} | [مَفْعَلَة]{.ar}
    |[إِمَام]{.ar} [EimAm]{.trn} "a leader"      |[أمّ]{.arroot} | [فِعَال]{.ar}
    |[حَقّ]{.ar} [Haqq]{.trn} "a truth, a right" |[حق]{.arroot} | [فَعْل]{.ar}
    |[هِرّ]{.ar} [hirr]{.trn} "a cat~m~"         |[هر]{.arroot} | [فِعْل]{.ar}
