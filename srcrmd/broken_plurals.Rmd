...
+ Some words have roots that have the same letter repeated in the root. These are called _doubled_ roots. 
  ...
  + The doubled letter may modify the basic word pattern somewhat. For example:
    ...
    |Root | Word | Plural pattern | Expected plural | Actual plural
    |:-|:--|:--|:--|:--
    |[شدّ]{.arroot} |[شَدِيد]{.ar} |[أَفْعِلَاء^2^]{.ar} |$\times$\ [أَشْدِدَاء^2^]{.ar} |[أَشِدَّاء^2^]{.ar}
    |[حلّ]{.arroot} |[مَحَلَّة]{.ar} |[مَفَاعِل^2^]{.ar}  |$\times$\ [مَحَالِل^2^]{.ar}  |[مَحَالّ^2^]{.ar} 
