...
23. **[فَعَالِي^2^]{.ar} [faeAlI^2^]{.trn}**. Examples:
...
+ There often exist multiple broken plurals for the same singular noun. Many times, in fact, a singular noun may have a sound plural in addition to one or more broken plurals. Examples:
  ...
  We will discuss how to manage these multiple these multiple plurals in a subsequent section.
...
+ The letters [ء]{.ar}, [ا]{.ar}, [و]{.ar}, and [ي]{.ar} are considered _weak_ letters. Words that one or more these weak letters in their roots are called _defective_ words. We will discuss defective words more completely in later chapters, if [#allAh]{.trn2} wills. For now, we will note the following:
  ...
  + A [ي]{.ar} at the end of a word frequently gets ommitted (in the indefinite u- and i-states) and replaced by an [in]{.trn}-mark [◌ٍ]{.ar} on the preceding letter. This happend even when the [ي]{.ar} is extrinsic to the root, and even if the word is semi-flexible and would not normally accept an [n]{.trn} mark. Examples:

    |Root | Word pattern | Expected word (indefinite u-state) | Actual word (indefinite u- and i-states)
    |:-|:--|:--|:--
    |[قضي]{.arroot} |[فَاعِل]{.ar} |$\times$\ [قَاضِيٌ]{.ar} |[قَاضٍ]{.ar}
    |[جري]{.arroot} |[فَوَاعِل^2^]{.ar} |$\times$\ [جَوَارِيُ^2^]{.ar} |[جَوَارٍ^2^]{.ar}
    |[ليل]{.arroot} |[فَعَالِي^2^]{.ar} |$\times$\ [لَيَالِيُ^2^]{.ar} |[لَيَالٍ^2^]{.ar}
