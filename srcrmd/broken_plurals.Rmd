...
5.  **[فِعَال]{.ar} [fieAl]{.trn}**. Examples:
    ...
    |[غَضْبَان^2^، غَضْبَىٰ^2^: غِضَاب]{.ar} |very angry     ||
...
So, for example, [حَدَائِق^2^]{.ar} [HadAEiq^2^]{.trn} is preferred over [حَدِيقَات]{.ar} [HadIqAt]{.trn} as the plural of [حَدِيقَة]{.ar}. Although, [حَدِيقَات]{.ar} [HadIqAt]{.trn} is also correct.
...
Unfortunately, there is often not much relation between the pattern of the singular and the pattern of the plural. So you should memorize the plural of a noun with its singular.
