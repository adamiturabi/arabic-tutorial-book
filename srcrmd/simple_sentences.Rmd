...
2. The _you-participant_. This is the participant whom the I/we-participant is directly speaking to. When the I/we-participant refers to the participant he is speaking to, he uses the "you" pronoun in English. We will call this the _you-participant_. Because the word "you" is the same for the singular and the plural, we will use a subscript with a number to indicate if we are talking about the singular or the plural. For example, we will use "you~1~" for the singular.
3. The _they-participant_. This is the participant who is not being directly spoken to. Their only participation in the speech is that they are being referred to. When the I/we-participant refers to them in English, the pronouns used for this participant are "he", "him", "she", "her", "it", "they", and "them". We will call this participant the _he/she/they-participant_.
...
### Detached pronouns for the singular he/she-participant

Here are the Arabic detached pronouns for the singular he/she-participant:

+ He-participant: [هُوَ]{.ar} [huwa]{.trn} "he".
+ She-participant: [هِيَ]{.ar} [hiya]{.trn} "she".
...
### Detached pronouns for the singular you~1~-participant and I-participant

Here are the pronouns for the singular you~1~-participant and I-participant:

+ You~1m~-participant (masc.): [أَنْتَ]{.ar} [Eanta]{.trn} "you~m~".
+ You~1f~-participant (fem.): [أَنْتِ]{.ar} [Eanti]{.trn} "you~f~".
+ I-participant (masc. & fem.): [أَنَا]{.ar} [Eana]{.trn} "I". 

Note that the you-participant pronoun "you" has separate pronouns for the masculine and the feminine while the I-participant pronoun "I" has the same pronoun for both genders. Examples with these pronouns:
