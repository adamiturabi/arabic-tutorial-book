...
[سُؤَالٌ]{.ar} [suEAlun]{.trn}, in addition to being a doing verbal-noun "questioning" is re-used as a common noun with the meaning "a question" and the broken plural [أَسْئِلَةٌ]{.ar} [EasEilatun]{.trn} "questions". So, for example, we can say:
...
Just as some doing verbal-nouns are re-used as common nouns, there are some common nouns that may be re-used as doing verbal-nouns. For example, the verb [فَعَلَ يَفْعَلُ]{.ar} [faeala yafealu]{.trn} "to do ([هـ]{.ar} an action)" has the doing verbal-noun [فَعْلٌ]{.ar} [faelun]{.trn}.
