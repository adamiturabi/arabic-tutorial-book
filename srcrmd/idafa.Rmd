...
## The annexation with a describer
...
[ذَهَبَ ٱلْغُلَامُ إِلَىٰ بَيْتِ رَجُلٍ كَبِيرٍ.]{.ar}  
"The boy went to a big/old man's house."  
or  
"The boy went to a man's big house."  

How do we know whether the describer [كَبِيرٍ]{.ar} is meant to describe the annexe noun [بَيْتِ]{.ar} or the base noun [رَجُلٍ]{.ar}?
The annexe noun [بَيْتِ]{.ar} and the base noun [رَجُلٍ]{.ar} are both masculine, singular, indefinite, and in the i-state.

The answer is that in such cases, context will have to tell us which of the two meanings is intended. Also, sometimes, the meaning of the describer is such that it will likely apply to only one of the two nouns. For example,

[ذَهَبَ ٱلْغُلَامُ إِلَىٰ بَيْتِ رَجُلٍ كَرِيمٍ.]{.ar}  
"The boy went to a noble/generous man's house."  

In the sentence above the describer [كَرِيمٍ]{.ar} "noble/generous" is likely to apply to a man, and not to a house.
