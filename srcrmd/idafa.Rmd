...
In order to apply a describer to the annexe noun in such a case, we have to break the annexation and form a prepositional phrase instead, usually with the preposition [لِ]{.ar}, which, here, will mean "of". Example:
