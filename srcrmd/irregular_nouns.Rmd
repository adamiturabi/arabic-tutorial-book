...
The fifth of "the five nouns" is [فُو]{.ar} [fU]{.trn}. It is the most irregular noun so far in that it is derived from [فَم]{.ar} [fam]{.trn} "a mouth". 

The word [فَم]{.ar} [fam]{.trn} is regular in many ways. It is only irregular when it is a singular annexe noun. Let's first see its regular bahavior.
