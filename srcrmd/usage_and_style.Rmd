...
ii.  "There is a type of anger which is good and [there is] a type of anger which is bad.
...
Similarly, a introductory [mubtadaE]{.trn2} or [xabar]{.trn2} can be manufactured to pave the way for the main sentence. For example:
...
This solution should only be considered if the above strategies do not work.
