...
2. The direct doee in i-state annexed to the doer verbal-noun
   ...
   for the meaning: "I will do it." Note again, that the latter sentence could also support the noun meaning of the doer-verbal noun: "I am its doer.", i.e., "I am the one who did it."
   ...
   for the meaning: "He is going to kill the people." Note, once again, that the latter sentence also supports the meaning: "He is the people's killer.", i.e., "He is the one who killed them", and that context would be needed to tell us which of the two meanings is intended.

   The annexation of a doer verbal-noun to its direct doee in the i-state is not the kind of "proper" annexation that we have learned so far. In fact, it is called an _improper annexation_ and we shall study it in more detail in chapter {TODO], if [#allAh]{.trn} wills.

### The definite doer verbal-noun as a verb

So far we have seen only an indefinite doer verbal-noun being used with the meaning of an incomplete-action verb. However, the definite doer verbal-noun, too, can give this meaning. Here are some examples:
