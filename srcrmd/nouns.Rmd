...
When we discuss nouns in isolation we shall pronounce the looped [ة]{.trn} as a [h]{.trn}. Therefore, 
...
When discussing the definite noun in isolation we may write it without the final short vowel thus: [ٱَلْكِتَاب]{.ar} [EalkitAb]{.trn}.
