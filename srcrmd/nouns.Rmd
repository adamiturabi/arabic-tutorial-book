...
A good dictionary should mention the gender of all these exceptional words. In addition, in appendix\ \@ref(unmarked-fem-nouns) as well, we have a compiled a list of feminine nouns that don't end with a feminine marker. (TODO: get from Hava.)
