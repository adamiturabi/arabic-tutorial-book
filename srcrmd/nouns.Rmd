...
"a" is called the _indefinite article_ and "the" is called the "definite article".

### Definite nouns in Arabic

The definite article in Arabic is 
[ٱَلْ]{.ar} [al]{.trn}. It corresponds to the English definite article "the".
In order to make a noun definite, we attach 
[ٱَلْ]{.ar} [al]{.trn}
to its beginning.

For example, to make [ٱَلْكِتَاب]{.ar} [EalkitAb]{.trn} is the definite noun "the book".
...
"This man gave that boy some water."

In the above sentence "man" and "boy" are definite, and "water" is indefinite.
