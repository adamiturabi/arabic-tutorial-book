...
1. The noun must be a adjectival-noun, not a common noun. So the common noun [ثُعْبَان]{.ar} [vuebAn]{.trn} "a serpent" of the root [ثعي]{.arroot} is a common noun and therefore, not a semi-flexible noun.
...
### Nouns of the patterns [فَفَافِف]{.ar}, [فَفَافِيف]{.ar}, and [فَفَافِفّ]{.ar}
...
+ [كَرَاسِيّ^2^]{.ar} [karAsiyy^2^]{.trn} "chairs"
