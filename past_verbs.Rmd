...
A pronoun may replace a noun as the doer of a verb. For example, instead of saying "Zayd went", you can say "he went", or "you went", etc. 
In Arabic too doer nouns may be replaced with doer pronouns. 
Doer pronouns are attached to the end of the basic form of the verb while modifying the vowel on the final letter of the basic verb.

Here we show the doer pronouns in Arabic. The root template [فعل]{.arroot} is used to show how they modify the final letter of the basic verb.

Person | Doer pronoun | Doer pronoun with verb
:------|:--|:--
Non-participating person (masc.) "he"  | _invisible_          | [فَعَلَ]{.ar} [faeala]{.trn}
Non-participating person (fem.)  "she" | _invisible_          | [فَعَلَتْ]{.ar} [faealat]{.trn}
Spoken-to person (masc.)  "you~masc.~" | [تَ]{.ar} [-ta]{.trn} | [فَعَلْتَ]{.ar} [faealta]{.trn}
Spoken-to person (fem.)  "you~fem.~"   | [تِ]{.ar} [-ti]{.trn} | [فَعَلْتِ]{.ar} [faealti]{.trn}
Speaking person (masc. and fem.)  "I"  | [تُ]{.ar} [-tu]{.trn} | [فَعَلْتُ]{.ar} [faealtu]{.trn}

Note how the doer pronouns for the non-participating persons "he" and "she" say _invisible_. In Arabic, doer pronouns are either visible or invisible. We shall see what this means with examples.

Note also how the visible doer pronouns modify the basic verb by replacing the [a]{.trn}-mark [◌َ]{.ar} on the final letter by a null vowel mark [◌ْ]{.ar}.

Furthermore, note how the doer pronoun for the spoken-to person "you" is differentiated for masculine and feminine doers whereas the doer pronoun for the speaking person "I" is the same for both genders.

Here are some examples of visible doer pronouns:
...
Now we come to the invisible doer pronouns. When we wish to use the doer pronouns for the non-participating person "he" and "she" we will simply delete the doer noun that the pronoun is replacing without any other changes. The doer pronoun will then be said to exist, because it is required for the meaning of the sentence, but it will be invisible. Here are some examples.
...
Take care to note that doer pronouns modify the final letter of the basic verb, whereas the [تْ]{.ar} of femininity does not. So make sure you see the difference in the following two sentences:
...
Just like doer nouns may be replaced with doer pronouns, doee nouns may too be replaced with _doee pronouns_. Doee pronouns are also attached to the end of the verb but they don't modify the vowel on the final letter of the verb. The doee pronouns are:
...
Person | Doee pronoun
:------|:--
Non-participating person (masc.) "him" | [إِيَّاهُ]{.ar} [EiyyAhu]{.trn} 
Non-participating person (fem.)  "her" | [إِيَّاهَا]{.ar} [EiyyAhA]{.trn}
Spoken-to person (masc.)  "you~masc.~" | [إِيَّاكَ]{.ar} [EiyyAka]{.trn} 
Spoken-to person (fem.)  "you~fem.~"   | [إِيَّاكِ]{.ar} [EiyyAki]{.trn} 
Speaking person (masc. and fem.)  "me" | [إِيَّايَ]{.ar} [EiyyAya]{.trn} 

Note that for the speaking person "me", there is no intervening [نِ]{.ar} between the prefix [إِيَّا]{.ar} [EiyyA]{.trn} and the doee pronoun. Note also that only [يَ]{.ar} [-ya]{.trn} is allowed to be attached to the prefix [إِيَّا]{.ar} [EiyyA]{.trn}. [ي]{.ar} [-I]{.trn} is impermissible.
