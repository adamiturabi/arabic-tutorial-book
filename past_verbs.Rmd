...
So why don't we simply say that the doee pronoun for "me" is [نِي]{.ar} [nI]{.trn}? This is because these same doee pronouns are also attached to nouns and prepositions as we shall see in later chapters, if [#allAh]{.trn2} wills, and in those cases there is generally no intervening [نِ]{.ar}. <!--exceptions like منّي and others -->
