...
\def\beglong{0}
\def\endlong{9}
\def\regions{Spain, North Africa, Egypt, Syria, the Hijaz, Baghdad, Kufah, Basrah, Persia}
\def\mixcolor{gray}

% \dynasty{<color>}{<name>}{<startyear c.e.>}{<endyear c.e.>}{<graphical level (>0)>}
%\dynasty{<color>}{<begregion>}{<endregion>}{<begyear ah>}{<endyear ah>}
\newcommand\dynasty[5]{%
...
\foreach [count=\i] \x in \regions {
    ...
    \person{5.5}{577}{left} {east}{ 16}{0}{Abu al-Barakaat al-Anbari}
    ...
    \dynasty    {OliveGreen}   {2.5}  {8.5}    {11}    {41}  % Prophet pbuh
    \dynasty    {OliveGreen}   {5}    {5}      {0}     {11}  % rashidun
    \dynasty    {Gray}         {2}    {9}      {41}    {132} % ummayads me
    \dynasty    {Gray}         {1}    {1}      {\cetoah{756}}    {\cetoah{1031}} % ummayads me
\end{tikzpicture}
\end{document}
