...
%\dynasty{<color>}{<begregion>}{<endregion>}{<begyear ah>}{<endyear ah>}{<name>}
\newcommand\dynasty[6]{%
\begin{pgfonlayer}{background}
    ...
    ({#2-1},#4) rectangle (#3,#5);
    % label
    \node [white, yshift=0pt, font=\sffamily] 
...
\foreach \y in {100,200,...,\endah} 
    {\draw (0, \y) -- (-.2, \y) node [anchor=east, font=\bfseries] {\y};}
...
\foreach [count=\i] \x in \regions {
    ...
    \person{5.5}{577}{right} {west}{-16}{0}{Abu al-Barakat al-Anbari}
    ...
    \person{8.5}{538}{left} {east}{ 16}{0}{al-Zamakhshari}
    \person{8.5}{684}{left} {east}{ 16}{0}{al-Radiyy al-Astarabadhi}
    ...
    \dynasty    {Blue}         {1}    {1}      {\cetoah{756}}    {\cetoah{1031}} {UMMAYADS}
    \dynasty    {Yellow}       {2}    {9}      {132}    {\cetoah{930}} {ABBASIDS}
    \dynasty    {Yellow}       {5}    {5}      {\cetoah{909}}    {600} {}% Abbasids
    \dynasty    {Orange}       {3}    {4}      {\cetoah{930}}    {\cetoah{1171}} {FATIMIDS}
    \dynasty    {Brown}        {3}    {4}      {\cetoah{1171}}   {\cetoah{1250}} {AYYUBIDS}
    ...
    \dynasty    {Purple}       {3}    {5}      {\cetoah{1250}}   {\cetoah{1517}} {MAMLUKS}
