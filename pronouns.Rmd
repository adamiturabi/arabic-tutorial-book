...
1. [أَنْتَ]{.ar} [anta]{.trn} "you (sing. masc.)".
4. [أَنْتِ]{.ar} [anti]{.trn} "you (sing. fem.)".
...
1. [أَنَا]{.ar} [ana]{.trn} "I". 
12. [نَحْنُ]{.ar} [naHnu]{.trn} "we (pl. masc. & fem.)"

Notes:

+ In [أَنَا]{.ar} [ana]{.trn} "I", the [Ealif]{.trn} after the [ن]{.ar} is silent and [ن]{.ar} is pronounced with a short vowel. At the end of a sentence, the vowel maintained and it will continue to be pronounced [ana]{.trn}, not [an]{.trn}.
