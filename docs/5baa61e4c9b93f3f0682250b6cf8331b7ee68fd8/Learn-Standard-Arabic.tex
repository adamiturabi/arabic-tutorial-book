...
\tightlist
\item
  There are separate nouns for the male and female animate being and the nouns are similar to each other.
\item
...
\subsubsection{Similar nouns for male and female animate beings}\label{similar-nouns-for-male-and-female-animate-beings}
...
\foreignlanguage{arabic}{حَمَامَة} \emph{ḥamāmat} & fem. & dove \\
...
Notably, \foreignlanguage{arabic}{نَفْس} \emph{nafs} is treated as feminine when it refers to the soul of a person.
...
\foreignlanguage{arabic}{رَهِينَة} \emph{rahīnah} is a feminine noun meaning \enquote{pledge}. For inanimate objects it refers to something that is held as a security or a collateral. With its animate meaning is used to refer to a human hostage.
