...
\textsc{The Authors}\\
\url{https://github.com/adamiturabi/arabic-tutorial-book}
...
\section{\texorpdfstring{Pattern of the \(\emptyset\)-state incomplete-action verb.}{Pattern of the \textbackslash emptyset-state incomplete-action verb.}}\label{pattern-of-the-emptyset-state-incomplete-action-verb.}
