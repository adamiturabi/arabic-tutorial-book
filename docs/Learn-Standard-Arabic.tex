...
\fancyfoot[RE, RO]{\phantom{xxx}\\\phantom{xxx}\\\phantom{xxx}\\\phantom{xxx}\\\textcolor{gray}{\scriptsize{Author Names, \textit{Learn Standard Arabic}, \texttt{\gitTag}\\\texttt{https://adamiturabi.github.io/arabic-tutorial-book/}}}}
