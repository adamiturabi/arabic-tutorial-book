...
By the way,
\foreignlanguage{arabic}{کَيْ} and a following a-state incomplete-action verb may \emph{not} be replaced directly by
...
There is a modern tendency to use the words ḍ͡harf makan \foreignlanguage{arabic}{هُنَاکَ} and the majhūl verb \foreignlanguage{arabic}{يُوجَدُ} as direct equivalents of the English \enquote{there} and \enquote{exists} respectively.
So one might find:
...
These usages of \foreignlanguage{arabic}{هُنَاکَ}, \foreignlanguage{arabic}{ثَمَّةَ}, and \foreignlanguage{arabic}{يُوجَدُ} are foreign to Arabic and there is no reason to allow them.
