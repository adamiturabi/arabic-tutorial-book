...
\item
  ...
  Note that the lightened \foreignlanguage{arabic}{أَنْ} has combined with \foreignlanguage{arabic}{لَا} to form \foreignlanguage{arabic}{أَلَّا}, similar to the manner that we learned for the a-state-verbal \foreignlanguage{arabic}{أَنْ} (for example: \foreignlanguage{arabic}{أَلَّا يَذْهَبَ} \enquote{that he not go}) in chapter~\ref{chapter-a-state-incomplete-action-verbs}. However, with lightened \foreignlanguage{arabic}{أَنْ}, the verb \foreignlanguage{arabic}{يَذْهَبُ} is in the u-state, not the a-state.
\item
