...
\foreignlanguage{arabic}{ء}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ب}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ت}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ث}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ج}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ح}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{خ}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{د}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ذ}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ر}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ز}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{س}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ش}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ص}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
ʾ & b & t & t͡h & j & ḥ & k͡h & d & d͡h & r & z & s & s͡h & ṣ \\
\end{longtable}
...
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ض}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ط}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ظ}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ع}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{غ}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ف}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ق}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ک}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ل}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{م}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ن}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ه}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{و}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{ي}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
ḍ & ṭ & ḍ͡h & ɛ & g͡h & f & q & k & l & m & n & h & w & y \\
\end{longtable}
...
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{◌َا}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{◌ُو}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{◌ِي}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{◌َوْ}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\foreignlanguage{arabic}{◌َيْ}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
and the lām of the definite article is not transliterated.
\foreignlanguage{arabic}{ة} is transcribed as \emph{t} except at the end of an utterance, when it is transcribed as \emph{h}.
For example:

\foreignlanguage{arabic}{بِسمِ ٱللَّـٰهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ.}\\
\emph{bismi -llāhi -rraḥmāni -rraḥīm.}
...
word-final \foreignlanguage{arabic}{◌ِيّ} \emph{-iyy} is transliterated as \enquote{ī},
...
as shown.
\foreignlanguage{arabic}{ة} is transcribed as \enquote{h} except when in construct, where it is transcribed as \enquote{t}.
Accurate romanizations are preferred unless an established and distinctly separate usage is current in English.
Examples:

\enquote{Ɛalī and Usāmah revised Sūrat al-Ɛankabūt from the Qurʾān in the mosque in the month of Rabīɛ al-T͡hāni.}
