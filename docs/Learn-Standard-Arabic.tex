...
\section{Topic-comment sentences and the pronoun of the matter}\label{topic-comment-sentences-and-the-pronoun-of-the-matter}
...
\subsection{The pronoun of the matter}\label{the-pronoun-of-the-matter}
...
There is a special pronoun, called the \emph{pronoun of the matter} that begins topic-comment sentences. This pronoun does not refer to any previously known entity, but rather refers to the comment that follows it. It is sometimes translated as \enquote{the matter is} but is often left untranslated. Here is an example:

\includegraphics{Learn-Standard-Arabic_files/figure-latex/unnamed-chunk-33-1.pdf}

\enquote{The matter is: the cold is intense.}
...
The pronoun of the matter is frequently used with \foreignlanguage{arabic}{إِنَّ} and its sisters.
Here are some examples:
...
The lightweight \foreignlanguage{arabic}{أَنْ} only introduces topic-comment clauses whose topic is understood to be a deleted pronoun of the matter.
...
\enquote{I know that the matter is: the cold is intense.}

If we replace the heavyweight \foreignlanguage{arabic}{أَنَّ} in the above example with the lightweight \foreignlanguage{arabic}{أَنْ} then we pronoun of the matter topic is deleted, thus:
...
The lightweight \foreignlanguage{arabic}{کَأَنْ} is similar to the lightweight \foreignlanguage{arabic}{أَنْ} in that it introduces a topic-comment sentence and the topic is usually a deleted pronoun of the matter. For example,
