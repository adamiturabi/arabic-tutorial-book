...
\subsection{\texorpdfstring{Option to drop prepositiion before \foreignlanguage{arabic}{أَنْ}}{Option to drop prepositiion before أَنْ}}\label{option-to-drop-prepositiion-before-ux623ux646}
...
But when using \foreignlanguage{arabic}{لَا} to negate the verb, then \foreignlanguage{arabic}{أَنْ} may not be dropped, and the combination of \foreignlanguage{arabic}{لِ}, \foreignlanguage{arabic}{أَنْ}, and \foreignlanguage{arabic}{لَا} is written as \foreignlanguage{arabic}{لِئَلَّا} \emph{liʾallā}. For example,
...
However, we saw that, with \foreignlanguage{arabic}{لِ}, keeping or dropping the \foreignlanguage{arabic}{أَنْ} was optional.
