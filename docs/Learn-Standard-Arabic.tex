...
\begin{figure}
\centering
\includegraphics{Learn-Standard-Arabic_files/figure-latex/unnamed-chunk-2-1.pdf}
...
9 & \foreignlanguage{arabic}{ذ} & \emph{ð} & \foreignlanguage{arabic}{ذَال} \emph{ðāl} & Place your tongue as in \foreignlanguage{arabic}{ث} and force air out. But this time instead of trying to hiss \enquote{ssss} try to buzz \enquote{zzzz} and again keep your tongue touching the top and bottom teeth. \\
...
17 & \foreignlanguage{arabic}{ظ} & \emph{ð̣} & \foreignlanguage{arabic}{ظَاء} \emph{ð̣āʾ} & An emphatic \foreignlanguage{arabic}{ذ} that will be described later. \\
...
\subsubsection{\texorpdfstring{\foreignlanguage{arabic}{ص} \emph{ṣād}, \foreignlanguage{arabic}{ط} \emph{ṭāʾ}, and \foreignlanguage{arabic}{ظ} \emph{ð̣āʾ}}{ص ṣād, ط ṭāʾ, and ظ ð̣āʾ}}\label{ux635-sad-ux637-tae-and-ux638-pae}

The letters \foreignlanguage{arabic}{س} \emph{sīn}, \foreignlanguage{arabic}{ت} \emph{tāʾ}, and \foreignlanguage{arabic}{ذ} \emph{ðāl} are pronounced with the mouth and lips in a wide grin. Now try pronouncing them, in turn, with the lips round forming a small circle. The sounds will be emphatic and will be \foreignlanguage{arabic}{ص} \emph{ṣād}, \foreignlanguage{arabic}{ط} \emph{ṭāʾ}, and \foreignlanguage{arabic}{ظ} \emph{ð̣āʾ} respectively.
...
\item
  \emph{ū} like in English \enquote{moon} written with an unmarked \foreignlanguage{arabic}{و} \emph{wāw} with the preceding letter having an \emph{u}-mark. Example \foreignlanguage{arabic}{ذُو} \emph{ðū}.
\end{enumerate}
...
\item
  \foreignlanguage{arabic}{کَذَا} \emph{kaðā}
\item
...
\tightlist
\item
  \foreignlanguage{arabic}{هَـٰذَا} \emph{hāðā}
\item
  \foreignlanguage{arabic}{ذَ~ٰلِکَ} \emph{ðālika}
\end{itemize}
...
\item
  \foreignlanguage{arabic}{مُنْذُ} \emph{munðu}
\item
...
\item
  \foreignlanguage{arabic}{شَيْـًٔا} \emph{s͟hayʾan} \vphantom{\huge J}
\item
  \foreignlanguage{arabic}{سُوءًا} \emph{sūʾan} \vphantom{\huge J}
\item
  \foreignlanguage{arabic}{غَبَنٌ} \emph{g͟habanun} \vphantom{\huge J}
\end{itemize}
...
\emph{ðahaba ʾila -lbayti}

but should be pronounced as\\
\emph{ðahaba ʾila -lbayt}
...
\item
  \foreignlanguage{arabic}{أُذُن} \emph{ʾuðun} (fem.) \enquote{ear}
\item
...
\foreignlanguage{arabic}{«ذهب»} & \foreignlanguage{arabic}{ذَهَبَ} \emph{ðahaba} & \enquote{went} \\
...
\emph{nað̣ara -rrajulu ʾila -lqamar.}\\
\enquote{The man looked at the moon.}

In this sentence \foreignlanguage{arabic}{ٱَلْقَمَرِ} \emph{alqamari} \enquote{the moon} is an indirect doee of the verb \foreignlanguage{arabic}{نَظَرَ} \emph{nað̣ara} \enquote{looked} because it is preceded by the preposition \foreignlanguage{arabic}{إِلَىٰ} \emph{ʾilā} \enquote{to}. The preposition, as usual, causes the word after it (the indirect doee \foreignlanguage{arabic}{ٱَلْقَمَرِ} \emph{ʾalqamari}) to be in the i-state, as opposed to the a-state of the direct doee.

Note also, that the verb \enquote{looked} in English used the preposition \enquote{at} whereas the Arabic verb \foreignlanguage{arabic}{نَظَرَ} \emph{nað̣ara} used the preopsition \foreignlanguage{arabic}{إِلَىٰ} \emph{ʾilā} \enquote{to} for the same meaning. This is very common and you should not expect Arabic to use exact counterparts of the prepositions used in English. In fact, everytime you learn a new verb, you should also learn the prepositions that go with it.
...
\emph{nað̣ara -rrajulu fi -lʾamri.}\\
...
\emph{nað̣ara -rrajulu -lmaktūba fi -lkitābi.}\\
...
The above sentence ends with the doer pronoun, so the vowel-mark on the doer pronoun is not pronounced (\emph{ðahabt}). So, how would be know which doer pronoun it is? That is, does the sentence say \enquote{I went.} or \enquote{You\textsubscript{m} went.} or \enquote{You\textsubscript{f}. went.}? The answer is that the sentence by itself is ambiguous and context would tell us which of the three options is intended.
...
\emph{ðahaba -lg͟hulāmu ʾila -lmadrasah.}\\
...
\emph{ʾak͟haðati -ljāriyatu -ṣṣag͟hīratu kitaban jadīdan mina -lʾummi -ṭṭayyibah.}\\
...
\emph{qadima -lkabīru wawaɛað̣a -lg͟hulāma.}\\
...
\emph{ðahaba -rrajulu ʾilā ṣaḥrāʾa wāsiɛah.}\\
...
We've already seen an example of such a word: \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{ðikrā\textsuperscript{2}} \enquote{a remembrance}. The root of this word is \foreignlanguage{arabic}{«ذکر»} and it is on the pattern \foreignlanguage{arabic}{فِعْلَىٰ}.
...
Since \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{ðikrā\textsuperscript{2}} already ends with the vowel-mark \foreignlanguage{arabic}{◌ٰ}, the last letter won't have any additional vowel markers and therefore the word will appear the same in all states:
...
\emph{ʾalkitābu ðikrā jamīlah.}\\
\enquote{The book is a beautiful remembrance.}

Note, again how the describer \foreignlanguage{arabic}{جَمِيلَة} \emph{jamīlah} is feminine and in the u-state, in order to match the gender and state of the describee \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{ðikrā\textsuperscript{2}}.
...
\foreignlanguage{arabic}{«ذکر»} & \foreignlanguage{arabic}{ذِکْرَىٰ} \emph{ðikrā} \enquote{a remembrance} & \foreignlanguage{arabic}{ذِکْرَيَانِ} \emph{ðikrayāni} & \foreignlanguage{arabic}{ذِکْرَيَيْنِ} \emph{ðikrayayni} \\
\end{longtable}
...
\emph{ðahabtu ʾila -lmadīnati -lqadīmah.}\\
...
\emph{ʾarrujalāni ðahabā ʾilā baytin.}\\
...
\emph{ʾakala -rrajulāni was͟haribā waðahabā.}\\
...
\emph{ʾarrajulāni ʾakalā was͟haribā waðahabā.}\\
...
\item
  ...
  \emph{nað̣ara -lg͟hulāmu ʾila -lḥayawānāti.}\\
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{«ذکر»} & \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{ðikrā\textsuperscript{2}} \enquote{a remembrance} & \foreignlanguage{arabic}{ذِکْرَيَات} \emph{ðikrayāt} \\
\end{longtable}
...
\item
  ...
  \tightlist
  \item
    \foreignlanguage{arabic}{ظُلْمَة} \emph{ð̣ulmah} \enquote{a darkness} can become, optionally, either \foreignlanguage{arabic}{ظُلْمَات} \emph{ð̣ulmāt} or \foreignlanguage{arabic}{ظُلَمَات} \emph{ð̣ulamāt}, or \foreignlanguage{arabic}{ظُلُمَات} \emph{ð̣ulumāt} \enquote{darknesses}.
  \item
...
\foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{ðikrā\textsuperscript{2}} \enquote{a remembrance} & \foreignlanguage{arabic}{ذِکْرَيَات} \emph{ðikrayāt} \\
\end{longtable}
...
\item
  ...
  \tightlist
  \item
    \foreignlanguage{arabic}{ذَهَبْنَ} \emph{ðahabna} \enquote{they\textsubscript{3,f} went}
  \end{itemize}
  ...
  \tightlist
  \item
    \foreignlanguage{arabic}{ذَهَبَتَا} \emph{ðahabatā} \enquote{they\textsubscript{2,f} went}
  \end{itemize}
\item
...
\emph{ʾalmuɛallimūna ðahabū ʾilā madrasah.}\\
...
\emph{ʾakala -llāɛibūna was͟haribū waðahabū.}\\
...
\emph{ʾallāɛibūna ʾakalū was͟haribū waðahabū.}\\
...
\emph{ʾakalati -llāɛibātu was͟haribna waðahabn.}\\
...
\emph{ʾallāɛibātu ʾakalna was͟haribna waðahabn.}\\
...
\emph{ðahabtu ʾana waʾanta wahuwa.}\\
...
\emph{ʾalʾummu wa-ljāriyatu wa-lg͟hulāmu ðahabū.}\\
...
\emph{ðahabat jāriyatun g͟haḍbā ʾilā ṣaḥrāʾ.}\\
...
\emph{ðahabati -ljāriyatu -lg͟haḍbā ʾila -ṣṣaḥrāʾ.}\\
...
\emph{ʾak͟haða -ttilmīðu -lɛilma ɛani -lmuɛallimīna -lkirām.}\\
...
\emph{ð̣alama -ljabābiratu -lmasākīna waqatalūhum.}\\
...
\emph{ðahabtu ʾilā bayti ḥami -rrajul.}\\
...
\emph{ðahabtu ʾilā bayti ʾak͟hīhinn.}\\
...
\emph{ðahaba -lʾak͟hawāni fi -lmasjidi.}\\
...
\subsection{\texorpdfstring{\foreignlanguage{arabic}{ذُو} \emph{ðū} and \foreignlanguage{arabic}{ذَات} \emph{ðāt}}{ذُو ðū and ذَات ðāt}}\label{zu}

The fourth irregular noun from \enquote{the five nouns} is the masculine noun \foreignlanguage{arabic}{ذُو} \emph{ðū} and its feminine counterpart \foreignlanguage{arabic}{ذَات} and \emph{ðāt}. The words \foreignlanguage{arabic}{ذُو} \emph{ðū} and \foreignlanguage{arabic}{ذَات} \emph{ðāt} mean \enquote{owner of} or \enquote{possessor of}.

So, for example, \foreignlanguage{arabic}{ذُو ٱلْمَالِ} \emph{ðu -lmāli} means \enquote{possessor\textsubscript{m} of wealth} or \enquote{wealthy person\textsubscript{m}}. The singular, dual, and plural of \foreignlanguage{arabic}{ذُو} \emph{ðū} in all three states is shown in the table below:
...
\bottomrule\noalign{}
\endlastfoot
u-state & \foreignlanguage{arabic}{ذُو} \emph{ðū} & \foreignlanguage{arabic}{ذَوَا} \emph{ðawā} & \foreignlanguage{arabic}{ذَوُو} \emph{ðawū} \\
a-state & \foreignlanguage{arabic}{ذَا} \emph{ðā} & \foreignlanguage{arabic}{ذَوَيْ} \emph{ðaway} & \foreignlanguage{arabic}{ذَوِي} \emph{ðawī} \\
i-state & \foreignlanguage{arabic}{ذِي} \emph{ðī} & same as a-state & same as a-state \\
\end{longtable}

The noun \foreignlanguage{arabic}{ذُو} \emph{ðū} and its duals and plurals are only ever used as annexe nouns in annexations. Furthermore, they may not be annexed to pronouns. Here are some examples:

\foreignlanguage{arabic}{ٱَلرَّجُلُ ذُو ٱلْمَالِ.}\\
\emph{ʾarrujulu ðu -lmāl.}\\
...
\bottomrule\noalign{}
\endlastfoot
u-state & \foreignlanguage{arabic}{ذَاتُ} \emph{ðātu} & \foreignlanguage{arabic}{ذَوَاتَا} \emph{ðawātā} & \foreignlanguage{arabic}{ذَوَاتُ} \emph{ðawātu} \\
a-state & \foreignlanguage{arabic}{ذَاتَ} \emph{ðāta} & \foreignlanguage{arabic}{ذَوَاتَيْ} \emph{ðawātay} & \foreignlanguage{arabic}{ذَوَاتِ} \emph{ðawāti} \\
i-state & \foreignlanguage{arabic}{ذَاتِ} \emph{ðāti} & same as a-state & same as a-state \\
\end{longtable}

Examples:

\foreignlanguage{arabic}{هَـٰذِهِ ٱلشَّجَرَةُ ذَاتُ ثَمَرٍ کَثِيرٍ.}\\
\emph{hāðihi -s͟hs͟hajaratu ðātu t͟hamarin kat͟hīrin.}\\
...
\foreignlanguage{arabic}{ذَوُو} \emph{ðawū} which we discussed in section~\ref{zu} above.
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{مُحَمَّد} & Muḥammad & \foreignlanguage{arabic}{عَائِشَة\textsuperscript{2}} & Ɛāʾis͟hah \\
\foreignlanguage{arabic}{سَعِيد} & Saɛīd & \foreignlanguage{arabic}{فَاطِمَة\textsuperscript{2}} & Faṭimah \\
\foreignlanguage{arabic}{ٱَلْحَسَن} & al-Ḥasan & \foreignlanguage{arabic}{حَفْصَة\textsuperscript{2}} & Ḥafṣah \\
\foreignlanguage{arabic}{ٱَلنُّعْمَان} & al-Nuɛmān & \foreignlanguage{arabic}{سُمَيَّة\textsuperscript{2}} & Sumayyah \\
...
\foreignlanguage{arabic}{عُثْمَان\textsuperscript{2}} & Ɛut͟hmān & \foreignlanguage{arabic}{مَرْيَم\textsuperscript{2}} & Maryam \\
\foreignlanguage{arabic}{عُمَر\textsuperscript{2}} & Ɛumar & \foreignlanguage{arabic}{سُعَاد\textsuperscript{2}} & Suɛād \\
\foreignlanguage{arabic}{إِبْرَاهِيم\textsuperscript{2}} & Ibrāhīm & \foreignlanguage{arabic}{أَسْمَاء\textsuperscript{2}} & Asmāʾ \\
\foreignlanguage{arabic}{عَبْد ٱللَّـٰه} & Ɛabd Allāh & \foreignlanguage{arabic}{لَيْلَىٰ\textsuperscript{2}} & Laylā \\
...
\emph{ðahabtu ʾilā bayti muḥammadini -lkarīmi wazaynaba -ṭṭayyibah.}\\
...
\emph{ðahabat jamīlatu ʾila -lbayt.}
...
\emph{ðahabat jamīlatun ʾila -lbayt.}\\
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{مُحَمَّد} & Muḥammad & \foreignlanguage{arabic}{مُعَاذ} & Muɛāð \\
\foreignlanguage{arabic}{نُوح} & Nūh & \foreignlanguage{arabic}{سَعْد} & Saɛd \\
\foreignlanguage{arabic}{شُعَيْب} & S͟huɛayb & \foreignlanguage{arabic}{عَمَّار} & Ɛammār \\
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{عُثْمَان\textsuperscript{2}} & Ɛut͟hmān & \foreignlanguage{arabic}{رَمَضَان\textsuperscript{2}} & Ramaḍān \\
\foreignlanguage{arabic}{سُفْيَان\textsuperscript{2}} & Sufyān & \foreignlanguage{arabic}{شَعْبَان\textsuperscript{2}} & S͟haɛbān \\
\end{longtable}

Example:

\foreignlanguage{arabic}{جَلَس عُثْمَانُ مَعَ سُفْيَانَ فِي رَمَضَانَ.}\\
\enquote{Ɛut͟hmān sat with Sufyān in Ramaḍān.}
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{أَحْمَد\textsuperscript{2}} & Aḥmad & \foreignlanguage{arabic}{أَسْعَد\textsuperscript{2}} & Asɛad \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{عُمَر\textsuperscript{2}} & Ɛumar & \foreignlanguage{arabic}{مُضَر\textsuperscript{2}} & Muḍar \\
\end{longtable}
...
\item
  \foreignlanguage{arabic}{يَعِيش\textsuperscript{2}} Yaɛīs͟h \enquote{He lives}
\end{itemize}
...
\foreignlanguage{arabic}{سُعَاد\textsuperscript{2}} & Suɛād & \foreignlanguage{arabic}{هَاجَر\textsuperscript{2}} & Hājar \\
\end{longtable}
...
\enquote{The student Muɛāð asked the teacher Saɛd.}
...
In a manner similar to \enquote{parent of} names, a person may be referred to as the son of his parent. For example, the Companion \foreignlanguage{arabic}{عُمَر\textsuperscript{2}} Ɛumar had a son named
\foreignlanguage{arabic}{عَبْد ٱللَّـٰه} Ɛabd Allāh. He is commonly known as \foreignlanguage{arabic}{ٱِبْن عُمَر\textsuperscript{2}} Ibn Ɛumar \enquote{Ɛumar's son}.
...
\begin{itemize}
\item
  \foreignlanguage{arabic}{ذُو ٱلْقَرْنَينِ} Ðu l-Qarnayn \enquote{He of the two horns}
\item
...
\foreignlanguage{arabic}{ٱَلْعَبَّاس} & al-Ɛabbās & \foreignlanguage{arabic}{ٱَلْحَارِث} & al-Ḥārit͟h \\
\end{longtable}
...
Tribes are usually called by the name of their progenitor. For example, \foreignlanguage{arabic}{إِسْرَائِيل\textsuperscript{2}} Isrāʾīl is a name of the Prophet \foreignlanguage{arabic}{يَعْقُوب\textsuperscript{2}} Yaɛqūb.
...
\foreignlanguage{arabic}{ٱَلْأَمِير} & Commander & \foreignlanguage{arabic}{ٱَلْحَافِظ} & Ḥāfið̣ \\
...
\item
  \foreignlanguage{arabic}{ٱَلْحَافِظ} Ḥāfið̣ (one who has memorized, and preserved religious texts)
\end{itemize}
...
\enquote{The Mother of the Believers Ɛāʾis͟hah is the daughter of the Successor of the Messenger of Allāh Abū Bakr.}
...
\foreignlanguage{arabic}{شَافِعِيّ} & a S͟hāfiɛite & \foreignlanguage{arabic}{حَنَفِيّ} & a Ḥanafī \\
...
\enquote{Ɛāʾis͟hah is the daughter of the Successor of the Messenger of Allāh, Abū Bakr, the steadfast affirmer of the truth.}

\foreignlanguage{arabic}{قَتَلَ أَبُو لُؤْلُؤَةَ ٱلْمَجُوسِيُّ أَمِيرَ ٱلْمُؤْمِنِينَ أَبَا حَفْصٍ عُمَرَ بْنَ ٱلْخَطَّابِ.}\\
\enquote{Abū Luʾluʾah, the Magian killed the Commander of the Believers, Abū Ḥafṣ, Ɛumar the son of al-K͟haṭṭāb.}
...
\enquote{The Ḥāfið̣, the historian, the exegete, the Pillar of the Faith, the father of al-Fidāʾ, Ismāʾīl the son of Ɛumar the son of Kat͟hīr, the Qurays͟hite, the Damascan, the S͟hāfiɛite wrote an exegesis.}\\
...
\emph{yā ʾayyuha -lʾustāðu, qad faɛaltu -lwājiba}\\
...
\emph{ʾayyatuha -lmuɛallimatu, hāðā kitābi.}\\
...
\emph{mā ɛaraftu ðālika -rrajula, yā ɛabda -llāhi.}\\
...
\emph{yā talāmīða -lmadrasati, -lɛilmu ʾamānatun.}\\
...
\begin{itemize}
\item
  Many of the pointing nouns contain small \emph{ʾalif} \foreignlanguage{arabic}{◌ٰ}. For most of them, this is how they must be written. It would be incorrect to write \foreignlanguage{arabic}{هَـٰذَا} \emph{hāðā} as \foreignlanguage{arabic}{هَاذَا}.
\item
...
\item
  ...
  The dual pointing nouns, however, are flexible nouns, for example: \foreignlanguage{arabic}{هَـٰذَانِ} (u-state) / \foreignlanguage{arabic}{هَـٰذَيْنِ} \emph{hāðayni} (a- and i-states).
\item
...
\item
  ...
  \item
    \foreignlanguage{arabic}{ذَهَبَ يَذْهَبُ} \emph{ðahaba yað·habu} \enquote{he went, he goes}
  \item
...
\emph{sayað·habu -rrajulu.}\\
and\\
\foreignlanguage{arabic}{سَوْفَ يَذْهَبُ ٱلرَّجُلُ}\\
\emph{sawfa yað·habu -rrajulu.}\\
...
The doing verbal-noun associated with this verb is \foreignlanguage{arabic}{ذَهَاب} \emph{ðahāb}. It denotes \enquote{the action of going}, or simply \enquote{going}. In this section we shall learn how this and other verbal-nouns are used.
...
\emph{taɛibtu mina -ððahābi ʾila -lmadīnati -lbaɛīdati.}\\
...
\emph{ḥazintu min ðahābi zaydin ʾilā madīnatin baɛīdatin.}\\
...
\emph{kataba -lʾustāðu suʾālan ɛala -ssabbūrati.}\\
...
\emph{ṭalaba -lʾustāðu mina -ttalāmīða fiɛla -lwājibi.}\\
...
\emph{yað·habu zaydun ʾila -lmadrasati.}\\
...
Also note that this is now a subject-information sentence instead of a verbal sentence. \foreignlanguage{arabic}{زَيْدٌ} \emph{zaydun} \enquote{Zayd} is the subject, and \foreignlanguage{arabic}{ذَاهِبٌ} \emph{ðāhibun} is part of the information.
...
\emph{zaynabu jālisatun ɛala hāða -lkursiyyi.}\\
...
\emph{tajlisu zaynabu ɛala hāða -lkursiyyi.}\\
...
\emph{ʾana ðāhibun ʾilā bayti ṣadīqī fi -ṣṣabāḥi.}\\
...
\emph{saʾað·habu ʾilā bayti ṣadīqī.}\\
...
\emph{qadima zayduni -ððāhibu ʾila -ljāmiɛati.}\\
...
\emph{nað̣ara zaydun ʾila -rrijāli.}\\
\enquote{Zayd looked at the men.}

then, the doee verbal-noun that refers to \foreignlanguage{arabic}{ٱلرِّجَالِ} \emph{ʾarrijāli} \enquote{the men} is \foreignlanguage{arabic}{مَنْظُور إِلَيْهِمْ} \emph{manð̣ūr ʾilayhim} \enquote{persons\textsubscript{m.} looked at}.

If doee verbal-nouns of indirect doees are used in sentences then it is the first word (in this case \foreignlanguage{arabic}{مَنْظُور} \emph{manð̣ūrun}) that changes for definiteness and state (but not for gender or number, as already discussed). Here are some examples:
...
\emph{hāði -lkurā hiya -lmalɛūbu bihā.}\\
...
\item
  ...
  \end{itemize}
\item
  The u-state and a-state verbs for the masculine plural absentee and addressee participants have a final silent \emph{ʾalif}:
...
\subsection{Doubled and weak roots}\label{doubled-and-weak-roots}
...
Root: \foreignlanguage{arabic}{«سعي»}
...
\subsection{\texorpdfstring{The lightened \foreignlanguage{arabic}{أَنْ}}{The lightened أَنْ}}\label{the-lightened-ux623ux646}
...
\item
  ...
  Note that the \foreignlanguage{arabic}{لَنْ} and \foreignlanguage{arabic}{لَمْ}, even when after the lightened \foreignlanguage{arabic}{أَنْ}, change the state of the following incomplete-action verb to the a-state and \(\emptyset\)-state respectively.
\item
...
\foreignlanguage{arabic}{«صغر»} & \foreignlanguage{arabic}{صَغِيرٌ} \emph{ṣag͟hīrun} \enquote{small} & \foreignlanguage{arabic}{أَصْغَرُ} \emph{ʾaṣg͟haru} \enquote{smaller} \\
...
\foreignlanguage{arabic}{«ثقل»} & \foreignlanguage{arabic}{ثَقِيلٌ} \emph{t͟haqīlun} \enquote{heavy} & \foreignlanguage{arabic}{أَثْقَلُ} \emph{ʾat͟hqalu} \enquote{heavier} \\
\foreignlanguage{arabic}{«خف»} & \foreignlanguage{arabic}{خَفِيفٌ} \emph{k͟hafīfun} \enquote{light} & \foreignlanguage{arabic}{أَخَفُّ} \emph{ʾak͟haffu} \enquote{lighter} \\
...
\foreignlanguage{arabic}{«کثر»} & \foreignlanguage{arabic}{کَثِيرٌ} \emph{kat͟hīrun} \enquote{many} & \foreignlanguage{arabic}{أَکْثَرُ} \emph{ʾakt͟haru} \enquote{more} \\
...
\emph{ʾalg͟hulāmu ʾaṭwalu mina -ljāriyati.}\\
...
\emph{ʾaljāriyati ʾaṭwalu mina -lg͟hulāmu.}\\
...
\emph{ʾalkutubu ʾat͟hqalu mina -lʾaqlāmi.}\\
...
\emph{ʾalkutubu -lkabīratu hiya -t͟ht͟huqlā.}\\
...
\emph{ʾas͟hs͟hajaratu ʾaqrabu ʾilā zaydin minhā ʾilā muḥammadin.}

The attached pronoun \foreignlanguage{arabic}{ـهَا} \emph{-hā} refers to \foreignlanguage{arabic}{ٱَلشَّجَرَةُ} \emph{ʾas͟hs͟hajaratu} \enquote{the tree}.
...
\emph{hāðā ʾakbaru bayti -lmadīnati.}
...
In addition, there are two words: \foreignlanguage{arabic}{خَيْرٌ} \emph{k͟hayrun} and \foreignlanguage{arabic}{شَرٌّ} \emph{s͟harrun}, which are really designative nouns meaning \enquote{goodness} and \enquote{evil} respectively.
...
\bottomrule\noalign{}
\endlastfoot
sing. & \foreignlanguage{arabic}{آخَر} \emph{ʾāk͟haru} & \foreignlanguage{arabic}{أُخْرَىٰ} \emph{ʾuk͟hrā} \\
dual & \foreignlanguage{arabic}{آخَرَانِ} \emph{ʾāk͟harāni} & \foreignlanguage{arabic}{أُخْرَيَانِ} \emph{ʾuk͟hrayāni} \\
sound plur. & \foreignlanguage{arabic}{آخَرُونَ} \emph{ʾāk͟harūna} & \foreignlanguage{arabic}{أُخْرَيَاتٌ} \emph{ʾuk͟hrayātun} \\
broken plur. & \foreignlanguage{arabic}{أَوَاخِرُ} \emph{ʾawāk͟hiru} & \foreignlanguage{arabic}{أُخَرُ} \emph{ʾuk͟haru} \\
\end{longtable}

Note that the masculine broken plural \foreignlanguage{arabic}{أَوَاخِرُ} \emph{ʾawāk͟hiru} (on the pattern \foreignlanguage{arabic}{أَفَاعِلُ} \emph{ʾafāɛilu}) has replaced the \foreignlanguage{arabic}{ء} in the root with a \foreignlanguage{arabic}{و}. This is a regular replacement in order to avoid two \foreignlanguage{arabic}{ء}s next to one another in \foreignlanguage{arabic}{أَءَاخِرُ} \emph{ʾaʾāk͟hiru}. This broken plural is given here for completeness but it is actually very rarely used. The sound \emph{ūn} plural \foreignlanguage{arabic}{آخَرُونَ} \emph{ʾāk͟harūna} is used instead.

Also note that the feminine broken plural \foreignlanguage{arabic}{أُخَرُ} \emph{ʾuk͟haru} is non-fully changing. This is irregular because the broken plural pattern \foreignlanguage{arabic}{فُعَلٌ} \emph{fuɛalun} is usually fully-changing.

We use \foreignlanguage{arabic}{آخَرُ} \emph{ʾāk͟haru} just like any other qualitative noun and we will give some examples below.

\foreignlanguage{arabic}{جَاءَ زَيْدٌ وَرَجُلٌ آخَرُ.}\\
\emph{jāʾa zaydun warajulun ʾāk͟haru.}\\
\enquote{Zayd and another man came.}

\foreignlanguage{arabic}{ذَهَبَتْ زَيْنَبُ إِلَى ٱلْمَدْرَسَةِ ٱلْأُخْرَىٰ.}\\
\emph{ðahabat zaynabu ʾila -lmadrasati -lʾuk͟hrā.}\\
\enquote{Zaynab went to the other school.}

\foreignlanguage{arabic}{قَرَأْتُ هَـٰذَا ٱلْکِتَابَ وَکِتَابَيْنِ آخَرَيْنِ.}\\
\emph{qaraʾtu hāða -lkitāba wakitābayni ʾāk͟harayni.}\\
\enquote{I read this book and two other books.}

\foreignlanguage{arabic}{ذَهَبَ رِجَالٌ آخَرُونَ.}\\
\emph{ðahaba rijālun ʾāk͟harūna}\\
\enquote{Other men went.}

\foreignlanguage{arabic}{ذَهَبَتْ زَيْنَبُ مَعَ ٱلنِّسَاءِ ٱلْأُخْرَيَاتِ.}\\
\emph{ðahabat zaynabu maɛa -nnisāʾi -lʾuk͟hrayāti.}\\
...
\emph{qaraʾtu hāða -lkitāba wakutuban ʾuk͟hrā.}\\
\enquote{I read this book and other books.}

However, the feminine broken plural \foreignlanguage{arabic}{أُخَرُ} \emph{ʾuk͟haru} can also be used, especially if there is no other indication of plurality. Examples:

\foreignlanguage{arabic}{هَـٰذَا ٱلْکِتَابُ خَفِيفٌ وَٱلْأُخَرُ ثَقِيلَةٌ.}\\
\emph{hāða -lkitābu k͟hafīfun wa-lʾuk͟haru t͟haqīlatun.}\\
\enquote{This book is light and the others are heavy.}

\foreignlanguage{arabic}{قَرَأَ هَـٰذَا ٱلْکِتَابَ وَقَرَأَ أُخَرَ.}\\
\emph{qaraʾa -lkitāba waqaraʾa ʾuk͟hara.}\\
...
\item
  ...
  \item
    If the \emph{hamzaḧ} carries any other vowel, it is written seated on an \emph{ʾalif}, and is marked with the appropriated vowel mark, for example \foreignlanguage{arabic}{أَسْلَمَ} \emph{ʾaslama}, \foreignlanguage{arabic}{أُرِيدُ} \emph{ʾurīdu}, \foreignlanguage{arabic}{إِسْلَامُ} \emph{ʾislāmu}, \foreignlanguage{arabic}{إِيمَانُ} \emph{ʾīmānu}, \foreignlanguage{arabic}{أُوخِذَ} \emph{ʾūk͟hiða}.
  \end{enumerate}
\item
  ...
  \item
    ...
    \item
      ...
      If it is followed by a long-\emph{ā} vowel represented by an \emph{ʾalif}, the \emph{hamzaḧ} is unseated followed by the \emph{ʾalif} and the combination is written as \foreignlanguage{arabic}{آ}. Example: \foreignlanguage{arabic}{مِرْآةُ} \emph{mirʾātu}, \foreignlanguage{arabic}{ظَمْآنُ} \emph{ð̣amʾānu}.\\
