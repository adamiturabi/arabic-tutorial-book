...
\enquote{Indeed Zayd is sitting and ʿAmr {[}as well{]}.}
...
\section{\texorpdfstring{The lightweight versions \foreignlanguage{arabic}{إِنْ}, \foreignlanguage{arabic}{أَنْ}, \foreignlanguage{arabic}{کَأَنْ}, and \foreignlanguage{arabic}{لَـٰکِنْ}}{The lightweight versions إِنْ, أَنْ, کَأَنْ, and لَـٰکِنْ}}\label{the-lightweight-versions-ux625ux646-ux623ux646-ux643ux623ux646-and-ux644ux640ux643ux646}

The particles \foreignlanguage{arabic}{إِنَّ}, \foreignlanguage{arabic}{أَنَّ}, \foreignlanguage{arabic}{کَأَنَّ}, and \foreignlanguage{arabic}{لَـٰکِنَّ}, because of the doubled \foreignlanguage{arabic}{نّ} are considered \emph{heavyweight}.
There exist \emph{lightweight} versions of these particles that are:
...
\subsection{\texorpdfstring{The lightweight \foreignlanguage{arabic}{إِنْ}}{The lightweight إِنْ}}\label{the-lightweight-ux625ux646}
...
However, the strengthening \foreignlanguage{arabic}{لَ} (see section~\ref{inna-strengthening-la} above), that was optional with the heavyweight \foreignlanguage{arabic}{إِنَّ}, is now mandatory with the lightweight \foreignlanguage{arabic}{إِنْ}. For example,

\foreignlanguage{arabic}{إِنْ زَيْدٌ لَمُسْلِمٌ.}\\
\enquote{Indeed Zayd is a Muslim.}

The other notable difference between
the lightweight \foreignlanguage{arabic}{إِنْ}
and
the heavyweight \foreignlanguage{arabic}{إِنَّ}
is that
the heavyweight \foreignlanguage{arabic}{إِنَّ} is only used to introduce subject-information sentences.
The lightweight \foreignlanguage{arabic}{إِنْ},
...
\subsection{\texorpdfstring{The lightweight \foreignlanguage{arabic}{أَنْ}}{The lightweight أَنْ}}\label{the-lightweight-ux623ux646}

As we know, the heavyweight \foreignlanguage{arabic}{أَنَّ} is an emphatic particle and is frequently used with the pronoun of the fact, thus:
...
the heavyweight \foreignlanguage{arabic}{أَنَّ} along with its following pronoun of the fact (\foreignlanguage{arabic}{أَنَّهُ}/\foreignlanguage{arabic}{أَنَّهَا}) with
a lightweight \foreignlanguage{arabic}{أَنْ}, thus:

\foreignlanguage{arabic}{أَعْلَمُ أَنِ ٱلْبَرْدُ شَدِيدٌ.}\\
\enquote{I know that the cold is intense.}

Note that
the lightweight \foreignlanguage{arabic}{أَنْ} replaces
\foreignlanguage{arabic}{أَنَّهُ},
which is the combination of
heavyweight \foreignlanguage{arabic}{أَنَّ} \emph{and} the pronoun of the fact \foreignlanguage{arabic}{هُ}.
So the pronoun of the fact (\foreignlanguage{arabic}{هُ}) does not appear with
the lightweight \foreignlanguage{arabic}{أَنْ}.

If the comment of the
lightweight \foreignlanguage{arabic}{أَنْ}
...
\item
  ...
  \foreignlanguage{arabic}{أَعْلَمُ أَلَّا يَذْهَبُ.}\\
  \enquote{I know that he does/will not go.}

  Note that the lightweight \foreignlanguage{arabic}{أَنْ} has combined with \foreignlanguage{arabic}{لَا} to form \foreignlanguage{arabic}{أَلَّا}, similar to the manner that we learned for the a-state-verbal \foreignlanguage{arabic}{أَنْ} (for example: \foreignlanguage{arabic}{أَلَّا يَذْهَبَ} \enquote{that he not go}) in chapter~\ref{chapter-a-state-incomplete-action-verbs}. However, with lightweight \foreignlanguage{arabic}{أَنْ}, the verb \foreignlanguage{arabic}{يَذْهَبُ} is in the u-state, not the a-state.
\item
  The conditional particle \foreignlanguage{arabic}{لَوْ}. We will study conditional sentences in chapter~\ref{conditional-sentences}.
\end{enumerate}

Rigid verbs like \foreignlanguage{arabic}{لَيْسَ} and verbs expressing supplications are exempted from needing to be separated from the lightweight \foreignlanguage{arabic}{أَنْ}. Example:
...
care must be taken to distinguish between this lightweight \foreignlanguage{arabic}{أَنْ} and the a-state-verbal \foreignlanguage{arabic}{أَنْ}
...
\begin{itemize}
\item
  If the verb before \foreignlanguage{arabic}{أَنْ} signifies certainty then only \foreignlanguage{arabic}{أَنَّ} and its lightweight version \foreignlanguage{arabic}{أَنْ} is used. For example,
...
\item
  If the verb before \foreignlanguage{arabic}{أَنْ} signifies neither certainty nor wanting, hoping, or expecting, then either \foreignlanguage{arabic}{أَنْ} may be used. For example,
...
\subsection{\texorpdfstring{The lightweight \foreignlanguage{arabic}{کَأَنْ}}{The lightweight کَأَنْ}}\label{the-lightweight-ux643ux623ux646}

The lightweight \foreignlanguage{arabic}{کَأَنْ} is similar to the lightweight \foreignlanguage{arabic}{أَنْ} in that it introduces a topic-comment sentence and the topic is usually a deleted pronoun of the fact. For example,

\foreignlanguage{arabic}{کَأَنْ ٱلْبَرْدُ ذَهَبَ.}\\
\enquote{{[}It is{]} as if the cold has gone.}

Also similar to the lightweight \foreignlanguage{arabic}{أَنْ}, the lightweight \foreignlanguage{arabic}{کَأَنْ} may introduce a verbal sentence but it must be separated from \foreignlanguage{arabic}{کَأَنْ} by either \foreignlanguage{arabic}{قَدْ} or \foreignlanguage{arabic}{لَمْ}. For example,

\foreignlanguage{arabic}{ذَهَبَ کَأَنْ لَمْ يَسْمَعْ.}\\
\enquote{He went as if he did not hear.}

\subsection{\texorpdfstring{The lightweight \foreignlanguage{arabic}{لَـٰکِنْ}}{The lightweight لَـٰکِنْ}}\label{the-lightweight-ux644ux640ux643ux646}

The lightweight \foreignlanguage{arabic}{لَـٰکِنْ} has the same meaning as the heavyweight \foreignlanguage{arabic}{لَـٰکِنَّ} but it has no grammatical effect on the word or sentence after it. It may introduce either subject-information or verbal sentences. For example,
...
\emph{hāẕā ʾakbaru bayti -lmadīnati.}
...
\emph{qaraʾtu hāẕa -lkitāba wakutuban ʾuk͟hrā.}\\
...
\emph{hāẕa -lkitābu k͟hafīfun wa-lʾuk͟haru t͟haqīlatun.}\\
