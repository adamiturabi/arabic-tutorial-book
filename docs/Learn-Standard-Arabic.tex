...
There is also the \emph{explanatory \foreignlanguage{arabic}{أَنْ}} and the \emph{extra \foreignlanguage{arabic}{أَنْ}} that we will cover in chapter~(@types-of-an).
