...
There are some historical and regional variants to the above rules. The main one is a variant of rule 2.b.ii above. In this variant, when the letter before hamzah has a ø-mark, the hamzah is generally written unseated. So they write:
