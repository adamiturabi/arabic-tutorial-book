...
\item
  ...
  \end{itemize}
\item
  If the hamzah is after a long-\emph{ū} vowel or an \emph{aw} semi-vowel, and the hamzah does not have an \emph{i}-mark, then it is written unseated. Examples:

  \begin{itemize}
  \tightlist
  \item
    \vphantom{\huge J} {\tradarab{سُوءَهُ}} \emph{sūʾahu}
  \item
    \vphantom{\huge J} {\tradarab{سُوءَانِ}} \emph{sūʾāni}
  \item
    \vphantom{\huge J} {\tradarab{ضَوْءَهُ}} \emph{ḍawʾahu}
  \item
    \vphantom{\huge J} {\tradarab{ضَوْءَانِ}} \emph{ḍawʾāni}
  \item
    \vphantom{\huge J} {\tradarab{سُوءُهُ}} \emph{sūʾuhu}
  \item
...
\item
  \vphantom{\huge J} {\tradarab{تَبَوُّء}} becomes {\tradarab{تَبَوُّءٌ, تَبَوُّءًا, تَبَوُّءٍ}}
\end{itemize}
...
\def\labelenumi{\arabic{enumi}.}
\item
  Hamzah superscript on a kas͡hīdah character: \foreignlanguage{arabic}{ـٔ}. Example: \foreignlanguage{arabic}{خَطِيـَٔة}. The Unicode input sequence is:

  {\texttt{u+0640}} \textsc{arabic tatweel}\\
  {\texttt{u+0654}} \textsc{arabic hamza above}

  This is a more accurate approximation, but some fonts may not position the hamzah correctly on the kas͡hīdah, or position vowel marks on the superscript hamzah correctly.
\item
  Hamzah seated on yāʾ: \foreignlanguage{arabic}{ئ}. Example: \foreignlanguage{arabic}{خَطِيئَة}. This is a more coarse, yet more prevalent, and better supported, approximation.
\end{enumerate}
