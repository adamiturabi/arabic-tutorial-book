...
pre-Islāmic and early Islāmic era as Classical Arabic.

All languages change naturally over time. For example, English has changed to such a degree that the Old English language spoken 1400 years ago would be unintelligible to us today. So too did the Arabic dialects begin to change. But as part of preserving His religion, Allāh preserved the Arabic language as well. This was by means of the efforts of scholars who recorded the Classical Arabic language of the time of the revelation.
...
7 & \foreignlanguage{arabic}{خ} & \emph{k͡h} & \foreignlanguage{arabic}{خَاء} \emph{k͡hāʾ} & Similar to \enquote{ch} in Scottish \enquote{loch}. Try saying \enquote{kh} but with a scraping sound. \\
...
9 & \foreignlanguage{arabic}{ذ} & \emph{d͡h} & \foreignlanguage{arabic}{ذَال} \emph{d͡hāl} & Place your tongue as in \foreignlanguage{arabic}{ث} and force air out. But this time instead of trying to hiss \enquote{ssss} try to buzz \enquote{zzzz} and again keep your tongue touching the top and bottom teeth. \\
...
13 & \foreignlanguage{arabic}{ش} & \emph{s͡h} & \foreignlanguage{arabic}{شِين} \emph{s͡hīn} & Equivalent to English \enquote{sh} in \enquote{show}. \\
...
17 & \foreignlanguage{arabic}{ظ} & \emph{ḍ͡h} & \foreignlanguage{arabic}{ظَاء} \emph{ḍ͡hāʾ} & An emphatic \foreignlanguage{arabic}{ذ} that will be described later. \\
...
19 & \foreignlanguage{arabic}{غ} & \emph{g͡h} & \foreignlanguage{arabic}{غَيْن} \emph{g͡hayn} & Somewhat like a \enquote{gh} sound but much softer. Try pronouncing \foreignlanguage{arabic}{خ} but without any scraping. \\
...
\subsubsection{\texorpdfstring{\foreignlanguage{arabic}{ص} \emph{ṣād}, \foreignlanguage{arabic}{ط} \emph{ṭāʾ}, and \foreignlanguage{arabic}{ظ} \emph{ḍ͡hāʾ}}{ص ṣād, ط ṭāʾ, and ظ ḍ͡hāʾ}}\label{ux635-sad-ux637-tae-and-ux638-pae}

The letters \foreignlanguage{arabic}{س} \emph{sīn}, \foreignlanguage{arabic}{ت} \emph{tāʾ}, and \foreignlanguage{arabic}{ذ} \emph{d͡hāl} are pronounced with the mouth and lips in a wide grin. Now try pronouncing them, in turn, with the lips round forming a small circle. The sounds will be emphatic and will be \foreignlanguage{arabic}{ص} \emph{ṣād}, \foreignlanguage{arabic}{ط} \emph{ṭāʾ}, and \foreignlanguage{arabic}{ظ} \emph{ḍ͡hāʾ} respectively.
...
\item
  \emph{ū} like in English \enquote{moon} written with an unmarked \foreignlanguage{arabic}{و} \emph{wāw} with the preceding letter having an \emph{u}-mark. Example \foreignlanguage{arabic}{ذُو} \emph{d͡hū}.
\end{enumerate}
...
\item
  \emph{āy} like in English \enquote{bye}. This is written with a \emph{yāʾ} with a \(\emptyset\)-mark on it and a \emph{ā} vowel before it. Example \foreignlanguage{arabic}{شَايْ} \emph{s͡hāy}.
\end{enumerate}
...
\def\labelenumi{\arabic{enumi}.}
\item
  If the word ends with a looped \emph{tāʾ} \foreignlanguage{arabic}{ة}. In this case we don't add the silent \emph{ʾalif}. For example, \foreignlanguage{arabic}{غَاضِبَة} becomes \foreignlanguage{arabic}{غَاضِبَةً} \emph{g͡hāḍibatan}, not \foreignlanguage{arabic}{غَاضِبَةًا} or \foreignlanguage{arabic}{غَاضِبَتًا}.
\item
...
We've already seen an example of such a word: \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{d͡hikrā\textsuperscript{2}} \enquote{a remembrance}. The root of this word is \foreignlanguage{arabic}{«ذکر»} and it is on the pattern \foreignlanguage{arabic}{فِعْلَىٰ}.
...
Since \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{d͡hikrā\textsuperscript{2}} already ends with the vowel-mark \foreignlanguage{arabic}{◌ٰ}, the last letter won't have any additional vowel markers and therefore the word will appear the same in all states:
...
Note, again how the describer \foreignlanguage{arabic}{جَمِيلَة} \emph{jamīlah} is feminine and in the u-state, in order to match the gender and state of the describee \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{d͡hikrā\textsuperscript{2}}.
...
If a noun ends with a looped \emph{tāʾ} \foreignlanguage{arabic}{ة}, then it is converted to an open \emph{tāʾ} \foreignlanguage{arabic}{ت} before appending the dual suffix. For example, dualizing \foreignlanguage{arabic}{شَجَرَة} \emph{s͡hajarah} \enquote{a tree}, we get \enquote{trees\textsubscript{2}}:
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{«ذکر»} & \foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{d͡hikrā\textsuperscript{2}} \enquote{a remembrance} & \foreignlanguage{arabic}{ذِکْرَيَات} \emph{d͡hikrayāt} \\
\end{longtable}
...
\foreignlanguage{arabic}{ذِکْرَىٰ\textsuperscript{2}} \emph{d͡hikrā\textsuperscript{2}} \enquote{a remembrance} & \foreignlanguage{arabic}{ذِکْرَيَات} \emph{d͡hikrayāt} \\
\end{longtable}
...
\tightlist
\item
  \foreignlanguage{arabic}{غَضْبَىٰ\textsuperscript{2}} \emph{g͡haḍbā\textsuperscript{2}} \emph{adj.} (fem.) \enquote{a very angry one\textsubscript{f}} from the root \foreignlanguage{arabic}{«غضب»}
\item
...
\item
  ...
  \item
    The broken plural \foreignlanguage{arabic}{أَشْيَاء\textsuperscript{2}} \emph{ʾas͡hyāʾ} (of the singular noun \foreignlanguage{arabic}{شَيْء} \emph{s͡hayʾ} \enquote{a thing}) is irregular in that it is semi-flexible. Otherwise its pattern \foreignlanguage{arabic}{أَفْعَال} \emph{ʾafɛāl} is regularly fully-flexible.
  \item
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{مُحَمَّد} & Muḥammad & \foreignlanguage{arabic}{عَائِشَة\textsuperscript{2}} & Ɛāʾis͡hah \\
...
\foreignlanguage{arabic}{عُثْمَان\textsuperscript{2}} & Ɛut͡hmān & \foreignlanguage{arabic}{مَرْيَم\textsuperscript{2}} & Maryam \\
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{خَدِيجَة\textsuperscript{2}} & K͡hadījah & \foreignlanguage{arabic}{مَيْمُونَة\textsuperscript{2}} & Maymūnah \\
\foreignlanguage{arabic}{فَاطِمَة\textsuperscript{2}} & Faṭimah & \foreignlanguage{arabic}{صَفِيَّة\textsuperscript{2}} & Ṣafiyyah \\
\foreignlanguage{arabic}{عَائِشَة\textsuperscript{2}} & Ɛāʾis͡hah & \foreignlanguage{arabic}{خَوْلَة\textsuperscript{2}} & K͡hawlah \\
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{عُثْمَان\textsuperscript{2}} & Ɛut͡hmān & \foreignlanguage{arabic}{رَمَضَان\textsuperscript{2}} & Ramaḍān \\
\foreignlanguage{arabic}{سُفْيَان\textsuperscript{2}} & Sufyān & \foreignlanguage{arabic}{شَعْبَان\textsuperscript{2}} & S͡haɛbān \\
\end{longtable}
...
\item
  \foreignlanguage{arabic}{يَعِيش\textsuperscript{2}} Yaɛīs͡h \enquote{He lives}
\end{itemize}
...
\foreignlanguage{arabic}{بَغْدَاد\textsuperscript{2}} & Bag͡hdād & \foreignlanguage{arabic}{ٱَلْهِنْد} & India \\
...
\begin{itemize}
\item
  Many of the pointing nouns contain small \emph{ʾalif} \foreignlanguage{arabic}{◌ٰ}. For most of them, this is how they must be written. It would be incorrect to write \foreignlanguage{arabic}{هَـٰذَا} \emph{hād͡hā} as \foreignlanguage{arabic}{هَاذَا}.
\item
...
\foreignlanguage{arabic}{زَيْنَب\textsuperscript{2}} & Zaynab & \foreignlanguage{arabic}{قُرَيْش} & Qurays͡h \\
\end{longtable}
...
\item
  When unseated \emph{hamzaḧ} comes between two letters that are joined, then it is written above the line that joins them, for example: \foreignlanguage{arabic}{خَطِيـَٔةٌ} \emph{k͡haṭīʾatun}. In this word, the \emph{yāʾ} \foreignlanguage{arabic}{ي} joins to the looped \emph{tāʾ} \foreignlanguage{arabic}{ة}. So the unseated \emph{hamzaḧ} is written above the joining line like so \foreignlanguage{arabic}{ــٔـ}.
\item
...
\item
  ...
  \item
    If the \emph{hamzaḧ} carries any other vowel, it is written seated on an \emph{ʾalif}, and is marked with the appropriated vowel mark, for example \foreignlanguage{arabic}{أَسْلَمَ} \emph{ʾaslama}, \foreignlanguage{arabic}{أُرِيدُ} \emph{ʾurīdu}, \foreignlanguage{arabic}{إِسْلَامُ} \emph{ʾislāmu}, \foreignlanguage{arabic}{إِيمَانُ} \emph{ʾīmānu}, \foreignlanguage{arabic}{أُوخِذَ} \emph{ʾūk͡hid͡ha}.
  \end{enumerate}
\item
  ...
  \item
    ...
    \item
      ...
      \foreignlanguage{arabic}{هَيْـَٔةُ} \emph{hayʾatu}, \foreignlanguage{arabic}{خَطِيـَٔةُ} \emph{k͡haṭīʾatu}\\
      ...
      \foreignlanguage{arabic}{شَيْـُٔهُ} \emph{s͡hayʾuhu}, \foreignlanguage{arabic}{شَيْـَٔهُ} \emph{s͡hayʾahu}, \foreignlanguage{arabic}{شَيْـِٔهِ} \emph{s͡hayʾihi}, \foreignlanguage{arabic}{شَيْـَٔانِ} \emph{s͡hayʾāni}, \foreignlanguage{arabic}{شَيْـَٔيْنِ} \emph{s͡hayʾayni}\\
  ...
  \item
    ...
    \item
      ...
      If it is followed by a long-\emph{ā} vowel represented by an \emph{ʾalif}, the \emph{hamzaḧ} is unseated followed by the \emph{ʾalif} and the combination is written as \foreignlanguage{arabic}{آ}. Example: \foreignlanguage{arabic}{مِرْآةُ} \emph{mirʾātu}, \foreignlanguage{arabic}{ظَمْآنُ} \emph{ḍ͡hamʾānu}.\\
  ...
  \item
    ...
    \item
      ...
      If the \emph{hamzaḧ} is followed by a long-\emph{ā} vowel represented by an \emph{ʾalif}, the \emph{hamzaḧ} is written unseated. Examples: \foreignlanguage{arabic}{شَنَآنُ} \emph{s͡hanaʾānu}.\\
...
\item
  ...
  \tightlist
  \item
    If there is a long vowel (\emph{ā}, \emph{ī}, \emph{ū}) or a semi-vowel (\emph{aw}, \emph{ay}) before it then the \emph{hamzaḧ} will be written unseated. Examples: \foreignlanguage{arabic}{دُعَاءُ} \emph{duɛāʾu}, \foreignlanguage{arabic}{سُوءُ} \emph{sūʾu}, \foreignlanguage{arabic}{جِيءَ} \emph{jīʾa}, \foreignlanguage{arabic}{ضَوْءَ} \emph{ḍawʾa}, \foreignlanguage{arabic}{شَيْءَ} \emph{s͡hayʾa}.
  \item
    Otherwise, if the previous letter has a \(\emptyset\)-mark, the \emph{hamzaḧ} will again be unseated. Examples: \foreignlanguage{arabic}{بُطْءُ} \emph{buṭʾu}, \foreignlanguage{arabic}{عِبْءُ} \emph{ɛibʾu}, \foreignlanguage{arabic}{شَطْءُ} \emph{s͡haṭʾu}
  \item
