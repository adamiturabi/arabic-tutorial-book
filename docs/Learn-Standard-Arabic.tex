...
Arabic has three short vowels, three long vowels, two semi-vowels, and a ø-mark. Each of these has an order of precedence and a hamzah seat, that we have shown in the table below:
...
\vphantom{\huge J} {\tradarab{رَأَىٰ}} \emph{raʾā} & \emph{a} & \emph{a} & \emph{a} & {\tradarab{أ}} \\
...
When hamzah would occur in the middle of a word, they would replace it with a \emph{a}, \emph{u}, or \emph{i} vowel.
...
and the spelling \emph{without} hamzah became standardized.
So \foreignlanguage{arabic}{ء} is now added on top of various \emph{seats} that would instead be pronounced without hamzah.
...
\item
  ...
  This is a more accurate approximation, but some fonts may not position the hamzah correctly on the kas͡hīdah, or position vowels marks on the superscript hamzah correctly.
\item
