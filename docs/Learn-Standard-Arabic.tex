...
\tightlist
\item
  \emph{aw} like in English \enquote{show}. This is written with a \emph{wāw} with a ø-mark on it and a \emph{ā} vowel before it. Example \foreignlanguage{arabic}{لَوْ} \emph{law}.
\item
  \emph{ay} like in English \enquote{bait}. This is written with a \emph{yāʾ} with a ø-mark on it and a \emph{ā} vowel before it. Example \foreignlanguage{arabic}{کَيْ} \emph{kay}.
...
\tightlist
\item
  \emph{āw} like in English \enquote{cow}. This is written with a \emph{wāw} with a ø-mark on it and a \emph{ā} vowel before it. Example \foreignlanguage{arabic}{وَاوْ} \emph{wāw}.
\item
  \emph{āy} like in English \enquote{bye}. This is written with a \emph{yāʾ} with a ø-mark on it and a \emph{ā} vowel before it. Example \foreignlanguage{arabic}{شَايْ} \emph{s͡hāy}.
\end{enumerate}
...
If the definite article \foreignlanguage{arabic}{ٱَلْ} \emph{ʾal} is with prefixed to nouns that have an initial connecting \emph{hamzah}, then the \foreignlanguage{arabic}{ل} shall no longer have an ø-mark \foreignlanguage{arabic}{◌ْ}. Instead it shall have an \emph{i}-mark \foreignlanguage{arabic}{◌ِ}. Example:
...
\item
  ...
  If the noun begins with a connecting \emph{hamzah} then the \foreignlanguage{arabic}{ل} in \foreignlanguage{arabic}{ٱَلْ} gets an \emph{i}-mark \foreignlanguage{arabic}{◌ِ} instead of its usual ø-mark \foreignlanguage{arabic}{◌ْ}. We described this in
...
\item
  ...
  \enquote{to a son}
\item
  If a preposition ends with a ø-mark \foreignlanguage{arabic}{◌ْ} and it is followed by a word that begins with a connecting \emph{hamzah}, then the ø-mark is changed to a short vowel according to the following rules:
...
\item
  ...
  \end{itemize}
\item
  The final ø-mark on the \foreignlanguage{arabic}{مْ} in the masculine plural doer pronoun \foreignlanguage{arabic}{تُمْ} \emph{-tum} becomes a \emph{u}-mark \foreignlanguage{arabic}{تُمُ} \emph{-tumu} when followed by a connecting \emph{hamzah}. Examples:
...
If an annexe noun ends with \foreignlanguage{arabic}{ىٰ} then it gets converted to an \emph{ʾalif} when annexing it to an attached pronoun. Example with \textsuperscript{2}\foreignlanguage{arabic}{فَتَاوَىٰ} \enquote{legal opinions}:
...
\item
  ...
  \end{itemize}
\item
  The a-state verbs for the masculine plural absentee and addressee participants have a final silent \emph{ʾalif}:
...
\section{\texorpdfstring{The a-state incomplete-action verb after \foreignlanguage{arabic}{أَنْ} \emph{ʾan}}{The a-state incomplete-action verb after أَنْ ʾan}}\label{the-a-state-incomplete-action-verb-after-ux623ux646-ean}
...
\item
  ...
  \end{itemize}
\item
  The u-state and ø-state verbs for the masculine plural absentee and addressee participants have a final silent \emph{ʾalif}:
...
\item
  ...
  incomplete-action verb
  ends with a
  ø-mark \foreignlanguage{arabic}{◌ْ}, and the next word begins with a connecting \emph{hamzah} \foreignlanguage{arabic}{ٱ} then the
...
\section{Uses of the ø-state incomplete-action verb}\label{uses-of-the-0-state-incomplete-action-verb}
...
\subsection{Other uses of the ø-state incomplete-action verb}\label{other-uses-of-the-0-state-incomplete-action-verb}
...
In order to form the verb of command, we remove the initial \foreignlanguage{arabic}{ت} from the addressee particpant verb. The verb then begins with an ø-mark so we place a connecting \emph{hamzah} in front of it.
...
\item
  ...
  \item
    ...
    \end{enumerate}
  \item
    If the letter before the \emph{hamzaḧ} has a ø-mark and is not \emph{wāw} or \emph{yāʾ}, then:
...
\item
  ...
  \item
    Otherwise, if the previous letter has a ø-mark, the \emph{hamzaḧ} will again be unseated. Examples: \foreignlanguage{arabic}{بُطْءُ} \emph{buṭʾu}, \foreignlanguage{arabic}{عِبْءُ} \emph{ɛibʾu}, \foreignlanguage{arabic}{شَطْءُ} \emph{s͡haṭʾu}
  \item
