...
\tightlist
\item
  Seated on an \emph{ʾalif}: {\tradarab{أ}} or {\tradarab{إ}}
\item
  Seated on an \emph{wāw}: {\tradarab{ؤ}}
\item
  Seated on an \emph{yāʾ}: {\tradarab{ئ}}
\item
  Unseated: {\tradarab{ء}}
\end{enumerate}
...
\begin{itemize}
\item
  When unseated hamzah comes between two letters that are joined, then it is written above the line that joins them, for example: {\tradarab{خَطِيءَة}} \emph{k͡haṭīʾah}. In this word, the \emph{yāʾ} {\tradarab{ي}} joins to the \emph{tāʾ marbūṭah} {\tradarab{ة}}.
\item
  When unseated hamzah is followed by an \emph{ʾalif}: {\tradarab{ءا}}, the combination of hamzah and \emph{ʾalif} is usually written as {\tradarab{آ}} as a convention. Examples: {\tradarab{آمَنَ}} \emph{ʾāmana}, {\tradarab{ظَمْآن}} \emph{ḍ͡hamʾān}, {\tradarab{شَنَآن}} \emph{s͡hanaʾān}. However, when the \emph{ʾalif} is a suffix or part of a suffix, or the hamzah is doubled, or there is an \emph{ʾalif} before the hamzah then we will write {\tradarab{ءا}}, not {\tradarab{آ}}. Examples: {\tradarab{شَيْءَانِ}} \emph{s͡hayʾāni}, {\tradarab{سَءَّال}} \emph{saʾʾāl}, {\tradarab{قِرَاءَات}} \emph{qirāʾāt}.
\item
  When hamzah is seated on \emph{ʾalif}, if it has an \emph{i}-mark, it is written below the \emph{ʾalif}: {\tradarab{إِ}}. Otherwise, it is written above the \emph{ʾalif}: {\tradarab{أَ}}, {\tradarab{أُ}}, {\tradarab{أْ}}.
\item
  When hamzah is seated on \emph{yāʾ} {\tradarab{ئ}} the dots of the \emph{yāʾ} are no longer written. Here's how it will appear in different positions:
  ...
  Note that hamzah is seated on \emph{yāʾ} in the middle position {\tradarab{ـئـ}} is different from unseated hamzah between two joining letters {\tradarab{ـءـ}}.
\end{itemize}
...
\tightlist
\item
  If the hamzah carries a long-\emph{ā} vowel, it is written unseated followed by an \emph{ʾalif} and written as {\tradarab{آ}}, for example {\tradarab{آمَنَ}} \emph{ʾāmana}.
\item
  If the hamzah carries any other vowel, it is written seated on an \emph{ʾalif}, and is marked with the appropriated vowel mark, for example {\tradarab{أَسْلَمَ}} \emph{ʾaslama}, {\tradarab{أُرِيدُ}} \emph{ʾurīdu}, {\tradarab{إِسْلَام}} \emph{ʾislām}, {\tradarab{إِيمَان}} \emph{ʾīmān}, {\tradarab{أُوخِذَ}} \emph{ʾūk͡hid͡ha}.
\end{enumerate}
...
\textbf{Main rule:} Disregard any doubling mark {\tradarab{◌ّ}} and consider the vowel on the consonant before the hamzah and the \emph{shortened} vowel on the hamzah itself. Determine which of the two vowels wins by being higher in precedence in the above table. The winning vowel's seat will be the seat of the hamzah.

\textbf{Sub-rule:} If the main rule determines that hamzah is to be seated on \emph{ʾalif}, and there is a long \emph{ā} vowel on the hamzah using an \emph{ʾalif}, then hamzah shall be unseated. And the combination of {\tradarab{ءَا}} will usually be written as {\tradarab{آ}}.
...
\bottomrule\noalign{}
\endlastfoot
{\tradarab{هَيْءَة}} \emph{hayʾah} & \emph{ay} & \emph{a} & \emph{ay} & {\tradarab{ء}} \\
{\tradarab{خَطِيءَة}} \emph{k͡haṭīʾah} & \emph{ī} & \emph{a} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{اسْتِيءَاس}} \emph{ʾistīʾās} & \emph{ī} & \emph{a} & \emph{ī} & {\tradarab{ء}} (Exception: {\tradarab{ءَا}} is not written as {\tradarab{آ}} when the preceding vowel is \emph{ī}.) \\
{\tradarab{تَوْءَم}} \emph{tawʾam} & \emph{aw} & \emph{a} & \emph{aw} & {\tradarab{ء}} \\
{\tradarab{سَائِل}} \emph{sāʾil} & \emph{ā} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{تَسَاؤُل}} \emph{tasāʾul} & \emph{ā} & \emph{u} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{تَسَاءَلَ}} \emph{tasāʾala} & \emph{ā} & \emph{a} & \emph{ā} & {\tradarab{ء}} \\
{\tradarab{قِرَاءَات}} \emph{qirāʾāt} & \emph{ā} & \emph{a} & \emph{ā} & {\tradarab{ء}} \\
{\tradarab{مَسْؤُول}} \emph{masʾūl} & {\tradarab{◌ْ}} & \emph{u} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{تَرْئِيس}} \emph{tarʾīs} & {\tradarab{◌ْ}} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{مِرْآة}} \emph{mirʾāh} & {\tradarab{◌ْ}} & \emph{a} & \emph{a} & {\tradarab{ء}} (Using sub-rule.) \\
{\tradarab{ظَمْآن}} \emph{ḍ͡hamʾān} & {\tradarab{◌ْ}} & \emph{a} & \emph{a} & {\tradarab{ء}} (Using sub-rule.) \\
{\tradarab{مَسْأَلَة}} \emph{masʾalah} & {\tradarab{◌ْ}} & \emph{a} & \emph{a} & {\tradarab{أ}} \\
{\tradarab{الْمَرْأَة}} \emph{almarʾah} & {\tradarab{◌ْ}} & \emph{a} & \emph{a} & {\tradarab{أ}} \\
{\tradarab{بِئْسَ}} \emph{biʾsa} & \emph{i} & {\tradarab{◌ْ}} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{سُؤْلَکَ}} \emph{suʾlaka} & \emph{u} & {\tradarab{◌ْ}} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{کَأْس}} \emph{kaʾs} & \emph{a} & {\tradarab{◌ْ}} & \emph{a} & {\tradarab{أ}} \\
{\tradarab{سُئِلَ}} \emph{suʾila} & \emph{u} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{يَئِسَ}} \emph{yaʾisa} & \emph{a} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{رَئِيس}} \emph{raʾīs} & \emph{a} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{سُؤَال}} \emph{suʾāl} & \emph{u} & \emph{a} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{رُؤُوس}} \emph{ruʾūs} & \emph{u} & \emph{u} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{لُؤَيّ}} \emph{luʾayy} & \emph{u} & \emph{a} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{شَنَآن}} \emph{s͡hanaʾān} & \emph{a} & \emph{a} & \emph{a} & {\tradarab{ء}} (Using sub-rule.) \\
{\tradarab{سَأَلَ}} \emph{saʾala} & \emph{a} & \emph{a} & \emph{a} & {\tradarab{أ}} \\
{\tradarab{رَأَىٰ}} \emph{raʾā} & \emph{a} & \emph{a} & \emph{a} & {\tradarab{أ}} \\
{\tradarab{رَأَّسَ}} \emph{raʾʾasa} & \emph{a} & \emph{a} & \emph{a} & {\tradarab{أ}} \\
{\tradarab{يُرَئِّسُ}} \emph{yuraʾʾisu} & \emph{a} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{رُئِّسَ}} \emph{ruʾʾisa} & \emph{u} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{تَفَؤُّل}} \emph{tafaʾʾul} & \emph{a} & \emph{u} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{سَءَّال}} \emph{saʾʾāl} & \emph{a} & \emph{a} & \emph{a} & {\tradarab{ء}} (Using sub-rule.) \\
{\tradarab{لَءَّال}} \emph{laʾʾāl} & \emph{a} & \emph{a} & \emph{a} & {\tradarab{ء}} (Using sub-rule.) \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
{\tradarab{دُعَاءُ}} \emph{duɛāʾu} & \emph{ā} & {\tradarab{ء}} \\
{\tradarab{سُوءُ}} \emph{sūʾu} & \emph{ū} & {\tradarab{ء}} \\
{\tradarab{جِيءَ}} \emph{jīʾa} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{ضَوْءَ}} \emph{ḍawʾa} & \emph{aw} & {\tradarab{ء}} \\
{\tradarab{شَيْءَ}} \emph{s͡hayʾa} & \emph{ay} & {\tradarab{ء}} \\
{\tradarab{بُطْءُ}} \emph{buṭʾu} & {\tradarab{◌ْ}} & {\tradarab{ء}} \\
{\tradarab{عِبْءُ}} \emph{ɛibʾu} & {\tradarab{◌ْ}} & {\tradarab{ء}} \\
{\tradarab{شَطْءُ}} \emph{s͡haṭʾu} & {\tradarab{◌ْ}} & {\tradarab{ء}} \\
{\tradarab{يُهَدِّئُ}} \emph{yuhaddiʾu} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{سَيِّئُ}} \emph{sayyiʾu} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{بَطُؤَ}} \emph{baṭuʾa} & \emph{u} & {\tradarab{ؤ}} \\
{\tradarab{يَهْدَأُ}} \emph{yahdaʾu} & \emph{a} & {\tradarab{أ}} \\
{\tradarab{مُبْتَدَإِ}} \emph{mubtadaʾi} & \emph{a} & {\tradarab{إ}} \\
\end{longtable}

The exception to this rule is when the previous letter is a doubled \emph{wāw} with an \emph{u}-mark.
In this case the hamzah will again be unseated. Example {\tradarab{تَبَوُّءُ}} \emph{tabawwuʾu}.

Note also that {\tradarab{مُبْتَدَإِ}} \emph{mubtadaʾi} can be written with the hamzah below the \emph{ʾalif} because of the \emph{i}-mark on the hamzah.
...
\tightlist
\item
  {\tradarab{لِ + أُسْتَاذِ = لِأُسْتَاذِ}}\\
\item
  {\tradarab{الْ + آخِرَة = الْآخِرَة}}
\end{itemize}
...
\bottomrule\noalign{}
\endlastfoot
{\tradarab{بَرِيءُونَ}} \emph{barīʾūna} & \emph{ī} & \emph{u} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{بَرِيءَانِ}} \emph{barīʾāni} & \emph{ī} & \emph{a} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{بَرِيءِينَ}} \emph{barīʾīna} & \emph{ī} & \emph{i} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{بَرِيءَيْنِ}} \emph{barīʾayni} & \emph{ī} & \emph{a} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{شَيْءُهُ}} \emph{s͡hayʾuhu} & \emph{ay} & \emph{u} & \emph{ay} & {\tradarab{ء}} \\
{\tradarab{شَيْءَهُ}} \emph{s͡hayʾahu} & \emph{ay} & \emph{a} & \emph{ay} & {\tradarab{ء}} \\
{\tradarab{شَيْءِهِ}} \emph{s͡hayʾihi} & \emph{ay} & \emph{i} & \emph{ay} & {\tradarab{ء}} \\
{\tradarab{شَيْءَانِ}} \emph{s͡hayʾāni} & \emph{ay} & \emph{a} & \emph{ay} & {\tradarab{ء}} \\
{\tradarab{شَيْءَيْنِ}} \emph{s͡hayʾayni} & \emph{ay} & \emph{a} & \emph{ay} & {\tradarab{ء}} \\
{\tradarab{مَجِيءُهُ}} \emph{majīʾuhu} & \emph{ī} & \emph{u} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{مَجِيءَهُ}} \emph{majīʾahu} & \emph{ī} & \emph{a} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{مَجِيءِهِ}} \emph{majīʾihi} & \emph{ī} & \emph{i} & \emph{ī} & {\tradarab{ء}} \\
{\tradarab{سُوئِهِ}} \emph{sūʾihi} & \emph{ū} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{ضَوْئِهِ}} \emph{ḍawʾihi} & \emph{aw} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{سُوءَهُ}} \emph{sūʾahu} & \emph{ū} & \emph{a} & \emph{ū} & {\tradarab{ء}} \\
{\tradarab{سُوءَانِ}} \emph{sūʾāni} & \emph{ū} & \emph{a} & \emph{ū} & {\tradarab{ء}} \\
{\tradarab{ضَوْءَهُ}} \emph{ḍawʾahu} & \emph{aw} & \emph{a} & \emph{aw} & {\tradarab{ء}} \\
{\tradarab{ضَوْءَانِ}} \emph{ḍawʾāni} & \emph{aw} & \emph{a} & \emph{aw} & {\tradarab{ء}} \\
{\tradarab{سُوءُهُ}} \emph{sūʾuhu} & \emph{ū} & \emph{u} & \emph{ū} & {\tradarab{ء}} \\
{\tradarab{يَسُوءُونَ}} \emph{yasūʾūna} & \emph{ū} & \emph{u} & \emph{ū} & {\tradarab{ء}} \\
{\tradarab{نُوآنٌ}} \emph{nūʾānun}. & \emph{ū} & \emph{a} & \emph{ū} & {\tradarab{ء}} \\
{\tradarab{مُتَّکِئِينَ}} \emph{muttakiʾīna} & \emph{i} & \emph{i} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{يُبَرِّئُونَ}} \emph{yubarriʾūna} & \emph{i} & \emph{u} & \emph{i} & {\tradarab{ئ}} \\
{\tradarab{يُبَرَّؤُونَ}} \emph{yubarraʾūna} & \emph{a} & \emph{u} & \emph{u} & {\tradarab{ؤ}} \\
\end{longtable}
...
\tightlist
\item
  {\tradarab{جُزْءَانِ}} \emph{juzʾāni}\\
\item
  {\tradarab{عِبْءَانِ}} \emph{ɛibʾāni}\\
\item
  {\tradarab{عِبْءَيْنِ}} \emph{ɛibʾayni}\\
\item
  {\tradarab{بُطْءَهُ}} \emph{buṭʾahu}\\
\item
  {\tradarab{بُطْءُهُ}} \emph{buṭʾuhu}\\
\item
  {\tradarab{بُطْءِهِ}} \emph{buṭʾihi}
\end{itemize}
...
\emph{n}-marks on a final hamzah does not affect the writing of the hamzah except in the case of \emph{an}-mark. When writing \emph{an}-mark on a hamzah at the end of a word:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  If there is an \emph{ʾalif} before a unseated hamzah {\tradarab{اء}}, then we don't add a silent \emph{ʾalif} when writing \emph{an}-mark. For example {\tradarab{دَاء}} becomes {\tradarab{دَاءً}} \emph{dāʾan}, not {\tradarab{دَاءًا}}.
\item
  Otherwise, we add the silent \emph{ʾalif} after the hamzah so that the hamzah is now in the middle of the word with a suffix \emph{ʾalif} after it. We now pretend that the hamzah has an \emph{a}-mark and that the \emph{ʾalif} after it is a long-\emph{ā} vowel. Then we go through the rules for writing hamzah in the middle of a word (given above) to determine how hamzah will be written. We then write the \emph{an}-mark on the hamzah. Examples:
\end{enumerate}

\begin{itemize}
\tightlist
\item
  {\tradarab{مُبْتَدَأ}} becomes {\tradarab{مُبْتَدَأٌ، مُبْتَدَءًا، مُبْتَدَإٍ}}
\item
  {\tradarab{مَلْجَأ}} becomes {\tradarab{مَلْجَأٌ، مَلْجَءًا، مَلْجَإٍ}}
\item
  {\tradarab{جُزْء}} becomes {\tradarab{جُزْءٌ، جُزْءًا، جُزْءٍ}}
\item
  {\tradarab{شَيْء}} becomes {\tradarab{شَيْءٌ، شَيْءًا، شَيْءٍ}}
\end{itemize}
...
\tightlist
\item
  {\tradarab{مَسْءُول}} instead of {\tradarab{مَسْؤُول}}
\item
  {\tradarab{أَسْءِلَة}} instead of {\tradarab{أَسْئِلَة}}
\item
  {\tradarab{مَسْءَلَة}} instead of {\tradarab{مَسْأَلَة}}
\end{itemize}

However, this rule appears to be not consistently followed. For example, \emph{al-nas͡hʾah} is generally always written {\tradarab{النَّشْأَة}} never {\tradarab{النَّشْءَة}}.
...
\tightlist
\item
  {\tradarab{رُءُوس}} instead of {\tradarab{رُؤُوس}}.
\item
  {\tradarab{رَءِيس}} instead of {\tradarab{رَئِيس}}.
\end{itemize}
