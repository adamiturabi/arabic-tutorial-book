...
\def\labelenumi{\arabic{enumi}.}
\item
  When \foreignlanguage{arabic}{حَتَّىٰ} is used to indicate an extreme point at which the action of the following verb would occur, or is meant to occur. For example,
