...
While the above concession can be granted to \foreignlanguage{arabic}{يوجد}, we find no such justifying circumstances for the existential \foreignlanguage{arabic}{هناک}.
