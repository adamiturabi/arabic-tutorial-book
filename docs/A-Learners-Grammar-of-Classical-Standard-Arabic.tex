...
\tightlist
\item
  \emph{a} as the first vowel in English ``manipulate'', written with an \emph{a}-mark \foreignlanguage{arabic}{◌َ} which is a small diagonal line above the letter like \foreignlanguage{arabic}{مَـ} \emph{ma}.
\item
  \emph{i} as in English ``bit'', written with an \emph{i}-mark \foreignlanguage{arabic}{◌ِ} which is a small diagonal line under the letter like \foreignlanguage{arabic}{بِـ} \emph{bi}.
\item
  \emph{u} as in English ``put'', written with an \emph{u}-mark \foreignlanguage{arabic}{◌ُ} which is like a tiny \foreignlanguage{arabic}{و} wāw above the letter like \foreignlanguage{arabic}{فُـ} \emph{fu}.
\end{enumerate}
...
\tightlist
\item
  \emph{ā} generally written with an unmarked {alif} \foreignlanguage{arabic}{ا} and with the preceding letter having an \emph{a}-mark. Example \foreignlanguage{arabic}{مَا} \emph{mā}. This vowel is mostly pronounced like the vowel in English ``man''. If however, it comes after these letters \foreignlanguage{arabic}{خ،ر،ص،ض،ط،ظ،غ،ق} it is pronounced like English \enquote{awe}.
\item
  \emph{ī} like in English ``meek'' written with an unmarked \foreignlanguage{arabic}{ي} yāʾ with the preceding letter having an \emph{i}-mark. Example \foreignlanguage{arabic}{فِي} \emph{fī}.
\item
  \emph{ū} like in English ``moon'' written with an unmarked \foreignlanguage{arabic}{و} wāw with the preceding letter having an \emph{u}-mark. Example \foreignlanguage{arabic}{ذُو} \emph{d͡hū}.
\end{enumerate}
...
\tightlist
\item
  \emph{aw} like in English ``show''. This is written with a wāw with a ø-mark on it and a short \emph{a} vowel before it. Example \foreignlanguage{arabic}{لَوْ} \emph{law}.
\item
  \emph{ay} like in English ``bait''. This is written with a yāʾ with a ø-mark on it and a short \emph{a} vowel before it. Example \foreignlanguage{arabic}{كَيْ} \emph{kay}.
...
\tightlist
\item
  \emph{āw} like in English ``cow''. This is written with a wāw with a ø-mark on it and a long \emph{ā} vowel before it. Example \foreignlanguage{arabic}{وَاوْ} \emph{wāw}.
\item
  \emph{āy} like in English ``bye''. This is written with a yāʾ with a ø-mark on it and a long \emph{ā} vowel before it. Example \foreignlanguage{arabic}{شَايْ} \emph{s͡hāy}.
\end{enumerate}
...
\item
  \vphantom{\huge J} {\tradarab{مُرْجِءُون}} \emph{murjiʾūn} instead of {\tradarab{مُرْجِئُون}}
\item
  \vphantom{\huge J} {\tradarab{رَئِيس}} \emph{raʾīs} instead of {\tradarab{رَءِيس}}
\end{itemize}
