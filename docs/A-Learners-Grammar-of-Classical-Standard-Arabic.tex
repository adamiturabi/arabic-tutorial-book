...
\section{Yes/No questions}\label{yesno-questions}

TODO

\section{\texorpdfstring{\foreignlanguage{arabic}{مَنْ} \enquote{Who}}{مَنْ ``Who''}}\label{ux645ux646-who}

TODO

\section{\texorpdfstring{\foreignlanguage{arabic}{مَا} \enquote{What}}{مَا ``What''}}\label{ux645ux627-what}

TODO

\section{\texorpdfstring{\foreignlanguage{arabic}{أَيّ} \enquote{Which}}{أَيّ ``Which''}}\label{ux623ux64a-which}

TODO

\section{\texorpdfstring{\foreignlanguage{arabic}{کَيْفَ} \enquote{Which}}{کَيْفَ ``Which''}}\label{ux643ux64aux641-which}

TODO

\section{\texorpdfstring{\foreignlanguage{arabic}{أَيْنَ} \enquote{Where}}{أَيْنَ ``Where''}}\label{ux623ux64aux646-where}

TODO

\section{\texorpdfstring{\foreignlanguage{arabic}{مَتَىٰ} \enquote{When}}{مَتَىٰ ``When''}}\label{ux645ux62aux649-when}
