...
\bottomrule\noalign{}
\endlastfoot
\textsuperscript{2}\foreignlanguage{arabic}{مَکَّة} & Makkah & \textsuperscript{2}\foreignlanguage{arabic}{رَمَضَان} & Ramadān (a month) \\
...
\bottomrule\noalign{}
\endlastfoot
\textsuperscript{2}\foreignlanguage{arabic}{مَکَّة} & Makkah & \foreignlanguage{arabic}{ٱَلْمَدِينَة} & al-Madīnah \\
...
\foreignlanguage{arabic}{مَکِّي} & a Makkan & \foreignlanguage{arabic}{تَمِيمِيّ} & a Tamīmian \\
...
\foreignlanguage{arabic}{أَکَلْتُ ٱلسَّمَکَةَ حَتَّىٰ رَأْسِهَا.}\\
...
\foreignlanguage{arabic}{أَکَلْتُ ٱلسَّمَکَةَ حَتَّىٰ رَأْسَهَا.}\\
...
(\foreignlanguage{arabic}{أَکَلْتُ ٱلسَّمَکَةَ وَرَأْسَهَا.}
\enquote{I ate the fish and its head.})

Consider now yet another variant of this sentence:

\foreignlanguage{arabic}{أَکَلْتُ ٱلسَّمَکَةَ. حَتَّىٰ رَأْسُهَا {[}أَکَلْتُهَا{]}.}\\
...
\item
  ...
  \foreignlanguage{arabic}{غَضِبَ حَتَّىٰ لَا يَمْلِکَ نَفْسَهُ.}\\
  ...
  \foreignlanguage{arabic}{غَضِبَ إِلَىٰ أَلَّا يَمْلِکَ نَفْسَهُ.}
\item
  When \foreignlanguage{arabic}{حَتَّىٰ} is used with the meaning \enquote{to such a purpose that}. This is a similar meaning to \foreignlanguage{arabic}{کَيْ} \enquote{in order that}.
  For example,
...
\foreignlanguage{arabic}{يَأْکُلُ حَتَّىٰ يَشْبَعَ.}\\
...
\foreignlanguage{arabic}{أَکَلْتُ ٱلطَّعَامَ حَتَّىٰ شَبِعْتُ.}\\
...
\foreignlanguage{arabic}{أَکَلْتُ ٱلطَّعَامَ حَتَّىٰ أَشْبَعُ.}\\
...
\foreignlanguage{arabic}{غَضِبَ حَتَّىٰ لَا يَمْلِکُ نَفْسَهُ.}\\
...
\item
  ...
  \foreignlanguage{arabic}{کُسِرَتِ ٱلزُّجَاجَةُ.}\\
...
they\textsubscript{3f} & \foreignlanguage{arabic}{کُنَّ} & \foreignlanguage{arabic}{يَکُنَّ} \\
you\textsubscript{3m} & \foreignlanguage{arabic}{کُنْتُمْ} & \foreignlanguage{arabic}{تَکُونُونَ} \\
you\textsubscript{3f} & \foreignlanguage{arabic}{کُنْتُنَّ} & \foreignlanguage{arabic}{تَکُنَّ} \\
we & \foreignlanguage{arabic}{کُنَّا} & \foreignlanguage{arabic}{نَکُونُ} \\
\end{longtable}
...
and its direct doee, \foreignlanguage{arabic}{مُعَلِّمًا}, is also called its information.\footnote{The Baṣran school explained the reason for the \foreignlanguage{arabic}{خبر} of \foreignlanguage{arabic}{کان} being \foreignlanguage{arabic}{منصوب} that it is a \foreignlanguage{arabic}{مفعول به}. The Kūfan school, on the other hand, considered it a \foreignlanguage{arabic}{حال}.

  From \foreignlanguage{arabic}{المقاصد الشافية في شرح الخلاصة الکافية (شرح ألفية ابن مالک) للشاطبي} vol.~2, p.~137:

  \begin{quote}
  \foreignlanguage{arabic}{لَمّا کان وجهُ نَصْبِهُ مُختَلفًا فيه بَين البصريين والکوفيين؛ فذهب البصريون إلى أَنّه منصوب خبرًا لها، فالمبتدأ والخبر معها کالفاعل والمفعول. وذهب الکوفيون إلى أنه ينصَبُ على الحال.}
  \end{quote}}
...
\foreignlanguage{arabic}{ٱَلنِّسَاءُ فِي بُيُوتِهِنَّ.} & \foreignlanguage{arabic}{کَانَتْ ٱلنِّسَاءُ فِي بُيُوتِهِنَّ.} \\
...
\foreignlanguage{arabic}{ٱلثِّيرَانُ کَانَتْ ضَخْمَةً.} (typical)\\
\enquote{The bulls were large.}

Also allowed, but not as common:\\
\foreignlanguage{arabic}{ٱلثِّيرَانُ کَانَتْ ضِخَامًا.}\\
\foreignlanguage{arabic}{ٱلثِّيرَانُ کُنَّ ضَخْمَاتٍ.}
...
\foreignlanguage{arabic}{وَکُنَّا نَحْنُ ٱلْوَارِثِينَ}\\
\enquote{And it is We who were the inheritors} {[}al-Qurʾān 28:58, translation by Saheeh International{]}

\foreignlanguage{arabic}{کُنْتَ أَنْتَ ٱلرَّقِيبَ عَلَيْهِمْ}\\
...
\foreignlanguage{arabic}{مَا کَانَ إِبْرَٰهِيمُ يَهُودِيًّۭا وَلَا نَصْرَانِيًّۭا وَلَـٰکِن کَانَ حَنِيفًۭا مُّسْلِمًۭا وَمَا کَانَ مِنَ ٱلْمُشْرِکِينَ}\\
...
\foreignlanguage{arabic}{ذَهَبْتُ إِلَى ٱلسُّوقِ فِي ٱلصَّبَاحِ. وَکَانَتْ لِي عَادَةً.}\\
...
\foreignlanguage{arabic}{تَکُونُ السَّمَاءُ زَرْقَاءَ.}\\
...
\foreignlanguage{arabic}{قَالَ وَمَا الْبِتْعُ وَالْمِزْرُ؟ قُلْتُ شَرَابٌ يَکُونُ مِنَ الْعَسَلِ وَالْمِزْرُ يَکُونُ مِنَ الشَّعِيرِ}\\
...
\foreignlanguage{arabic}{يَکُونُ اللِّحَافُ وِسَادَةً وَلَا تَکُونُ الْوِسَادَةُ لِحَافًا.}\\
\enquote{The blanket can be a pillow but the pillow cannot be a blanket.}

\foreignlanguage{arabic}{مَا يَکُونُ الرَّجُلُ صَدِيقَکَ حَتّى يَصْدُقَکَ.}\\
...
\foreignlanguage{arabic}{فَقَدْ کَذَّبْتُمْ فَسَوْفَ يَکُونُ لِزَامًا}\\
...
\foreignlanguage{arabic}{يَوْمَ يَکُونُ ٱلنَّاسُ کَٱلْفَرَاشِ ٱلْمَبْثُوثِ}\\
...
\foreignlanguage{arabic}{نَزَلَ بِهِ ٱلرُّوحُ ٱلْأَمِينُ. عَلَىٰ قَلْبِکَ لِتَکُونَ مِنَ ٱلْمُنذِرِينَ}\\
...
\foreignlanguage{arabic}{لَّن يَسْتَنکِفَ ٱلْمَسِيحُ أَن يَکُونَ عَبْدًۭا لِّلَّهِ وَلَا ٱلْمَلَـٰٓئِکَةُ ٱلْمُقَرَّبُونَ}\\
...
\foreignlanguage{arabic}{أَفَأَنتَ تُکْرِهُ ٱلنَّاسَ حَتَّىٰ يَکُونُوا۟ مُؤْمِنِينَ}\\
...
\foreignlanguage{arabic}{وَلْتَکُن مِّنکُمْ أُمَّةٌۭ يَدْعُونَ إِلَى ٱلْخَيْرِ وَيَأْمُرُونَ بِٱلْمَعْرُوفِ وَيَنْهَوْنَ عَنِ ٱلْمُنکَرِ}\\
...
\foreignlanguage{arabic}{ٱلْحَقُّ مِن رَّبِّکَ فَلَا تَکُن مِّنَ ٱلْمُمْتَرِينَ}\\
...
\foreignlanguage{arabic}{لَمْ يَکُنِ النَّبِيُّ صلى الله عليه وسلم سَبَّابًا وَلاَ فَحَّاشًا وَلاَ لَعَّانًا}\\
...
\foreignlanguage{arabic}{لَمْ تَکُنِ ٱلرَّجُلَ.}\\
...
\foreignlanguage{arabic}{فَقُلْنَا لَهُمْ کُونُوا۟ قِرَدَةً خَـٰسِـِٔينَ}\\
...
\foreignlanguage{arabic}{يَکُونُ فِي آخِرِ الزَّمَانِ دَجَّالُونَ کَذَّابُونَ}\\
\enquote{There will be in the end of time charlatan liars}\\
{[}From Ḥadīt͡h in Ṣaḥīḥ Muslim:7{]}

\foreignlanguage{arabic}{إِنَّهَا تَکُونُ الظُّلْمَةُ وَالسَّيْلُ}\\
...
\foreignlanguage{arabic}{وَيَخَافُونَ يَوْمًۭا کَانَ شَرُّهُۥ مُسْتَطِيرًۭا}\\
...
\foreignlanguage{arabic}{کَانَ}
is to indicate a state that always existed and will always exist.\footnote{From \foreignlanguage{arabic}{البحر المحيط لأبي حيان} in the tafsīr of \foreignlanguage{arabic}{کُنْتُمْ خَيْرَ أُمَّةٍ} {[}3:110{]}:

  \begin{quote}
  \foreignlanguage{arabic}{وظاهر کان هنا أنها الناقصة، وخير أمة هو الخبر. ولا يراد بها هنا الدلالة على مضي الزمان وانقطاع النسبة نحو قولک: کان زيد قائماً، بل المراد دوام النسبة کقوله:\{ وکان الله غفوراً رحيماً \} {[}الأحزاب: 73{]}\{ ولا تقربوا الزنا إنه کان فاحشة وساء سبيلاً \} {[}الإسراء: 32{]} وکون کان تدل على الدوام ومرادفه لم يزل قولاً مرجوحاً، بل الأصح أنها کسائر الأفعال تدل على الانقطاع، ثم قد تستعمل حيث لا يراد الانقطاع. وقيل: کان هنا بمعنى صار، أيْ صرتم خير أمة. وقيل: کان هنا تامة، وخير أمة حال. وأبعد من ذهب إلى أنّها زائدة، لأن الزائدة لا تکون أول کلام، ولا عمل لها. وقال الزمخشري: کان عبارة عن وجود الشيء في من ماض على سبيل الإبهام، وليس فيه دليل على عدم سابق، ولا على انقطاع طارىء. ومنه قوله تعالى: \{ وکان الله غفوراً \}. و منه قوله: کنتم خير أمة، کأنه قيل: وجدتم خير أمة انتهى کلامه. فقوله: أنها لا تدل على عدم سابق هذا إذا لم تکن بمعنى صار، فإذا کانت بمعنى صار دلت على عدم سابق. فإذا قلت: کان زيد عالماً بمعنى صار، دلت على أنه انتقل من حالة الجهل إلى حالة العلم. وقوله: ولا على انقطاع طارىء قد ذکرنا قبل أن الصحيح أنها کسائر الأفعال يدل لفظ المضي منها على الانقطاع، ثم قد تستعمل حيث لا يکون انقطاع. وفرقٌ بين الدلالة والاستعمال، ألا ترى أنک تقول: هذا اللفظ يدل على العموم؟ ثم تستعمل حيث لا يراد العموم، بل المراد الخصوص. وقوله: کأنه قال وجدتم خير أمة، هذا يعارض أنها مثل قوله: \{ وکان الله غفوراً رحيماً \} لأن تقديره وجدتم خير أمة يدل على أنها تامة، وأن خير أمة حال. وقوله: \{ وکان الله غفوراً \} لا شک أنها هنا الناقصة فتعارضا.}
  \end{quote}} For example:

\foreignlanguage{arabic}{وَکَانَ ٱللَّهُ غَفُورًۭا رَّحِيمًۢا}\\
\enquote{And ever is Allāh Forgiving and Merciful.}\\
{[}From al-Qurʾān 33:73, translation by Saheeh International{]}

\foreignlanguage{arabic}{وَلَا تَقْرَبُوا۟ ٱلزِّنَىٰٓ ۖ إِنَّهُۥ کَانَ فَـٰحِشَةًۭ وَسَآءَ سَبِيلًۭا}\\
...
\foreignlanguage{arabic}{کَانَ يَعْبُدُ مُشْرِکُو مَکَّةَ ٱلْأَصْنَامَ.}\\
or\\
\foreignlanguage{arabic}{کَانَ مُشْرِکُو مَکَّةَ يَعْبُدُونَ ٱلْأَصْنَامَ.}\\
\enquote{The polytheists of Makkah used to worship idols.}

\foreignlanguage{arabic}{کَانَتْ تُحِبُّ الصَّدَقَةَ.}\\
\enquote{She used to love {[}to practice{]} charity.}\\
{[}From Ḥadīt͡h in Ṣaḥīḥ al-Buk͡hārī:1420{]}

\foreignlanguage{arabic}{کَانَت تَّأْتِيهِمْ رُسُلُهُم بِٱلْبَيِّنَـٰتِ}\\
...
\foreignlanguage{arabic}{کُنْتُ أَلْعَبُ بِالْبَنَاتِ عِنْدَ النَّبِيِّ صلى الله عليه وسلم وَکَانَ لِي صَوَاحِبُ يَلْعَبْنَ مَعِي}\\
...
\foreignlanguage{arabic}{قَالُوا هَذَا قَدْ کَانَ يَکْتُبُ لِمُحَمَّدٍ}\\
...
\foreignlanguage{arabic}{إِنَّ أُنَاسًا کَانُوا يُؤْخَذُونَ بِالْوَحْىِ فِي عَهْدِ رَسُولِ اللَّهِ صلى الله عليه وسلم}\\
...
\foreignlanguage{arabic}{کَانَتْ تَعْمَلُ بِيَدِهَا وَتَصَدَّقُ}\\
...
\foreignlanguage{arabic}{مَا کَانَ أَحَدٌ يَبْدَأُ، أَوْ يَبْدُرُ، ابْنَ عُمَرَ بِالسَّلامِ}\\
\enquote{No one preceded or got ahead of Ibn Ɛumar with (giving) the greeting.}\\
{[}Ḥadīt͡h in al-Adab al-Mufrad:982{]}

\foreignlanguage{arabic}{کَانُوا۟ لَا يَتَنَاهَوْنَ عَن مُّنکَرٍۢ فَعَلُوهُ}\\
...
\foreignlanguage{arabic}{قَدْ کَانَ يَکُونُ فِي الأُمَمِ مُحَدَّثُونَ}\\
...
\foreignlanguage{arabic}{وَٱتَّبَعُوا۟ مَا تَتْلُوا۟ ٱلشَّيَـٰطِينُ عَلَىٰ مُلْکِ سُلَيْمَـٰنَ ۖ}\\
...
\foreignlanguage{arabic}{کَانَتِ ٱلْعُصِيُّ مَرْکُوزَةً فِي ٱلْأَرْضِ.}\\
...
\foreignlanguage{arabic}{مَاتَ ٱلرَّشِيدُ بِطُوسَ وَکَانَ خَرَجَ إِلَىٰ خُرَاسَانَ لِمُحَارَبَةِ رَافِعِ بْنِ ٱللَّيْثِ.}\\
...
\foreignlanguage{arabic}{کُنْتُ قَدْ رَبَّيْتُ جَارِيَةً}\\
...
\foreignlanguage{arabic}{مَاتَ ٱلرَّشِيدُ بِطُوسَ وَکَانَ خَرَجَ إِلَىٰ خُرَاسَانَ لِمُحَارَبَةِ رَافِعِ بْنِ ٱللَّيْثِ.}\\
\foreignlanguage{arabic}{وَکَانَ رَافِعٌ هَـٰذَا قَدْ خَرَجَ وَخَلَعَ ٱلطَّاعَةَ وَتَغَلَّبَ عَلَىٰ سَمَرْقَنْدَ.}\\
...
\foreignlanguage{arabic}{لاَ يَأْتِي ابْنَ آدَمَ النَّذْرُ بِشَىْءٍ لَمْ يَکُنْ قَدْ قَدَّرْتُهُ}\\
...
\foreignlanguage{arabic}{وَدِدْتُ أَنِّي لَمْ أَکُنْ خَرَجْتُ الْعَامَ}\\
\enquote{I wish I had not come out (for Ḥajj) this year}\\
{[}From Sunan Abī Dawūd:1778{]}

\foreignlanguage{arabic}{وَمَا کَانَ قَدْ أَتَاهَا بِشَيْءٍ}\footnote{From \foreignlanguage{arabic}{إحياء علوم الدين لأبي حامد الغزالي} (without \foreignlanguage{arabic}{إسناد}):

  \begin{quote}
  \foreignlanguage{arabic}{وَکَانَ مُعَاذُ بْنُ جَبَلٍ عَامِلًا لعمر رَضِيَ اللَّهُ عَنْهُ فَلَمَّا رَجَعَ قَالَتْ لَهُ امْرَأَتُهُ مَا جِئْتَ بِهِ مِمَّا يَأْتِي بِهِ الْعُمَّالُ إِلَى أَهْلِهِمْ وَمَا کَانَ قَدْ أَتَاهَا بِشَيْءٍ فَقَالَ کَانَ عِنْدِي ضَاغِطٌ قَالَتْ کُنْتَ أَمِينًا عِنْدَ رَسُولِ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ وعند أبي بکر رضي الله عنه فبعث عمر
  مَعَکَ ضَاغِطًا وَقَامَتْ بِذَلِکَ بَيْنَ نِسَائِهَا وَاشْتَکَتْ عمر فَلَمَّا بَلَغَهُ ذَلِکَ دَعَا معاذا وَقَالَ بعثت معک ضاغطاً قال لم أَجِدُ مَا أَعْتَذِرُ بِهِ إِلَيْهَا إِلَّا ذَلِکَ فضحک عمر رضي الله عنه وَأَعْطَاهُ شَيْئًا فَقَالَ أَرْضِهَا بِهِ}
  \end{quote}}\\
...
\foreignlanguage{arabic}{يَشْطَرِطُ فِي ٱلنَّائِبِ أَنْ يَکُونَ قَدْ حَجَّ عَنْ نَفْسِهِ}\\
...
\foreignlanguage{arabic}{کُنْ أَنْتَ تُکَلِّمُهُمْ}\\
...
\foreignlanguage{arabic}{وَمَا کَانَ ٱللَّهُ لِيُعَذِّبَهُمْ وَأَنتَ فِيهِمْ ۚ}\\
...
This signifies that the action of the verb does not behoove, or is not appropriate or desrving or possibly for the person denoted by the noun after \foreignlanguage{arabic}{لِ}.\footnote{From \foreignlanguage{arabic}{البحر المحيط لأبي حيان} in the tafsīr of \foreignlanguage{arabic}{مَا کَانَ لِبَشَرٍ} {[}3:79{]}:

  \begin{quote}
  \foreignlanguage{arabic}{ومعنى \{ ما کان لبشر أن يؤتيه الله \} وما جاء نحوه أنه ينفي عنه الکون، والمراد نفي الخبر، وذلک على قسمين.}

  \foreignlanguage{arabic}{أحدهما: أن يکون الانتفاء من حيث العقل، ويعبر عنه بالنفي التام، ومثاله قوله:\{ ما کان لکم أن تنبتوا شجرها \} {[}النمل: 60{]}\{ وما کان لنفس أن تموت إلا بإذن الله \} {[}آل عمران: 145{]}.}

  \foreignlanguage{arabic}{والثاني: أن يکون الانتفاء فيه على سبيل الانتفاء، ويعبر عنه بالنفي غير التام، ومثاله قول أبي بکر الصديق، رضي الله عنه: ما کان لابن أبي قحافة أن يتقدّم أن يصلى بين يدي رسول الله صلى الله عليه وسلم.}

  \foreignlanguage{arabic}{ومدرک القسمين إنما يعرف بسياق الکلام الذي النفي فيه، وهذه الآية من القسم الأول، لأنا نعلم أن الله لا يعطي الکَذَبة والمدَّعين النبوّة، وفي هذه الآية دلالة على عصمة الأنبياء عليهم السلام.}
  \end{quote}

  From \foreignlanguage{arabic}{التحرير والتوير} in the tafsīr of the same verse:

  \begin{quote}
  \foreignlanguage{arabic}{وقوله \{ ما کان لبشر \} نفي لاستحقاق أحد لذلک القول واللام فيه للاستحقاق. وأصل هذا الترکيب في الکلام ما کان فُلان فاعلاً کذا، فلما أريدت المبالغة في النفي عدل عن نفي الفعل إلى نفي المصدر الدال على الجنس، وجعل نفي الجنس عن الشخص بواسطة نفي الاستحقاق إذ لا طريقة لِحمل اسم ذات على اسم ذات إلاّ بواسطة بعض الحروف، فصار الترکيب ما کان له أن يفعل، ويقال أيضاً ليس له أن يفعل، ومثل ذلک في الإثبات کقوله تعالى\{ إن لک ألا تجوع فيها ولا تعرى \} طه 118. فمعنى الآية ليس قولُ \{ کونوا عباداً لي \} حقاً لبشر أيِّ بشر کان. وهذه اللام هي أصل لام الجحود التي في نحو\{ وما کان الله ليعذّبهم \} الأنفال 33، فتراکيب لام الجحود کلّها من قبيل قلب مثل هذا الترکيب لقصد المبالغة في النفي، بحيث ينفى أن يکون وجود المسند إليه مجعولاً لأجل فِعْل کذا، أي فهو بريء منه بأصل الخلقة ولذلک سميت جحوداً. والمنفي في ظاهر هذه الآية إيتاء الحکم والنبوءة، ولکن قد علم أنّ مصبّ النفي هو المعطوف من قوله \{ ثم يقول للناس کونوا عباداً لي \} أي ما کان له أن يقول کونوا عباداً لي إذا آتاه الله الکتاب إلخ.}
  \end{quote}}
For example:

\foreignlanguage{arabic}{فَأَنۢبَتْنَا بِهِۦ حَدَآئِقَ ذَاتَ بَهْجَةٍۢ مَّا کَانَ لَکُمْ أَن تُنۢبِتُوا۟ شَجَرَهَآ ۗ}\\
...
\foreignlanguage{arabic}{مَا کَانَ لِبَشَرٍ أَن يُؤْتِيَهُ ٱللَّهُ ٱلْکِتَـٰبَ وَٱلْحُکْمَ وَٱلنُّبُوَّةَ ثُمَّ يَقُولَ لِلنَّاسِ کُونُوا۟ عِبَادًۭا لِّى مِن دُونِ ٱللَّهِ}\\
...
\foreignlanguage{arabic}{قَالَ أَبُو بَکْرٍ مَا کَانَ لاِبْنِ أَبِي قُحَافَةَ أَنْ يُصَلِّيَ بَيْنَ يَدَىْ رَسُولِ اللَّهِ صلى الله عليه وسلم}\\
...
TODO: Multiple pronoun subjects: \foreignlanguage{arabic}{إِنِّ وَ إِيَّاکَ \ldots{}}
...
\foreignlanguage{arabic}{رَأَيْتُ ذَ~ٰلِکَ ٱلرَّجُلَ.}\\
...
\foreignlanguage{arabic}{رَأَيْتُ ذَ~ٰلِکَ ٱلرَّجُلَ ٱلطَّوِيلَ ٱلَّذِي لَقِيتُهُ بِٱلْأَمْسِ.}\\
...
\foreignlanguage{arabic}{وَالَّذِينَ يَکْنِزُونَ ٱلذَّهَبَ وَٱلْفِضَّةَ وَلَا يُنْفِقُونَهَا فِي سَبِيلِ ٱللَّـٰهِ فَبَشِّرْهُمْ بِعَذَابٍ أَلِيمٍ}\\
...
\foreignlanguage{arabic}{خِيَارُ أَئِمَّتِکُمُ الَّذِينَ تُحِبُّونَهُمْ وَيُحِبُّونَکُمْ}\\
...
\foreignlanguage{arabic}{أَوْ کَٱلَّذِي مَرَّ عَلَىٰ قَرْيَةٍ}\\
\enquote{Or {[}consider such an example{]} as the one who passed by a township}\\
2:259

As a base noun in an annexation:

\foreignlanguage{arabic}{قَدْ سَمِعَ ٱللَّـٰهُ قَوْلَ ٱلَّتِي تُجَادِلُکَ فِي زَوْجِهَا}\\
...
\foreignlanguage{arabic}{وَالَّذِينَ يَکْنِزُونَ ٱلذَّهَبَ وَٱلْفِضَّةَ}\\
...
\foreignlanguage{arabic}{خِيَارُ أَئِمَّتِکُمُ الَّذِينَ تُحِبُّونَهُمْ}\\
\enquote{The best of your rulers are the ones whom you love and who love you}\\
...
\foreignlanguage{arabic}{وَالَّذِينَ يَکْنِزُونَ ٱلذَّهَبَ وَٱلْفِضَّةَ}
\enquote{And those who hoard gold and silver,}
the link-back pronoun is the plural masculine absent-person doer pronoun \foreignlanguage{arabic}{و} \enquote{they} in \foreignlanguage{arabic}{يَکْنِزُونَ} \enquote{they hoard}.
...
\foreignlanguage{arabic}{فَقَالَ مُوسَى يَا آدَمُ أَنْتَ الَّذِي خَلَقَکَ اللَّهُ بِيَدِهِ}\\
...
\foreignlanguage{arabic}{يَاأَيُّهَا الَّذِي نُزِّلَ عَلَيْهِ الذِّکْرُ}\\
...
\item
  ...
  \item
    ...
    \foreignlanguage{arabic}{تَکَلَّمَ ٱلَّذِي عِنْدَکَ.}\\
    ...
    \foreignlanguage{arabic}{تَکَلَّمَ ٱلَّذِي هُوَ عِنْدَکَ.}
  \end{enumerate}
...
There are also some other rarely or dialectally used general connected nouns that we will not cover. These are \foreignlanguage{arabic}{أَيّ} \emph{ʾayy}, \foreignlanguage{arabic}{ذُو} \emph{d͡hū}, and \foreignlanguage{arabic}{ذَا} \emph{d͡hā}.\footnote{Fischer claims (§427):
  ...
  \foreignlanguage{arabic}{عَرَفَ ٱلْمَکِيدَةَ وَکَيْفَ کَانَ ٱلْمَلِکُ أَوْقَعَهَا}
  ...
  However, we have not been able to find the classical grammarians including \foreignlanguage{arabic}{کيف}, \foreignlanguage{arabic}{أين}, etc. among \foreignlanguage{arabic}{الأسماء الموصولة}.
  ...
  \foreignlanguage{arabic}{هُوَ الَّذِي يُصَوِّرُکُمْ فِي الْأَرْحَامِ کَيْفَ يَشَاءُ} {[}3:6{]}, and
  \foreignlanguage{arabic}{لِيُرِيَهُ کَيْفَ يُوَارِي سَوْءَةَ أَخِيهِ} {[}5:31{]}
  ...
  The article \foreignlanguage{arabic}{ٱل} is also generally included among \foreignlanguage{arabic}{الأسماء الموصولة المشترکة}.
...
\item
  ...
  \foreignlanguage{arabic}{صَلِّ مِنَ ٱلرَّکَعَاتِ مَا يَتَيَسَّرْنَ.}\\
  or\\
  \foreignlanguage{arabic}{صَلِّ مِنَ ٱلرَّکَعَاتِ مَا تَتَيَسَّرُ.}\\
...
\item
  ...
  \foreignlanguage{arabic}{صَلِّ مِنَ ٱلرَّکَعَاتِ مَا يَتَيَسَّرُ.}\\
  \enquote{Pray from the units (of prayer) what is easy.}
...
\foreignlanguage{arabic}{رَبِّ إِنِّي نَذَرْتُ لَکَ مَا فِي بَطْنِي مُحَرَّرًا}\\
...
\foreignlanguage{arabic}{فَانکِحُوا مَا طَابَ لَکُم مِّنَ النِّسَاءِ}\\
...
\foreignlanguage{arabic}{مَالُکَ مَا قَدَّمْتَ، وَمَالُ وَارِثِکَ مَا أَخَّرْتَ}\\
...
\foreignlanguage{arabic}{وَأَغْنِنِي بِفَضْلِکَ عَمَّنْ سِوَاکَ}\\
...
the general connected nouns do not occur as describers.\footnote{See \foreignlanguage{arabic}{کتاب المقتصد في شرح الإيضاح للجرجاني}, vol.~1, p.~319:

  \begin{quote}
  \foreignlanguage{arabic}{ومَن لا يوصف به، ألا ترى لا تقول: مررت بالرجل مَن أخوه منطلق. فتجعله صفةً للرجل، کما تقول: بالرجل الذي أخوه منطلق}
  \end{quote}

  Also \foreignlanguage{arabic}{شرح الرضي على الکافية لابن الحاجب} vol.~2, p.~314:

  \begin{quote}
  \foreignlanguage{arabic}{ولا يقع من الموصولات وصفا إلا ما في أوله اللام، نحو الذي والتي، واللاتي، وبابها، لمشابهته لفظا للصفة المشبهة في کونه على ثلاثة أحرف فصاعدا، بخلاف من وما، وأما (أي) الموصول فلم يقع وصفا، لأن الأغلب فيه: الشرط والاستفهام ووقوعه موصولا قليل فروعي ذلک الأکثر، وإنما يوصف بذو، الطائية وإن کانت على حرفين کما في قوله:}

  \foreignlanguage{arabic}{٣٢٧ - فقولا لهذا المرء ذو جاء ساعيا \ldots{} هلم فان المشرفي الفرائض}
  \end{quote}

  Basically, of \foreignlanguage{arabic}{الأسماء الموصولة المشترکة} (which comprise \foreignlanguage{arabic}{ما, مَن, أي, أل, ذو, ذا}) only the dialectal \foreignlanguage{arabic}{ذو} appears as a \foreignlanguage{arabic}{صفة}.}
...
\foreignlanguage{arabic}{والمسلمون مَن تبع رسول الله صلى الله عليه وسلم کثير}\\
...
\foreignlanguage{arabic}{فَأَعْطَانِي مَا کَانَ عِنْدَهُ مِنْ خُبْزٍ.}\\
...
\foreignlanguage{arabic}{اللَّهُمَّ اقْسِمْ لَنَا مِنْ خَشْيَتِکَ مَا يَحُولُ بَيْنَنَا وَبَيْنَ مَعَاصِيکَ}\\
...
\foreignlanguage{arabic}{وَيْلٌ لِّکُلِّ هُمَزَةٍ لُّمَزَةٍ}\\
...
\foreignlanguage{arabic}{مَنْ کَانَتْ أُمَّکَ؟}\\
\enquote{Who was your mother?}

Note how \foreignlanguage{arabic}{کَانَتْ} has a feminine doer pronoun to match the gender of \foreignlanguage{arabic}{أُمَّکَ}.\footnote{Wright states (vol.~2, §170, p.~313C):

  \begin{quote}
  As interrogatives, \foreignlanguage{arabic}{مَنْ} and \foreignlanguage{arabic}{مَا} are construed with the masculine singular of a verb, but occasionally admit of the feminine when the predicate is of the feminine gender; as \foreignlanguage{arabic}{مَنْ کَانَتْ أُمَّکَ} who was your mother?
  \end{quote}

  From \foreignlanguage{arabic}{البحر المحيط لأبي حيان} for the tafsīr of \foreignlanguage{arabic}{فَإِن کَانَتَا ٱثۡنَتَیۡنِ} {[}4:176{]}:

  \begin{quote}
  \foreignlanguage{arabic}{\ldots{} مَن صُرِّحَ بِها ولَها لَفْظٌ ومَعْنًى. فَمَن أنَّثَ راعى المَعْنى، لِأنَّ التَّقْدِيرَ: أيَّةُ أُمٍّ کانَتْ أُمَّکَ. ومَدْلُولُ الخَبَرِ في هَذا مُخالِفٌ لِمَدْلُولِ الِاسْمِ، بِخِلافِ الآيَةِ، فَإنَّ المَدْلُولَيْنِ واحِدٌ، ولَمْ يُؤَنَّثْ في مَن کانَتْ أُمَّکَ لِتَأْنِيثِ الخَبَرِ، إنَّما أُنِّثَ مُراعاةً لِمَعْنى مَن إذْ أرادَ بِها مُؤَنَّثًا. ألا تَرى أنَّکَ تَقُولُ: مَن قامَتْ فَتُؤَنَّثُ مُراعاةً لِلْمَعْنى إذا أرَدْتَ السُّؤالَ عَنْ مُؤَنَّثٍ، ولا خَبَرَ هُنا فَيُؤَنَّثُ قامَتْ لِأجْلِهِ}
  \end{quote}

  From \foreignlanguage{arabic}{البحر المحيط لأبي حيان} for the tafsīr of \foreignlanguage{arabic}{ثُمَّ لَمۡ تَکُن فِتۡنَتُهُمۡ} {[}6:23{]}:

  \begin{quote}
  \foreignlanguage{arabic}{وأمّا مَن کانَتْ أُمَّکَ، فَإنَّهُ حَمَلَ اسْمَ کانَ عَلى مَعْنى (مَن)؛ لِأنَّ مَن لَها لَفْظٌ مُفْرَدٌ، ولَها مَعْنًى بِحَسَبِ ما تُرِيدُ مِن إفْرادٍ وتَثْنِيَةٍ وجَمْعٍ وتَذْکِيرٍ وتَأْنِيثٍ، ولَيْسَ الحَمْلُ عَلى المَعْنى لِمُراعاةِ الخَبَرِ، ألا تَرى أنَّهُ يَجِيءُ حَيْثُ لا خَبَرَ ؟ نَحْوَ ومِنهم مَن يَسْتَمِعُونَ إلَيْکَ. و(تَکُنْ) مِثْلُ مَن يا ذِئْبُ يَصْطَحِبانِ. ومَن تَقْنُتْ في قِراءَةِ التّاءِ، فَلَيْسَتْ تَأْنِيثُ کانَتْ لِتَأْنِيثِ الخَبَرِ، وإنَّما هو لِلْحَمْلِ عَلى مَعْنى (مَن) حَيْثُ أرَدْتَ بِهِ المُؤَنَّثَ، وکَأنَّکَ قُلْتَ: أيَّةُ امْرَأةٍ کانَتْ أُمَّکَ}
  \end{quote}}
...
\section{\texorpdfstring{\foreignlanguage{arabic}{کَيْفَ} \enquote{How} questions}{کَيْفَ ``How'' questions}}\label{ux643ux64aux641-how-questions}
...
(\foreignlanguage{arabic}{أَ}, \foreignlanguage{arabic}{مَنْ}, \foreignlanguage{arabic}{مَا}, \foreignlanguage{arabic}{کَيْفَ}, etc.)
...
\foreignlanguage{arabic}{مَا عَلِمْتُ أَذَهَبَ أَمْ مَکَثَ}\\
I don't know whether he went or stayed.

Here the question sentence is:
\foreignlanguage{arabic}{أَذَهَبَ أَمْ مَکَثَ}
...
\enquote{then let her enter from whichever of the doors of paradise she wishes.}\footnote{Distinguishing question words from their other functions is often not straightforward. Consider the example:
  ...
  \foreignlanguage{arabic}{أَتَدْرِي أَيَّ کِتَابٍ قَرَأَ؟}\\
  Do you know which book he read?

  \foreignlanguage{arabic}{أَيّ} is a question noun in the a-state because it is the direct doee of the verb \foreignlanguage{arabic}{قَرَأَ}. It can't be a connected noun because \foreignlanguage{arabic}{أَيَّ کِتَابٍ} is indefinite and connected nouns are always considered definite.

  See also these excerpts:

  From the tafsīr of \foreignlanguage{arabic}{وَإِذَا مَآ أُنزِلَتْ سُورَةٌ فَمِنْهُمْ مَّن يَقُولُ أَيُّکُمْ زَادَتْهُ هَـٰذِهِ إِيمَاناً} {[}9:124{]} from \foreignlanguage{arabic}{تفسير الآلوسي}:

  \begin{quote}
  \foreignlanguage{arabic}{وقرأ عبيد بن عمير \{أَيُّکُمْ\} بالنصب على تقدير فعل يفسره المذکور ويقدر مؤخرًا لأن الاستفهام له الصدر أي أيکم زادت زادته الخ.}
  \end{quote}

  From the tafsīr of \foreignlanguage{arabic}{ثُمَّ لَنَنزِعَنَّ مِن کُلِّ شِيعَةٍ أَيُّهُمْ أَشَدُّ عَلَى ٱلرَّحْمَـٰنِ عِتِيّاً} {[}9:124{]} from \foreignlanguage{arabic}{بداىع الفوائد لابن القيم}:

  \begin{quote}
  \foreignlanguage{arabic}{و ﴿أيُّهم أشَدُّ﴾ للنحاة فيه أقوال:}

  \foreignlanguage{arabic}{أحدها: قول الخليل أنه مبتدأ وأشد خبره ولم يعمل لننزعن فيه لأنه محکي والتقدير الذي يقال فيه: ﴿أيُّهم أشَدُّ عَلى الرَّحْمَنِ عِتِيًّا﴾ وعلى هذا فـ (أي) استفهامية.}

  \foreignlanguage{arabic}{الثاني: قول يونس أنه رفع على جهة التعليق للفعل السابق کما لو قلت علمت أنه أخوک فعلق الفعل عن الفعل کما تعلق أفعال القلوب.}

  \foreignlanguage{arabic}{الثالث: قول سيبويه إن (أي) هنا موصولة مبنية على الضم والمسوغ لبنائها حذف صدر صلتها، وعنده أصل الکلام أيهم هو أشد فلما حذف صدر الصلة بنيت على الضم تشبيها لها بالغايات التي قد حذفت مضافاتها ک قبل وبعد وعلى کل واحد من الأقوال إشکالات نذکرها ثم نبين الصحيح إن شاء الله.}
  ...
  \foreignlanguage{arabic}{وأما ما يحذف من القول فإنه إنما يکون قولا مجردا عن کونه صلة لموصول نحو قوله: ﴿والمَلائِکَةُ باسِطُو أيْدِيهِمْ أخْرِجُوا أنْفُسَکُمُ﴾ أي يقولون أو قائلين ومثله: ﴿والَّذِينَ اتَّخَذُوا مِن دُونِهِ أوْلِياءَ ما نَعْبُدُهم إلاّ لِيُقَرِّبُونا إلى اللَّهِ زُلْفى﴾}

  \foreignlanguage{arabic}{الرابع: أنه إذا قدر المحذوف هکذا لم يستقم الکلام فإنه يصير ﴿لَنَنْزِعَنَّ مِن کُلِّ شِيعَةٍ﴾ الذين يقال فيهم ﴿أيُّهم أشَدُّ﴾}

  \foreignlanguage{arabic}{وهذا فاسد فإن ذلک المنزوع لا يقال فيه: ﴿أيُّهم أشَدُّ﴾ بل هو نفسه أشد أو من أشد الشيعة على الرحمن فلا يقع عليه الاستفهام بعد نزعه فتأمله.}

  \foreignlanguage{arabic}{الخامس: أن الاستفهام لا يقع إلا بعد أفعال العلم والقول على الحکاية ولا يقع بعد غيره من الأفعال تقول علمت أزيد عندک أم عمرو ولو قلت ضربت أزيد أم عمرو لم يجز وننزعن ليس من أفعال العلم}

  \foreignlanguage{arabic}{فإذا قلت: ضربت أيهم قام. لم تکن إلا موصولة ولا يصح أن يقال ضربت الذي يقال فيه أيهم قام، وإنما توهم مثل ذلک لکون اللفظ صالحا لجهة أخرى مستقيمة فيتوهم متوهم أن حمله على الجهة الأخرى يستقيم والذي يدل عليه أنه لو قدرت موضعه استفهاما صريحا ليس له جهة أخرى لم يجز}

  \foreignlanguage{arabic}{فإذا قلت: ضرب أزيد عندک أم عمرو. لم يجز بخلاف ضرب أيهم عندک.}

  \foreignlanguage{arabic}{فلو کان أيهم استفهاما لجاز الکلام مع الاستفهام الذي بمعناهما وإنما لم يقع الاستفهام إلا بعد أفعال العلم والقول أما القول فلأنه يحکي به کل جملة خبرية کانت أو إنشائية، وأما أفعال العلم فإنما وقع بعدها الاستفهام لکون الاستفهام مستعلما به فکأنک إذا قلت: أزيد عندک أم عمرو کان معناه أعلمني، وإذا قلت: علمت أزيد عندک أم عمرو.}

  \foreignlanguage{arabic}{کان معناه علمت ما يطلب استعلامه فلهذا صح وقوع الاستفهام بعد العلم لأنه استعلام ثم حمل الحسبان والظن عليهما لکونهما من بابه ووجه آخر وهو کثرة استعمال أفعال العلم فجعل شأن ليس لغيرها.}

  \foreignlanguage{arabic}{السادس: أن هذا الحذف الذي قدره في الآية حذف لا يدل عليه سياق فهو مجهول الوضع وکل حذف کان بهذه المنزلة کان تقديره من باب علم الغيب وأما قول يونس بن حبيب فإشکاله ظاهر فإن التعليق إنما يکون في أفعال القلوب نحو العلم والظن والحسبان دون غيرها.}

  \foreignlanguage{arabic}{ولا يجوز أن تقول ضربت أيهم قام على أن تکون (أيهم) استفهاما وقد علق الفعل عن العمل فيه وأما قول سيبويه فإشکاله أنه بناء خارج عن النظائر ولم يوجد في اللغة شاهد له قال السهيلي ما ذکره سيبويه لو استشهد عليه بشاهد من نظم أو نثر أو وجدنا بعده في کلام فصيح شاهدا له لم نعدل به قولا ولا رأينا لغيره عنه طولا ولکنا لم نجز ما بين لمخالفته غيره لا سيما مثل هذه المخالفة فإنا لا نسلم أنه حذف من الکلام شيء وإن قال: إنه حذف ولا بد والتقدير أيهم هو أخوک فيقال: لم يبنوا في النکرة فيقولون مررت برجل أخوک أو رأيت رجلا أبوک أي هو أخوک وأبوک ولم خصوا أيا هذا دون سائر الأسماء أن يحذف من صلته ثم يبنى للحذف ومتى وجدنا شيئا من الجملة يحذف ثم يبنى الموصوف بالجملة من أجل ذلک الحذف وذلک الحذف لا نجعله متضمنا لمعنى الحرف ولا مضارعا له وهذه علة البناء وقد عدمت في أي قال والمختار قول الخليل ولکنه يحتاج إلى شرح وذلک أنه لم يرد بالحکاية ما يسبق إلى الفهم من تقدير معنى القول ولکنه أراد حکاية لفظ الاستفهام الذي هو أصل في أي کما يحکيه بعد العلم إذا قلت قد علمت من أخوک وأقام زيد أم قعد فقد ترکت الکلام على حاله قبل دخول الفعل لبقاء معنى الاختصاص والتعيين في أي الذي کان موجودا فيها وهي استفهام لأن ذلک المعنى هو الذي وضعت له استفهاما کانت أو خبرا کما حکوا لفظ النداء في قولهم اللهم اغفر لي أيها الرجل وارحمنا أيتها العصابة فنحکي لفظ هذا إشعارا بالتعيين والاختصاص الموجود في حال النداء لوجود معنى الاختصاص والتعيين فيه قال وقول يونس: إن الفعل ملغي حق وإن لم يکن من أفعال القلب وعلة إلغائه ما قدمناه من حکاية لفظ الاستفهام للاختصاص فإذا أتممت العلة وقلت ضربت أيهم أخوک. زالت مضارعة الاستفهام وغلب فيه معنى الخبر لوجود الصلة التامة بعده}

  \foreignlanguage{arabic}{قال وأما قوله تعالى: ﴿وَسَيَعْلَمُ الَّذِينَ ظَلَمُوا أيَّ مُنْقَلَبٍ يَنْقَلِبُونَ﴾ وإجماعهم على أنها منصوبة بـ ﴿ينقلبون﴾ لا بـ ﴿سيعلم﴾ وقد کان يتصور فيها أن تکون منصوبة بـ سيعلم على جهة الاستفهام ولکن تکون موصولة والجملة صلتها والعائد محذوف ولکن منع من هذا أصل أصلناه ودليل أقمناه على أن الاسم الموصول إذا عني به المصدر ووصل بفعل مشتق من ذلک المصدر لم يجز لعدم الفائدة المطلوبة من الصلة وهي إيضاح الموصول وتبيينه والمصدر لا يوضح فعله المشتق من لفظه لأنه کأنه هو لفظا ومعنى إلا في المختلف الأنواع کما تقدم قال ووجه آخر أقوى من هذا وهو أن أيا لا تکون بمعنى الذي حتى تضاف إلى معرفة فتقول لقيت أيهم في الدار إذ من المحال أن يکون بمعنى الذي وهو نکرة والذي لا ينکر وهذا أصل يبنى عليه في (أي).}
  \end{quote}

  From \foreignlanguage{arabic}{معانى القآن للفراء} for the tafsīr of {[}2:69{]}:

  \begin{quote}
  \foreignlanguage{arabic}{فأعملْ في '' ما '' '' وأي '' الفعلَ الذي بعدَهما، ولا تُعمِل الذي قبلهما إذا کان مُشتقّاً من العِلْم ؛ کقولک : ما أعلم أَيُّهم قال ذاک، ولا أعلمنّ أَيُّهم قال ذاک، وما أدرِى أَيَّهم ضربت، فهو في العِلِم والإخبار والإنْباء وما أشبهها على ما وصفتُ لک. منه قول الله تبارک وتعالى :﴿ وَما أَدْرَاکَ ماهِيَهْ ﴾ ﴿ وَما أَدْرَاکَ ما يَوْمُ الدَّينِ ﴾ '' ما '' الثانية رفعٌ، فرفعتَها بيوم ؛ کقولک : ما أدراک أي شيء يومُ الدّين، وکذلک قول الله تبارک وتعالى :﴿ لِنَعْلَمَ أي الْحِزْبَيْنِ أَحْصَى ﴾ رفعتَه بأَحْصَى، وتقول إذا کان الفعل واقعا على أي : ما أدرى أَيَّهم ضربت. وإنما امتنعت من أن تُوقع على أي الفعل الذي قبلها من العلم وأشباهه ؛ لأنک تجِدُ الفعلَ غيرَ واقع على أي في المعنى ؛ ألا ترى أنک إذا قلت : اذْهَبْ فاعلم أيُّهما قام أنک تسأل غيرهما عن حالهما فتجد الفعل واقعا على الذي أعلمک، کما أنک تقول : سل أيُّهُمْ قام، والمعنى : سل الناس أيُّهُمْ قام. ولو أوقعت الفعل على '' أي '' فقلت : اسأل أيَّهُمْ قام لکنت کأنک تضمر أيّاً مرّة أخرى ؛ لأنک تقول : سل زيدا أيُّهُمْ قام، فإذا أوقعت الفعل على زيد فقد جاءت '' أي '' بعده. فکذلک '' أي '' إذا أوقعت عليها الفعل خرجت من معنى الاستفهام، وذلک إن أردته، جائز، تقول : لأضْرِبَنَّ أيَّهُم يقول ذاک ؛ لأنّ الضرب لا يقع على {[} اسم ثم يأتي بعد ذلک استفهام، وذلک لأن الضرب لا يقع على {]} اثنين، وأنتَ تقول في المسألة : سل عبد الله عن کذا، کأنک قلت : سله عن کذا، ولا يجوز ضربت عبد الله کذا وکذا إلا أن تريد صفة الضرب، فأما الأسماء فلا. وقول الله :﴿ ثُمَّ لَنَنْزِعَنّ مِنْ کُلِّ شِيعةٍ أيُّهُم أشَدُّ على الرّحْمَنِ عِتيّاً ﴾ من نصب أيّاً أوقع عليها النزع وليس باستفهام، کأنه قال : ثم لنستخرجن العاتيَ الذي هو أشد. وفيها وجهان من الرفع ؛ أحدهما أن تجعل الفعل مکتفيا بِمن في الوقوع عليها، کما تقول : قد قتلنا من کل قوم، وأصبنا من کل طعام، ثم تستأنف أيّاً فترفعها بالذي بعدها، کما قال جلّ وعزّ :﴿ يَبْتَغُونَ إلى رَبِّهِمُ الْوَسِيلَةَ أيُّهُمْ أَقْرَبُ ﴾ أي ينظرون أيُّهُم أقرب. ومثله ﴿ يُلْقُونَ أقْلاَمَهُمْ أَيُّهُمْ يَکْفُلُ مَرْيَمَ ﴾. وأما الوجه، الآخر فإن في قوله تعالى :﴿ ثم لَنَنْزِعَنّ مِنْ کلِّ شِيعَةٍ ﴾ لننزعن من الذين تشايعوا على هذا، ينظرون بالتشايع أيهم أشدّ وأخبث، وأيهم أشدّ على الرحمن عِتيّاً، والشيعة ويتشايعون سواء في المعنى. وفيه وجه ثالث من الرفع أن تجعل ﴿ ثُمّ لَننْزِعَنَّ مِنْ کُلِّ شِيعَةٍ ﴾ بالنداء ؛ أي لننادين ﴿ أيُّهُمْ أشدُّ على الرّحْمانِ عِتيّاً ﴾ وليس هذا الوجه يريدون. ومثله مما تعرفه به قوله :﴿ أفَلَمْ يَيْأَسِ الَّذِيِنَ آمنَوُا أَنْ لَوْ يشاء اللَّهُ لهَدَى الناس جَميعاً ﴾ فقال بعض المفسرين ﴿ أَفَلَمْ يَيْأَسِ الَّذِينَ آمَنُوا ﴾ : ألم يعلم، والمعنى - والله أعلم - أفلم ييأسوا علما بأن الله لو شاء لهدى الناس جميعا. وکذلک '' لَنَنْزِعَنّ '' يقول يريد ننزعهم بالنداء.}
  \end{quote}}
...
\vphantom{\huge J} {\tradarab{مُرْجَءَلت}} \emph{murjaʾāt} & \emph{a} & \emph{ā} & \emph{ā} & {\tradarab{ء}} \\
...
\vphantom{\huge J} {\tradarab{مُتَّکِءِينَ}} \emph{muttakiʾīna} & \emph{i} & \emph{ī} & \emph{ī} & {\tradarab{ء}} \\
\vphantom{\huge J} {\tradarab{مُتَّکِءُونَ}} \emph{muttakiʾūna} & \emph{i} & \emph{ū} & \emph{ū} & {\tradarab{ء}} \\
...
Another, more modern, variant is to modify the precedence rule of vowels. According to this modern variant, the vowel before hamzah is compared with the \emph{shortened} vowel on the hamzah. This results in some changes in the hamzah seat. For example:

\begin{itemize}
\tightlist
\item
  \vphantom{\huge J} {\tradarab{مَسْؤُول}} instead of {\tradarab{مَسْءُول}}
\item
  \vphantom{\huge J} {\tradarab{رُؤُوس}} instead of {\tradarab{رُءُوس}}
\end{itemize}

Excepted from this variant is the combination \foreignlanguage{arabic}{aEA} which will continue to be written as \foreignlanguage{arabic}{ـَءَا} or \foreignlanguage{arabic}{ـَآ}. For example: {\tradarab{شَنَآن}}, {\tradarab{مُرْجَءَات}}.
...
There is a modern tendency to use the ḍ͡harf makan \foreignlanguage{arabic}{هُنَاکَ} and the majhūl verb \foreignlanguage{arabic}{يُوجَدُ}.
So one might find:
...
Sometimes in place of \foreignlanguage{arabic}{هُنَاکَ}, its synonym, \foreignlanguage{arabic}{ثَمَّةَ} is used.
These usages of \foreignlanguage{arabic}{هُنَاکَ}, \foreignlanguage{arabic}{ثَمَّةَ}, and \foreignlanguage{arabic}{يُوجَدُ} are foreign to Arabic and should generally be avoided.
...
\foreignlanguage{arabic}{الغَضَبُ غَضَبَانِ: غَضَبٌ مُسْتَحَبٌّ وَغَضَبٌ مَکْرُوهٌ.}\\
\enquote{Anger is (actually) two angers: an anger that is liked, and an anger that is disliked.}

\foreignlanguage{arabic}{مَنَ ٱلْغَضَبِ مَا يٌسْتَحَبُّ وَمَا يٌکْرَهُ.}\\
...
\foreignlanguage{arabic}{ما فعل أصحابک}\\
...
\foreignlanguage{arabic}{مَا هَذَا الَّذِي يَذْکُرُونَ عَنِ الْحَسَنِ}\\
abudawud:4621
...
\foreignlanguage{arabic}{إِذَا تَوَاجَهَ الْمُسْلِمَانِ بِسَيْفَيْهِمَا فَکِلاَهُمَا مِنْ أَهْلِ النَّارِ ``. قِيلَ فَهَذَا الْقَاتِلُ، فَمَا بَالُ الْمَقْتُولِ}\\
bukhari:7083
...
\foreignlanguage{arabic}{عَنِ النَّبِيِّ صلى الله عليه وسلم أَنَّهُ نَهَى أَنْ يَشْرَبَ الرَّجُلُ قَائِمًا . قَتَادَةُ فَقُلْنَا فَالأَکْلُ فَقَالَ ذَاکَ أَشَرُّ أَوْ أَخْبَثُة}
\enquote{what about eating?}
muslim:2024b

\foreignlanguage{arabic}{قَالَ رَسُولُ اللَّهِ صلى الله عليه وسلم لِلْمُتَلاَعِنَيْنِ '' حِسَابُکُمَا عَلَى اللَّهِ أَحَدُکُمَا کَاذِبٌ لاَ سَبِيلَ لَکَ عَلَيْهَا '' . قَالَ يَا رَسُولَ اللَّهِ مَالِي}\\
