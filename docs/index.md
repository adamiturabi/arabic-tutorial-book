...
[^1]: The term _Classical Arabic_ is not very precisely defined, and other authors may use it to also include the early [#islAm]{.trn2}ic and pre-[#islAm]{.trn2}ic dialects.
