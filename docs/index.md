...
In the process of preserving Arabic, a standard variety emerged from among the various dialects of Arabic. This standard variety is known as Classical Standard Arabic, or simply Classical Arabic. The Arabic dialects used before the emergence of Classical Standard Arabic are then referred to, collectively,  as pre-classical Arabic. Classical Arabic was used as the language of science and literature in the [#islAm]{.trn2}ic world. As scholars developed new branches of religious and secular sciences, new terms and meanings were added to it and at this point it is referred to as post-classical Standard Arabic. A few words were also borrowed from foreign languages as needed by the different scientific disciplines. These additions were, by and large, deliberate, done by scholars who were experts in their field and also well versed in Classical Arabic, and validated by subsequent generations of scholarly discourse. Besides these needed additions, the grammar and base language remained remarkably unchanged.
...
In modern times, many new words and meanings have been added to Standard Arabic, often via translation from Western languages, to keep up with technological advancements and modern media. However, it must be said that these additions have often been done by translators rather than scholars in the field, and have sometimes lacked the deliberation seen in the additions to post-classical Standard Arabic. This modern development of Standard Arabic is called Modern Standard Arabic. There are also a small amount of words, meanings, and grammatical usages, which existed in Classical Arabic, but which are deemed archaic, and are therefore largely unused, in Modern Standard Arabic.

## Scope of this book

In this book, we will study classical and post-classical Standard Arabic. We will focus on the pre-modern language. If [#allAh]{.trn2} wills, this will help you to begin to understand the language of the [#qurEAn]{.trn2}, the [#HadIv]{.trn2}, and [#islAm]{.trn2}ic literature.
...
#### [A]{.trn} vowel written with a [yAE]{.trn} {#a-vowel-written-with-a-ya}
...
[إِلَىٰ]{.ar} [EilA]{.trn} "to" have a long-[A]{.trn} vowel at the end but it is written with a dotless [yAE]{.trn} [ىٰ]{.ar} instead of an [alif]{.trn}. (We have already learned that some words are written this way in section\ \@ref(a-vowel-written-with-a-ya).)
...
+ If a preposition ends with a long vowel, then, as usual, it get shortened to a short vowel when it is followed by a word which begins with a connecting [hamzah]{.trn}. Examples:
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
There are some nouns that end with an [Ealif]{.trn} before the [ة]{.ar}, like [فَتَاة]{.ar} [fatAh]{.trn} "a young woman". We will learn how to dualize these nouns later, if [#allAh]{.trn2} wills.
...
There are some nouns that end with an [Ealif]{.trn} before the [ة]{.ar}, like [فَتَاة]{.ar} [fatAh]{.trn} "a young woman". We will learn how to pluralize these nouns later, if [#allAh]{.trn2} wills.
...
+ The absentee plural masculine verb doer pronoun "they~3,m~" [و]{.ar} [U]{.trn} is written with a silent [Ealif]{.trn} after it which is written only and not pronounced. This [Ealif]{.trn} is dropped when a doee pronoun is attached. For example: 
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
Note, also, that because the base noun [ٱَلرَّجُلِ]{.ar} begins with a connecting [hamzah]{.trn} [ٱ]{.ar}, therefore the long vowel [A]{.trn} at the end of [بَيْتَا]{.ar} is pronounced as a short vowel [a]{.trn}, thus:
...
(Note that there is no silent [Ealif]{.trn} after [مُعَلِّمُو]{.ar} as there is after a verb with a plural absentee-participant doer pronoun, e.g. [لَعِبُوا]{.ar} "they~3,m~ played")
...
When [ٱَلْ]{.ar} is prefixed to these nouns to make them definite, they lose the initial connecting [hamzah]{.trn} and change their internal vowels. This table shows what we mean:
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-20-1.png)<!-- -->
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
