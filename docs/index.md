...
3. A negative particle like [لَا]{.ar}, [لَنْ]{.ar}, or [لَمْ]{.ar}.
   ...
   Note that the lightened [أَنْ]{.ar} has combined with [لَا]{.ar} to form [أَلَّا]{.ar}, similar to the manner that we learned for the a-state-verbal [أَنْ]{.ar} (for example: [أَلَّا يَذْهَبَ]{.ar} "that he not go") in chapter\ \@ref(chapter-a-state-incomplete-action-verbs). However, with lightened [أَنْ]{.ar}, the verb [يَذْهَبُ]{.ar} is in the u-state, not the a-state.
