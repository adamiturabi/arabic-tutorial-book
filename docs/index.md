...
Arabic has three short vowels, three long vowels, two semi-vowels, and a [0]{.txt}-mark. Each of these has an order of precedence and a hamzah seat, that we have shown in the table below:
...
|\vphantom{\huge J} [رَأَىٰ]{.tradar} [raEA]{.trn}        | [a]{.trn}  | [a]{.trn}  | [a]{.trn}  | [أ]{.tradar} |
