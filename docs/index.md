...
+ If the hamzah is after a long-[U]{.trn} vowel or an [aw]{.trn} semi-vowel, and the hamzah does not have an [i]{.trn}-mark, then it is written unseated. Examples:
  ...
  + \vphantom{\huge J} [سُوءَهُ]{.tradar} [sUEahu]{.trn}
  + \vphantom{\huge J} [سُوءَانِ]{.tradar} [sUEAni]{.trn}
  + \vphantom{\huge J} [ضَوْءَهُ]{.tradar} [DawEahu]{.trn}
  + \vphantom{\huge J} [ضَوْءَانِ]{.tradar} [DawEAni]{.trn}
  + \vphantom{\huge J} [سُوءُهُ]{.tradar} [sUEuhu]{.trn}
