...
[ٱلْحَافِظُ ٱلْمُؤَرِّخُ ٱلْمُفَسِّرُ عِمَادُ ٱلدِّينِ أَبُو ٱلْفِدَاءِ إِسْمَاعِيلُ بْنُ عُمَرَ بْنِ كَثِيرٍ ٱلْقُرَشِيُّ ٱلدِّمَشْقِيُّ ٱلشَّافِعِيُّ]{.ar}  
"The [#HAfiP]{.trn2}, the historian, the exegete, the Pillar of the Faith, the father of [al-#fidAE]{.trn2}, [#ismAEIl]{.trn2} the son of [#eumar]{.trn2} the son of [#kavIr]{.trn2}, the [#qurayc]{.trn2}ite, the Damascan, the [#cAfie]{.trn2}ite"  
...
<!--chapter:end:srcrmd/questions.Rmd-->
...
|\vphantom{\huge J} [مُتَّكِئَ]{.tradar} [muttakiEa]{.trn}  | [i]{.trn}  | [ئ]{.tradar} |
...
|\vphantom{\huge J} [مُرْجَءَات]{.tradar} [murjaEAt]{.trn}     | [a]{.trn}  | [A]{.trn} | [A]{.trn}   | [ء]{.tradar} |
...
|\vphantom{\huge J} [مُتَّكِئُونَ]{.tradar} [muttakiEUna]{.trn}  | [i]{.trn}  | [U]{.trn} | [i]{.trn}   | [ئ]{.tradar} |
...
+ \vphantom{\huge J} [مَسْؤُول]{.tradar}  [masEUl]{.trn} instead of [مَسْءُول]{.tradar}
+ \vphantom{\huge J} [رُؤُوس]{.tradar}   [ruEUs]{.trn}  instead of [رُءُوس]{.tradar}
+ \vphantom{\huge J} [ٱقْرَؤُوا]{.tradar} [iqraEU]{.trn} instead of [ٱقْرَءُوا]{.tradar}

Excepted from this variant is the combination [aEA]{.trn} which will continue to be written as [ـَءَا]{.tradar} or [ـَآ]{.tradar}. For example: [شَنَآن]{.tradar}, [مُرْجَءَات]{.tradar}.
