...
<p class="caption">(\#fig:unnamed-chunk-2)Timeline of the development of Standard Arabic.</p>
</div>
...
![](Learn-Standard-Arabic_files/figure-html/unnamed-chunk-22-1.png)<!-- -->
...
As we know, the heavyweight [أَنَّ]{.ar} is an emphatic particle and is frequently used with the pronoun of the fact, thus:
...
the heavyweight [أَنَّ]{.ar} along with its following pronoun of the fact ([أَنَّهُ]{.ar}/[أَنَّهَا]{.ar}) with
a lightweight [أَنْ]{.ar}, thus:

[أَعْلَمُ أَنِ ٱلْبَرْدُ شَدِيدٌ.]{.ar}  
"I know that the cold is intense."

Note that
the lightweight [أَنْ]{.ar} replaces 
[أَنَّهُ]{.ar},
which is the combination of
heavyweight [أَنَّ]{.ar} _and_ the pronoun of the fact [هُ]{.ar}.
So the pronoun of the fact ([هُ]{.ar}) does not appear with
the lightweight [أَنْ]{.ar}.

<!--
The combination of a heavyweight [أَنَّ]{.ar} with a following pronoun of the fact ([أَنَّهُ]{.ar}/[أَنَّهَا]{.ar}) may be replaced with
a lightweight [أَنْ]{.ar}. 
...
3. A negative particle like [لَا]{.ar}, [لَنْ]{.ar}, or [لَمْ]{.ar}.
   ...
   Note that the lightweight [أَنْ]{.ar} has combined with [لَا]{.ar} to form [أَلَّا]{.ar}, similar to the manner that we learned for the a-state-verbal [أَنْ]{.ar} (for example: [أَلَّا يَذْهَبَ]{.ar} "that he not go") in chapter\ \@ref(chapter-a-state-incomplete-action-verbs). However, with lightweight [أَنْ]{.ar}, the verb [يَذْهَبُ]{.ar} is in the u-state, not the a-state.
...
care must be taken to distinguish between this lightweight [أَنْ]{.ar} and the a-state-verbal [أَنْ]{.ar} 
(that we learned in chapter\ \@ref(chapter-a-state-incomplete-action-verbs)),
which is used with a-state verbs.
