...
+ [فَتَحَ بَابَيِ ٱلْبَيْتِ.]{.ar}  
  ...
  Note that a helper [i]{.trn} vowel is placed on the [ي]{.ar} in [بَابَيِ]{.ar} [bAbayi]{.trn} instead of the null-vowel mark because of the connecting [hamzah]{.trn} after it.
