...
+ With dual nouns and sound [Un]{.trn} plural nouns, when the last noun in the noun-chain is [ـِي]{.ar} [-I]{.trn} "my", the [ـِي]{.ar} [-I]{.trn} becomes a [يَ]{.ar} [ya]{.trn} when preceded by an unvowelled [ا]{.ar} [Ealif]{.trn}, [و]{.ar}, [wAw]{.trn}, or [ي]{.ar} [yAE]{.trn}. The [يَ]{.ar} gets doubled when preceded by an unvowelled [ي]{.ar}. Examples:
