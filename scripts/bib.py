...
def populate_resource_list():
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[صحيح البخاري]{.ar}, <https://sunnah.com/bukhari>"
    ))

  resource_list.append(BibResource(
    "muslim"
    , cit_text = "[صحيح مسلم]{.ar}"
    , bib_text = "[صحيح مسلم]{.ar}, <https://sunnah.com/muslim>"
    ))

  resource_list.append(BibResource(
    "nasai"
    , cit_text = "[سنن النسائي]{.ar}"
    , bib_text = "[سنن النسائي]{.ar}, <https://sunnah.com/nasai>"
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[سنن أبي داود]{.ar}, <https://sunnah.com/abudawud>"
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[جامع الترمذي]{.ar}, <https://sunnah.com/tirmidhi>"
    ))
 
  resource_list.append(BibResource(
    "ibnmajah"
    , cit_text = "[سنن ابن ماجه]{.ar}"
    , bib_text = "[سنن ابن ماجه]{.ar}, <https://sunnah.com/ibnmajah>"
    ))
 
  resource_list.append(BibResource(
    "malik"
    , cit_text = "[موطأ مالك]{.ar}"
    , bib_text = "[موطأ مالك]{.ar}, <https://sunnah.com/malik>"
    , sort_key = "موطا مالك"
    ))
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[مسند أحمد]{.ar}, <https://sunnah.com/ahmad>"
    , sort_key = "مسند احمد"
    ))
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[سنن الدارمي]{.ar}, <https://sunnah.com/darimi>"
    ))
 
  resource_list.append(BibResource(
    "nawawi40"
    , cit_text = "[الأربعون النووية]{.ar}"
    , bib_text = "[الأربعون النووية]{.ar}, <https://sunnah.com/nawawi40>"
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[رياض الصالحين]{.ar}, <https://sunnah.com/riyadussalihin>"
    ))
 
  resource_list.append(BibResource(
    "adab"
    , cit_text = "[الأدب المفرد]{.ar}"
    , bib_text = "[الأدب المفرد]{.ar}, <https://sunnah.com/adab>"
    , sort_key = "ادب المفرد"
    ))
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[الشمائل المحمدية]{.ar}, <https://sunnah.com/shamail>"
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[مشكاة المصابيح]{.ar}, <https://sunnah.com/mishkat>"
    ))
 
  resource_list.append(BibResource(
    "bulugh"
    , cit_text = "[بلوغ المرام]{.ar}"
    , bib_text = "[بلوغ المرام]{.ar}, <https://sunnah.com/bulugh>"
    ))
 
  resource_list.append(BibResource(
    "forty"
    , cit_text = "[الأربعينات]{.ar}"
    , bib_text = "[الأربعينات]{.ar}, <https://sunnah.com/forty>"
    , sort_key = "اربعينات"
    ))
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[حصن المسلم]{.ar}, <https://sunnah.com/hisn>"
    ))
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[البحر المحيط، تأليف: أبو حيان]{.ar}, <https://tafsir.app>"
    , sort_key = "بحر المحيط"
    ))
  ...
  resource_list.append(BibResource(
    ...
    , bib_text = "[تفسير التحرير والتنوير، تأليف: ابن عاشور]{.ar}, <https://tafsir.app>"
    ))
 
  resource_list.append(BibResource(
    "tabari"
    , cit_text = "[تفسير الطبري]{.ar}"
    , bib_text = "[تفسير الطبري]{.ar}, <https://tafsir.app>"
    ))
 
  resource_list.append(BibResource(
    "ibn-katheer"
    , cit_text = "[تفسير ابن كثير]{.ar}"
    , bib_text = "[تفسير ابن كثير]{.ar}, <https://tafsir.app>"
    ))
 
  resource_list.append(BibResource(
    "ibn-alqayyim"
    , cit_text = "[تفسير ابن القيم]{.ar}"
    , bib_text = "[تفسير ابن القيم]{.ar}, <https://tafsir.app>"
    ))
 
  resource_list.append(BibResource(
    "ibn-taymiyyah"
    , cit_text = "[تفسير ابن تيمية]{.ar}"
    , bib_text = "[تفسير ابن تيمية]{.ar}, <https://tafsir.app>"
    ))
 
  resource_list.append(BibResource(
    "ibn-uthaymeen"
    , cit_text = "[تفسير ابن عثيمين]{.ar}"
    , bib_text = "[تفسير ابن عثيمين]{.ar}, <https://tafsir.app>"
    ))
 
  resource_list.append(BibResource(
    "qurtubi"
    , cit_text = "[تفسير القرطبي]{.ar}"
    , bib_text = "[تفسير القرطبي]{.ar}, <https://tafsir.app>"
    ))
