...
map_table["badal"] = "re-render" # replacement, substitute, sub, rehash, restate, reword, do-over, re-word, re-render
map_table["mubdalb"] = "pre-render" # replacee, substitutee, done-over
