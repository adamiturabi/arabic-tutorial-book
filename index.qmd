...
* Unless otherwise indicated, translations from the [#qurEAn]{.trn2} are by [#SaH]{.trn2}ee[H]{.trn2} International™, sourced from <https://quran.com>.
* Unless otherwise indicated, the numbering of [#HadIv]{.trn2} is that used by <https://sunnah.com>.
