...
We have also used some grammatical terminology from Arabic directly, usually in cases where our target learner may have already been exposed to them from learning the recitation of the [#qurEAn]{.trn2}, or where the term is complex enough that creating a term specifically in English wouldn't make it any simpler.
