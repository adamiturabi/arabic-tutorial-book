...
The primary texts of [_islAm]{.trn2} (the [_qurEAn]{.trn2} and the [_HadIv]{.trn2}) are in Arabic.
...
We hope that this will, if [_allAh]{.trn2} wills, make them feel more connected to the primary texts and their teachings.
Furthermore, they can be empowered to study the vast body of Arabic [_islAm]{.trn2}ic literature.
...
We have also aimed to make this a self-instruction textbook so that a diligent student should, if [_allAh]{.trn2} wills, be able to study it independently.
...
We have also used some grammatical terminology from Arabic directly, usually in cases where our target learner may have already been exposed to them from [_qurEAn]{.trn2} recitation rules, or where the term is complex enough that creating a term specifically in English wouldn't make it any simpler.
...
"[_ealI]{.trn2} and [_usAmah]{.trn2} revised [_sUrat al-#eankabUt]{.trn2} from the [_qurEAn]{.trn2} in the mosque in the month of [_rabIe al-#vAnI]{.trn2}."
