...
* Translation is enclosed in  _guillemets_ ([]{.trans}). For example:

  [جَاءَ زَيْدٌ]{.ar}  
  [Zayd came.]{.trans}

* Transcription is in _italics_. For example:

  [جَاءَ زَيْدٌ]{.ar}  
  [jAEa zaydun]{.trn}

* Word-initial [sukUn]{.trn2} and connecting-hamzah are transcripted using a hyphen. For example:

  [زَيْدُ بْنُ عَمْرٍو]{.ar}  
  [zaydu -bnu eamrin]{.trn}

* Names in the translation are not italicized. For example:

  [زَيْدُ بْنُ عَمْرٍو]{.ar}  
  [[#zayd ibn #eamr]{.trn2}]{.trans}
...
* The page numbers for citations may vary across different editions and publishers. We have attempted to specify the edition that we are using in the [references](#chap-references).
