...
We use [آخَرُ]{.ar} [EAxaru]{.trn} just like any other descriptive noun and we will give some examples below.
...
With non-rational nouns, just like other descriptive nouns, the feminine singular is usually used. Example:
...
However, if there is no other indication of plurality then the feminine broken plural [أُخَرُ]{.ar} [Euxaru]{.trn} is commonly used. For example:
