...
Here you can see that non-rational beings, when mentioned, use the feminine singular.
...
[هَـٰؤُلَاءِ هُمُ ٱلْأَطْوَلُونَ وَأُولَـٰئِكَ هُمُ ٱلأَقَاصِرُ.]{.ar}  
[hAEulAEi humu -lEaTwalUna waEulAEika humu -lEaqASiru.]{.trn}  
"These are the tallest [men] and those are the shortest [men]."  
The masculine plurals are used only for plural male rational beings. Here it is implied that they are men.

[قَسَمْتُ ٱلْأَقْلَامَ. هَـٰؤُلَاءِ هُنَّ ٱلطُّولَيَاتُ وَأُولَـٰئِكَ هُنَّ ٱلقُصَرُ.]{.ar}  
[qasamtu -lEaqlAma. hAEulAEi hunna -TTUlayAtu waEulAEika hunna -lquSaru.]{.trn}  
"I divided the pens. These are the tallest and those are the shortest."  
Consistent with what we have learned so far, the feminine plural can be used for non-rational beings (whether masculine or feminine), especially when they are not mentioned in the sentence.
