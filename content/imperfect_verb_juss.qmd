...
We have already studied the u-state of [mudarie]{.term} verbs in 
chapter\ \@ref(u-state-[mudarie]{.term}-verbs).
And we will defer the study of 
a-state of [mudarie]{.term} verbs to
chapter\ \@ref(a-state-[mudarie]{.term}-verbs).
...
## Forming the 0-state [mudarie]{.term} verb
...
|Participant|[_mudarie]{.term} verb [fail]{.term} pronoun|u-state [mudarie]{.term} verb | 0-state [mudarie]{.term} verb|
|:---|:--|:---|:---|
...
<!--
## Uses of the 0-state [mudarie]{.term} verb

The u-state is the default state for [mudarie]{.term} verbs. The 
0-state
...
<!--
FIXME: Use with the addressee is exceedingly rare. Rather the verb of command should be used (below). See [كتاب شرح المفصل لابن يعيش]{.ar} vol 4 p. 691. Add (perhaps in passive verbs chapter), how [لام الأمر]{.ar} can be used with passive verbs for all three deputy [fail]{.term}s, including addressee, and is infact the only way to command the deputy [fail]{.term}.
...
that [لَا]{.ar} can be used to negate a u-state [mudarie]{.term} verb for the present and future tense.
Example:
...
section\ \@ref(negating-[madi]{.term}-verbs) that the [madi]{.term} verb is negated using the particle [مَا]{.ar}. For example:
...
## Other uses of the 0-state [mudarie]{.term} verb

The 0-state [mudarie]{.term} verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
...
for the singular masculine addressee [fail]{.term} "he":
