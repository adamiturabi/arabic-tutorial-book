...
We have already studied the u-state of [mudarie]{.subs} verbs in 
chapter\ \@ref(u-state-[mudarie]{.subs}-verbs).
And we will defer the study of 
a-state of [mudarie]{.subs} verbs to
chapter\ \@ref(a-state-[mudarie]{.subs}-verbs).
...
## Forming the 0-state [mudarie]{.subs} verb
...
|Participant|[_mudarie]{.subs} verb [fail]{.subs} pronoun|u-state [mudarie]{.subs} verb | 0-state [mudarie]{.subs} verb|
|:---|:--|:---|:---|
...
<!--
## Uses of the 0-state [mudarie]{.subs} verb

The u-state is the default state for [mudarie]{.subs} verbs. The 
0-state
...
that [لَا]{.ar} can be used to negate a u-state [mudarie]{.subs} verb for the present and future tense.
Example:
...
## Other uses of the 0-state [mudarie]{.subs} verb

The 0-state [mudarie]{.subs} verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
