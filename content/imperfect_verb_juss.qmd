...
|Participant|[_mudarie]{.subs} verb [fail]{.subs} pronoun|[ustate]{.subs} [mudarie]{.subs} verb | [0state]{.subs} [mudarie]{.subs} verb|
|:---|:--|:---|:---|
...
<!--
FIXME: Use with the addressee is exceedingly rare. Rather the verb of command should be used (below). See [كتاب شرح المفصل لابن يعيش]{.ar} vol 4 p. 691. Add (perhaps in passive verbs chapter), how [لام الأمر]{.ar} can be used with passive verbs for all three [naib]{.subs} [fail]{.subs}s, including addressee, and is infact the only way to command the [naib]{.subs} [fail]{.subs}.
...
for the singular masculine addressee [fail]{.subs} "he":
