...
The dual is formed by appending the dual suffix [◌َانِ]{.ar} [-Ani]{.trn} when the noun is in the [ustate]{.subs} and [◌َيْنِ]{.ar} [-ayni]{.trn} when the noun is in the [astate]{.subs} or [istate]{.subs}. Definite nouns, which have [ٱَلْ]{.ar} in their beginning are dualized the same way. 

For example, when we dualize [بَيْت]{.ar} [bayt]{.trn} "a house" in order to say "houses~2~", we get:

| States | Indefinite | Definite
|:----|:-------|:-------
|[ustate]{.subs}         | [بَيْتَانِ]{.ar} [baytAni]{.trn}  | [ٱَلْبَيْتَانِ]{.ar} [EalbaytAni]{.trn}
|[astate]{.subs} and [istate]{.subs} | [بَيْتَيْنِ]{.ar} [baytayni]{.trn} | [ٱَلْبَيْتَيْنِ]{.ar} [Ealbaytayni]{.trn}   

Note that indefinite duals are not [tanwin]{.subs}ed. The only difference between definite and indefinite duals is the definite article [ٱَلْ]{.ar} "the". 
...
| States | Indefinite | Definite
:----|:-------|:-------
[ustate]{.subs}         | [شَجَرَتَانِ]{.ar} [cajaratAni]{.trn} | [ٱَلشَّجَرَتَانِ]{.ar} [EaccajaratAni]{.trn}
[astate]{.subs} and [istate]{.subs} | [شَجَرَتَيْنِ]{.ar} [cajaratayni]{.trn}| [ٱَلشَّجَرَتَيْنِ]{.ar} [Eaccajaratayni]{.trn}
...
+ [ustate]{.subs}: [أُمَّانِ]{.ar} [EummAni]{.trn}
+ [astate]{.subs} and [istate]{.subs}: [أُمَّيْنِ]{.ar} [Eummayni]{.trn}
...
|Root|Singular| Dual ([ustate]{.subs}) |Dual ([astate]{.subs} and [istate]{.subs})|
|:-|:-----|:--|:--|
...
The word [خِبَاء]{.ar} [xibAE]{.trn} "a tent" is from the root [خبء]{.ar} and is on the pattern [فِعَال]{.ar}. Its duals are [خِبَاءَانِ]{.ar} ([ustate]{.subs}), and [خِبَاءَيْنِ]{.ar} ([astate]{.subs} and [istate]{.subs}) "tents~2~".
...
## Dual [naat]{.subs}s and [manut]{.subs}s in descriptive noun-phrases

We learned that when an [sifah]{.subs} is a [naat]{.subs} in an descriptive noun-phrase, then it matches the [manut]{.subs} in definiteness, state, and gender.  For example:

[ذَهَبْتُ إِلَى ٱلْمَدِينَةِ ٱلْقَدِيمَةِ.]{.ar}  
[pahabtu Eila -lmadInati -lqadImah.]{.trn}  
"I went to the old city."

To this we add that the [naat]{.subs} shall also match the [manut]{.subs} in number. So if the [manut]{.subs} is a dual then the [sifah]{.subs} [naat]{.subs} shall be dualzed to match it. Examples:
...
<!--Just like common nouns, [sifah]{.subs}s are also dualized. When a [sifah]{.subs} is used to describe a dual noun, the [sifah]{.subs} will also be dual. Examples:
...
## Duals in [mubtada]{.subs}-[xabar]{.subs} sentences

In [mubtada]{.subs}-[xabar]{.subs} sentences, if the [mubtada]{.subs} is a dual, and the [xabar]{.subs} is a [sifah]{.subs}, then the [xabar]{.subs} will typically match the [mubtada]{.subs} in being a dual. For example:
...
<!--Note that both [ٱَلْمَرْأَتَانِ]{.ar} [EalmarEatAni]{.trn} "the two women" and [أُمَّانِ]{.ar}  [EummAni]{.trn}  "two mothers" are in the [ustate]{.subs} because, just like for sentences with singulars, the [mubtada]{.subs} and [xabar]{.subs} are put in the [ustate]{.subs}.-->

Such is usually also the case even when the [xabar]{.subs} is a common noun, not an [sifah]{.subs}. For example,

[ٱَلرَّجُلَانِ مُعَلِّمَانِ.]{.ar}  
[EarrujulAni mueallimAn.]{.trn}  
"The men~2~ are teachers~m,2~."

Sometimes, however, the [mubtada]{.subs} and [xabar]{.subs} may not match in number because of the meaning of the sentence. For example,
...
In the above example, the [xabar]{.subs} does not match the [mubtada]{.subs} in both number, and, as it happens, in gender.
...
In the last example, the feminine [sifah]{.subs} [قَرِبَتَانِ]{.ar} [qarIbatAni]{.trn} is used because it is referring to the feminine noun [ٱَلْجَارِيَتَيْنِ]{.ar} [EaljAriyatayni]{.trn} "the girls~2~".
...
### Attached pronouns for the [mafulb]{.subs}

The dual attached pronouns that we have just learned are also for the [mafulb]{.subs}
...
We learned that the [madi]{.subs} verb for a masculine doer is on the pattern [فَعَلَ]{.ar}. And when the doer is feminine, the [ت]{.ar} of femininity is attached to the verb thus: [فَعَلَتْ]{.ar}. We have used these verbs with singular doer nouns. The doer noun always comes after the verb and shall be in the [ustate]{.subs}. Examples:
...
The above verbal sentence can be rearranged to be a [mubtada]{.subs}-[xabar]{.subs} sentence. This gives more emphasis to the [mubtada]{.subs}. In this case, the verb shall follow the [mubtada]{.subs} and will need a doer pronoun after it.
...
The above verbal sentence can be rearranged to be a [mubtada]{.subs}-[xabar]{.subs} sentence. In that case, all the verbs shall have doer pronouns. The sentence will have the same translation as above, except for an emphasis on the [mubtada]{.subs} of the sentence.
