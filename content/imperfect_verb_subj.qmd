...
# a-state [mudarie]{.subs} verbs

## Introduction

In 
chapter\ \@ref(u-state-[mudarie]{.subs}-verbs)
...
We introduced the u-state [mudarie]{.subs} verb in
chapter\ \@ref(u-state-[mudarie]{.subs}-verbs).
In this chapter we will study the 
a-state
[mudarie]{.subs} verb.

The u-state [mudarie]{.subs} verb makes a plain statement.
The a-state [mudarie]{.subs} verb implies a wish or purpose.
The a-state [mudarie]{.subs} verb is used after the following articles:
...
## Forming the a-state [mudarie]{.subs} verb

Here is the u-state [mudarie]{.subs} verb for the singular masculine absentee participant [fail]{.subs} "he":

[يَفْعَلُ]{.ar}  
[yafealu]{.trn}  
"he does"

Note that, because it is in the u-state, the its final letter ends with a [umark]{.subs} [◌ُ]{.ar}.
...
This is done for all participants whose [fail]{.subs} pronoun is invisible and u-state verb ends with a [umark]{.subs} [◌ُ]{.ar}.

For participants whose [fail]{.subs} pronoun is followed by an extra [ن]{.ar} in the u-state verb, this final [ن]{.ar} is dropped in order to form the 
a-state
[mudarie]{.subs} verb.
...
|Participant|[_mudarie]{.subs} verb [fail]{.subs} pronoun|u-state [mudarie]{.subs} verb | a-state [mudarie]{.subs} verb|
|:---|:--|:---|:---|
...
+ The a-state verbs for the masculine plural absentee and addressee participants have a final silent [alif]{.trn2}: 
...
[mudarie]{.subs} verb to be in the a-state.
...
### Basic usage of [أَنْ]{.ar} [Ean]{.trn} with the a-state [mudarie]{.subs} verb
...
[لَا]{.ar} can be used to negate the following a-state [mudarie]{.subs} verb.
...
[أَنْ]{.ar} must directly precede the following a-state [mudarie]{.subs} verb and must not be separated from it.
...
In the i-state as the [mudafil]{.subs} in an [idafa]{.subs}:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below] {\scriptsize i-state [mudafil]{.subs}};
...
<!--
By the way, this [لِ]{.ar}, which is used with a-state [mudarie]{.subs} verbs, is different from 
the [لِ]{.ar} we learned in section\ \@ref(indirect-commands), which is used with the 0-state [mudarie]{.subs} verbs for indirect commands.
-->

By the way, the grammatical equivalence of [أَنْ]{.ar} and a following a-state [mudarie]{.subs} verb with a [masdar]{.subs} applies also to when [لِ]{.ar} is used before (either an expressed or an implied) [أَنْ]{.ar}. So, for example, if we have a sentence:
...
There is a specific [لِ]{.ar}, called the [لِ]{.ar} of denial,  which is used with a-state [mudarie]{.subs} verbs and the verb [كَانَ]{.ar} that we will discuss in section (TODO in [كَانَ]{.ar} chapter).
...
It is also used before the a-state [mudarie]{.subs} verb.
The difference from [لِ]{.ar} is that, when [لِ]{.ar} is used with the a-state [mudarie]{.subs} verb, expressing or dropping the [أَنْ]{.ar} was optional.
...
By the way, 
[كَيْ]{.ar} and a following a-state [mudarie]{.subs} verb are not _directly_ replaced by
a [masdar]{.subs}.
...
[رَأْس]{.ar},
here, is in the a-state because it is a [mafulb]{.subs} of the verb [أَكَلَ]{.ar} "ate".
The particle
[حَتَّىٰ]{.ar} "even",
...
Now
[رَأْس]{.ar}
is in the u-state because it is actually the [mubtada]{.subs} of a new sentence, whose [xabar]{.subs} is (an either expressed or implied) [أَكَلْتُهَا]{.ar} "I ate it".
[حَتَّىٰ]{.ar},
...
#### [حَتَّىٰ]{.ar} with a following a-state [mudarie]{.subs} verb

When
[حَتَّىٰ]{.ar}
is used with an expectation or purpose of a future action of the verb following it, then 
the verb following it is an a-state [mudarie]{.subs} verb. 
<!--
When the verb following
[حَتَّىٰ]{.ar}
signifies the expectation or purpose of a future action, then the verb used is an a-state [mudarie]{.subs} verb. 
-->
...
1. When [حَتَّىٰ]{.ar} is used to indicate an extreme point at which the action of the following verb would occur, or is meant to occur. Here, 
   ...
   Also, similar to the case of [كَيْ]{.ar}, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following [mudarie]{.subs} verb being in the a-state.
   In fact, 
   [حَتَّىٰ]{.ar},
...
2. When [حَتَّىٰ]{.ar} is used with the meaning "to such a purpose that". This is a similar meaning to [كَيْ]{.ar} "in order that".
   ...
   Again, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following [mudarie]{.subs} verb being in the a-state.
...
When used with a following [mudarie]{.subs} verb, the verb is put in the u-state and the meaning is that the action of the verb _before_
[حَتَّىٰ]{.ar}
...
Compare these examples with the corresponding ones in the previous sub-section that have an a-state [mudarie]{.subs} verb.


<!--The preposition 
[حَتَّىٰ]{.ar} [HattA]{.trn}
is unusual in that the [mudarie]{.subs} verb following it may either be in the a-state or the u-state, with slightly different meanings.
When the [mudarie]{.subs} verb following it is in the u-state then
[حَتَّىٰ]{.ar} gives the meaning "until".
And when the [mudarie]{.subs} verb following it is in the a-state then
...
[لَا]{.ar} and [أَنْ]{.ar} are combined to form [لَنْ]{.ar} [lan]{.trn} with the meaning "shall not". [لَنْ]{.ar} is used with the a-state [mudarie]{.subs} verb to emphatically negate the future.
...
occur after an a-state [mudarie]{.subs} verb, then 
a second a-state [mudarie]{.subs} verb
...
[وَ]{.ar}, [فَ]{.ar}, [أَوْ]{.ar}, and [ثُمَّ]{.ar} also cause the following [mudarie]{.subs} verb to be in the a-state in their own right, not simply as connectors. This is discussed in more detail in chapter TODO.
