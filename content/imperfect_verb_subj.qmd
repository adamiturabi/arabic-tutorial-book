...
# a-state [mudarie]{.term} verbs

## Introduction

In 
chapter\ \@ref(u-state-[mudarie]{.term}-verbs)
we mentioned that [mudarie]{.term} verbs have three states (like nouns). 
...
We introduced the u-state [mudarie]{.term} verb in
chapter\ \@ref(u-state-[mudarie]{.term}-verbs).
In this chapter we will study the 
a-state
[mudarie]{.term} verb.

The u-state [mudarie]{.term} verb makes a plain statement.
The a-state [mudarie]{.term} verb implies a wish or purpose.
The a-state [mudarie]{.term} verb is used after the following articles:
...
## Forming the a-state [mudarie]{.term} verb

Here is the u-state [mudarie]{.term} verb for the singular masculine absentee participant [fail]{.term} "he":
...
This is done for all participants whose [fail]{.term} pronoun is invisible and u-state verb ends with a [u]{.trn}-mark [◌ُ]{.ar}.

For participants whose [fail]{.term} pronoun is followed by an extra [ن]{.ar} in the u-state verb, this final [ن]{.ar} is dropped in order to form the 
a-state
[mudarie]{.term} verb.
...
a-state
[mudarie]{.term} verb
for all [fail]{.term} participants.

|Participant|[_mudarie]{.term} verb [fail]{.term} pronoun|u-state [mudarie]{.term} verb | a-state [mudarie]{.term} verb|
|:---|:--|:---|:---|
...
[mudarie]{.term} verb to be in the a-state.
...
### Basic usage of [أَنْ]{.ar} [Ean]{.trn} with the a-state [mudarie]{.term} verb
...
[لَا]{.ar} can be used to negate the following a-state [mudarie]{.term} verb.
...
[أَنْ]{.ar} must directly precede the following a-state [mudarie]{.term} verb and must not be separated from it.

### Grammatical equivalence of [أَنْ]{.ar} clause with a [masdar]{.term}

In grammatical theory,
[أَنْ]{.ar} 
and the following verb form a clause that is equivalent in meaning to the [masdar]{.term} of the verb. So in the example,
[أَمَلَ ٱلطَّالِبُ أَنْ يَنْجَحَ.]{.ar}, the 
[أَنْ]{.ar} clause is
[أَنْ يَنْجَحَ]{.ar}.
It is equivalent to the [masdar]{.term} [ٱلنَّجَاح]{.ar}.
...
[أَنْ]{.ar} clause
is in place of the [mafulb]{.term} of the verb [أَمَلَ]{.ar}:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, below] {\scriptsize [mafulb]{.term}};
...
In the i-state as the [mudafil]{.term} in an [idafa]{.term}:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below] {\scriptsize i-state [mudafil]{.term}};
...
In the above example the verb [رَغِبَ يَرْغَبُ]{.ar} takes an [indir_mafulb]{.term} after the preposition [فِي]{.ar}.
...
### [أَنْ]{.ar} with the [madi]{.term} verb

[أَنْ]{.ar} may also occur before a [madi]{.term} verb. Example:
...
The [أَنْ]{.ar} we have learned here is called the _[masdar]{.term}i [أَنْ]{.ar}_ because of the equivalence of its clause with a [masdar]{.term}.
...
<!--
By the way, this [لِ]{.ar}, which is used with a-state [mudarie]{.term} verbs, is different from 
the [لِ]{.ar} we learned in section\ \@ref(indirect-commands), which is used with the 0-state [mudarie]{.term} verbs for indirect commands.
-->

By the way, the grammatical equivalence of [أَنْ]{.ar} and a following a-state [mudarie]{.term} verb with a [masdar]{.term} applies also to when [لِ]{.ar} is used before (either an expressed or an implied) [أَنْ]{.ar}. So, for example, if we have a sentence:
...
Then, grammatically, [أَنْ]{.ar} and what follows it may be expressed with the [masdar]{.term} [عِلْم]{.ar} thus:
...
There is a specific [لِ]{.ar}, called the [لِ]{.ar} of denial,  which is used with a-state [mudarie]{.term} verbs and the verb [كَانَ]{.ar} that we will discuss in section (TODO in [كَانَ]{.ar} chapter).
...
It is also used before the a-state [mudarie]{.term} verb.
The difference from [لِ]{.ar} is that, when [لِ]{.ar} is used with the a-state [mudarie]{.term} verb, expressing or dropping the [أَنْ]{.ar} was optional.
...
By the way, 
[كَيْ]{.ar} and a following a-state [mudarie]{.term} verb are not _directly_ replaced by
a [masdar]{.term}.
...
Then [لِ]{.ar} is to be used in place of [كَيْ]{.ar} if we wish to replace it and what follows with the [masdar]{.term} [عِلْم]{.ar} thus:
...
[رَأْس]{.ar},
here, is in the a-state because it is a [mafulb]{.term} of the verb [أَكَلَ]{.ar} "ate".
The particle
[حَتَّىٰ]{.ar} "even",
here, is only a connector between the [mafulb]{.term}s in much the same way as [وَ]{.ar} "and". 
...
#### [حَتَّىٰ]{.ar} with a following a-state [mudarie]{.term} verb

When
[حَتَّىٰ]{.ar}
is used with an expectation or purpose of a future action of the verb following it, then 
the verb following it is an a-state [mudarie]{.term} verb. 
<!--
When the verb following
[حَتَّىٰ]{.ar}
signifies the expectation or purpose of a future action, then the verb used is an a-state [mudarie]{.term} verb. 
-->
...
1. When [حَتَّىٰ]{.ar} is used to indicate an extreme point at which the action of the following verb would occur, or is meant to occur. Here, 
   ...
   Also, similar to the case of [كَيْ]{.ar}, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following [mudarie]{.term} verb being in the a-state.
   In fact, 
   [حَتَّىٰ]{.ar},
...
2. When [حَتَّىٰ]{.ar} is used with the meaning "to such a purpose that". This is a similar meaning to [كَيْ]{.ar} "in order that".
   ...
   Again, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following [mudarie]{.term} verb being in the a-state.
...
[حَتَّىٰ]{.ar}
in this case
may even be a [madi]{.term} verb. For example:

[أَكَلْتُ ٱلطَّعَامَ حَتَّىٰ شَبِعْتُ.]{.ar}  
"I ate the food until I became full."

When used with a following [mudarie]{.term} verb, the verb is put in the u-state and the meaning is that the action of the verb _before_
[حَتَّىٰ]{.ar}
...
Compare these examples with the corresponding ones in the previous sub-section that have an a-state [mudarie]{.term} verb.


<!--The preposition 
[حَتَّىٰ]{.ar} [HattA]{.trn}
is unusual in that the [mudarie]{.term} verb following it may either be in the a-state or the u-state, with slightly different meanings.
When the [mudarie]{.term} verb following it is in the u-state then
[حَتَّىٰ]{.ar} gives the meaning "until".
And when the [mudarie]{.term} verb following it is in the a-state then
...
[حَتَّىٰ]{.ar} 
is also used with [madi]{.term} verbs. Example:

[أَكَلَ حَتَّىٰ شَبِعَ.]{.ar} ([madi]{.term}, no [أَنْ]{.ar})  
"He ate until he was sated."
-->

## After [لَنْ]{.ar} [lan]{.trn}

[لَا]{.ar} and [أَنْ]{.ar} are combined to form [لَنْ]{.ar} [lan]{.trn} with the meaning "shall not". [لَنْ]{.ar} is used with the a-state [mudarie]{.term} verb to emphatically negate the future.
...
occur after an a-state [mudarie]{.term} verb, then 
a second a-state [mudarie]{.term} verb
...
[وَ]{.ar}, [فَ]{.ar}, [أَوْ]{.ar}, and [ثُمَّ]{.ar} also cause the following [mudarie]{.term} verb to be in the a-state in their own right, not simply as connectors. This is discussed in more detail in chapter TODO.
