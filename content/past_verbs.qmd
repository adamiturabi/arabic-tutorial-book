...
For this we will have to learn a third category of pronoun pronouns called _doer pronouns_ for [madi]{.term} verbs.
...
It is only the doer pronouns for the singular absentee participant that are implied for [madi]{.term} verbs. The doer pronouns for the singular addressee and speaker participants are expressed.
The expressed doer pronouns are attached to the verb.

Here we show how the expressed doer pronouns are attached to the verb using the root paradigm [فعل]{.ar}. The middle root letter ([ع]{.ar}) has an [a]{.trn}-vowel [◌َ]{.ar} here but this vowel will vary for other verbs.
...
Note also how the expressed singular doer pronouns modify the verb by replacing the [a]{.trn}-mark [◌َ]{.ar} on its final letter by a 0-mark [◌ْ]{.ar}.
...
Here [ٱَلرَّجُلُ]{.ar} [arrajulu]{.trn} "the man" is the subject of the sentence, and [كَتَبَ كِتَابًا]{.ar} [kataba kitAban]{.trn} "he wrote a book", itself a verbal sentence with an implied doer pronoun, is the information about the subject. So the translation of the sentence is technically:
...
So now, when the [mafulb]{.term} noun [ٱلْكِتَابَ]{.ar} [EalkitAba]{.trn} "the book" is replaced with the pronoun "it", the doee pronoun must be attached to the verb, and then the doer noun follows the doee pronoun:
...
Now, consider a sentence with an [indir_mafulb]{.term}. Again, the normal order of words in a sentence is verb, doer noun, preposition, doee noun. For example,
