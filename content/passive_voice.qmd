...
Note that the noun [ٱَلْمَاءُ]{.ar} [EalmAEu]{.trn} "the water" is in the [ustate]{.subs}. This is because, in the absence of the doer, the [mafulb]{.subs} of the known-doer verb ([ٱَلْمَاءَ]{.ar}) is deputized to take doer's place in the [ustate]{.subs}. It is then known as the _[naib]{.subs} doer_.
