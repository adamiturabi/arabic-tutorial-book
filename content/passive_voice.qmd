...
Note that the noun [ٱَلْمَاءُ]{.ar} [EalmAEu]{.trn} "the water" is in the u-state. This is because, in the absence of the doer, the [mafulb]{.subs} of the known-doer verb ([ٱَلْمَاءَ]{.ar}) is deputized to take doer's place in the u-state. It is then known as the _[naib]{.subs} doer_.
...
When such verbs are converted to the [passive]{.subs} verb construction, then one, and only one, [mafulb]{.subs} shall be chosen to be the [naib]{.subs} doer. It is generally preferred to make the first [mafulb]{.subs} the [naib]{.subs}-doer, and leave the second [mafulb]{.subs}, as is, in the a-state.
...
However, the preposition causes the noun following it to remain in the i-state. So the [naib]{.subs} doer is not indicated by an apparent [umark]{.subs} (or by the other indicators of the u-state).
...
When this sentence is converted to an [passive]{.subs} construction then the adverb of time or place can be taken as the [naib]{.subs} doer in the u-state:

[سُهِرَتْ لَيلَةُ ٱلْقَدْرِ.]{.ar}  
"The Night of Power was stayed up [in]."

Note the u-state of [لَيْلَةُ]{.ar} [laylatu]{.trn} as the [naib]{.subs} doer.
...
When such sentences are converted to the [passive]{.subs} verb construction, then the [masdar]{.subs} may be taken as the [naib]{.subs} doer in the u-state.
...
In the above sentence the prepositional phrase [فِي ٱلْمَسْجِدِ]{.ar} was chosen as the [naib]{.subs} doer, and the adverb of time [لَيْلَةَ]{.ar} remains, as is, in the a-state.
