...
And the passive caseful verb has the same three cases as the active caseful verb.
For example:

+ [فُعِلُوا]{.ar} [fueilU]{.trn} "they~3m~" (caseless)
+ [تُفْعَلَانِ]{.ar} [tufealAni]{.trn} "you~2~" or "they~2f~" (u-case caseful)
+ [أُفْعَلَ]{.ar} [Eufeala]{.trn} "I" (a-case caseful)
+ etc.
...
## Cases of the passive caseful verb

The 
passive caseful verb
