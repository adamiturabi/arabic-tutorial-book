...
Note how the noun [بَيْتٍ]{.ar} [baytin]{.trn} "a house" is in the i-state because of the preposition [فِي]{.ar} [fI]{.trn} "in" before it. The i-state is indicated by the [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar} on the final letter of [بَيْت]{.ar}.

Arabic has two types of prepositions: _true_ prepositions and _pseudo_-prepositions.

## True prepositions

True prepositions are _particles_. Particles are a class of words, like nouns and verbs. Particles don't have the properties of nouns. Thus, they cannot be definite or indefinite. They cannot be preceded by [ٱَلْ]{.ar} [al]{.trn} nor may they be [tanwin]{.subs}ed. And they don't have state (u-state, a-state, i-state). 
