...
In Arabic prepositions, when placed before a noun, put it in the i-case. For example the preposition [فِي]{.ar} [fI]{.trn} means "in". We can put it before the noun [بَيْت]{.ar} [bayt]{.trn} "a house":

[فِي بَيْتٍ]{.ar}  
[fI baytin]{.trn}  
"in a house"

Note how the noun [بَيْتٍ]{.ar} [baytin]{.trn} "a house" is in the i-case because of the preposition [فِي]{.ar} [fI]{.trn} "in" before it. The i-case is indicated by the [tanwIn]{.trn2}ed [kasrah]{.trn2} [◌ٍ]{.ar} on the final letter of [بَيْت]{.ar}.

Arabic has two types of prepositions: _true_ prepositions and _pseudo_-prepositions.

## True prepositions

True prepositions are _particles_. Particles are a class of words, like nouns and verbs. Particles don't have the properties of nouns. Thus, they cannot be definite or indefinite. They cannot be preceded by [ٱَلْ]{.ar} [al]{.trn} nor may they be [tanwIn]{.trn2}ed. And they don't have case (u-case, a-case, i-case). 
...
+ When a single letter preposition comes before a definite noun with [ٱَلْ]{.ar} [al]{.trn}, the preposition is generally joined to the [alif]{.trn2} in the [ٱَلْ]{.ar} [al]{.trn}. The [alif]{.trn2} is now not pronounced (because as we know it has a connecting [hamzah]{.trn2}). Example:
  ...
  If the noun begins with a connecting [hamzah]{.trn2} then the [ل]{.ar} in [ٱَلْ]{.ar} gets an [kasrah]{.trn2} [◌ِ]{.ar} instead of its usual [sukUn]{.trn2} [◌ْ]{.ar}. We described this in 
...
+ If a preposition ends with a [sukUn]{.trn2} [◌ْ ]{.ar} and it is followed by a word that begins with a connecting [hamzah]{.trn2}, then the [sukUn]{.trn2} is changed to a short vowel according to the following rules:

  + The ending of the preposition [عَنْ]{.ar} [ean]{.trn} gets an [kasrah]{.trn2} and becomes [عَنِ]{.ar} [eani]{.trn}. Examples:
  ...
  + The ending of the preposition [مِنْ]{.ar} [min]{.trn} gets an [fatHah]{.trn2} if followed by the [ٱَلْ]{.ar} [al]{.trn} of a definite noun. Otherwise it gets an [kasrah]{.trn2} if followed by any other connecting [hamzah]{.trn2}. Examples:
...
Detached pronouns are the equivalent of "he", "she", and "I", etc. They are used in place of nouns that are in the u-case.

Now we will learn about _attached pronouns_. Attached pronouns are, more or less, the equivalent of "him", "her", and "me", etc.
They are used in place of nouns that are in the a-case and the i-case. One place where attached pronouns are used is when the replace the noun directly following a preposition.
...
4. The attached pronoun for the speaker deserves special attention.  The pronoun itself is the letter [ي]{.ar}. But it has two variants:
   ...
   Generally, both of these variants cause the final letter of the word before them, if a consonant, to have an [kasrah]{.trn2} [◌ِ]{.ar}, regardless of the whether or not that letter originally had an [kasrah]{.trn2}. Examples:
...
3. For any word that ends with a long vowel ([-A]{.trn}, [-I]{.trn}, or [-U]{.trn}) or a semi-vowel ([-ay]{.trn} or [-aw]{.trn}), the variant [◌ِي]{.ar} [-I]{.trn} for the speaker attached pronoun is not used. Instead, only the variant [يَ]{.ar} [-ya]{.trn} may be used with such words. 
   ...
   In addition, the pronoun [يَ]{.ar} [-ya]{.trn} will not cause the final letter of word before it to have an [kasrah]{.trn2} because it does that only to consonants, not to vowels or semivowels.
...
1. When the speaking person attached pronoun is attached to prepositions that end with [نْ]{.ar}, like [مِنْ]{.ar} [min]{.trn}, [عَنْ]{.ar} [ean]{.trn}, and [لَدُنْ]{.ar} [ladun]{.trn}, an additional intervening [ن]{.ar} is added between the preposition and the attached pronoun. Being a consonant, this [ن]{.ar} is forced to have a short [i]{.trn}-vowel [◌ِ]{.ar} according to the rule above, and becomes [نِ]{.ar}. In writing, [ن]{.ar} is written only once and is doubled with a [caddah]{.trn2} [◌ّ]{.ar} on it. So we get:
   + [ي]{.ar} + [نِ]{.ar} + [مِنْ]{.ar} = [مِنِّي]{.ar} [minnI]{.trn}
   + [ي]{.ar} + [نِ]{.ar} + [عَنْ]{.ar} = [عَنِّي]{.ar} [eannI]{.trn}
   + [ي]{.ar} + [نِ]{.ar} + [لَدُنْ]{.ar} = [لَدُنِّي]{.ar} [ladunnI]{.trn}
...
Note that the preposition [فِي]{.ar} [fI]{.trn} "in" only puts the noun after it ([ٱلْبَيْتِ]{.ar} [Ealbayti]{.trn} "the house") in the i-case. It has no effect on the case of the noun before it ([رَجُلٌ]{.ar} [rajulun]{.trn} "a man"). In this case, it is in the u-case.
...
Note that when you don't repeat the preposition, the second noun is still in the i-case.
