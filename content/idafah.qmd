...
+ The base noun in an annexation shall always be in the i-case.
+ The case of the annexe noun is variable and shall depend on its function in the sentence.
...
-->
## Case of the annexe noun and base noun

The base noun in an annexation is always in the i-case. The annexe noun may be in any case, depending on its function in the sentence. For example,
<!--
...
However, this time it will match the annexe noun, not the base noun, in case, definiteness, gender, and number. So we get:

[كِتَابُ ٱلْجَارِيَةِ ٱلصَّغِيرُ]{.ar}  
"the girl's small book"

Note how the attribute 
[ٱَلصَّغِيرُ]{.ar} matches the annexe noun [كِتَابُ]{.ar} in case and gender.
...
Now, you might be foreseeing a problem. What if the annexe noun and the base noun have the same gender, and the annexe noun too is in the i-case? For example, in the sentence:
...
The annexe noun [بَيْتِ]{.ar} and the base noun [ٱَلرَّجُل]{.ar} are both masculine, singular, definite, and in the i-case.
...
Contrary from expected behavior, a semi-flexible annexe noun, even when indefinite, takes an [kasrah]{.trn2}\ [◌ِ]{.ar} in the i-case instead of an [fatHah]{.trn2}\ [◌َ]{.ar}. Example,
...
All the nouns except the first annexe noun must be in the i-case. Consistent with 
section\ \@ref(a-semi-flexible-noun-as-the-annexe-noun)
if a semi-flexible noun is any of the annexe nouns and is in the i-case, then its i-case is indicated by an [fatHah]{.trn2} [◌َ]{.ar}. Example:
...
+ The annexe noun may be in any case, depending on its function in the sentence.
+ The base noun is in the i-case. But because the base noun is a pronoun, and pronouns are rigid nouns (see section\ \@ref(rigidity-of-pronouns) that don't change their ending based on their case, therefore it's i-case will not be apparent.
...
If the annexe noun is semi-flexible then it gets a [◌ِ]{.ar} in the i-case, as we've already learned. Example with the semi-flexible broken plural ^2^[حَدَائِق]{.ar} "gardens".
...
As base noun, duals and [Un]{.trn} sound plurals behave no differently than other nouns. Being base nouns they will be in the i-case and this shall be indicated by:
...
If the dual annexe noun were in the i-case then the final [ي]{.ar} gets an [kasrah]{.trn2} [◌ِ]{.trn} if there is following connecting [hamzah]{.trn2}. Example:
...
When an [Un]{.trn} sound plural is annexed to the singular speaker participant pronoun, then again, only the [يَ]{.ar} variant can be used. However, in addition, the expression will appear the same regardless of the case of the annexe noun. So for all cases (u-case, a-case, and i-case), we will get:
...
Note that both 
[ٱلْغُلَامِ]{.ar} [EalgulAmi]{.trn} and [ٱَلْجَارِيَةِ]{.ar} [EaljAriyati]{.trn} are in the i-case because they are both base nouns in the annexation.
