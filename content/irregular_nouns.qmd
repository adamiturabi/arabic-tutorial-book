...
Where the nouns behave irregularly is when they are an annexe noun in an annexation. Then instead of indicating their case with [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, they indicate their case using the long vowels [و]{.ar} [U]{.trn}, [ا]{.ar} [A]{.trn}, and [ي]{.ar} [I]{.trn} instead. Here are some examples:
...
The above irregular behavior of these three nouns is only when they are annexe nouns. When they happen to be base nouns in annexations, then they again they behave like regular nouns and their case is indicated by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by [tanwIn]{.trn2} 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
...
The word [ذَات]{.ar} is the feminine of [ذُو]{.ar}. When used as an annexe noun, its cases, duals, and plurals are as in the table below:
...
Here is how it will appear as a singular annexe noun in the three cases:
