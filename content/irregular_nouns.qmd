...
Where the nouns behave irregularly is when they are an [mudaf]{.term} in an [idafa]{.term}. Then instead of displaying their state with [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, they display their state using the long vowels [و]{.ar} [U]{.trn}, [ا]{.ar} [A]{.trn}, and [ي]{.ar} [I]{.trn} instead. Here are some examples:
...
However, if the attached pronoun is [ي]{.ar} (for the singular speaker participant), then in that case, the attached pronoun [ي]{.ar} attaches to the [mudaf]{.term} directly, without any intervening long vowel:

<!--
Even when the [mudafil]{.term} in the noun-chain is an attached pronoun, these nouns behave in this irregular way, except if the attached pronoun is for the speaking person [ي]{.ar}. In that case, the attached pronoun [ي]{.ar} attaches to the [mudaf]{.term} directly, without any intervening long vowel. Examples:
-->
...
The above irregular behavior of these three nouns is only when they are [mudaf]{.term}s. When they happen to be [mudafil]{.term}s in [idafa]{.term}s, then they again they behave like regular nouns and their state is displayed by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by [nUn]{.trn2}ation 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
...
The noun [ذُو]{.ar} [pU]{.trn} and its duals and plurals are only ever used as [mudaf]{.term}s in [idafa]{.term}s. Furthermore, they may not be annexed to pronouns. Here are some examples:

[ٱَلرَّجُلُ ذُو ٱلْمَالِ.]{.ar}  
[Earrujulu pu -lmAl.]{.trn}  
"The man is the possessor of wealth." = "This man is wealthy."

The word [ذَات]{.ar} is the feminine of [ذُو]{.ar}. When used as an [mudaf]{.term}, its states, duals, and plurals are as in the table below:
...
It is a [mudafil]{.term} in an [idafa]{.term} regularly:

[نَطَقَ لِسَانُ ٱلْفَمِ.]{.ar}  
[naTaqa lisAnu -lfam.]{.trn}  
"The mouth's tongue articulated [speech]."

It forms duals regularly, which are used in [idafa]{.term}s regularly
...
When [فَم]{.ar} is a singular [mudaf]{.term}, then it is usual for it to follow the example of the rest of the five nouns.
...
Here is how it will appear as a singular [mudaf]{.term} in the three states:
...
In addition to the above irregular behavior, it is permissible, but less common, to treat [فَم]{.ar} regularly as an [mudaf]{.term} in an [idafa]{.term}. So it is permissible to also say:
...
means "people~m~ of". It is only used as a masculine plural [mudaf]{.term}, similar in meaning to
