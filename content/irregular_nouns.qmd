...
They behave a little differently from regular nouns in how they indicate their case.
<!--
We have learned that regular nouns have three cases: the u-case, a-case, and i-case. For singular nouns, the u-case is marked by the [Dammah]{.trn2} [◌ُ]{.ar}, the a-case is marked by the [fatHah]{.trn2} [◌َ]{.ar}, and the i-case is marked by the [kasrah]{.trn2} [◌ِ]{.ar}. The [tanwIn]{.trn2}s [◌ٌ]{.ar}, [◌ً]{.ar} and [◌ٍ]{.ar} are only but extensions of [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar} respectively.
...
Without the final root letter [و]{.ar}, these nouns indicate their case like regular nouns. Here are some examples:
...
Where the nouns behave irregularly is when they are an annexed noun in an annexation. Then instead of indicating their case with [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, they indicate their case using the long vowels [و]{.ar} [U]{.trn}, [ا]{.ar} [A]{.trn}, and [ي]{.ar} [I]{.trn} instead. Here are some examples:
...
However, if the attached pronoun is [ي]{.ar} (for the singular speaker participant), then in that case, the attached pronoun [ي]{.ar} attaches to the annexed noun directly, without any intervening long vowel:

<!--
Even when the annexed-to noun in the noun-chain is an attached pronoun, these nouns behave in this irregular way, except if the attached pronoun is for the speaking person [ي]{.ar}. In that case, the attached pronoun [ي]{.ar} attaches to the annexed noun directly, without any intervening long vowel. Examples:
-->

[أَخِي]{.ar}  
[EaxI]{.trn}  
"my brother" (u-case, a-case, and i-case).

[أَبِي]{.ar}  
[EabI]{.trn}  
"my father" (u-case, a-case, and i-case).

[حَمِي]{.ar}  
[HamI]{.trn}  
"my father-in-law" (u-case, a-case, and i-case).
...
The above irregular behavior of these three nouns is only when they are annexed nouns. When they happen to be annexed-to nouns in annexations, then they again they behave like regular nouns and their case is indicated by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by [tanwIn]{.trn2} 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
...
|Word | Dual (u-case) | Dual (a-case and i-case)|Plural|
|:-|:--|:---|:---|
...
So, for example, [ذُو ٱلْمَالِ]{.ar} [pu -lmAli]{.trn} means "possessor~m~ of wealth" or "wealthy person~m~". The singular, dual, and plural of [ذُو]{.ar} [pU]{.trn} in all three cases is shown in the table below:

|Case|Singular|Dual|Plural|
|:--|:---|:---|:---|
|u-case|[ذُو]{.ar} [pU]{.trn} |[ذَوَا]{.ar} [pawA]{.trn}|[ذَوُو]{.ar} [pawU]{.trn}|
|a-case|[ذَا]{.ar} [pA]{.trn} |[ذَوَيْ]{.ar} [paway]{.trn}|[ذَوِي]{.ar} [pawI]{.trn}|
|i-case|[ذِي]{.ar} [pI]{.trn} |same as a-case|same as a-case|

The noun [ذُو]{.ar} [pU]{.trn} and its duals and plurals are only ever used as annexed nouns in annexations. Furthermore, they may not be annexed to pronouns. Here are some examples:

[ٱَلرَّجُلُ ذُو ٱلْمَالِ.]{.ar}  
[Earrujulu pu -lmAl.]{.trn}  
"The man is the possessor of wealth." = "This man is wealthy."

The word [ذَات]{.ar} is the feminine of [ذُو]{.ar}. When used as an annexed noun, its cases, duals, and plurals are as in the table below:

|Case|Singular|Dual|Plural|
|:--|:---|:---|:---|
|u-case|[ذَاتُ]{.ar} [pAtu]{.trn} |[ذَوَاتَا]{.ar} [pawAtA]{.trn} |[ذَوَاتُ]{.ar} [pawAtu]{.trn}|
|a-case|[ذَاتَ]{.ar} [pAta]{.trn} |[ذَوَاتَيْ]{.ar} [pawAtay]{.trn}|[ذَوَاتِ]{.ar} [pawAti]{.trn}|
|i-case|[ذَاتِ]{.ar} [pAti]{.trn} |same as a-case|same as a-case|
...
It is a annexed-to noun in an annexation regularly:
...
When [فَم]{.ar} is a singular annexed noun, then it is usual for it to follow the example of the rest of the five nouns.
...
The three cases of the singular [فُو]{.ar} [fU]{.trn} are shown in the table below:
-->

Here is how it will appear as a singular annexed noun in the three cases:

|u-case|a-case|i-case|
|:---|:---|:---|
...
When the attached pronoun for the speaking person [ي]{.ar} is attached to [فُو]{.ar} [fU]{.trn}, [فَا]{.ar} [fA]{.trn}, or [فِي]{.ar} [fI]{.trn} the combination is always [فِيَّ]{.ar} [fiyya]{.trn} in all three cases. Examples:
...
In addition to the above irregular behavior, it is permissible, but less common, to treat [فَم]{.ar} regularly as an annexed noun in an annexation. So it is permissible to also say:
...
means "people~m~ of". It is only used as a masculine plural annexed noun, similar in meaning to
[ذَوُو]{.ar} [pawU]{.trn} which we discussed in section\ \@ref(zu) above.
There is no singular or dual of this noun.

Here is its form in the different cases:
...
|Singular |[At]{.trn} sound plural |[Un]{.trn} sound plural (u-case) |[Un]{.trn} sound plural (a-case and i-case)|
|:--|:---|:---|:---|
...
|Singular |[Un]{.trn} sound plural (u-case) |[Un]{.trn} sound plural (a-case and i-case)|
|:--|:---|:---|
...
Note that 
[بَنَات]{.ar} [banAt]{.trn}
is not a broken plural from the root [بنت]{.ar}. Therefore, it obeys the rules of [At]{.trn} sound plurals and does not end with [◌َ]{.ar} or [◌ً]{.ar} in the a-case.
...
When the definite article [ٱَلْ]{.ar} [Eal]{.trn} is prefixed to a noun which begins with a connecting [hamzah]{.trn2}, the [hamzah]{.trn2} is not pronounced. Instead the [lAm]{.trn} in [ٱَلْ]{.ar} will take an [kasrah]{.trn2}. For example, [ٱِبْنٌ]{.ar} [Eibnun]{.trn} "a son" becomes [ٱَلِٱبْنُ]{.ar} [Ealibnu]{.trn} "the son".
-->
...
Case         | Definite of [ٱِمْرَأ]{.ar}     | Definite of [ٱِمْرَأَة]{.ar}
:-------------|:----------------------------|:----------------------------
u-case       |[ٱَلْمَرْءُ]{.ar} [EalmarEu]{.trn}|[ٱَلْمَرْأَةُ]{.ar} [EalmarEatu]{.trn}
a-case       |[ٱَلْمَرْءَ]{.ar} [EalmarEa]{.trn}|[ٱَلْمَرْأَةَ]{.ar} [EalmarEata]{.trn}
i-case       |[ٱَلْمَرْءِ]{.ar} [EalmarEi]{.trn}|[ٱَلْمَرْأَةِ]{.ar} [EalmarEati]{.trn}

The masculine noun
[ٱِمْرَأ]{.ar} [EimraE]{.trn}
has an additional irregularity.
When it is indefinite, it irregularly indicates its case, not only on its final letter [ء]{.ar}, but also on the letter before it [ر]{.ar}. 

It is also permissible for it to behave regularly by indicating its case on its final letter only, but this is not as commonly used.

This table shows what we mean:

Case         | Regular indefinite (less common) | Irregular indefinite (more common)
:-------------|:-----------------|:--------------
u-case       |[ٱِمْرَأٌ]{.ar} [EimraEun]{.trn} |[ٱِمْرُؤٌ]{.ar} [EimruEun]{.trn}
a-case       |[ٱِمْرَءًا]{.ar} [EimraEan]{.trn}|[ٱِمْرَءًا]{.ar} [EimraEan]{.trn}
i-case       |[ٱِمْرَأٍ]{.ar} [EimraEin]{.trn} |[ٱِمْرِئٍ]{.ar} [EimriEin]{.trn}
