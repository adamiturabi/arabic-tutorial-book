...
The above irregular behavior of these three nouns is only when they are [mudaf]{.subs}s. When they happen to be [mudafil]{.subs}s in [idafa]{.subs}s, then they again they behave like regular nouns and their state is displayed by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by [nUn]{.trn2}ation 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
