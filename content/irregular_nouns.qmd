...
Where the nouns behave irregularly is when they are an [mudaf]{.subs} in an [idaafah]{.subs}. Then instead of displaying their state with [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, they display their state using the long vowels [و]{.ar} [U]{.trn}, [ا]{.ar} [A]{.trn}, and [ي]{.ar} [I]{.trn} instead. Here are some examples:
...
The above irregular behavior of these three nouns is only when they are [mudaf]{.subs}s. When they happen to be [mudafil]{.subs}s in [idaafah]{.subs}s, then they again they behave like regular nouns and their state is displayed by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by [tanwin]{.subs} 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
...
The noun [ذُو]{.ar} [pU]{.trn} and its duals and plurals are only ever used as [mudaf]{.subs}s in [idaafah]{.subs}s. Furthermore, they may not be annexed to pronouns. Here are some examples:
...
It is a [mudafil]{.subs} in an [idaafah]{.subs} regularly:

[نَطَقَ لِسَانُ ٱلْفَمِ.]{.ar}  
[naTaqa lisAnu -lfam.]{.trn}  
"The mouth's tongue articulated [speech]."

It forms duals regularly, which are used in [idaafah]{.subs}s regularly
...
In addition to the above irregular behavior, it is permissible, but less common, to treat [فَم]{.ar} regularly as an [mudaf]{.subs} in an [idaafah]{.subs}. So it is permissible to also say:
