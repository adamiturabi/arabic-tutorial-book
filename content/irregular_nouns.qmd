...
<!--
We have learned that regular nouns have three states: the [ustate]{.subs}, [astate]{.subs}, and [istate]{.subs}. For singular nouns, the [ustate]{.subs} is marked by the [umark]{.subs} [◌ُ]{.ar}, the [astate]{.subs} is marked by the [amark]{.subs} [◌َ]{.ar}, and the [istate]{.subs} is marked by the [imark]{.subs} [◌ِ]{.ar}. The [tanwin]{.subs}s [◌ٌ]{.ar}, [◌ً]{.ar} and [◌ٍ]{.ar} are only but extensions of [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar} respectively.
...
Where the nouns behave irregularly is when they are an [mudaf]{.subs} in an [idafa]{.subs}. Then instead of displaying their state with [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, they display their state using the long vowels [و]{.ar} [U]{.trn}, [ا]{.ar} [A]{.trn}, and [ي]{.ar} [I]{.trn} instead. Here are some examples:
...
[أَبُوهُ]{.ar}  
[EabUhu]{.trn}  
"his father" ([ustate]{.subs}).

[أَخَانَا]{.ar}  
[EaxAnA]{.trn}  
"our brother" ([astate]{.subs}).

However, if the attached pronoun is [ي]{.ar} (for the singular speaker participant), then in that case, the attached pronoun [ي]{.ar} attaches to the [mudaf]{.subs} directly, without any intervening long vowel:

<!--
Even when the [mudafil]{.subs} in the noun-chain is an attached pronoun, these nouns behave in this irregular way, except if the attached pronoun is for the speaking person [ي]{.ar}. In that case, the attached pronoun [ي]{.ar} attaches to the [mudaf]{.subs} directly, without any intervening long vowel. Examples:
-->

[أَخِي]{.ar}  
[EaxI]{.trn}  
"my brother" ([ustate]{.subs}, [astate]{.subs}, and [istate]{.subs}).

[أَبِي]{.ar}  
[EabI]{.trn}  
"my father" ([ustate]{.subs}, [astate]{.subs}, and [istate]{.subs}).

[حَمِي]{.ar}  
[HamI]{.trn}  
"my father-in-law" ([ustate]{.subs}, [astate]{.subs}, and [istate]{.subs}).
...
The above irregular behavior of these three nouns is only when they are [mudaf]{.subs}s. When they happen to be [mudafil]{.subs}s in [idafa]{.subs}s, then they again they behave like regular nouns and their state is displayed by the short vowel marks [◌ُ]{.ar}, [◌َ]{.ar}, and [◌ِ]{.ar}, when definite, and by [tanwin]{.subs} 
[◌ٌ]{.ar}, 
[◌ً]{.ar}, and
...
|Word | Dual ([ustate]{.subs}) | Dual ([astate]{.subs} and [istate]{.subs})|Plural|
|:-|:--|:---|:---|
...
|:--|:---|:---|:---|
|[ustate]{.subs}|[ذُو]{.ar} [pU]{.trn} |[ذَوَا]{.ar} [pawA]{.trn}|[ذَوُو]{.ar} [pawU]{.trn}|
|[astate]{.subs}|[ذَا]{.ar} [pA]{.trn} |[ذَوَيْ]{.ar} [paway]{.trn}|[ذَوِي]{.ar} [pawI]{.trn}|
|[istate]{.subs}|[ذِي]{.ar} [pI]{.trn} |same as [astate]{.subs}|same as [astate]{.subs}|

The noun [ذُو]{.ar} [pU]{.trn} and its duals and plurals are only ever used as [mudaf]{.subs}s in [idafa]{.subs}s. Furthermore, they may not be annexed to pronouns. Here are some examples:

[ٱَلرَّجُلُ ذُو ٱلْمَالِ.]{.ar}  
[Earrujulu pu -lmAl.]{.trn}  
"The man is the possessor of wealth." = "This man is wealthy."

The word [ذَات]{.ar} is the feminine of [ذُو]{.ar}. When used as an [mudaf]{.subs}, its states, duals, and plurals are as in the table below:

|State|Singular|Dual|Plural|
|:--|:---|:---|:---|
|[ustate]{.subs}|[ذَاتُ]{.ar} [pAtu]{.trn} |[ذَوَاتَا]{.ar} [pawAtA]{.trn} |[ذَوَاتُ]{.ar} [pawAtu]{.trn}|
|[astate]{.subs}|[ذَاتَ]{.ar} [pAta]{.trn} |[ذَوَاتَيْ]{.ar} [pawAtay]{.trn}|[ذَوَاتِ]{.ar} [pawAti]{.trn}|
|[istate]{.subs}|[ذَاتِ]{.ar} [pAti]{.trn} |same as [astate]{.subs}|same as [astate]{.subs}|
...
It is a [mudafil]{.subs} in an [idafa]{.subs} regularly:

[نَطَقَ لِسَانُ ٱلْفَمِ.]{.ar}  
[naTaqa lisAnu -lfam.]{.trn}  
"The mouth's tongue articulated [speech]."

It forms duals regularly, which are used in [idafa]{.subs}s regularly
...
When [فَم]{.ar} is a singular [mudaf]{.subs}, then it is usual for it to follow the example of the rest of the five nouns.
...
Here is how it will appear as a singular [mudaf]{.subs} in the three states:

|[ustate]{.subs}|[astate]{.subs}|[istate]{.subs}|
|:---|:---|:---|
...
In addition to the above irregular behavior, it is permissible, but less common, to treat [فَم]{.ar} regularly as an [mudaf]{.subs} in an [idafa]{.subs}. So it is permissible to also say:
...
means "people~m~ of". It is only used as a masculine plural [mudaf]{.subs}, similar in meaning to
...
|Singular |[At]{.trn} sound plural |[Un]{.trn} sound plural ([ustate]{.subs}) |[Un]{.trn} sound plural ([astate]{.subs} and [istate]{.subs})|
|:--|:---|:---|:---|
...
|Singular |[Un]{.trn} sound plural ([ustate]{.subs}) |[Un]{.trn} sound plural ([astate]{.subs} and [istate]{.subs})|
|:--|:---|:---|
...
Note that 
[بَنَات]{.ar} [banAt]{.trn}
is not a broken plural from the root [بنت]{.ar}. Therefore, it obeys the rules of [At]{.trn} sound plurals and does not end with [◌َ]{.ar} or [◌ً]{.ar} in the [astate]{.subs}.
...
When the definite article [ٱَلْ]{.ar} [Eal]{.trn} is prefixed to a noun which begins with a connecting [hamzah]{.trn2}, the [hamzah]{.trn2} is not pronounced. Instead the [lAm]{.trn} in [ٱَلْ]{.ar} will take an [imark]{.subs}. For example, [ٱِبْنٌ]{.ar} [Eibnun]{.trn} "a son" becomes [ٱَلِٱبْنُ]{.ar} [Ealibnu]{.trn} "the son".
-->
...
:-------------|:----------------------------|:----------------------------
[ustate]{.subs}       |[ٱَلْمَرْءُ]{.ar} [EalmarEu]{.trn}|[ٱَلْمَرْأَةُ]{.ar} [EalmarEatu]{.trn}
[astate]{.subs}       |[ٱَلْمَرْءَ]{.ar} [EalmarEa]{.trn}|[ٱَلْمَرْأَةَ]{.ar} [EalmarEata]{.trn}
[istate]{.subs}       |[ٱَلْمَرْءِ]{.ar} [EalmarEi]{.trn}|[ٱَلْمَرْأَةِ]{.ar} [EalmarEati]{.trn}
...
:-------------|:-----------------|:--------------
[ustate]{.subs}       |[ٱِمْرَأٌ]{.ar} [EimraEun]{.trn} |[ٱِمْرُؤٌ]{.ar} [EimruEun]{.trn}
[astate]{.subs}       |[ٱِمْرَءًا]{.ar} [EimraEan]{.trn}|[ٱِمْرَءًا]{.ar} [EimraEan]{.trn}
[istate]{.subs}       |[ٱِمْرَأٍ]{.ar} [EimraEin]{.trn} |[ٱِمْرِئٍ]{.ar} [EimriEin]{.trn}
