...
Consistent with what we have learned so far, when the [manut]{.subs} in a noun-phrase is plural, then the [na3t]{.subs} comes after it, and matches it in state, definiteness, gender, and number.

Either or both of the [na3t]{.subs} and the [manut]{.subs} may be sound plurals or broken plurals.
...
By the way, this rule only applies to [sifah]{.subs}s in the [manut]{.subs} or the [xabar]{.subs}. A common noun in the [na3t]{.subs} or [xabar]{.subs} will continue match the [manut]{.subs} or [mubtada]{.subs} in gender and number.
...
Similarly, if an [sifah]{.subs} connoting a non-intelligent being is used not as a [na3t]{.subs} or an [xabar]{.subs} in a sentence, then it should be pluralized to indicate plurality.
