...
We have learned that the essential meaning of the doer participle is the doer of the action of the verb from which it is derived. In addition to this essential meaning, the doer participle can also be used in place of the verb from which it is derived. This is only done when the verb to be replaced is the caseful verb. The doer participle does not replace the caseless verb. We will now explain this usage.
...
If we wish to indicate that Zayd is actually going to school at present we can replace the caseful verb with the indefinite doer participle. So we get:
...
We have already learned a method to express a future action using the particles [سَـ]{.ar} [sa-]{.trn} and [سَوْفَ]{.ar} [sawfa]{.trn} with the caseful verb. So we could also have said:
...
So far we have seen only an indefinite doer participle being used with the meaning of an caseful verb. However, the definite doer participle, too, can give this meaning. The meaning is often in the present tense. Here are some examples:
...
Much of what has been said regarding the doer participle applies to the doee participle as well: The doee participle may be used with a verbal meaning for the caseful verb only. So if we say:
