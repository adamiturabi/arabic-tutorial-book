...
The form 1 verb has variability in the middle ([ع]{.ar}) letter, which can have either an [fatHah]{.trn2}, [kasrah]{.trn2}, or [Dammah]{.trn2}.
It also has variability in the pattern its [maSdar]{.trn2}.
