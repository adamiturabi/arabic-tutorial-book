...
In this chapter, we will learn about a new type of verb, whose [fail]{.subs} is called its [ism_of]{.subs}, and whose [mafulb]{.subs} is called its [xabar]{.subs}.
...
Together, these verbs are also called _deficient_ verbs, because, besides their [fail]{.subs}/[ism_of]{.subs}, they also need an [xabar]{.subs} to complete the meaning of the sentence.
...
The separating pronoun [هُمْ]{.ar} does not, in this case, serve to disambiguate the [xabar]{.subs} [ٱلْفَائزِينَ]{.ar} "the winners", from being a [naat]{.subs}, as it did in sentences without [كَانَ]{.ar} (see section\ \@ref([ism_of]{.subs}-[xabar]{.subs}-sentences-separating-pronoun)).
This is because the [astate]{.subs} of [ٱلْفَائزِينَ]{.ar} already tells us that it is the [xabar]{.subs} of [كَانَ]{.ar}. 
If [ٱلْفَائزِينَ]{.ar} were a [naat]{.subs} of the [ustate]{.subs} [ism_of]{.subs} [ٱَلْمُوْمِنُونَ]{.ar}, then it too would be in the [ustate]{.subs}, not the [astate]{.subs}.
...
1. [زَيْد]{.ar} is the [fail]{.subs} of [يَكْتُبُ]{.ar}, and the [ism_of]{.subs} of [كَانَ]{.ar} is a hidden pronoun of the fact.
2. [زَيْد]{.ar} is the delayed [ism_of]{.subs} of [كَانَ]{.ar} and [يَكْتُبُ]{.ar} is the [xabar]{.subs} of [كَانَ]{.ar}. The [fail]{.subs} of [يَكْتُبُ]{.ar} is a hidden pronoun.

Either way, the meaning, as we have mentioned, is the same.
Here are some more examples for different types of [fail]{.subs}s/[ism_of]{.subs}s:
...
For example,
[كَانَ لَا يَقْرَأُ ٱلْقُرْآنَ]{.ar} "He used to not read the [#qurEAn]{.trn2} imparts that the person was intentionally not doing so.
Whereas
[مَا كَانَ يَقْرَأُ ٱلْقُرْآنَ]{.ar} does not convey the intentionality of the lack of action. For example, the person may not have been reading the [#qurEAn]{.trn2} because he did not know how to.
