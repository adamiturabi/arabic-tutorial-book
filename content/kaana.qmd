...
We have learned that a verb must have a doer in the u-state and can have a [mafulb]{.term} in the a-state.
In this chapter, we will learn about a new type of verb, whose doer is called its subject, and whose [mafulb]{.term} is called its information.
...
|Doer pronoun|past verb|[mudarie]{.term} verb|
|:----|:----|:----|
...
The following [mudarie]{.term} verb may also be an unknown-doer verb. Example:
