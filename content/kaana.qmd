...
We have learned that a verb must have a [fail]{.subs} in the u-state and can have a [mafulb]{.subs} in the a-state.
...
[ٱلرَّجُلُ]{.ar} is the [mubtada]{.subs} in the u-state, and
[مُعَلِّمٌ]{.ar} is the [xabar]{.subs}, also in the u-state.
...
and its [mafulb]{.subs}, [مُعَلِّمًا]{.ar}, is in the a-state.
...
This is because the a-state of [ٱلْفَائزِينَ]{.ar} already tells us that it is the [xabar]{.subs} of [كَانَ]{.ar}. 
If [ٱلْفَائزِينَ]{.ar} were a [naat]{.subs} of the u-state [ismof]{.subs} [ٱَلْمُوْمِنُونَ]{.ar}, then it too would be in the u-state, not the a-state.
...
Note that [ٱَلْفَائِزُونَ]{.ar} is in the u-state, so it is not, by itself, the [xabar]{.subs} of [كَانَ]{.ar}.
So this is, in fact, a [mubtada]{.subs}-[xabar]{.subs} sentence.
[ٱَلْمُوْمِنُونَ]{.ar} is the [ismof]{.subs} of [كَانَ]{.ar}.
The [xabar]{.subs} of [كَانَ]{.ar} is the [xabar]{.subs} [هُمُ ٱلفَائِزُونَ]{.ar}, which is itself a [mubtada]{.subs}-[xabar]{.subs} sentence with a u-state [mubtada]{.subs} ([هُمْ]{.ar}) and a u-state [xabar]{.subs} ([ٱلْفَائزُونَ]{.ar}).
...
### The u-state [mudarie]{.subs} verb [يَكُونُ]{.ar}

We have already mentioned that Arabic does not usually express any word for "is".
So when, then, is the u-state [mudarie]{.subs} verb [يَكُونُ]{.ar} used?
...
Habitual [يَكُونُ]{.ar} is negated using [مَا]{.ar} or [لَا]{.ar}, just like other u-state [mudarie]{.subs} verbs.
...
### The a-state [mudarie]{.subs} verb [يَكُونَ]{.ar}

Like a-state [mudarie]{.subs} verbs in general, [يَكُونَ]{.ar} "be" expresses the meaning of purpose, wish, or expectation. It occurs after the particles
[أَنْ]{.ar},
[لَنْ]{.ar},
[لِ]{.ar},
[كَيْ]{.ar},
[حَتَّىٰ]{.ar}, and
[إِذَنْ]{.ar}.
All this is consistent with what we have learned about a-state [mudarie]{.subs} verbs in chapter\ \@ref(a-state-[mudarie]{.subs}-verbs).
Here are some examples:
...
### The 0-state [mudarie]{.subs} verb [يَكُنْ]{.ar} {#lam-yakun}

The 0-state [mudarie]{.subs} verb [يَكُنْ]{.ar} 
is used consistent with the usage of 
0-state [mudarie]{.subs} verbs in general.
(See chapter\ \@ref(0-state-[mudarie]{.subs}-verbs).)
...
for the 0-state [mudarie]{.subs} verbs that don't have a [و]{.ar} before them. 
These are:
...
Note that [مَلِك]{.ar} "king" is in the u-state as the [ismof]{.subs}.
...
followed by [لِ]{.ar}
and then an a-state [mudarie]{.subs} verb.
...
and then [أَنْ]{.ar} followed by an a-state [mudarie]{.subs} verb.
