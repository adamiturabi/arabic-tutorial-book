...
We have learned that a verb must have a [fail]{.subs} in the [ustate]{.subs} and can have a [mafulb]{.subs} in the [astate]{.subs}.
In this chapter, we will learn about a new type of verb, whose [fail]{.subs} is called its [ismof]{.subs}, and whose [mafulb]{.subs} is called its [xabar]{.subs}.
...
## [كَانَ]{.ar}, its [ismof]{.subs}, and its [xabar]{.subs}
...
The complete table for this verb for all [fail]{.subs} pronouns is given below:

|[_fail]{.subs} pronoun|past verb|[mudarie]{.subs} verb|
|:----|:----|:----|
...
the [fail]{.subs} of [كَانَ]{.ar},
[ٱلرَّجُلُ]{.ar}, is also called its [ismof]{.subs}
...
Together, these verbs are also called _deficient_ verbs, because, besides their [fail]{.subs}/[ismof]{.subs}, they also need an [xabar]{.subs} to complete the meaning of the sentence.
That is, without the [xabar]{.subs}, the sentence is deficient.

"Is" [mubtada]{.subs}-[xabar]{.subs} sentences can be converted to "was" [ismof]{.subs}-[xabar]{.subs} sentences using the verb [كَانَ]{.ar}. Here are some examples:
...
### Sequence of [كَانَ]{.ar}, its [ismof]{.subs}, and its [xabar]{.subs}

In sentence word order, the natural sequence is 
verb, [ismof]{.subs}, [xabar]{.subs}.

[كَانَ زَيْدٌ قَائِمًا.]{.ar}
[Wright, vol.\ ii, §41, rem.\ a, p.\ 100B]{.aside}  
"Zayd was standing."

but we may also, for the same meaning, apply the sequence verb, [xabar]{.subs}, [ismof]{.subs}:

[كَانَ قَائِمًا زَيْدٌ.]{.ar}
[Wright, vol.\ ii, §41, rem.\ a, p.\ 100B]{.aside}  
"Zayd was standing."

and also the sequence [xabar]{.subs}, verb, [ismof]{.subs}:
...
And the [xabar]{.subs} is [كَانَ قَائِمًا]{.ar}, which is itself a [كَانَ]{.ar} [ismof]{.subs}-[xabar]{.subs} sentence in the sequence verb, [ismof]{.subs}, [xabar]{.subs}.
The [ismof]{.subs} is the hidden pronoun "he" and the [xabar]{.subs} is [قَائِمًا]{.ar}.
...
when the [ismof]{.subs} and [xabar]{.subs} are both definite, 
then a separating pronoun, which is a detached pronoun that matches the [ismof]{.subs}, can be inserted between them.
For example,

[كَانَ ٱلْمُؤْمِنُونَ هُمُ ٱلْفَائِزِينَ.]{.ar}  
"The believers were the winners."

The separating pronoun [هُمْ]{.ar} does not, in this case, serve to disambiguate the [xabar]{.subs} [ٱلْفَائزِينَ]{.ar} "the winners", from being a [naat]{.subs}, as it did in sentences without [كَانَ]{.ar} (see section\ \@ref([ismof]{.subs}-[xabar]{.subs}-sentences-separating-pronoun)).
This is because the [astate]{.subs} of [ٱلْفَائزِينَ]{.ar} already tells us that it is the [xabar]{.subs} of [كَانَ]{.ar}. 
If [ٱلْفَائزِينَ]{.ar} were a [naat]{.subs} of the [ustate]{.subs} [ismof]{.subs} [ٱَلْمُوْمِنُونَ]{.ar}, then it too would be in the [ustate]{.subs}, not the [astate]{.subs}.
So the separating pronoun serves more, here, to emphasize the [ismof]{.subs}.

Most of the time, separating pronouns are used in [كَانَ]{.ar} sentences when the [ismof]{.subs} of [كَانَ]{.ar} is itself a pronoun. Examples:
...
[ٱَلْمُوْمِنُونَ]{.ar} is the [ismof]{.subs} of [كَانَ]{.ar}.
...
### Gender of a pronoun [ismof]{.subs} of [كان]{.ar}
...
This rules carries over to [كَانَ]{.ar} [ismof]{.subs}-[xabar]{.subs} sentences as well. For example:
...
The rules related to [كَانَ]{.ar}, its [ismof]{.subs}, and its [xabar]{.subs}, that we have given above apply also to its [mudarie]{.subs} verb [يَكُونُ]{.ar}.
...
(Part of [HadIv]{.trn2} 2137 from [_jAmie al-#tirmipI]{.trn2})
...
"I presume that the person approaching is [_abU #parr]{.trn2}"

[كُنْ أَبَا زَيْدٍ]{.ar}
[Wright, vol.\ ii, §20, rem.\ b, p.\ 44C]{.aside}  
"I guess that you are [_abU]{.trn2} Zayd."
...
Note that [مَلِك]{.ar} "king" is in the [ustate]{.subs} as the [ismof]{.subs}.
...
[From [_HadIv]{.trn2} in [_SaHIH #muslim]{.trn2}:7]
...
The order of the [ismof]{.subs} and the [mudarie]{.subs} verb can be re-arranged for the same meaning thus:

[كَانَ يَكْتُبُ زَيْدٌ.]{.ar}  

Now, two grammatical analyses are possible:

1. [زَيْد]{.ar} is the [fail]{.subs} of [يَكْتُبُ]{.ar}, and the [ismof]{.subs} of [كَانَ]{.ar} is a hidden pronoun of the fact.
2. [زَيْد]{.ar} is the delayed [ismof]{.subs} of [كَانَ]{.ar} and [يَكْتُبُ]{.ar} is the [xabar]{.subs} of [كَانَ]{.ar}. The [fail]{.subs} of [يَكْتُبُ]{.ar} is a hidden pronoun.

Either way, the meaning, as we have mentioned, is the same.
Here are some more examples for different types of [fail]{.subs}s/[ismof]{.subs}s:
...
"They said, 'This [person] used to transcribe for [_muHammad]{.trn2} [ﷺ]{.aralt}'"
...
"No one preceded or got ahead of Ibn [_eumar]{.trn2} with (giving) the greeting."  
...
For example,
[كَانَ لَا يَقْرَأُ ٱلْقُرْآنَ]{.ar} "He used to not read the [_qurEAn]{.trn2} imparts that the person was intentionally not doing so.
Whereas
[مَا كَانَ يَقْرَأُ ٱلْقُرْآنَ]{.ar} does not convey the intentionality of the lack of action. For example, the person may not have been reading the [_qurEAn]{.trn2} because he did not know how to.
...
"[_Hupayfah]{.trn2} said: 'You might have done that.'"  
...
#### [كَانَ]{.ar} followed by a [ismfail]{.subs} or [ismmaful]{.subs} instead of a [mudarie]{.subs} verb

Instead of a [mudarie]{.subs} verb after [كَانَ]{.ar}, its [ismfail]{.subs} or [ismmaful]{.subs} may be used instead. 
...
"[al-#racId]{.trn2} died at [_TUs]{.trn2} after (literally: and) he had set out for [_xurAsAn]{.trn2} to combat [_rAfie ibn al-#layv]{.trn2}."
...
"[al-#racId]{.trn2} died at [_TUs]{.trn2} after he had set out for [_xurAsAn]{.trn2} to combat [_rAfie ibn al-#layv]{.trn2}.
And this [_rAfie]{.trn2} had already rebelled and cast off his allegiance and taken forcible posession of Samarqand."  
(Note how 
[قَدْ]{.ar}
is only used before 
[_rAfie]{.trn2}'s action of rebelling.)
...
"I wish I had not come out (for [_Hajj]{.trn2}) this year"
...
"It is conditional for the [naib]{.subs} that he be in as state of already having performed the [_Hajj]{.trn2} for himself."
...
[مَا كَانَ]{.ar} 
or
[لَمْ يَكُنْ]{.ar} with the appropriate suffixes or prefixes for the [ismof]{.subs})
followed by [لِ]{.ar}
...
"[_abU]{.trn2} Bakr said ; it was not befitting for the son of [_abU #quHAfah]{.trn2} to lead the prayer in the presence of the Messenger of [_allAh]{.trn2} [ﷺ]{.aralt}"
