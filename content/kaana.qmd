...
We have learned that a verb must have a [fail]{.term} in the u-state and can have a [mafulb]{.term} in the a-state.
In this chapter, we will learn about a new type of verb, whose [fail]{.term} is called its subject, and whose [mafulb]{.term} is called its information.
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, rotate=90, anchor=south, left=0ex, align=left] {\scriptsize [mafulb]{.term}/\\\scriptsize information};
...
It's [mudarie]{.term} verb is [يَكُونُ]{.ar} [yakUnu]{.trn}.
The complete table for this verb for all [fail]{.term} pronouns is given below:

|[_fail]{.term} pronoun|past verb|[mudarie]{.term} verb|
|:----|:----|:----|
...
the [fail]{.term} of [كَانَ]{.ar},
[ٱلرَّجُلُ]{.ar}, is in the u-state, and
and its [mafulb]{.term}, [مُعَلِّمًا]{.ar}, is in the a-state.

However, unlike most other verbs,
the [fail]{.term} of [كَانَ]{.ar},
[ٱلرَّجُلُ]{.ar}, is also called its subject
and its [mafulb]{.term}, [مُعَلِّمًا]{.ar}, is also called its information.
...
Together, these verbs are also called _deficient_ verbs, because, besides their [fail]{.term}/subject, they also need an information to complete the meaning of the sentence.
...
## The [mudarie]{.term} verb [يَكُونُ]{.ar}

The rules related to [كَانَ]{.ar}, its subject, and its information, that we have given above apply also to its [mudarie]{.term} verb [يَكُونُ]{.ar}.

We will now discuss the usages of the specific states of the [mudarie]{.term} verb.

### The u-state [mudarie]{.term} verb [يَكُونُ]{.ar}

We have already mentioned that Arabic does not usually express any word for "is".
So when, then, is the u-state [mudarie]{.term} verb [يَكُونُ]{.ar} used?
...
If we wish to emphasize the habitual meaning, we may use the [mudarie]{.term} verb [يَكُونُ]{.ar}, thus:
...
Habitual [يَكُونُ]{.ar} is negated using [مَا]{.ar} or [لَا]{.ar}, just like other u-state [mudarie]{.term} verbs.
...
Another usage of the [mudarie]{.term} verb
[يَكُونُ]{.ar}
...
### The a-state [mudarie]{.term} verb [يَكُونَ]{.ar}

Like a-state [mudarie]{.term} verbs in general, [يَكُونَ]{.ar} "be" expresses the meaning of purpose, wish, or expectation. It occurs after the particles
[أَنْ]{.ar},
[لَنْ]{.ar},
[لِ]{.ar},
[كَيْ]{.ar},
[حَتَّىٰ]{.ar}, and
[إِذَنْ]{.ar}.
All this is consistent with what we have learned about a-state [mudarie]{.term} verbs in chapter\ \@ref(a-state-[mudarie]{.term}-verbs).
Here are some examples:
...
### The 0-state [mudarie]{.term} verb [يَكُنْ]{.ar} {#lam-yakun}

The 0-state [mudarie]{.term} verb [يَكُنْ]{.ar} 
is used consistent with the usage of 
0-state [mudarie]{.term} verbs in general.
(See chapter\ \@ref(0-state-[mudarie]{.term}-verbs).)
...
for the 0-state [mudarie]{.term} verbs that don't have a [و]{.ar} before them. 
These are:
...
### [كَانَ]{.ar} combined with a [mudarie]{.term} verb

[كَانَ]{.ar}
is combined with a following [mudarie]{.term} verb to express that the action of the verb was repeatedly or continually ocurring in the past.
For example:
...
The order of the subject and the [mudarie]{.term} verb can be re-arranged for the same meaning thus:

[كَانَ يَكْتُبُ زَيْدٌ.]{.ar}  

Now, two grammatical analyses are possible:

1. [زَيْد]{.ar} is the [fail]{.term} of [يَكْتُبُ]{.ar}, and the subject of [كَانَ]{.ar} is a hidden pronoun of the fact.
2. [زَيْد]{.ar} is the delayed subject of [كَانَ]{.ar} and [يَكْتُبُ]{.ar} is the information of [كَانَ]{.ar}. The [fail]{.term} of [يَكْتُبُ]{.ar} is a hidden pronoun.

Either way, the meaning, as we have mentioned, is the same.
Here are some more examples for different types of [fail]{.term}s/subjects:
...
Occasionally, the particle [قَدْ]{.ar} precedes the combination of [كَانَ]{.ar} and the [mudarie]{.term} verb. Example:
...
The following [mudarie]{.term} verb may also be an [passive]{.term} verb. Example:
...
#### One [كَانَ]{.ar} suffices multiple [mudarie]{.term} verbs

If the signification of an action ocurring continually in the past applies to more that one [mudarie]{.term} verb, then it is sufficient to prefix 
[كَانَ]{.ar}
...
#### Negation of [كَانَ]{.ar} and a [mudarie]{.term} verb

In order to negate the combination of
[كَانَ]{.ar}
and the following [mudarie]{.term} verb,
multiple options are available. Using [يَفْعَلُ]{.ar} as an example [mudarie]{.term} verb, we can have:
...
Occasionally, 
[كَانَ]{.ar}
can be combined with its own [mudarie]{.term} verb
[يَكُونُ]{.ar}
...
Sometimes
[كَانَ]{.ar}
is used with a [mudarie]{.term} verb to express an action that could, should, or would have occurred. Examples:
...
If one or more past verbs precedes the [mudarie]{.term} verb 
or if the context indicates that the action was occurring in the past, then
[كَانَ]{.ar}
can be omitted, and the [mudarie]{.term} verb is used by itself.^[Wright, vol.\ ii, §9, p.\ 21C] For example:
...
#### [كَانَ]{.ar} followed by a [ismfail]{.term} or [ismmaful]{.term} instead of a [mudarie]{.term} verb

Instead of a [mudarie]{.term} verb after [كَانَ]{.ar}, its [ismfail]{.term} or [ismmaful]{.term} may be used instead. 
...
### Verb of command [كُنْ]{.ar} combined with a [mudarie]{.term} verb

Ocassionally,
the verb of command [كُنْ]{.ar} is combined with a [mudarie]{.term} verb, thus:
...
followed by [لِ]{.ar}
and then an a-state [mudarie]{.term} verb.
...
and then [أَنْ]{.ar} followed by an a-state [mudarie]{.term} verb.
