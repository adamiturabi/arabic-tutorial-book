...
Most nouns in Arabic are _fully-flexible_. This means that, when indefinite, they are [tanwin]{.subs}ed and the indefinite i-state is shown by a [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar} at the end of the noun. For example, [رَجُل]{.ar} [rajul]{.trn} "a man" and [بَيْت]{.ar} [bayt]{.trn} "a house" are fully-flexible nouns. So, you can see, below, that they are [tanwin]{.subs}ed, and the indefinite i-state is indicated by a [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar}:

[ذَهَبَ رَجُلٌ إِلَىٰ بَيْتٍ.]{.ar}  
[pahaba rajulun EilA bayt.]{.trn}  
"A man went to a house."

Some nouns are _semi-flexible_. This means that they are not [tanwin]{.subs}ed, and also, the indefinite i-state is indicated by an [amark]{.subs} [◌َ]{.ar}. Examples of such nouns are:
