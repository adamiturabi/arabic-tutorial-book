...
Before we begin our discussion about broken plurals, we will do a quick review of word patterns and semi-flexible nouns. This will, if [_allAh]{.trn2} wills, facilitate the explanation of broken plurals.
...
Most nouns in Arabic are _fully-flexible_. This means that, when indefinite, they are [tanwin]{.subs}ed and the indefinite [istate]{.subs} is shown by a [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar} at the end of the noun. For example, [رَجُل]{.ar} [rajul]{.trn} "a man" and [بَيْت]{.ar} [bayt]{.trn} "a house" are fully-flexible nouns. So, you can see, below, that they are [tanwin]{.subs}ed, and the indefinite [istate]{.subs} is indicated by a [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar}:

[ذَهَبَ رَجُلٌ إِلَىٰ بَيْتٍ.]{.ar}  
[pahaba rajulun EilA bayt.]{.trn}  
"A man went to a house."

Some nouns are _semi-flexible_. This means that they are not [tanwin]{.subs}ed, and also, the indefinite [istate]{.subs} is indicated by an [amark]{.subs} [◌َ]{.ar}. Examples of such nouns are:
...
+ Both common nouns and [sifah]{.subs}s form broken plurals.
...
+ The broken plural patterns [فِعْلَان]{.ar} [fielAn]{.trn} and [فُعْلَان]{.ar} [fuelAn]{.trn} are fully-flexible nouns. Although they end with the [ان]{.ar} ending which is extrinsic to the root, they are not semi-flexible nouns. Only singular [sifah]{.subs}s that end with an extrinsic [ان]{.ar} on the pattern [فَعْلَان]{.ar}, and that also fulfil the other conitions listed in section\ \@ref([sifah]{.subs}-an-diptote), are semi-flexible.
...
+ The letters [ء]{.ar}, [ا]{.ar}, [و]{.ar}, and [ي]{.ar} are considered _weak_ letters. Words that one or more these weak letters in their roots are called _defective_ words. We will discuss defective words more completely in later chapters, if [_allAh]{.trn2} wills. For now, we will note the following:
  ...
  + A [ي]{.ar} at the end of a word, in some states, gets omitted  and replaced by a [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar} on the preceding letter. This happens even when the [ي]{.ar} is extrinsic to the root, and even if the word is semi-flexible (and thus would not normally be [tanwin]{.subs}ed). Examples:
...
2. Sometimes, the usage of one of the plurals may be restricted. For example, [ضِعَاف]{.ar} and [ضُعَفَاء]{.ar} are both broken plurals of the masculine [sifah]{.subs} [ضَعِيف]{.ar} "a weak one~m~". For male intelligent beings, like "weak men", either of the two plurals could be used. But remember that broken plurals that end with an extrinsic [اء]{.ar} ending may only be used for male intelligent beings. So the plural [ضُعَفَاء]{.ar} may only be used for male intelligent beings like "men" or "boys", and not for masculine nouns that denote non-intelligent beings like "lions" or "pens", etc.

   Interestingly, [ضِعَاف]{.ar} is also shared as the broken plural for the feminine [sifah]{.subs} [ضَعِيفَة]{.ar} "a weak one~f~". So it can be used for plurals of feminine nouns, both for female intelligent beings like "women" and "girls", and for feminie nouns that denote non-intelligent beings like "trees".
...
If a singular noun has both an [Un]{.trn} sound plural and one or more broken plurals, then the use of the broken plural is generally preferred. The sound plural is then, generally, reserved for certain verbal usages. (We will study these in later chapters, if [_allAh]{.trn2} wills.)
...
+ [_sifah]{.subs}s of the pattern ^2^[فَعْلَاء]{.ar} which is the feminine of the masculine [sifah]{.subs} pattern ^2^[أَفْعَل]{.ar}. For example, [حور]{.ar} [حَوْرَاء]{.ar} [HawrAE]{.trn} "a beautiful eyed one~f~" uses the broken plural [حُور]{.ar} [HUr]{.trn}

+ [_sifah]{.subs}s of the pattern ^2^[فَعْلَىٰ]{.ar} which is the feminine of the masculine [sifah]{.subs} pattern ^2^[فَعْلَان]{.ar}. For example, [غضب]{.ar} [غَضْبَىٰ]{.ar} [gaDbA]{.trn} "very angry~f~" uses the broken plural [غِضَاب]{.ar} [giDAb]{.trn}.

+ The following exceptional nouns:

  + [ٱِمْرَأَة]{.ar} "a woman", broken plural: [نِسَاء]{.ar}
  + [أَمَة]{.ar} "a slave~f~", broken plural: [إِمَاء]{.ar}
  + [أُمَّة]{.ar} "a nation", broken plural: [أُمَم]{.ar}
...
The treatment of plurals in sentences is quite complicated.
Here we will give a simplified explanation that should suffice for basic usage, until we give a fuller treatment in (TODO: give chapter reference).

We will discuss the plurals of intelligent beings and non-intelligent beings separately.

### Plurals of intelligent beings in descriptive noun-phrases

Consistent with what we have learned so far, when the [manut]{.subs} in a noun-phrase is plural, then the [naat]{.subs} comes after it, and matches it in state, definiteness, gender, and number.

Either or both of the [naat]{.subs} and the [manut]{.subs} may be sound plurals or broken plurals.
...
### Plurals of intelligent beings in [mubtada]{.subs}-[xabar]{.subs} sentences

If the [mubtada]{.subs} of a sentence is a plural denoting intelligent beings then the [xabar]{.subs} typically matches it in being a plural. This is especially the case if the [xabar]{.subs} is an [sifah]{.subs}. For example:
...
Sometimes the [xabar]{.subs} may not match the [mubtada]{.subs} in plurality because of the meaning of the sentence. For example:
...
The use of detached pronouns is consistent with what we learned in section\ \@ref(detached-plural-pronouns). Examples:
...
### Plurals of intelligent beings with verbs

We have already studied verbs with sound plurals in section\ (ref). The same discussion applies to broken plurals as well. Here are a couple of examples:
...
We now turn our attention to plurals of non-intelligent beings. 
The treatment of plurals of non-intelligent beings is very different from everything we have learned so far. 
In this basic, simplified, explanation:
regardless of the grammatical or physical gender of the singular noun, plurals of non-intelligent beings are treated, for the purposes of matching [sifah]{.subs}s and pronouns, as
...
For the second option (feminine plural), in addition to the sound feminine plural of [sifah]{.subs}s, broken plurals are allowed to be used as well, as long as their meaning allows them to be used for non-intelligent beings.
-->
<!--not specifc to male intelligent beings (those that end with [اء]{.ar}).-->

So, for example, the noun [بَيت]{.ar} [bayt]{.trn} denotes the inanimate object "a house". 
It's plural is [بُيُوت]{.ar}. 
This plural is treated as a feminine singular noun.
This is despite the fact that the singular noun [بَيْت]{.ar} [bayt]{.trn} "a house" is grammatically masculine. 
See how the [بُيُوت]{.ar} [buyUt]{.trn} is used in the examples below:
...
"They~3,m~ lived in small houses."
...
Plurals of inanimate objects and animals (both male and female) are treated the same way. 
It doesn't matter what the grammatical or physical gender of the singular is or whether it has a sound or broken plural. Examples:
...
(Note how ^2^[أَشْيَاء]{.ar} is indefinite but is not [tanwin]{.subs}ed. This is because it is irregularly semi-flexible.)

By the way, this rule only applies to [sifah]{.subs}s in the [manut]{.subs} or the [xabar]{.subs}. A common noun in the [naat]{.subs} or [xabar]{.subs} will continue match the [manut]{.subs} or [mubtada]{.subs} in gender and number.
...
then [حَسَنَة]{.ar} may only be the feminine [sifah]{.subs} "a good one".
...
Similarly, if an [sifah]{.subs} connoting a non-intelligent being is used not as a [naat]{.subs} or an [xabar]{.subs} in a sentence, then it should be pluralized to indicate plurality.
...
It is important to note that treating non-intelligent beings as grammatically feminine is only for the plural. 
Singular and dual nouns for non-intelligent beings are treated according to the gender of singular noun, as we have learned in previous chapters. So, for example,
