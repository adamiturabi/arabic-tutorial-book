...
+ Adjectival nouns of the pattern ^2^[فَعْلَاء]{.ar} which is the feminine of the masculine adjectival noun pattern ^2^[أَفْعَل]{.ar}. For example, [حَمْرَاء]{.ar} [HamrAE]{.trn} "red~f~".

+ Adjectival nouns of the pattern ^2^[فَعْلَىٰ]{.ar} which is the feminine of the masculine adjectival noun pattern ^2^[فَعْلَان]{.ar}. For example, [غَضْبَىٰ]{.ar} [gaDbA]{.trn} "very angry~f~".
...
We will defer the discussion on how to use plural adjectival nouns until the next chapter, when we will learn broken plurals, if [_allAh]{.trn2} wills.
-->
...
The above verbal sentences with plural [fail]{.subs}s can be rearranged to be a subject-information sentences. This gives more emphasis to the subject. In this case, the verb shall follow the subject and will need a [fail]{.subs} pronoun after it.
...
The above verbal sentence can be rearranged to be a subject-information sentence. In that case, all the verbs shall have [fail]{.subs} pronouns. The sentence will have the same translation as above, except for an emphasis on the subject of the sentence.
...
The above verbal sentence can be rearranged to be a subject-information sentence. This gives more emphasis to the subject. In this case, the verb shall follow the subject and will need a [fail]{.subs} pronoun after it.
...
If the sentence is a subject information sentence, and the verb is in the information, then the [fail]{.subs} pronoun corresponding to the number of the subject is used. Examples:
