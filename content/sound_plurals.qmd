...
+ [#sifah]{.subs}s of the pattern ^2^[فَعْلَاء]{.ar} which is the feminine of the masculine [sifah]{.subs} pattern ^2^[أَفْعَل]{.ar}. For example, [حَمْرَاء]{.ar} [HamrAE]{.trn} "red~f~".

+ [#sifah]{.subs}s of the pattern ^2^[فَعْلَىٰ]{.ar} which is the feminine of the masculine [sifah]{.subs} pattern ^2^[فَعْلَان]{.ar}. For example, [غَضْبَىٰ]{.ar} [gaDbA]{.trn} "very angry~f~".
...
|Participant | [#fail]{.subs} pronoun |Meaning| [#fail]{.subs} pronoun with verb|
|:--|:--|:--|:--|
...
|plural participant | [#fail]{.subs} pronoun | Meaning |[#fail]{.subs} pronoun with verb|
|:--|:--|:--|:---|
...
|Person|Detached pronoun|[#madi]{.subs} verb [fail]{.subs} pronoun|[#madi]{.subs} verb with [fail]{.subs} pronoun|Attached pronoun|
|:---|:----|:----|:----|
