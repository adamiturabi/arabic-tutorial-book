...
1.  If a common noun is of the pattern [فَعْل]{.ar} [fael]{.trn} or [فَعْلَة]{.ar} [faelah]{.trn}, then the 0-mark on the middle letter shall be converted to an [a]{.trn}-mark [◌َ]{.ar} when forming the [At]{.trn} sound plural. For example:
...
+ The final 0-mark on the [مْ]{.ar} in the masculine plural pronouns ([هُمْ]{.ar} [hum]{.trn}, [أَنْتُمْ]{.ar} [Eantum]{.trn}, and [كُمْ]{.ar} [-kum]{.trn}) becomes a [u]{.trn}-mark ([هُمُ]{.ar} [humu]{.trn}, [أَنْتُمُ]{.ar} [Eantumu]{.trn},  and[كُمُ]{.ar} [-kumu]{.trn} respectively) when followed by a connecting [hamzah]{.trn2}. Examples:
...
### Plural [mafulb]{.term} pronouns

The plural attached pronouns that we have just learned are also used as [mafulb]{.term} pronouns. 
...
## Verbs with plural [fail]{.term}s

### Plural nouns for the [fail]{.term}

We learned that the [madi]{.term} verb for a masculine [fail]{.term} is on the pattern [فَعَلَ]{.ar}. And when the [fail]{.term} is feminine, the [ت]{.ar} of femininity is attached to the verb thus: [فَعَلَتْ]{.ar}. We have used these verbs with singular and dual [fail]{.term} nouns. The [fail]{.term} noun always comes after the verb and shall be in the u-state. Examples:
...
These same verbs are used when the [fail]{.term} noun is a plural. Examples:
...
### Plural pronouns for the [fail]{.term}

We have already learned the singular and dual [fail]{.term} pronouns. They are repeated here:

|Participant | [_fail]{.term} pronoun |Meaning| [_fail]{.term} pronoun with verb|
|:--|:--|:--|:--|
...
Now we will learn the plural [fail]{.term} pronouns:

|plural participant | [_fail]{.term} pronoun | Meaning |[_fail]{.term} pronoun with verb|
|:--|:--|:--|:---|
...
Note the following regarding the plural [fail]{.term} pronouns:

+ The [تْ]{.ar} of femininity does not attach to the absentee  plural feminine [fail]{.term} pronoun [نَ]{.ar} [-na]{.trn} "they~3,f~" [فَعَلْنَ]{.ar}. Example:
  
  + [ذَهَبْنَ]{.ar} [pahabna]{.trn} "they~3,f~ went"

  This is different from the behavior of the absentee dual [fail]{.term} pronoun [◌َا]{.ar} [-A]{.trn} "them~2,f~" which, for a feminine [fail]{.term}, does attach to the [تْ]{.ar} of femininity. Example:

  + [ذَهَبَتَا]{.ar} [pahabatA]{.trn} "they~2,f~ went"
+ The final 0-mark on the [مْ]{.ar} in the masculine plural [fail]{.term} pronoun [تُمْ]{.ar} [-tum]{.trn} becomes a [u]{.trn}-mark [تُمُ]{.ar} [-tumu]{.trn} when followed by a connecting [hamzah]{.trn2}. Examples:
...
+ The absentee plural masculine verb [fail]{.term} pronoun "they~3,m~" [و]{.ar} [U]{.trn} is written with a silent [alif]{.trn2} after it which is written only and not pronounced. This [alif]{.trn2} is dropped when a [mafulb]{.term} pronoun is attached. For example: 
  ...
  + [ضَرَبُوهُ.]{.ar}  
    [DarabUh.]{.trn}  
    "They~3,m~ hit him."
+ The plural masculine verb [fail]{.term} pronoun for the addressed person "you~3,m~" [تُمْ]{.ar} [-tum]{.trn} becomes [تُمُو]{.ar} [tumU]{.trn} when a [mafulb]{.term} pronoun is attached. For example:
  ...
  + [ضَرَبْتُمُوهُ.]{.ar}  
    [DarabtumUh.]{.trn}  
    "You~pl.\ masc.~ hit him."
+ The plural speaking participant [fail]{.term} pronoun [نَا]{.ar} [-nA]{.trn} is the same as the plural speaking participant attached pronoun [نَا]{.ar} [-nA]{.trn}. But you can tell them apart because the [fail]{.term} pronoun, when attached to the verb, causes the final letter of the verb to have a 0-mark. Consider the following two sentences:
...
### Sentence word order with plural [fail]{.term}s

As we've mentioned, the [fail]{.term}, whether a noun or a pronoun, always comes after the verb. Here are a couple of examples of verbal sentences with plural [fail]{.term}s:
...
The above verbal sentences with plural [fail]{.term}s can be rearranged to be a subject-information sentences. This gives more emphasis to the subject. In this case, the verb shall follow the subject and will need a [fail]{.term} pronoun after it.
...
If there are multiple verbs associated with the same [fail]{.term} in a verbal sentence, the [fail]{.term} noun will follow the first verb and the rest of the verbs will have [fail]{.term} pronouns. For example:
...
The above verbal sentence can be rearranged to be a subject-information sentence. In that case, all the verbs shall have [fail]{.term} pronouns. The sentence will have the same translation as above, except for an emphasis on the subject of the sentence.
...
Here are the detached, attached, and [fail]{.term} pronouns for the plural:

|Person|Detached pronoun|[_madi]{.term} verb [fail]{.term} pronoun|[_madi]{.term} verb with [fail]{.term} pronoun|Attached pronoun|
|:---|:----|:----|:----|
...
+ The final 0-mark on the [مْ]{.ar} in the masculine plural pronouns ([هُمْ]{.ar} [hum]{.trn}, [هُمْ]{.ar} [-hum]{.trn}, [أَنْتُمْ]{.ar} [Eantum]{.trn}, [تُمْ]{.ar} [-tum]{.trn}, [كُمْ]{.ar} [-kum]{.trn}) becomes a [u]{.trn}-mark ([هُمُ]{.ar} [humu]{.trn}, [هُمُ]{.ar} [-humu]{.trn}, [أَنْتُمُ]{.ar} [Eantumu]{.trn}, [تُمُ]{.ar} [-tumu]{.trn}, [كُمُ]{.ar} [-kumu]{.trn} respectively) when followed by a connecting [hamzah]{.trn2}. Examples:
  + [هُمُ ٱلْمُعَلِّمُونَ.]{.ar}  
    ...
    "They~pl.\ masc.~ are the (male) teachers."
+ The plural masculine verb [fail]{.term} pronoun for the absent person "they~pl.\ masc.~" [ـُوا]{.ar} [U]{.trn} has a silent [alif]{.trn2} which is written only and not pronounced. This [alif]{.trn2} is dropped when a [mafulb]{.term} pronoun is attached. For example: 
  + [ضَرَبُوا ٱلرَّجُلَ.]{.ar}  
    [Darabu -rrajula.]{.trn}  
    "They hit the man.
  + [ضَرَبُوهُ.]{.ar}  
...
+ The plural masculine verb [fail]{.term} pronoun for the addressed person "you~pl.\ masc.~" [تُمْ]{.ar} [-tum]{.trn} becomes [تُمُو]{.ar} [tumU]{.trn} when a [mafulb]{.term} pronoun is attached. For example:
  + [ضَرَبْتُمُ ٱلرَّجُلَ.]{.ar}  
...
## Verbs with plural intelligent [fail]{.term}s

Remember that in Arabic, a [fail]{.term}, whether a noun or a pronoun, always after a verb. 

[ذَهَبُوا إِلَىٰ بَيْتٍ.]{.ar}  
[pahabU EilA baytin.]{.trn}  
"They~pl.\ masc.~ went to a house."

When the [fail]{.term} is a plural noun then the plural [fail]{.term} pronoun is not employed.

[ذَهَبَ ٱلْمُعَلِّمُونَ إِلَىٰ بَيْتٍ.]{.ar}  
[pahabA -lmueallimUna EilA baytin.]{.trn}  
"The teachers went to a house."

The above verbal sentence can be rearranged to be a subject-information sentence. This gives more emphasis to the subject. In this case, the verb shall follow the subject and will need a [fail]{.term} pronoun after it.
...
### Verbs with multiple [fail]{.term}s mentioned individually

If there are multiple [fail]{.term}s of a verb, and each is mentioned individually, then there is often more than one way to handle them. Here we will give the more common usage.

If the verb is followed by multiple [fail]{.term}s, only the first is the true [fail]{.term} with respect to  modifying the verb according to its gender and number. Examples:
...
If the [fail]{.term}s consist of different persons (speaking person, addressed person, and absent person), then they are placed in order of strength: The speaking person is stronger than the addressed person, who is stronger than the absent person. The verb [fail]{.term} pronoun of the first (true) [fail]{.term} is then used. Example:
  
[ذَهَبْتُ أَنَا وَأَنْتَ وَهُوَ.]{.ar}  
[pahabtu Eana waEanta wahuwa.]{.trn}  
"I, you, and he went."

Note how the speaking person detached pronoun [أَنَا]{.ar} [Eana]{.trn} is used in addition to the [fail]{.term} pronoun [تُ]{.ar} [-tu]{.trn} in order to add [وَ]{.ar} [wa]{.trn} "and" to it.

If the sentence is a subject information sentence, and the verb is in the information, then the [fail]{.term} pronoun corresponding to the number of the subject is used. Examples:
...
<!--If the verb follows the [fail]{.term}s, then it will have the [fail]{.term} pronoun corresponding to number of the [fail]{.term}s. Example:-->
...
If the [fail]{.term}s consist of both male and female persons, then the verb will have the masculine [fail]{.term} prenoun corresponding to the number of the [fail]{.term}s. Example:
