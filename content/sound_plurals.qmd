...
+ The final 0-mark on the [مْ]{.ar} in the masculine plural [fail]{.subs} pronoun [تُمْ]{.ar} [-tum]{.trn} becomes a [u]{.trn}-mark [تُمُ]{.ar} [-tumu]{.trn} when followed by a connecting [hamzah]{.trn2}. Examples:
...
+ The plural masculine verb [fail]{.subs} pronoun for the addressed person "you~3,m~" [تُمْ]{.ar} [-tum]{.trn} becomes [تُمُو]{.ar} [tumU]{.trn} when a [mafulb]{.subs} pronoun is attached. For example:
  ...
  + [ضَرَبْتُمُوهُ.]{.ar}  
    [DarabtumUh.]{.trn}  
    "You~pl.\ masc.~ hit him."
+ The plural speaking participant [fail]{.subs} pronoun [نَا]{.ar} [-nA]{.trn} is the same as the plural speaking participant attached pronoun [نَا]{.ar} [-nA]{.trn}. But you can tell them apart because the [fail]{.subs} pronoun, when attached to the verb, causes the final letter of the verb to have a 0-mark. Consider the following two sentences:
