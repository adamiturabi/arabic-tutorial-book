...
+ The [At]{.trn} sound plural does not take the [amark]{.subs} [◌َ]{.ar} and the [tanwin]{.subs}ed [amark]{.subs} [◌ً]{.ar}. Instead the [imark]{.subs} [◌ِ]{.ar} and the [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar}-mark are used to indicate both the a-state and the i-state.
