...
The above verbal sentences with plural [faa3il]{.subs}s can be rearranged to be a [j_ism]{.subs}s. This gives more emphasis to the [mubtada]{.subs}. In this case, the verb shall follow the [mubtada]{.subs} and will need a [faa3il]{.subs} pronoun after it.
...
The above verbal sentence can be rearranged to be a [j_ism]{.subs}. In that case, all the verbs shall have [faa3il]{.subs} pronouns. The sentence will have the same translation as above, except for an emphasis on the [mubtada]{.subs} of the sentence.
...
The above verbal sentence can be rearranged to be a [j_ism]{.subs}. This gives more emphasis to the [mubtada]{.subs}. In this case, the verb shall follow the [mubtada]{.subs} and will need a [faa3il]{.subs} pronoun after it.
...
If the sentence is a [j_ism]{.subs}, and the verb is in the [xabar]{.subs}, then the [faa3il]{.subs} pronoun corresponding to the number of the [mubtada]{.subs} is used. Examples:
