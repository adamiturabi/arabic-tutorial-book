...
There are some nouns that end with an [alif]{.trn2} before the [ة]{.ar}, like [فَتَاة]{.ar} [fatAh]{.trn} "a young woman". We will learn how to pluralize these nouns later, if [#allAh]{.trn2} wills.
...
-->
Once you become more familiar with Arabic word patterns, distinguishing between primitive and derived nouns will become clearer, if [#allAh]{.trn2} wills.
...
We will see in chapter @broken_plurals, if [#allAh]{.trn2} wills, that they form broken plurals instead.
...
We will defer the discussion on how to use plural [sifah]{.subs}s until the next chapter, when we will learn broken plurals, if [#allAh]{.trn2} wills.
-->
...
## Verbs with plural [faa3il]{.subs}s

### Plural nouns for the [faa3il]{.subs}

We learned that the [madi]{.subs} verb for a masculine [faa3il]{.subs} is on the pattern [فَعَلَ]{.ar}. And when the [faa3il]{.subs} is feminine, the [ت]{.ar} of femininity is attached to the verb thus: [فَعَلَتْ]{.ar}. We have used these verbs with singular and dual [faa3il]{.subs} nouns. The [faa3il]{.subs} noun always comes after the verb and shall be in the [ustate]{.subs}. Examples:
...
These same verbs are used when the [faa3il]{.subs} noun is a plural. Examples:
...
### Plural pronouns for the [faa3il]{.subs}

We have already learned the singular and dual [faa3il]{.subs} pronouns. They are repeated here:

|Participant | [#faa3il]{.subs} pronoun |Meaning| [#faa3il]{.subs} pronoun with verb|
|:--|:--|:--|:--|
...
Now we will learn the plural [faa3il]{.subs} pronouns:

|plural participant | [#faa3il]{.subs} pronoun | Meaning |[#faa3il]{.subs} pronoun with verb|
|:--|:--|:--|:---|
...
Note the following regarding the plural [faa3il]{.subs} pronouns:

+ The [تْ]{.ar} of femininity does not attach to the absentee  plural feminine [faa3il]{.subs} pronoun [نَ]{.ar} [-na]{.trn} "they~3,f~" [فَعَلْنَ]{.ar}. Example:
  
  + [ذَهَبْنَ]{.ar} [pahabna]{.trn} "they~3,f~ went"

  This is different from the behavior of the absentee dual [faa3il]{.subs} pronoun [◌َا]{.ar} [-A]{.trn} "them~2,f~" which, for a feminine [faa3il]{.subs}, does attach to the [تْ]{.ar} of femininity. Example:

  + [ذَهَبَتَا]{.ar} [pahabatA]{.trn} "they~2,f~ went"
+ The final [0mark]{.subs} on the [مْ]{.ar} in the masculine plural [faa3il]{.subs} pronoun [تُمْ]{.ar} [-tum]{.trn} becomes a [umark]{.subs} [تُمُ]{.ar} [-tumu]{.trn} when followed by a connecting [hamzah]{.trn2}. Examples:
...
+ The absentee plural masculine verb [faa3il]{.subs} pronoun "they~3,m~" [و]{.ar} [U]{.trn} is written with a silent [alif]{.trn2} after it which is written only and not pronounced. This [alif]{.trn2} is dropped when a [mafulb]{.subs} pronoun is attached. For example: 
  ...
  + [ضَرَبُوهُ.]{.ar}  
    [DarabUh.]{.trn}  
    "They~3,m~ hit him."
+ The plural masculine verb [faa3il]{.subs} pronoun for the addressed person "you~3,m~" [تُمْ]{.ar} [-tum]{.trn} becomes [تُمُو]{.ar} [tumU]{.trn} when a [mafulb]{.subs} pronoun is attached. For example:
  ...
  + [ضَرَبْتُمُوهُ.]{.ar}  
    [DarabtumUh.]{.trn}  
    "You~pl.\ masc.~ hit him."
+ The plural speaking participant [faa3il]{.subs} pronoun [نَا]{.ar} [-nA]{.trn} is the same as the plural speaking participant attached pronoun [نَا]{.ar} [-nA]{.trn}. But you can tell them apart because the [faa3il]{.subs} pronoun, when attached to the verb, causes the final letter of the verb to have a [0mark]{.subs}. Consider the following two sentences:
...
### Sentence word order with plural [faa3il]{.subs}s

As we've mentioned, the [faa3il]{.subs}, whether a noun or a pronoun, always comes after the verb. Here are a couple of examples of verbal sentences with plural [faa3il]{.subs}s:
...
The above verbal sentences with plural [faa3il]{.subs}s can be rearranged to be a [mubtada]{.subs}-[xabar]{.subs} sentences. This gives more emphasis to the [mubtada]{.subs}. In this case, the verb shall follow the [mubtada]{.subs} and will need a [faa3il]{.subs} pronoun after it.
...
If there are multiple verbs associated with the same [faa3il]{.subs} in a verbal sentence, the [faa3il]{.subs} noun will follow the first verb and the rest of the verbs will have [faa3il]{.subs} pronouns. For example:
...
The above verbal sentence can be rearranged to be a [mubtada]{.subs}-[xabar]{.subs} sentence. In that case, all the verbs shall have [faa3il]{.subs} pronouns. The sentence will have the same translation as above, except for an emphasis on the [mubtada]{.subs} of the sentence.
...
Here are the detached, attached, and [faa3il]{.subs} pronouns for the plural:

|Person|Detached pronoun|[#madi]{.subs} verb [faa3il]{.subs} pronoun|[#madi]{.subs} verb with [faa3il]{.subs} pronoun|Attached pronoun|
|:---|:----|:----|:----|
...
+ The final [0mark]{.subs} on the [مْ]{.ar} in the masculine plural pronouns ([هُمْ]{.ar} [hum]{.trn}, [هُمْ]{.ar} [-hum]{.trn}, [أَنْتُمْ]{.ar} [Eantum]{.trn}, [تُمْ]{.ar} [-tum]{.trn}, [كُمْ]{.ar} [-kum]{.trn}) becomes a [umark]{.subs} ([هُمُ]{.ar} [humu]{.trn}, [هُمُ]{.ar} [-humu]{.trn}, [أَنْتُمُ]{.ar} [Eantumu]{.trn}, [تُمُ]{.ar} [-tumu]{.trn}, [كُمُ]{.ar} [-kumu]{.trn} respectively) when followed by a connecting [hamzah]{.trn2}. Examples:
  + [هُمُ ٱلْمُعَلِّمُونَ.]{.ar}  
    ...
    "They~pl.\ masc.~ are the (male) teachers."
+ The plural masculine verb [faa3il]{.subs} pronoun for the absent person "they~pl.\ masc.~" [ـُوا]{.ar} [U]{.trn} has a silent [alif]{.trn2} which is written only and not pronounced. This [alif]{.trn2} is dropped when a [mafulb]{.subs} pronoun is attached. For example: 
  + [ضَرَبُوا ٱلرَّجُلَ.]{.ar}  
    [Darabu -rrajula.]{.trn}  
    "They hit the man.
  + [ضَرَبُوهُ.]{.ar}  
...
+ The plural masculine verb [faa3il]{.subs} pronoun for the addressed person "you~pl.\ masc.~" [تُمْ]{.ar} [-tum]{.trn} becomes [تُمُو]{.ar} [tumU]{.trn} when a [mafulb]{.subs} pronoun is attached. For example:
  + [ضَرَبْتُمُ ٱلرَّجُلَ.]{.ar}  
...
## Verbs with plural intelligent [faa3il]{.subs}s

Remember that in Arabic, a [faa3il]{.subs}, whether a noun or a pronoun, always after a verb. 

[ذَهَبُوا إِلَىٰ بَيْتٍ.]{.ar}  
[pahabU EilA baytin.]{.trn}  
"They~pl.\ masc.~ went to a house."

When the [faa3il]{.subs} is a plural noun then the plural [faa3il]{.subs} pronoun is not employed.

[ذَهَبَ ٱلْمُعَلِّمُونَ إِلَىٰ بَيْتٍ.]{.ar}  
[pahabA -lmueallimUna EilA baytin.]{.trn}  
"The teachers went to a house."

The above verbal sentence can be rearranged to be a [mubtada]{.subs}-[xabar]{.subs} sentence. This gives more emphasis to the [mubtada]{.subs}. In this case, the verb shall follow the [mubtada]{.subs} and will need a [faa3il]{.subs} pronoun after it.
...
### Verbs with multiple [faa3il]{.subs}s mentioned individually

If there are multiple [faa3il]{.subs}s of a verb, and each is mentioned individually, then there is often more than one way to handle them. Here we will give the more common usage.

If the verb is followed by multiple [faa3il]{.subs}s, only the first is the true [faa3il]{.subs} with respect to  modifying the verb according to its gender and number. Examples:
...
If the [faa3il]{.subs}s consist of different persons (speaking person, addressed person, and absent person), then they are placed in order of strength: The speaking person is stronger than the addressed person, who is stronger than the absent person. The verb [faa3il]{.subs} pronoun of the first (true) [faa3il]{.subs} is then used. Example:
  
[ذَهَبْتُ أَنَا وَأَنْتَ وَهُوَ.]{.ar}  
[pahabtu Eana waEanta wahuwa.]{.trn}  
"I, you, and he went."

Note how the speaking person detached pronoun [أَنَا]{.ar} [Eana]{.trn} is used in addition to the [faa3il]{.subs} pronoun [تُ]{.ar} [-tu]{.trn} in order to add [وَ]{.ar} [wa]{.trn} "and" to it.

If the sentence is a [mubtada]{.subs}-[xabar]{.subs} sentence, and the verb is in the [xabar]{.subs}, then the [faa3il]{.subs} pronoun corresponding to the number of the [mubtada]{.subs} is used. Examples:
...
<!--If the verb follows the [faa3il]{.subs}s, then it will have the [faa3il]{.subs} pronoun corresponding to number of the [faa3il]{.subs}s. Example:-->
...
If the [faa3il]{.subs}s consist of both male and female persons, then the verb will have the masculine [faa3il]{.subs} prenoun corresponding to the number of the [faa3il]{.subs}s. Example:
