...
Note, as well, that the describer [وَاسِعَةٍ]{.ar} is [tanwin]{.subs}ed as it is indefinite and fully-flexible. The inability of its describee 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ 
to be [tanwin]{.subs}ed (because of its semi-flexibility) does not affect the describer.
