...
|:---|---:|
|Verb               | [الفِعْل]{.ar}         |
|[#mADI]{.trn2} verb       | [الفِعْل الماضِي]{.ar}  |
|[#muDArie]{.trn2} verb    | [الفِعْل المُضارِع]{.ar} |
|Verbal sentence           | [الجُمْلة الفِعْلِيّة]{.ar}|
|Past tense         | [الماضِي/المُضِيّ]{.ar}   |
|Present tense      | [الحال]{.ar}   |
|Future tense       | [الاسْتِقْبال]{.ar}|
|Doer          | [الفاعِل]{.ar}|
|Direct doee          | [المَفْعُول بِه]{.ar}|
|Latent doer | [الفاعِل المُسْتَتِر]{.ar}|
...
1. The _[mADI]{.trn2}_ verb.
2. The _[muDArie]{.trn2}_ verb.

Here is the [mADI]{.trn2}-[muDArie]{.trn2} verb pair for the Arabic equivalent of the English verb [to go]{.trans}:

|[#mADI]{.trn2} |[#muDArie]{.trn2} |
|:---|:---|
...
A [mADI]{.trn2} and [muDArie]{.trn2} form pair
exists for (almost) all verbs.

In this chapter we will study the [mADI]{.trn2} form of the verb.

<!--
We will study the [muDArie]{.trn2} verb and the verb of command in later chapters, if Allāh wills.
-->
<!--
Verbs can be either _[mADI]{.trn2}_ verbs where the action of the verb has been completed, e.g., "The boy went." or _[muDArie]{.trn2}_ verbs where the action of the verb is on-going or not yet completed, e.g., "The boy goes." In this chapter we will study _[mADI]{.trn2}_ verbs.
-->

## Tense and aspect

You may be wondering why the same verb in Arabic will have both
a [mADI]{.trn2} form and a [muDArie]{.trn2} form.
...
In Arabic, the [mADI]{.trn2} form verb is typically used to express the perfect aspect.
And the [muDArie]{.trn2} verb is typically used to express the imperfect aspect.^[Al-Dobaian, "A Syntactic Analysis of Arabic Tense and Aspect"]

But we would like to keep our terminology for these verb forms separate from any tense or aspect that a sentence using them may signify.^[Weigelt, F. "The particle _la-_ in Classical Arabic"]
That is why we are calling them [mADI]{.trn2} and [muDArie]{.trn2},
instead of _perfect_ and _imperfect_, respectively.

By the way, [mADI]{.trn2} literally means _past_ in Arabic.
...
(See @sec-jsh, for example, where the [mADI]{.trn2} verb is used very commonly in a future tense.)
...
Not only nouns, but verbs, too, are derived from roots. All verbs are derived from their roots in a fixed set of patterns called _forms_ which are numbered 1 onward. For example, the [mADI]{.trn2} form 2 verb pattern is [فَعَّلَ]{.ar} [faeeala]{.trn} and the [mADI]{.trn2} form 3 verb pattern is [فَاعَلَ]{.ar} [fAeala]{.trn}. There are approximately 9-10 forms that are in common usage. In addition, there are a few higher order forms (11 onward) that are less common. In this chapter will study the [mADI]{.trn2} form 1 verb only.

## The form 1 [mADI]{.trn2} verb

Here are some examples of [mADI]{.trn2} form 1 verbs in Arabic:

|Root | [#mADI]{.trn2} form 1 verb| Meaning|
|:----|:----|:----|
...
Note, also, that the [mADI]{.trn2} form 1 verb consists only of the three letters of the root. The first and the final letter always have an [fatHah]{.trn2} while the middle letter's vowel is variable. It may have an [fatHah]{.trn2}, [kasrah]{.trn2}, or an [Dammah]{.trn2}, depending on the verb. Using the paradigm root [فعل]{.ar}, we can say that the form 1 verb occurs in the patterns [فَعَلَ]{.ar}, [فَعِلَ]{.ar}, and [فَعُلَ]{.ar}. 

A good dictionary will tell us the middle vowel mark of a particular verb. However, as a trend, the [fatHah]{.trn2} is the most common for the middle vowel mark, followed by the [kasrah]{.trn2}, while the [Dammah]{.trn2} is the least common.
...
We have already learned of nounal sentences. Here we will learn of a new type of sentence called a _verbal sentence_. A verbal sentence is one that begins with a verb.
...
we will use the [mADI]{.trn2} verb, thus:

(@) [ذَهَبَ ٱلْغُلَامُ]{.ar}  
    [pahaba -lgulAmu]{.trn}  
    [The boy went.]{.trans}

[ذَهَبَ]{.ar} [pahaba]{.trn} [went]{.ar} is the verb and [ٱلْغُلَامُ]{.ar} [algulAmu]{.trn} "the boy" is the doer. Note how the doer is in the u-case. Also note that in English the doer comes before the verb whereas in Arabic the doer comes after the verb in sentence word order. We can state this as a rule of Arabic grammar: 

**In Arabic, every verb in a sentence shall have a doer noun. The doer noun shall be in the u-case and shall come after the verb in sentence word order.**

<!--In Arabic, a doer noun shall always be in the u-case and shall come after the verb in word order.
...
Note that whether or not we add a helper vowel to [تْ]{.ar}, the letter before it always has an [fatHah]{.trn2}.
-->
...
In this sentence, "wrote" is the verb, "the man" is the doer, and "a book" is what we shall call the _doee_. 
In fact, it is what we shall call a _direct doee_ because 
...
Note how in Arabic the doee [كِتَابًا]{.ar} [kitAban]{.trn} "a book" is in the a-case. This is because, in Arabic, verbs shall cause a direct doee to be in the a-case. This is true whether the direct doee is definite or indefinite. Here is another example:
...
Note again how [ٱلْجَارِيَةَ]{.ar} [aljAriyata]{.trn} "the girl" is in the a-case because it is a direct doee.

### Multiple direct doees

Some verbs can take more than one direct doee. In this case, all direct doees shall be in the a-case. For example,

[جَعَلَ ٱللَّـٰهُ ٱلرَّجُلَ مُسْلِمًا.]{.ar}  
[jaeala -llAhu -rrajula muslimA.]{.trn}  
"[#allAh]{.trn2} made the man a Muslim."

In this sentence both [ٱلرَّجُلَ]{.ar} [arrajula]{.trn} "the man" and [مُسْلِمًا]{.ar} [musliman]{.trn} "a Muslim" are direct doees of the verb [جَعَلَ]{.ar} [jaeala]{.trn} and therefore both are placed in the a-case.
...
In this sentence [ٱَلْقَمَرِ]{.ar} [alqamari]{.trn} "the moon" is an indirect doee of the verb [نَظَرَ]{.ar} [naPara]{.trn} "looked" because it is preceded by the preposition [إِلَىٰ]{.ar} [EilA]{.trn} "to". The preposition, as usual, causes the word after it (the indirect doee [ٱَلْقَمَرِ]{.ar} [Ealqamari]{.trn}) to be in the i-case, as opposed to the a-case of the direct doee.
...
Some verbs take a direct doee and another indirect doee, both at the same time. For example,
...
[ٱَلْمُعَلِّمَةَ]{.ar} [Ealmueallimata]{.trn} "the teacher~f~" is the direct doee, and therefore it is in the a-case.
[أَمْرٍ]{.ar} [Eamrin]{.trn} "a matter" is an indirect doee, and so it is in the i-case.
...
For this we will have to learn a third category of pronoun pronouns called _doer pronouns_ for [mADI]{.trn2} verbs.
doer pronouns are of two types: (i) expressed and  (ii) implied.
...
As you can see, all we did was omit the doer-noun [ٱَلرَّجُل]{.ar} [Earrujul]{.trn}, and we didn't add any word to replace it as the doer pronoun. This is because the doer pronoun for "he" is implied and automatically comes into place when we omit the doer noun.

The doer pronoun for "she" is similarly implied.
...
Why do we have to go to all the trouble of saying that the doer-pronouns of the singular absentee-participants "he" and "she" are implied? 
Why can't we simply say that there are no doer-pronouns for the singular absentee-participants?
...
That is: -->
we need to be able to state, as a rule of grammar, that every verb needs to have its own doer, whether expressed or implied. 
Later, 
if [#allAh]{.trn2} wills,
when we study verbs with dual and plural doers we will see that this will make a difference in the formation of the verb.
<!--And that doer shall come after the verb in sentence word order.-->
...
It is only the doer pronouns for the singular absentee participant that are implied for [mADI]{.trn2} verbs. The doer pronouns for the singular addressee and speaker participants are expressed.
The expressed doer pronouns are attached to the verb.

Here we show how the expressed doer pronouns are attached to the verb using the root paradigm [فعل]{.ar}. The middle root letter ([ع]{.ar}) has an [fatHah]{.trn2} [◌َ]{.ar} here but this vowel will vary for other verbs.
...
Note also how the expressed singular doer pronouns modify the verb by replacing the [fatHah]{.trn2} [◌َ]{.ar} on its final letter by a [sukUn]{.trn2} [◌ْ]{.ar}.
...
Here are some examples of sentences with expressed doer pronouns:
...
When we add a expressed doer pronoun to this verb, we get:
...
+ If the doer pronoun is implied, then the doee pronoun shall be attached to the verb again directly with only a possible [تْ]{.ar} of femininity intervening. For example:
...
+ An intervening [ن]{.ar} is always used between the verb and the speaker-participant doee pronoun variants [◌ِي]{.ar} [-I]{.trn} and [◌ِيَ]{.ar} [-iya]{.trn}. Remember that these pronouns force any consonant before it to have a [kasrah]{.trn2} [◌ِ]{.ar}. Therefore, the combination will be written as [نِي]{.ar} [-nI]{.trn} and [نِيَ]{.ar} [-niya]{.trn} respectively. For example:
  ...
  If there is an expressed doer pronoun, the intervening [ن]{.ar} shall come after it so that the [ن]{.ar} is always connected to the doee pronoun. For example,
...
The subsequent verbs all have doers too but they are the implied doer pronouns for the singular feminine absentee participant. That is why we don't write them. Note also that every verb has the [تْ]{.ar} of femininity attached to it to indicate its singular feminine absentee doer.
<!--
...
It may appear as if [ٱَلرَّجُلُ]{.ar} [arrajulu]{.trn} is the doer and it is coming before the verb [كَتَبَ]{.ar} [kataba]{.trn}. But actually, this is not the case. As a matter of fact, this sentence is basically a nounal sentence. 

Here [ٱَلرَّجُلُ]{.ar} [arrajulu]{.trn} "the man" is the subject of the sentence, and [كَتَبَ كِتَابًا]{.ar} [kataba kitAban]{.trn} "he wrote a book", itself a verbal sentence with an implied doer pronoun, is the info about the subject. So the translation of the sentence is technically:
...
## Negating [mADI]{.trn2} verbs

In order to negate a [mADI]{.trn2} verb, the particle [مَا]{.ar} [mA]{.trn} is placed before it. This gives the meaning of the action of the verb did not get, or has not got, done. So for example:
...
The particle [قَدْ]{.ar} [qad]{.trn}, when placed before a [mADI]{.trn2} verb emphasizes that the action of the verb has already or definitely occured.
