...
1. The _[mADI]{.trn2}_ verb, for example [ذَهَبَ]{.ar} [to go]{.trans}
2. The _[muDArie]{.trn2}_ verb, for example [يَذْهَب]{.ar} [to go]{.trans}

<!--
3. The _verb of command_. This is used for commands.
-->

The same verb will typically have a [mADI]{.trn2} form and a [muDArie]{.trn2} form,
...
(See @sec-jsh, for example, where the [mADI]{.trn2} verb is used very commonly for a future tense meaning.)
