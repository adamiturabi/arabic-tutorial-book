...
1. The _perfect_ verb. This typically signifies the past tense.
...
In this chapter we will study the perfect verb.
We will study the stateful verb and the verb of command in later chapters, if Allāh wills.

<!--
Verbs can be either _perfect_ verbs where the action of the verb has been completed, e.g., "The boy went." or _stateful_ verbs where the action of the verb is on-going or not yet completed, e.g., "The boy goes." In this chapter we will study _perfect_ verbs.
-->
...
Not only nouns, but verbs, too, are derived from roots. All verbs are derived from their roots in a fixed set of patterns called _forms_ which are numbered 1 onward. For example, the perfect form 2 verb pattern is [فَعَّلَ]{.ar} [faeeala]{.trn} and the perfect form 3 verb pattern is [فَاعَلَ]{.ar} [fAeala]{.trn}. There are approximately 9-10 forms that are in common usage. In addition, there are a few higher order forms (11 onward) that are less common. In this chapter will study the perfect form 1 verb only.

## The form 1 perfect verb

Here are some examples of perfect form 1 verbs in Arabic:

Root | Perfect form 1 verb| Meaning
:----|:----|:----
...
Note, also, that the perfect form 1 verb consists only of the three letters of the root. The first and the final letter always have an [fatHah]{.trn2} while the middle letter's vowel is variable. It may have an [fatHah]{.trn2}, [kasrah]{.trn2}, or an [Dammah]{.trn2}, depending on the verb. Using the paradigm root [فعل]{.ar}, we can say that the form 1 verb occurs in the patterns [فَعَلَ]{.ar}, [فَعِلَ]{.ar}, and [فَعُلَ]{.ar}. 
...
For this we will have to learn a third category of pronoun pronouns called _doer pronouns_ for perfect verbs.
...
It is only the doer pronouns for the singular absentee participant that are implied for perfect verbs. The doer pronouns for the singular addressee and speaker participants are expressed.
...
## Negating perfect verbs

In order to negate a perfect verb, the particle [مَا]{.ar} [mA]{.trn} is placed before it. This gives the meaning of the action of the verb did not get, or has not got, done. So for example:
...
The particle [قَدْ]{.ar} [qad]{.trn}, when placed before a perfect verb emphasizes that the action of the verb has already or definitely occured.
