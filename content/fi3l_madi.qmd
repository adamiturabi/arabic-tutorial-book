...
1. The _caseless_ verb. This typically signifies the past tense.
2. The _caseful_ verb. This usually signifies the present or future tenses, but in some formations, it can be used for the past tense as well.
3. The _verb of command_. This is used for commands.

In this chapter we will study the caseless verb.
We will study the caseful verb and the verb of command in later chapters, if Allāh wills.

<!--
Verbs can be either _caseless_ verbs where the action of the verb has been completed, e.g., "The boy went." or _caseful_ verbs where the action of the verb is on-going or not yet completed, e.g., "The boy goes." In this chapter we will study _caseless_ verbs.
-->
...
Not only nouns, but verbs, too, are derived from roots. All verbs are derived from their roots in a fixed set of patterns called _forms_ which are numbered 1 onward. For example, the caseless form 2 verb pattern is [فَعَّلَ]{.ar} [faeeala]{.trn} and the caseless form 3 verb pattern is [فَاعَلَ]{.ar} [fAeala]{.trn}. There are approximately 9-10 forms that are in common usage. In addition, there are a few higher order forms (11 onward) that are less common. In this chapter will study the caseless form 1 verb only.

## The form 1 caseless verb

Here are some examples of caseless form 1 verbs in Arabic:

Root | Caseless form 1 verb| Meaning
:----|:----|:----
...
Note, also, that the caseless form 1 verb consists only of the three letters of the root. The first and the final letter always have an [fatHah]{.trn2} while the middle letter's vowel is variable. It may have an [fatHah]{.trn2}, [kasrah]{.trn2}, or an [Dammah]{.trn2}, depending on the verb. Using the paradigm root [فعل]{.ar}, we can say that the form 1 verb occurs in the patterns [فَعَلَ]{.ar}, [فَعِلَ]{.ar}, and [فَعُلَ]{.ar}. 
...
For this we will have to learn a third category of pronoun pronouns called _doer pronouns_ for caseless verbs.
...
It is only the doer pronouns for the singular absentee participant that are implied for caseless verbs. The doer pronouns for the singular addressee and speaker participants are expressed.
...
## Negating caseless verbs

In order to negate a caseless verb, the particle [مَا]{.ar} [mA]{.trn} is placed before it. This gives the meaning of the action of the verb did not get, or has not got, done. So for example:
...
The particle [قَدْ]{.ar} [qad]{.trn}, when placed before a caseless verb emphasizes that the action of the verb has already or definitely occured.
