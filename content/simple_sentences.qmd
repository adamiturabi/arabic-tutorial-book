...
# [_mubtada]{.term}-[xabar]{.term} sentences

## Introduction

In this chapter we will learn about a class of sentences called _[mubtada]{.term}-[xabar]{.term} sentences._ 
[_mubtada]{.term}-[xabar]{.term} sentences consist of two parts:

i. The _[mubtada]{.term}_. This is the topic of the sentence.
ii. The _[xabar]{.term}_. This gives us some [xabar]{.term} about the [mubtada]{.term}.

## Forming [mubtada]{.term}-[xabar]{.term} sentences

Here is a [mubtada]{.term}-[xabar]{.term} sentence:
...
The [mubtada]{.term} of the sentence is "the building". This means that the sentence is about "the building". 

The [xabar]{.term} is "a house". This means that the [xabar]{.term} that the sentence is giving us about the [mubtada]{.term} is that it is "a house".
...
Next we put them both in the u-state. For [mubtada]{.term}-[xabar]{.term} sentences, both the [mubtada]{.term} and the [xabar]{.term} shall be in the u-state. Remember that the u-state is formed by putting a [nUn]{.trn2}ated [u]{.trn}-mark [◌ٌ]{.ar} at the end of an indefinite noun, and a [u]{.trn}-mark [◌ُ]{.ar} at the end of a definite noun. Here are the two nouns in the u-state:

i. [ٱَلْبِنَاءُ]{.ar} [EalbinAEu]{.trn} (masc.) "the building" (u-state)
ii. [بَيْتٌ]{.ar} [baytun]{.trn} (masc.) "a house" (u-state)

In order to form this sentence in Arabic, we put the [mubtada]{.term} first and then the [xabar]{.term}. So we get:
...
i.  The [mubtada]{.term}: [ٱَلْبَيْتُ]{.ar} [Ealbaytu]{.trn} (masc.) "the house" (u-state)
ii. The [xabar]{.term}: [بِنَاءٌ]{.ar} [binAEun]{.trn} (masc.) "a building" (u-state)

And then we put them together, first the [mubtada]{.term} and then the [xabar]{.term}:
...
## Matching the gender between the [mubtada]{.term} and the [xabar]{.term}

In the sentences above, both the [mubtada]{.term} and the [xabar]{.term} were masculine nouns. Now let's try forming a sentence where the [mubtada]{.term} and the [xabar]{.term} have different genders. Let's try saying:

"The building is a school."

i.   The [mubtada]{.term}: [ٱَلْبِنَاءُ]{.ar} [EalbinAEu]{.trn} (masc.) "the building" (u-state)
ii.  The [xabar]{.term}: [مَدْرَسَةٌ]{.ar} [madrasatun]{.trn} (fem.) "a school" (u-state)

In the same manner as before, we form the sentence by first writing the [mubtada]{.term} and then the [xabar]{.term}:
...
So we see that it is quite normal to have a sentence where the gender of the [mubtada]{.term} does not match the gender of the [xabar]{.term}. 
...
If either the [mubtada]{.term} or the [xabar]{.term} is a genderizable noun, the in this case the [mubtada]{.term} and the [xabar]{.term} are made to match each other in gender. For example, let's try to form the sentence:
-->
This is because the words we have dealt with so far denote animate objects.
If either the [mubtada]{.term} or the [xabar]{.term} denote animate beings, then in this case the [mubtada]{.term} and the [xabar]{.term} often do match each other in gender. For example, let's try to form the sentence:

"The mother is a teacher."

Here are the indiviual words that we will use to form the sentence:

i.  The [mubtada]{.term}: "the mother": [ٱَلْأُمُّ]{.ar} [EalEummu]{.trn} (fem.) (u-state).
ii. The [xabar]{.term}: "a teacher". We have two words for "a teacher" in Arabic: 
...
[مُعَلِّمَة]{.ar} [mueallimah]{.trn} (fem.) "a (female) teacher",
which is now the [mubtada]{.term} of the sentence, to match the feminine noun in the [xabar]{.term} 
...
<!--If the [mubtada]{.term} and the [xabar]{.term} apply to animate beings, then even if they are not genderizable, they will usually match each other in gender in order for the sentence to be meaningful. For example:-->
...
<!--
In the above sentence, both the [mubtada]{.term}
[ٱَلرَّجُل]{.ar}
[Earrujul]{.trn}
(masc.) "the man"
and the [xabar]{.term}
...
But if one of the non-genderizable nouns can be applied to both physical genders then the [mubtada]{.term} and [xabar]{.term} may mismatch in gender. For example, the noun [شَخْص]{.ar} [caxS]{.trn} "a person" is a masculine noun that is applied to both male and female persons. So if the person being referred to is a woman, for example, then we can get an apparent mismatch in gender between the grammatical gender of the [mubtada]{.term} and the grammatical [mubtada]{.term} of the [xabar]{.term}. Example:
-->
...
In the above examples, the grammatical genders mismatch between the [mubtada]{.term} and the [xabar]{.term}. But this is because we are matching with the physical gender of the person represented by the masculine noun [شَخْص]{.ar} [caxS]{.trn} "a person", not its grammatical gender.
...
and "a building" is [بِنَاءٌ]{.ar} [binAEun]{.trn}. In order to say "The house is a building" we put the [[mubtada]{.term}]{.syn} first and put its [[xabar]{.term}]{.syn} after it. Both the [[mubtada]{.term}]{.syn} and the [[xabar]{.term}]{.syn} are put in the u-state.

This kind of sentence is called a [[mubtada]{.term}-[xabar]{.term}]{.syn} sentence. It consists of two parts:

1. The part before "is": "the house". This is who the sentence is about. We call this the [[mubtada]{.term}]{.syn} of the sentence.
2. The part after "is": "a building". This is telling us some [xabar]{.term} about the [[mubtada]{.term}]{.syn}. We call this the [[xabar]{.term}]{.syn}.

Arabic does not normally express the word "is". In order to express this sentence in Arabic we put the [[mubtada]{.term}]{.syn} first and then the [[xabar]{.term}]{.syn}. For these simple sentences the [[mubtada]{.term}]{.syn} and the [[xabar]{.term}]{.syn} will be in the u-state.

"The house" is [ٱَلْبَيْتُ]{.ar} [albaytu]{.trn} and "a building" is [بِنَاءٌ]{.ar} [binAEun]{.trn}. In order to say "The house is a building" we put the [[mubtada]{.term}]{.syn} first and put its [[xabar]{.term}]{.syn} after it. Both the [[mubtada]{.term}]{.syn} and the [[xabar]{.term}]{.syn} are put in the u-state.
...
Note that, in this sentence, the [[mubtada]{.term}]{.syn} [ٱَلْحَيَوَانُ]{.ar} [alHayawAnu]{.trn} "the animal" is a masculine noun. And the [[xabar]{.term}]{.syn} 
[هِرَّةٌ]{.ar} [hirratun]{.trn} "a cat" is a feminine noun. So the [[mubtada]{.term}]{.syn} and the [[xabar]{.term}]{.syn} do not match in gender. This is perfectly normal. We make the [[xabar]{.term}]{.syn} match the [[mubtada]{.term}]{.syn} in gender only if:

1. There are separate words for the masculine and feminine nouns for the [[xabar]{.term}]{.syn}, and
2. Only one of the two words can be correctly applied to the [[mubtada]{.term}]{.syn}.

In this case there were separate words for the masculine and feminine nouns for the [[xabar]{.term}]{.syn}:

+ [هِرٌّ]{.ar} [hirrun]{.trn} "a male cat"
+ [هِرَّةٌ]{.ar} [hirratun]{.trn} "a female cat"

but both of these can be applied to the [[mubtada]{.term}]{.syn}, because the [[mubtada]{.term}]{.syn} [ٱَلْحَيَوَانُ]{.ar} [alHayawAnu]{.trn} (masc.) "the animal" is used for both male and female animals. [هِرَّةٌ]{.ar} [hirratun]{.trn} is chosen because it is commonly used for "a cat" as we have already explained.

We have already seen an example of matching the gender of the [[xabar]{.term}]{.syn} with the [[mubtada]{.term}]{.syn} in the example:
...
In order to explain the usage of pronouns, we will first show a sentence with a noun [mubtada]{.term}:

"The man is a teacher."

Now we you can replace the definite [mubtada]{.term} noun "the man" with the pronoun "he":
...
+ [ٱَلْبِنَاءُ مَدْرَسَةٌ.]{.ar}  
  ...
  Note that either [هُوَ]{.ar} [huwa]{.trn} "he" or [هِيَ]{.ar} [hiya]{.trn} "she" can be used in the above sentence because the gender of the [mubtada]{.term} [ٱَلْبِنَاء]{.ar} [EalbinAE]{.trn} (masc.) "the building" mismatches the gender of the [xabar]{.term} [مَدْرَسَة]{.ar} [madrasah]{.trn} (fem.) "a school.".

  In such cases where the genders of the [mubtada]{.term} and the [xabar]{.term} do not match, then, generally speaking, the pronoun for either gender could be employed with the following guideline:

  Prefer to match the gender of the [mubtada]{.term} pronoun with the gender of the [xabar]{.term}, unless the noun being replaced with a pronoun is an animate being, in which case prefer to use the gender of the animate being. 

  So in the above sentence we will prefer to use [هِيَ مَدْرَسَةٌ.]{.ar} [hiya madrasah.]{.trn} because the [xabar]{.term} [مَدْرَسَةٌ]{.ar} [madrasatun]{.trn} "a school" is feminine.

+ Here is an example with an animate being as the [mubtada]{.term}:
  ...
  Here, if we replace the noun [ٱَلْجَارِيَة]{.ar} [EaljAriyah]{.trn} "the girl" with a pronoun, we will prefer to use [هِيَ]{.ar} [hiya]{.trn} "she", because the girl is an animate being, even though the [xabar]{.term} [إِنْسَانٌ]{.ar} [EinsAnun]{.trn} "a human" is masculine.
...
## A definite noun as the [xabar]{.term} {#chap-smp-sent-sec-def-info}

In all the examples so far, the [xabar]{.term} has been an indefinite noun: "a building", "a teacher", "a cat", etc. It is also possible for the [xabar]{.term} to be a definite noun:
...
The above sentence, although correct, is ambiguous. It can also be interpreted as a noun-phrase, meaning "the teacher-man", instead of the complete sentence "The man is the teacher~m~." Therefore, in order to disambiguate and make it clear that we mean the complete sentence, a _disambiguating pronoun_ is usually (but not always) inserted between the [mubtada]{.term} and the [xabar]{.term}.
Disambiguating pronouns are detached pronouns that match the [mubtada]{.term} of the sentence in gender. With a disambiguating pronoun, the sentence above becomes:

[ٱَلرَّجُلُ هُوَ ٱلْمُعَلِّمُ.]{.ar}  
[Earrajulu  huwa -lmueallim.]{.trn}  
"The man is the teacher~m~."

The disambiguating pronoun here is [هُوَ]{.ar} [huwa]{.trn} and is not translated. Here are some more examples of sentences with definite [xabar]{.term}s and disambiguating pronouns.
...
## An indefinite noun as the [mubtada]{.term}

In all the sentences we have seen so far, the [mubtada]{.term} has always been a definite noun. This is usually the case. A [mubtada]{.term} needs a certain amount of _weight_ in order to be the first word in a sentence. And being definite gives it this needed weight. That is: "the man" is grammatically _heavier_ than "a man". So it is easier to start a sentence with "the man".

So can we even have a sentence that has an indefinite [mubtada]{.term}? For example:
<!--How about making the [mubtada]{.term} an indefinite noun? Can we say:-->

+ A house is a building.
+ A man is the teacher.

Yes, it is possible, but sentences where the [mubtada]{.term} is an indefinite noun are not as straightforward to express in Arabic. We will explore some ways of expressing them later if [_allAh]{.trn2} wills.
