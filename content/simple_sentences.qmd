...
Next we put them both in the u-state. For [mubtada]{.subs}-[xabar]{.subs} sentences, both the [mubtada]{.subs} and the [xabar]{.subs} shall be in the u-state. Remember that the u-state is formed by putting a [nUn]{.trn2}ated [u]{.trn}-mark [◌ٌ]{.ar} at the end of an indefinite noun, and a [u]{.trn}-mark [◌ُ]{.ar} at the end of a definite noun. Here are the two nouns in the u-state:
