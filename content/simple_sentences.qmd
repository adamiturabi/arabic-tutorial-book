...
Next we put them both in the u-state. For [mubtada]{.subs}-[xabar]{.subs} sentences, both the [mubtada]{.subs} and the [xabar]{.subs} shall be in the u-state. Remember that the u-state is formed by putting a [tanwin]{.subs}ed [umark]{.subs} [◌ٌ]{.ar} at the end of an indefinite noun, and a [umark]{.subs} [◌ُ]{.ar} at the end of a definite noun. Here are the two nouns in the u-state:
...
i.  The [mubtada]{.subs}: [ٱَلْبَيْتُ]{.ar} [Ealbaytu]{.trn} (masc.) "the house" (u-state)
ii. The [xabar]{.subs}: [بِنَاءٌ]{.ar} [binAEun]{.trn} (masc.) "a building" (u-state)
...
i.   The [mubtada]{.subs}: [ٱَلْبِنَاءُ]{.ar} [EalbinAEu]{.trn} (masc.) "the building" (u-state)
ii.  The [xabar]{.subs}: [مَدْرَسَةٌ]{.ar} [madrasatun]{.trn} (fem.) "a school" (u-state)
...
i.  The [mubtada]{.subs}: "the mother": [ٱَلْأُمُّ]{.ar} [EalEummu]{.trn} (fem.) (u-state).
...
and "a building" is [بِنَاءٌ]{.ar} [binAEun]{.trn}. In order to say "The house is a building" we put the [[mubtada]{.subs}]{.syn} first and put its [[xabar]{.subs}]{.syn} after it. Both the [[mubtada]{.subs}]{.syn} and the [[xabar]{.subs}]{.syn} are put in the u-state.
...
Arabic does not normally express the word "is". In order to express this sentence in Arabic we put the [[mubtada]{.subs}]{.syn} first and then the [[xabar]{.subs}]{.syn}. For these simple sentences the [[mubtada]{.subs}]{.syn} and the [[xabar]{.subs}]{.syn} will be in the u-state.

"The house" is [ٱَلْبَيْتُ]{.ar} [albaytu]{.trn} and "a building" is [بِنَاءٌ]{.ar} [binAEun]{.trn}. In order to say "The house is a building" we put the [[mubtada]{.subs}]{.syn} first and put its [[xabar]{.subs}]{.syn} after it. Both the [[mubtada]{.subs}]{.syn} and the [[xabar]{.subs}]{.syn} are put in the u-state.
