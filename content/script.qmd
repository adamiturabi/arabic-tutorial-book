...
1.  [a]{.trn} as the first vowel in English “manipulate”, written with an [amark]{.subs} [◌َ]{.ar} which is a small diagonal line above the letter like [مَـ]{.ar} [ma]{.trn}.
1.  [i]{.trn} as in English “bit”, written with an [imark]{.subs} [◌ِ]{.ar} which is a small diagonal line under the letter like [بِـ]{.ar} [bi]{.trn}.
1.  [u]{.trn} as in English “put”, written with an [umark]{.subs} [◌ُ]{.ar} which is like a tiny [و]{.ar} [wAw]{.trn2} above the letter like [فُـ]{.ar} [fu]{.trn}.
...
1.  [A]{.trn} generally written with an unmarked [alif]{.trn2} [ا]{.ar} and with the preceding letter having an [amark]{.subs}. Example [مَا]{.ar} [mA]{.trn}. This vowel is mostly pronounced like the vowel in English “man”. If however, it comes after these letters [خ،ر،ص،ض،ط،ظ،غ،ق]{.ar} it is pronounced like English "awe".
1.  [I]{.trn} like in English “meek” written with an unmarked [ي]{.ar} [yAE]{.trn2} with the preceding letter having an [imark]{.subs}. Example [فِي]{.ar} [fI]{.trn}.
1.  [U]{.trn} like in English “moon” written with an unmarked [و]{.ar} [wAw]{.trn2} with the preceding letter having an [umark]{.subs}. Example [ذُو]{.ar} [pU]{.trn}.
...
### Zero-vowel written with a [0mark]{.subs}

As we have seen above if an Arabic letter has a vowel after it it will take one of the three pronunciation marks: [◌َ]{.ar}, [◌ِ]{.ar}, [◌ُ]{.ar}. If, however, there is no vowel after the letter we will put a zero-vowel [0mark]{.subs} on it [◌ْ]{.ar}. This mark can generally only occur if there is a short vowel before the letter. Examples:
...
1. [aw]{.trn} like in English “show”. This is written with a [wAw]{.trn2} with a [0mark]{.subs} on it and a short [a]{.trn} vowel before it. Example [لَوْ]{.ar} [law]{.trn}. 
2. [ay]{.trn} like in English “bait”. This is written with a [yAE]{.trn2} with a [0mark]{.subs} on it and a short [a]{.trn} vowel before it. Example [كَيْ]{.ar} [kay]{.trn}. 
...
1. [Aw]{.trn} like in English “cow”. This is written with a [wAw]{.trn2} with a [0mark]{.subs} on it and a long [A]{.trn} vowel before it. Example [وَاوْ]{.ar} [wAw]{.trn}. 
2. [Ay]{.trn} like in English “bye”. This is written with a [yAE]{.trn2} with a [0mark]{.subs} on it and a long [A]{.trn} vowel before it. Example [شَايْ]{.ar} [cAy]{.trn}.

These long semi-vowels are rare and may only occur at the end of a sentence.

### Doubled letters

A word may contain "doubled" letters. This is when the same letter occurs, one after the other; the first letter has a [0mark]{.subs}, and the second letter has a vowel. For example, in the word [قَتْتَلَ]{.ar} [qattala]{.trn}, the letter [ت]{.ar} is doubled. When this occurs, we actually only write the letter once and put a "[shaddah]{.subs}" [◌ّ]{.ar} on it, like so: [قَتَّلَ]{.ar} [qattala]{.trn}. When pronouncing this word, stop at and stress the doubled letter [qattala]{.trn} and make sure it does not sound like the undoubled letter in [قَتَلَ]{.ar} [qatala]{.trn}. Examples with doubled letters:

+ [كَبَّرَ]{.ar} [kabbara]{.trn}
+ [حَدُّهُ]{.ar} [Hadduhu]{.trn}
+ [فَعَّالَ]{.ar} [faeeAla]{.trn}
+ [سِكِّينُ]{.ar} [sikkInu]{.trn}. Note that the [imark]{.subs} is below the [shaddah]{.subs} but above the letter [ك]{.ar}. This is the most common way to write this, although having the [imark]{.subs} below the letter is also sometimes done as well. (In this case, the [shaddah]{.subs} will still be above the letter.)
...
This is called _[tanwin]{.subs}_.
[_tanwin]{.subs} is indicated in writing,
...
<!--
Arabic also has three distinctive pronunciation marks, collectively called [tanwin]{.subs}s.

1. [tanwin]{.subs}ed [amark]{.subs} [◌ً]{.ar}
1. [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar}
1. [tanwin]{.subs}ed [umark]{.subs} [◌ٌ]{.ar}

These [tanwin]{.subs}s may only occur on a letter at the end of a word. They are pronounced as a short vowel ([a]{.trn}, [i]{.trn}, or [u]{.trn}) followed by an [n]{.trn}. For example, [سَالِمٌ]{.ar} [sAlimun]{.trn}, [سَالِمٍ]{.ar} [sAlimin]{.trn}.
...
The [tanwin]{.subs}ed [amark]{.subs} [◌ً]{.ar} has specific spelling rules: Generally, 
...
Here are some examples of [tanwin]{.subs}ed words:
...
Some words in arabic begin with a [0mark]{.subs}. When this occurs a connecting [hamzah]{.trn2} [ٱ]{.ar} (written as a tiny [صـ]{.ar} on an [alif]{.trn2}) is put before it. If this word comes in the beginning of the sentence the connecting alif is pronounced as a [hamzah]{.trn2}. Otherwise this connecting [hamzah]{.trn2} is not pronounced and the word is connected to the final vowel of the previous word in pronunciation. In this tutorial we will transcribe the connecting [hamzah]{.trn2} with a hyphen "-". Examples of connecting [hamzah]{.trn2}:
...
When a word is at the end of a sentence and it ends with a long vowel, then the final long vowel is pronounced normally. However, when a word at the end of a sentence does not end with a long vowel, then the final letter's pronunciation mark is pronounced as a [0mark]{.subs} when vocalizing the sentence. If the final letter is a [ة]{.ar} then it is pronounced as a [ه]{.ar} [hAE]{.trn2} with a [0mark]{.subs}. 
...
If however, the final letter's pronunciation mark is a [an]{.trn} mark then it is pronounced as a long-[A]{.trn} vowel. The only exception is if the final letter were [ةً]{.ar}, in which case it is then pronounced as a [hAE]{.trn2} with a [0mark]{.subs} [هْ]{.ar}. Here are examples of words with [an]{.trn} marks pronounced as if they were at the end of a sentence.
