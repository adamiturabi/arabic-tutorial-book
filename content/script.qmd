...
The principal difference that concerns us is that
the maddah mark [◌ٓ]{.ar} is used in [sca]{.smallcaps} as a replacement for [ءَا]{.ar}.
Whereas,
in the Qurʾānic script [◌ٓ]{.ar} denotes an elongated long [A]{.trn} vowel without a hamzah.
...
There are other minor differences as well, mainly dealing with pronunciation and punctuation.
...
| [يَا ٱبْنَ أُمَّ]{.ar} [yabnaEumma]{.trn} | [یَبۡنَؤُمَّ]{.quran} [[[سورة طه]{.ar} 20:94](https://quran.com/20/94)]{.citex} |
