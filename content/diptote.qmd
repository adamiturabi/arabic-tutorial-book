...
:------|:-----------|:---------
[ustate]{.subs}| [رَجُلٌ]{.ar} | [ٱَلرَّجُلُ]{.ar}
[astate]{.subs}| [رَجُلًا]{.ar}| [ٱَلرَّجُلَ]{.ar}
[istate]{.subs}| [رَجُلٍ]{.ar} | [ٱَلرَّجُلِ]{.ar}
...
As you can see, when [صَحْرَاء]{.ar} [SaHrAE]{.trn} is indefinite, it is not [tanwin]{.subs}ed. Also, when it is indefinite and in the [istate]{.subs}, the vowel mark on its final letter is not [◌ِ]{.ar}, as you might expect but [◌َ]{.ar} . And so the noun looks identical in the [astate]{.subs} and [istate]{.subs} when it is indefinite.
...
2. When indefinite and in the [istate]{.subs}, a semi-flexible noun's final letter does not have an [imark]{.subs}. Instead it shall have an [amark]{.subs}, just like when it is in the [astate]{.subs}.
...
Note that the vowel mark on the final letter of [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} is [◌َ]{.ar}, not [◌ٍ]{.ar}, even though it is indefinite and in the [istate]{.subs} (because it is preceded by the preposition [إِلَىٰ]{.ar} [EilA]{.trn} "to"). This is because it is a semi-flexible noun.

^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ in this sentence
is also a [manut]{.subs}, whose [na3t]{.subs} is [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". The final vowel mark [◌َ]{.ar} on the [manut]{.subs} [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} has no effect on the final vowel mark on the [na3t]{.subs} [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". All that matters in this regard is the state of the [manut]{.subs}. 

Note, also, that the [na3t]{.subs} [وَاسِعَة]{.ar} is feminine to match the gender of the [manut]{.subs} 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^. 

Note, as well, that the [na3t]{.subs} [وَاسِعَةٍ]{.ar} is [tanwin]{.subs}ed as it is indefinite and fully-flexible. The inability of its [manut]{.subs} 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ 
to be [tanwin]{.subs}ed (because of its semi-flexibility) does not affect the [na3t]{.subs}.
...
Since ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^ already ends with the vowel-mark [◌ٰ]{.ar}, the last letter won't have any additional vowel markers and therefore the word will appear the same in all states:
  ...
  State  | Indefinite | Definite
  :------|:-----------|:---------
  [ustate]{.subs}| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  [astate]{.subs}| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  [istate]{.subs}| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
...
Note, again how the [na3t]{.subs} [جَمِيلَة]{.ar} [jamIlah]{.trn} is feminine and in the [ustate]{.subs}, in order to match the gender and state of the [manut]{.subs} ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^.
...
### [#sifah]{.subs}s that end with an extrinsic [ان]{.ar} {[#sifah]{.subs}-an-diptote}
