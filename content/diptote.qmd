...
Note, again how the [naat]{.subs} [جَمِيلَة]{.ar} [jamIlah]{.trn} is feminine and in the [ustate]{.subs}, in order to match the gender and state of the [manut]{.subs} ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^.
