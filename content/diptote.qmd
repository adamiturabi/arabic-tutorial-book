...
Nouns are of two main categories of nouns, with regard to their endings in the different noun cases:
...
:------|:-----------|:---------
u-case| [رَجُلٌ]{.ar} | [ٱَلرَّجُلُ]{.ar}
a-case| [رَجُلًا]{.ar}| [ٱَلرَّجُلَ]{.ar}
i-case| [رَجُلٍ]{.ar} | [ٱَلرَّجُلِ]{.ar}

As you can see, the noun is [tanwIn]{.trn2}ed when it is indefinite, and also, the vowel mark on the last letter changes for each case that the noun is in. These kinds of nouns are called _fully-flexible_ nouns. They are by far the most common type of noun.
...
As you can see, when [صَحْرَاء]{.ar} [SaHrAE]{.trn} is indefinite, it is not [tanwIn]{.trn2}ed. Also, when it is indefinite and in the i-case, the vowel mark on its final letter is not [◌ِ]{.ar}, as you might expect but [◌َ]{.ar} . And so the noun looks identical in the a-case and i-case when it is indefinite.
...
1. When indefinite, a semi-flexible noun is not [tanwIn]{.trn2}ed.
2. When indefinite and in the i-case, a semi-flexible noun's final letter does not have an [kasrah]{.trn2}. Instead it shall have an [fatHah]{.trn2}, just like when it is in the a-case.
...
Note that the vowel mark on the final letter of [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} is [◌َ]{.ar}, not [◌ٍ]{.ar}, even though it is indefinite and in the i-case (because it is preceded by the preposition [إِلَىٰ]{.ar} [EilA]{.trn} "to"). This is because it is a semi-flexible noun.

^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ in this sentence
is also a attributee, whose attribute is [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". The final vowel mark [◌َ]{.ar} on the attributee [صَحْرَاءَ]{.ar} [SaHrAEa]{.trn} has no effect on the final vowel mark on the attribute [وَاسِعَةٍ]{.ar} [wAsieatin]{.trn} "wide". All that matters in this regard is the case of the attributee. 

Note, also, that the attribute [وَاسِعَة]{.ar} is feminine to match the gender of the attributee 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^. 

Note, as well, that the attribute [وَاسِعَةٍ]{.ar} is [tanwIn]{.trn2}ed as it is indefinite and fully-flexible. The inability of its attributee 
^2^[صَحْرَاء]{.ar} [SaHrAE]{.trn}^2^ 
to be [tanwIn]{.trn2}ed (because of its semi-flexibility) does not affect the attribute.
...
<!--
[ibtidAEun]{.trn} "a beginning" whose root is [بدء]{.ar} and which is on the pattern [ٱِفْتِعَالٌ]{.ar} [iftieAlun]{.trn}. Because here the [ء]{.ar} in [ٱبْتِدَاءٌ]{.ar} is part of the word's root, therefore it shall not be a semi-flexible noun. That is why you can see that it has an [tanwIn]{.trn2} when it is indefinite. 
-->
...
Since ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^ already ends with the vowel-mark [◌ٰ]{.ar}, the last letter won't have any additional vowel markers and therefore the word will appear the same in all cases:

  Case  | Indefinite | Definite
  :------|:-----------|:---------
  u-case| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  a-case| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
  i-case| [ذِكْرَىٰ]{.ar} | [ٱَلذِّكْرَىٰ]{.ar}
...
Note, again how the attribute [جَمِيلَة]{.ar} [jamIlah]{.trn} is feminine and in the u-case, in order to match the gender and case of the attributee ^2^[ذِكْرَىٰ]{.ar} [pikrA]{.trn}^2^.

Beware also that, just like in the case of [اء]{.ar}, there are some words where [ىٰ]{.ar} may be part of the word's root, e.g. [ٱَلْهُدَىٰ]{.ar} [EalhudA]{.trn} "the guidance" whose root is [هدي]{.ar}. Because here the [ىٰ]{.ar} in [ٱلْهُدَىٰ]{.ar} is part of the word's root, therefore it shall not be a semi-flexible noun. So, when it is indefinite, it will be [tanwIn]{.trn2}ed: [هُدًى]{.ar} [hudan]{.trn} "a guidance". Also, for the same reason, [ىٰ]{.ar} in this word is not a feminine marker, and the word is masculine.
...
1. The noun must be a adjectival noun on the pattern [فَعْلَان]{.ar}. So the common noun [ثُعْبَان]{.ar} [vuebAn]{.trn} "a serpent" of the root [ثعي]{.ar} is a common noun and therefore, not a semi-flexible noun.
2. The [ان]{.ar} must be extrinsic to the word's root. So [جَبَان]{.ar} [jabAnun]{.trn} "cowardly", an adjectival noun of the root [جبن]{.ar}, is not a semi-flexible noun.
3. The feminine of the adjectival noun shall not be formed by adding [ة]{.ar} to the masculine noun. So [نَدْمَان]{.ar} [nadmAn]{.trn} "regretful", an adjectival noun from the root [ندم]{.ar}, is not a semi-flexible noun, because its feminine is [نَدْمَانَة]{.ar} [nadmAnah]{.trn}.
