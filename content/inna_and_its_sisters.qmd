...
In the basic [mubtada]{.subs}-[xabar]{.subs} sentence, both the [mubtada]{.subs} and the [xabar]{.subs} are in the u-state. For example:
...
In the above sentence both the [mubtada]{.subs} [ٱَلرَّجُلَ]{.ar} "the man", and the [xabar]{.subs} [مُعَلِّمٌ]{.ar} "a teacher" are in the u-state. In this chapter we will study a family of particles, called
[إِنَّ]{.ar} and its sisters,
that modify the [mubtada]{.subs}-[xabar]{.subs} sentence by placing the [mubtada]{.subs} in the a-state instead of the u-state. For example,

[إِنَّ ٱلرَّجُلَ مُعَلِّمٌ.]{.ar}  
[Einna -rrajula mueallimun.]{.trn}  
"Indeed the man is a teacher."

Note how, in the above example, the [mubtada]{.subs} [ٱَلرَّجُلَ]{.ar} "the man" is now in the a-state. The [xabar]{.subs} [مُعَلِّمٌ]{.ar} "a teacher" remains in the u-state. 
...
The [ismof]{.subs} of
[إِنَّ]{.ar} [Einna]{.trn} 
may be a noun phrase, in which case, any [naat]{.subs}s or replacements of the [ismof]{.subs} are also in the a-state. Examples:

[إِنَّ هَـٰؤُلَاءِ ٱلرِّجَالَ ٱلْكِرَامَ أَصْدِقَائِي.]{.ar}  
"Indeed these noble men are my friends."

[إِنَّ]{.ar} [Einna]{.trn} may have multiple [ismof]{.subs}s, each in the a-state, separated by [وَ]{.ar}. Example,

[إِنَّ ٱلْمُسْلِمِينَ وَٱلْمُسْلِمَاتِ يَعْبُدُونَ ٱللَّـٰهَ.]{.ar}  
"Indeed the Muslim men and Muslim women worship [_allAh]{.trn2}."

If the [xabar]{.subs} of the first [ismof]{.subs} has been mentioned before the second [ismof]{.subs}, then the second [ismof]{.subs} may optionally be in the a-state or the u-state. For example:
...
By default, the [ismof]{.subs} of [إِنَّ]{.ar} [Einna]{.trn} must directly follow it with no intervening words or particles. The only exception is when the [xabar]{.subs} consists of a prepositional or adverbial phrase, it is then allowed to precede the [ismof]{.subs}. The [ismof]{.subs}, in any case, shall be in the a-state. For example,
...
[إِنَّ]{.ar},
for example, the [ismof]{.subs} being in the a-state, the order of the [ismof]{.subs} and the [xabar]{.subs}, the use of attached pronouns for the [ismof]{.subs}, etc.,
...
The [أَنَّ]{.ar} clause can occur in place of an i-state [mudafil]{.subs} in an [idafa]{.subs}. Example:
...
And you have seen this grammatical equivalence before with [أَنْ]{.ar} and a-state [mudarie]{.subs} verbs in chanpter\ \@ref(a-state-[mudarie]{.subs}-verbs-verbal-noun).
...
can be used in either of the following ways:
 ...
 i. With the same rules as the heavy [إِنَّ]{.ar}. The [ismof]{.subs} is put in the a-state and the use of the strengthening [لَ]{.ar} is optional. For example,
...
ii. The [ismof]{.subs} is not put in the a-state but is rather in the u-state.
...
the heavy [إِنَّ]{.ar}.
Where the [ismof]{.subs} is in the a-state and the use of the strengthening [لَ]{.ar} is optional. For example,
...
3. A negative particle like [لَا]{.ar}, [لَنْ]{.ar}, or [لَمْ]{.ar}.
   ...
   Note that the [لَنْ]{.ar} and [لَمْ]{.ar}, even when after the lightened [أَنْ]{.ar}, change the state of the following [mudarie]{.subs} verb to the a-state and 0-state respectively.
...
(that we learned in chapter\ \@ref(chapter-a-state-[mudarie]{.subs}-verbs)),
The a-state-verbal [أَنْ]{.ar} puts the following [mudarie]{.subs} verb in the a-state.
Whereas the [mudarie]{.subs} verb directly after the lightened [أَنْ]{.ar} remains in the u-state.
...
+ If the verb before [أَنْ]{.ar} does not reflect a view of something going to occur then the [أَنْ]{.ar} is typically the a-state-verbal [أَنْ]{.ar}. For example,
  ...
  Remember from chapter\ \@ref(chapter-a-state-[mudarie]{.subs}-verbs)), that the a-state-verbal [أَنْ]{.ar} can occur with [madi]{.subs} verbs as well. Example:
