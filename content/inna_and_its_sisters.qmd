...
In the basic [mubtada]{.subs}-[xabar]{.subs} sentence, both the [mubtada]{.subs} and the [xabar]{.subs} are in the [ustate]{.subs}. For example:
...
that modify the [mubtada]{.subs}-[xabar]{.subs} sentence by placing the [mubtada]{.subs} in the [astate]{.subs} instead of the [ustate]{.subs}. For example,
...
[إِنَّ]{.ar} [Einna]{.trn} is used to begin independent sentences. It has an emphatic meaning, as if the speaker is asserting the [xabar]{.subs} about the [ismof]{.subs}. It is often translated into English as "indeed" or "verily", but it is also often left untranslated.

[إِنَّ]{.ar} [Einna]{.trn} is only used to begin [mubtada]{.subs}-[xabar]{.subs} sentences. Verbal sentences cannot be introduced by [إِنَّ]{.ar} [Einna]{.trn} directly. (Later, in section\ \@ref(damiir-al-shan), we shall see how to overcome this restriction.). For example,
...
The [ismof]{.subs} of
[إِنَّ]{.ar} [Einna]{.trn} 
may be a noun phrase, in which case, any [naat]{.subs}s or replacements of the [ismof]{.subs} are also in the [astate]{.subs}. Examples:

[إِنَّ هَـٰؤُلَاءِ ٱلرِّجَالَ ٱلْكِرَامَ أَصْدِقَائِي.]{.ar}  
"Indeed these noble men are my friends."

[إِنَّ]{.ar} [Einna]{.trn} may have multiple [ismof]{.subs}s, each in the [astate]{.subs}, separated by [وَ]{.ar}. Example,

[إِنَّ ٱلْمُسْلِمِينَ وَٱلْمُسْلِمَاتِ يَعْبُدُونَ ٱللَّـٰهَ.]{.ar}  
"Indeed the Muslim men and Muslim women worship [_allAh]{.trn2}."

If the [xabar]{.subs} of the first [ismof]{.subs} has been mentioned before the second [ismof]{.subs}, then the second [ismof]{.subs} may optionally be in the [astate]{.subs} or the [ustate]{.subs}. For example:
...
[إِنَّ]{.ar} [Einna]{.trn} may be used to begin sentences with an indefinite [ismof]{.subs}. For example,
...
[إِنَّ]{.ar} [Einna]{.trn} is only used to begin [mubtada]{.subs}-[xabar]{.subs} sentences. Verbal sentences cannot be introduced by [إِنَّ]{.ar} [Einna]{.trn} directly. (Later, in section\ \@ref(damiir-al-shan), we shall see how to overcome this restriction.).
By default, the [ismof]{.subs} of [إِنَّ]{.ar} [Einna]{.trn} must directly follow it with no intervening words or particles. The only exception is when the [xabar]{.subs} consists of a prepositional or adverbial phrase, it is then allowed to precede the [ismof]{.subs}. The [ismof]{.subs}, in any case, shall be in the [astate]{.subs}. For example,
...
This reverse order is permitted even when the [ismof]{.subs} is definite. For example,

[إِنَّ مَعَكَ صَاحِبَكَ.]{.ar}  
"Indeed, with you, is _your companion_."

This puts the logical accent on the [ismof]{.subs} [صَاحِبَكَ]{.ar} "your companion". If the [ismof]{.subs} is placed first then this puts the logical accent on the [xabar]{.subs}:

[إِنَّ صَاحِبَكَ مَعَكَ.]{.ar}  
"Indeed your companion is _with_ you."

If the [ismof]{.subs} contains a pronoun that refers to a noun in the [xabar]{.subs} then the [xabar]{.subs} must precede the [ismof]{.subs}. For example,
...
### Pronoun [ismof]{.subs}s

<!--In the examples above, the [ismof]{.subs} of [إِنَّ]{.ar} has been a noun. -->
The [ismof]{.subs} of [إِنَّ]{.ar} may be a pronoun instead of a noun. For this the attached pronouns are used. For example,
...
TODO: Multiple pronoun [ismof]{.subs}s: [إِنِّ وَ إِيَّاكَ ...]{.ar}

[إِنَّ]{.ar} with the speaker pronouns are often used with [ismfail]{.subs}s to signify that the speaker intends to to the action of the verb. For example,

[إِنِّي ذَاهِبٌ إِلَىٰ ٱلْمَسْجِدِ.]{.ar}  
"I'm going to the mosque."

We also mentioned this point in section\ \@ref([ismfail]{.subs}-for-intended-future-action).

### [إِنَّ]{.ar} [Einna]{.trn} with a strengthening [لَ]{.ar} {#inna-strengthening-la}

The strengthening particle [لَ]{.ar} adds extra emphasis and may optionally be used between the [ismof]{.subs} of [إِنَّ]{.ar} and its [xabar]{.subs}.
If the [ismof]{.subs} occurs first (as is the default) then [لَ]{.ar} is connected to and placed directly before the [xabar]{.subs}. For example:

[إِنَّ زَيْدًا لَقَائِمٌ.]{.ar}  
"Indeed Zayd is definitely standing."

If the [xabar]{.subs} precedes the [ismof]{.subs}, then then [لَ]{.ar} is connected to and placed directly before the [ismof]{.subs}. For example:
...
[إِنَّ]{.ar},
for example, the [ismof]{.subs} being in the [astate]{.subs}, the order of the [ismof]{.subs} and the [xabar]{.subs}, the use of attached pronouns for the [ismof]{.subs}, etc.,
...
It is similar to [إِنَّ]{.ar} in that it is asserts the [xabar]{.subs} about the [ismof]{.subs}.
But 
[أَنَّ]{.ar} is different from [إِنَّ]{.ar} in that [إِنَّ]{.ar}, its [ismof]{.subs}, and its [xabar]{.subs} together constitute a complete sentence.
Whereas 
the
[أَنَّ]{.ar}
clause
([أَنَّ]{.ar}
, its [ismof]{.subs}, and its [xabar]{.subs} together) does not constitute a complete sentence. For example, consider the expression:
...
In a similar manner,
[أَنَّ]{.ar}
clauses can be placed where one would expect other noun positions, such as: a [mubtada]{.subs}, an [xabar]{.subs}, a [fail]{.subs}, and more. Here are some examples:

### The [أَنَّ]{.ar} clause in place of the [fail]{.subs}
...
As you know, [كَانَ]{.ar}'s [fail]{.subs} is also its [ismof]{.subs}, and its [mafulb]{.subs} is also its [xabar]{.subs}.
The [أَنَّ]{.ar} clause can occur in either the [ismof]{.subs} or the [xabar]{.subs} of [كَنَ]{.ar}. 
...
Now, the [أَنَّ]{.ar} clause as the [ismof]{.subs}:
...
Note that in the latter case, the [xabar]{.subs} precedes the [ismof]{.subs}.

### The [أَنَّ]{.ar} clause in place of an [istate]{.subs} noun

The [أَنَّ]{.ar} clause can occur in place of an [istate]{.subs} [mudafil]{.subs} in an [idafa]{.subs}. Example:
...
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its [ismof]{.subs}, and its [xabar]{.subs}) is considered equivalent to a [masdar]{.subs} (typically in an [idafa]{.subs}, and possibly with a [mafulb]{.subs} as well). It is this equivalence that allows it to thake the place of a [fail]{.subs}, [mafulb]{.subs}, and the other categories we have given above.
...
[كَأَنَّ]{.ar} [kaEanna]{.trn}, its [ismof]{.subs}, and its [xabar]{.subs} constitute a complete sentence. For example,
...
There is a sub-type of [mubtada]{.subs}-[xabar]{.subs} sentence
...
We have, in fact, already seen sentences like this in section\ \@ref(past-verbs-order-of-words), when we take a verbal sentence and convert it to a [mubtada]{.subs}-[xabar]{.subs} sentence. This is the example we discussed there:
...
A [mubtada]{.subs}-[xabar]{.subs} sentence,
...
In the example
[ٱَلشَّجَرَةُفُرُوعُهَا طَوِيلَةٌ.]{.ar}, the attached pronoun [هَا]{.ar} "it" in [فُرُوعُهَا]{.ar} "its tree" is the linker pronoun that links back to the [ismof]{.subs} [ٱَلشَّجَرَةُ]{.ar} "the tree".

Similarly, in the example
[ٱَلرَّجُلُ كَتَبَ كِتَابًا.]{.ar}
the linker pronoun is the invisible [fail]{.subs} pronoun "he" of the verb [كَتَبَ]{.ar} "he wrote" that links back to the [ismof]{.subs} [ٱَلرَّجُلُ]{.ar} "the man".

#### [_mubtada]{.subs}-[xabar]{.subs} sentences with [إِنَّ]{.ar} and its sisters

[إِنَّ]{.ar} and its sisters are very often used in [mubtada]{.subs}-[xabar]{.subs} sentences. (With [أَنَّ]{.ar} it is, as usual, an incomplete sentence.) Here are some examples:
...
#### [_mubtada]{.subs}-[xabar]{.subs} sentences with a pronoun [ismof]{.subs}

The [ismof]{.subs}, in a [mubtada]{.subs}-[xabar]{.subs} sentence, is frequently a pronoun. For example,
...
There is a special pronoun, called the _pronoun of the fact_ that begins [mubtada]{.subs}-[xabar]{.subs} sentences. This pronoun does not refer to any previously known entity, but rather refers to the [xabar]{.subs} that follows it. It is sometimes translated as "the fact is" but is often left untranslated. Here is an example:
...
The [xabar]{.subs} does not contain a linker pronoun because the whole [xabar]{.subs} refers back to the [ismof]{.subs}.
...
can be used in either of the following ways:
 ...
 i. With the same rules as the heavy [إِنَّ]{.ar}. The [ismof]{.subs} is put in the [astate]{.subs} and the use of the strengthening [لَ]{.ar} is optional. For example,
...
ii. The [ismof]{.subs} is not put in the [astate]{.subs} but is rather in the [ustate]{.subs}.
...
the heavy [إِنَّ]{.ar}
is that 
the heavy [إِنَّ]{.ar} is only used to introduce [mubtada]{.subs}-[xabar]{.subs} sentences.
The lightened [إِنْ]{.ar},
...
the heavy [إِنَّ]{.ar}.
Where the [ismof]{.subs} is in the [astate]{.subs} and the use of the strengthening [لَ]{.ar} is optional. For example,
...
only introduces [mubtada]{.subs}-[xabar]{.subs} clauses whose [ismof]{.subs} is understood to be a deleted pronoun of the fact. 
The lightened [أَنْ]{.ar} only introduces [mubtada]{.subs}-[xabar]{.subs} clauses whose [ismof]{.subs} is understood to be a deleted pronoun of the fact. 
...
If we replace the heavy [أَنَّ]{.ar} in the above example with the lightened [أَنْ]{.ar} then we pronoun of the fact [ismof]{.subs} is deleted, thus:
...
the lightened [أَنْ]{.ar}
introduces a [xabar]{.subs} which is a [mubtada]{.subs}-[xabar]{.subs} sentence.
...
The lightened [كَأَنْ]{.ar} is similar to the lightened [أَنْ]{.ar} in that it introduces a [mubtada]{.subs}-[xabar]{.subs} sentence and the [ismof]{.subs} is usually a deleted pronoun of the fact. For example,
...
The lightened [لَـٰكِنْ]{.ar} has the same meaning as the heavy [لَـٰكِنَّ]{.ar} but it has no grammatical effect on the word or sentence after it. It may introduce either [mubtada]{.subs}-[xabar]{.subs} or verbal sentences. For example,
