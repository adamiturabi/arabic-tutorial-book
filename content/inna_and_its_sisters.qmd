...
As you know, [كَانَ]{.ar}'s doer is also its subject, and its [mafulb]{.term} is also its information.
...
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its subject, and its information) is considered equivalent to a [masdar]{.term} (typically in an [idafa]{.term}, and possibly with a [mafulb]{.term} as well). It is this equivalence that allows it to thake the place of a doer, [mafulb]{.term}, and the other categories we have given above.
