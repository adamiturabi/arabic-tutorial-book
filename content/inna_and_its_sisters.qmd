...
In the above sentence both the subject [ٱَلرَّجُلَ]{.ar} "the man", and the info [مُعَلِّمٌ]{.ar} "a teacher" are in the u-state. In this chapter we will study a family of particles, called
[إِنَّ]{.ar} and its sisters,
that modify the nounal sentence by placing the subject in the a-state instead of the u-state. For example,

[إِنَّ ٱلرَّجُلَ مُعَلِّمٌ.]{.ar}  
[Einna -rrajula mueallimun.]{.trn}  
"Indeed the man is a teacher."

Note how, in the above example, the subject [ٱَلرَّجُلَ]{.ar} "the man" is now in the a-state. The info [مُعَلِّمٌ]{.ar} "a teacher" remains in the u-state. 
...
[إِنَّ]{.ar} [Einna]{.trn} is used to begin independent sentences. It has an emphatic meaning, as if the speaker is asserting the info about the subject. It is often translated into English as "indeed" or "verily", but it is also often left untranslated.

[إِنَّ]{.ar} [Einna]{.trn} is only used to begin nounal sentences. Verbal sentences cannot be introduced by [إِنَّ]{.ar} [Einna]{.trn} directly. (Later, in section\ \@ref(damiir-al-shan), we shall see how to overcome this restriction.). For example,

[إِنَّ ٱلدِّينَ عِنْدَ ٱللَّـٰهِ ٱلْإِسْلَامُ.]{.ar}  
[Einna -ddIna einda -llAhi -lEislAmu.]{.trn}  
"Indeed, the religion in the sight of [#allAh]{.trn2} is [#islAm]{.trn2}." (Qurʾān\ 3:19, trans. Saheeh International)
...
The subject of
[إِنَّ]{.ar} [Einna]{.trn} 
may be a noun phrase, in which case, any attributes or replacements of the subject are also in the a-state. Examples:
...
[إِنَّ]{.ar} [Einna]{.trn} is only used to begin nounal sentences. Verbal sentences cannot be introduced by [إِنَّ]{.ar} [Einna]{.trn} directly. (Later, in section\ \@ref(damiir-al-shan), we shall see how to overcome this restriction.).
By default, the subject of [إِنَّ]{.ar} [Einna]{.trn} must directly follow it with no intervening words or particles. The only exception is when the info consists of a prepositional or adverbial phrase, it is then allowed to precede the subject. The subject, in any case, shall be in the a-state. For example,
...
[إِنَّ]{.ar} with the speaker pronouns are often used with doer participles to signify that the speaker intends to to the action of the verb. For example,
...
The strengthening particle [لَ]{.ar} adds extra emphasis and may optionally be used between the subject of [إِنَّ]{.ar} and its info.
If the subject occurs first (as is the default) then [لَ]{.ar} is connected to and placed directly before the info. For example:

[إِنَّ زَيْدًا لَقَائِمٌ.]{.ar}  
"Indeed Zayd is definitely standing."

If the info precedes the subject, then then [لَ]{.ar} is connected to and placed directly before the subject. For example:
...
[إِنَّ]{.ar},
for example, the subject being in the a-state, the order of the subject and the info, the use of attached pronouns for the subject, etc.,
...
It is similar to [إِنَّ]{.ar} in that it is asserts the info about the subject.
But 
[أَنَّ]{.ar} is different from [إِنَّ]{.ar} in that [إِنَّ]{.ar}, its subject, and its info together constitute a complete sentence.
Whereas 
the
[أَنَّ]{.ar}
clause
([أَنَّ]{.ar}
, its subject, and its info together) does not constitute a complete sentence. For example, consider the expression:
...
In a similar manner,
[أَنَّ]{.ar}
clauses can be placed where one would expect other noun positions, such as: a subject, an info, a doer, and more. Here are some examples:
...
### The [أَنَّ]{.ar} clause in place of the info
...
As you know, [كَانَ]{.ar}'s doer is also its subject, and its direct doee is also its info.
The [أَنَّ]{.ar} clause can occur in either the subject or the info of [كَنَ]{.ar}. 
For example, the [أَنَّ]{.ar} clause as the info:
...
### Equivalence of the [أَنَّ]{.ar} clause with a [maSdar]{.trn2}

As a matter of grammatical theory, the
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its subject, and its info) is considered equivalent to a [maSdar]{.trn2} (typically in an annexation, and possibly with a direct doee as well). It is this equivalence that allows it to thake the place of a doer, direct doee, and the other categories we have given above.
...
And you have seen this grammatical equivalence before with [أَنْ]{.ar} and a-state stateful verbs in chanpter\ \@ref(a-state-stateful-verbs-verbal-noun).
...
[كَأَنَّ]{.ar} [kaEanna]{.trn}, its subject, and its info constitute a complete sentence. For example,
...
## The state-of-affairs pronoun with [إِنَّ]{.ar} and its sisters
...
without having to specify a subject for
...
## The info as a complete sentence and the pronoun of the fact

### The info as a complete sentence

There is a sub-type of nounal sentence
where the info is a complete sentence.
Here is an example:
...
In these kinds of sentences, the subject introduces a topic, and the info is itself a sentence which comments on the topic/subject.
We have, in fact, already seen sentences like this in section\ \@ref(past-verbs-order-of-words), when we take a verbal sentence and convert it to a nounal sentence. This is the example we discussed there:
...
A nounal sentence,
in which the info is itself a sentence;
typically requires a pronoun in the info that links back to the subject. 
In the example
[ٱَلشَّجَرَةُفُرُوعُهَا طَوِيلَةٌ.]{.ar}, the attached pronoun [هَا]{.ar} "it" in [فُرُوعُهَا]{.ar} "its tree" is the linker pronoun that links back to the subject [ٱَلشَّجَرَةُ]{.ar} "the tree".

Similarly, in the example
[ٱَلرَّجُلُ كَتَبَ كِتَابًا.]{.ar}
the linker pronoun is the invisible doer pronoun "he" of the verb [كَتَبَ]{.ar} "he wrote" that links back to the subject [ٱَلرَّجُلُ]{.ar} "the man".

#### Nounal sentences with [إِنَّ]{.ar} and its sisters

[إِنَّ]{.ar} and its sisters are very often used in nounal sentences. (With [أَنَّ]{.ar} it is, as usual, an incomplete sentence.) Here are some examples:
...
#### Nounal sentences with a pronoun subject
...
There is a special pronoun, called the _pronoun of the fact_ that begins nounal sentences. This pronoun does not refer to any previously known entity, but rather refers to the info that follows it. It is sometimes translated as "the fact is" but is often left untranslated. Here is an example:
...
The info does not contain a linker pronoun because the whole info refers back to the subject.
...
[إِنْ]{.ar} and
[كَأَنْ]{.ar} are not very commonly used except in the Qurʾān, poetry, and other rhetorical texts.
[أَنْ]{.ar} and
[لَـٰكِنْ]{.ar}
...
the heavy [إِنَّ]{.ar}
is that 
the heavy [إِنَّ]{.ar} is only used to introduce nounal sentences.
The lightened [إِنْ]{.ar},
...
only introduces subject-info clauses whose subject is understood to be a deleted pronoun of the fact. 
The lightened [أَنْ]{.ar} only introduces subject-info clauses whose subject is understood to be a deleted pronoun of the fact. 
The info is, as usual, a complete sentence. 
For example, consider the following sentence with a heavy [أَنَّ]{.ar}:

[أَعْلَمُ أَنَّهُ ٱلْبَرْدُ شَدِيدٌ.]{.ar}  
"I know that the fact is: the cold is intense."

If we replace the heavy [أَنَّ]{.ar} in the above example with the lightened [أَنْ]{.ar} then we pronoun of the fact subject is deleted, thus:
...
the lightened [أَنْ]{.ar}
introduces a info which is a nounal sentence.
But the more common use of 
the lightened [أَنْ]{.ar}
is to introduce infos that are verbal sentences.

When the info of the 
lightened [أَنْ]{.ar}
...
3. A negative particle like [لَا]{.ar}, [لَنْ]{.ar}, or [لَمْ]{.ar}.
   ...
   Note that the [لَنْ]{.ar} and [لَمْ]{.ar}, even when after the lightened [أَنْ]{.ar}, change the state of the following stateful verb to the a-state and 0-state respectively.
...
(that we learned in chapter\ \@ref(chapter-a-state-stateful-verbs)),
The a-state-verbal [أَنْ]{.ar} puts the following stateful verb in the a-state.
Whereas the stateful verb directly after the lightened [أَنْ]{.ar} remains in the u-state.
...
+ If the verb before [أَنْ]{.ar} does not reflect a view of something going to occur then the [أَنْ]{.ar} is typically the a-state-verbal [أَنْ]{.ar}. For example,
  ...
  Remember from chapter\ \@ref(chapter-a-state-stateful-verbs)), that the a-state-verbal [أَنْ]{.ar} can occur with perfect verbs as well. Example:
...
The lightened [كَأَنْ]{.ar} is similar to the lightened [أَنْ]{.ar} in that it introduces a nounal sentence and the subject is usually a deleted pronoun of the fact. For example,
...
The lightened [لَـٰكِنْ]{.ar} has the same meaning as the heavy [لَـٰكِنَّ]{.ar} but it has no grammatical effect on the word or sentence after it. It may introduce either nounal sentences or verbal sentences. For example,
