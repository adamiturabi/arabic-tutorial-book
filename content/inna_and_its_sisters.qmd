...
[إِنَّ]{.ar} with the speaker pronouns are often used with [ismfail]{.term}s to signify that the speaker intends to to the action of the verb. For example,

[إِنِّي ذَاهِبٌ إِلَىٰ ٱلْمَسْجِدِ.]{.ar}  
"I'm going to the mosque."

We also mentioned this point in section\ \@ref([ismfail]{.term}-for-intended-future-action).
...
### The [أَنَّ]{.ar} clause in place of the [mafulb]{.term}
...
clause
([أَنَّ زَيْدًا صَادِقٌ]{.ar})
has occupied the place of the [mafulb]{.term} of the verb [أَعْلَمُ]{.ar}.

In a similar manner,
[أَنَّ]{.ar}
clauses can be placed where one would expect other noun positions, such as: a subject, an information, a [fail]{.term}, and more. Here are some examples:

### The [أَنَّ]{.ar} clause in place of the [fail]{.term}
...
As you know, [كَانَ]{.ar}'s [fail]{.term} is also its subject, and its [mafulb]{.term} is also its information.
...
The [أَنَّ]{.ar} clause can occur in place of an i-state [mudafil]{.term} in an [idafa]{.term}. Example:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, below] {\scriptsize [mudafil]{.term}};
...
### Equivalence of the [أَنَّ]{.ar} clause with a [masdar]{.term}

As a matter of grammatical theory, the
[أَنَّ]{.ar} clause, i.e. ([أَنَّ]{.ar} itself, its subject, and its information) is considered equivalent to a [masdar]{.term} (typically in an [idafa]{.term}, and possibly with a [mafulb]{.term} as well). It is this equivalence that allows it to thake the place of a [fail]{.term}, [mafulb]{.term}, and the other categories we have given above.
...
And you have seen this grammatical equivalence before with [أَنْ]{.ar} and a-state [mudarie]{.term} verbs in chanpter\ \@ref(a-state-[mudarie]{.term}-verbs-verbal-noun).
...
Similarly, in the example
[ٱَلرَّجُلُ كَتَبَ كِتَابًا.]{.ar}
the linker pronoun is the invisible [fail]{.term} pronoun "he" of the verb [كَتَبَ]{.ar} "he wrote" that links back to the topic [ٱَلرَّجُلُ]{.ar} "the man".
...
3. A negative particle like [لَا]{.ar}, [لَنْ]{.ar}, or [لَمْ]{.ar}.
   ...
   Note that the [لَنْ]{.ar} and [لَمْ]{.ar}, even when after the lightened [أَنْ]{.ar}, change the state of the following [mudarie]{.term} verb to the a-state and 0-state respectively.
...
(that we learned in chapter\ \@ref(chapter-a-state-[mudarie]{.term}-verbs)),
The a-state-verbal [أَنْ]{.ar} puts the following [mudarie]{.term} verb in the a-state.
Whereas the [mudarie]{.term} verb directly after the lightened [أَنْ]{.ar} remains in the u-state.
...
+ If the verb before [أَنْ]{.ar} does not reflect a view of something going to occur then the [أَنْ]{.ar} is typically the a-state-verbal [أَنْ]{.ar}. For example,
  ...
  Remember from chapter\ \@ref(chapter-a-state-[mudarie]{.term}-verbs)), that the a-state-verbal [أَنْ]{.ar} can occur with [madi]{.term} verbs as well. Example:
