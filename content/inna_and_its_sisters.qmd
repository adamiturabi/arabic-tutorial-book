...
#### [#mubtada]{.subs}-[xabar]{.subs} sentences with a pronoun [ism_of]{.subs}

The [ism_of]{.subs}, in a [mubtada]{.subs}-[xabar]{.subs} sentence, is frequently a pronoun. For example,
...
The lightened [كَأَنْ]{.ar} is similar to the lightened [أَنْ]{.ar} in that it introduces a [mubtada]{.subs}-[xabar]{.subs} sentence and the [ism_of]{.subs} is usually a deleted pronoun of the fact. For example,
