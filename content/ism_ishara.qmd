...
Remember, however, from section\ \@ref(describers-with-[idafa]{.term}s-to-pronouns), that pronouns may not be describees.
...
In section\ \@ref(pointing-to-an-[idafa]{.term})
below, we will deal with nouns that are part of an [idafa]{.term}, like [كِتَابَيِ ٱلرَّجُلِ]{.ar}.
...
Arabic uses [idafa]{.term}s to express the above meanings. So we will discuss [idafa]{.term}s like:
...
Note that both the above [idafa]{.term}s are definite because their [mudafil]{.term}s are definite.

Indefinite [idafa]{.term}s like 
[كِتَاب رَجُلٍ]{.ar} "a man's book"
cannot be used in pointing noun phrases.

#### The definite [mudafil]{.term} begins with [ٱَلْ]{.ar}

We will first consider [idafa]{.term}s where the definite [mudafil]{.term} begins with [ٱَلْ]{.ar}, like:

[كِتَابُ ٱلرَّجُلِ]{.ar}  
"the book of the man"

##### Pointing to the [mudafil]{.term}  

We would like to express the phrase:

"the book of this man"

In order to point to the [mudafil]{.term} [ٱَلرَّجُل]{.ar} "the man" with the pointing noun [هَـٰذَا]{.ar} "this-one~m~", we can put the pointing noun either before or after the [mudafil]{.term}, thus:
...
[ٱَلرَّجُل]{.ar} as the [mudafil]{.term} in the [idafa]{.term}.
In addition to being the [mudafil]{.term},
...
[ٱَلرَّجُل]{.ar}, here, keeps its place as the [mudafil]{.term} in the [idafa]{.term}.
In addition to being the [mudafil]{.term},
[ٱَلرَّجُل]{.ar}
...
##### Pointing to the [mudaf]{.term}  

Consider, again, the [idafa]{.term}:

[كِتَابُ ٱلرَّجُلِ]{.ar}  
"the book of the man"

We have already discussed how to point to the [mudafil]{.term}
[ٱَلرَّجُل]{.ar}
in a pointing noun phrase.
Now, we would like to point to the [mudaf]{.term} 
[كِتَاب]{.ar}
in a pointing noun phrase.
...
[كِتَاب]{.ar}, here, is both and [mudaf]{.term} and a describee.
...
The ambiguity of whether the pointing noun [هَـٰذَا]{.ar} points to the [mudaf]{.term} 
[كِتَابُ]{.ar}
or the [mudafil]{.term}
[ٱلرَّجُلِ]{.ar}
only exists because the [mudaf]{.term} and the [mudafil]{.term} match each other in gender and number: singular masculine.
If the [mudaf]{.term} and the [mudafil]{.term} were different in gender and number, then there would be no ambiguity. Examples:
...
Here are some more examples of pointing to [mudaf]{.term}s:

##### The [mudafil]{.term} is a proper noun beginning with [ٱَلْ]{.ar}  
...
We can apply the preceding discussion of pointing to the [mudaf]{.term} and [mudafil]{.term} to this [idafa]{.term} as well. So we get:
...
#### The definite [mudafil]{.term} does not begin with [ٱَلْ]{.ar}

Consider, now, that the [mudafil]{.term} is definite but does not begin with [ٱَلْ]{.ar}. There are two such types of nouns that we will discuss:

i. Proper nouns not beginning with [ٱَلْ]{.ar}
i. Pronouns

##### The [mudafil]{.term} is a proper noun not beginning with [ٱَلْ]{.ar}  

<!--Consider, now, that the [mudafil]{.term} is a proper noun that does not begin with [ٱَلْ]{.ar}, for example:-->
...
Because the [mudafil]{.term} [زَيْد]{.ar} does not begin with [ٱَلْ]{.ar}, any pointing nouns can come only after the entire [idafa]{.term}, thus:
...
that a pronoun may be a [mudafil]{.term} in an [idafa]{.term}.
Example:

[كِتَابُهُ]{.ar}  
"his book"

Neither the [mudaf]{.term} [كِتَاب]{.ar}, nor the attached pronoun [هُ]{.ar} begin with [ٱَلْ]{.ar}.
So if we want to add the pointing noun [هَـٰذَا]{.ar} to this [idafa]{.term} to form a pointing noun phrase,
then we have to place it at the end, after the [idafa]{.term}, thus:
...
We have also learned, in
section\ \@ref(describers-with-[idafa]{.term}s-to-pronouns)
that pronouns may not be describees in a descriptive noun phrase.

So, we are left with only one option: the [mudaf]{.term} [كِتَاب]{.ar} is the desceibee. And the meaning of the phrase is:
