...
+ Most of the pointing nouns are rigid nouns. That is: their endings are not modified for their state. 
  ...
  The dual pointing nouns, however, are flexible nouns, for example: [هَـٰذَانِ]{.ar}  ([ustate]{.subs})   / [هَـٰذَيْنِ]{.ar}  [hApayni]{.trn} ([astate]{.subs} and [istate]{.subs}).
...
Pointing nouns are different from pronouns in this regard. It is allowed to describe a pointing noun with a [naat]{.subs} in a noun phrase.
...
Just like an [sifah]{.subs}, a pointing noun can be a [naat]{.subs} in a noun-phrase. But remember from 
section\ \@ref(definiteness-of-pointing-nouns)
above that pointing nouns are definite.
So, if a pointing noun is a [naat]{.subs} in a noun-phrase, the [manut]{.subs} has to be definite too.
Example:
...
In the above example, the pointed-to noun [ٱَلْكِتَابَيْنِ]{.ar} is the [manut]{.subs} in a descriptive noun-phrase. It is definite, in the [astate]{.subs}, masculine, and dual.

The pointing noun [هَـٰذَيْنِ]{.ar} is its [naat]{.subs}. It follows the [manut]{.subs} and matches it being dual, in the [astate]{.subs}, masculine, and dual.
...
<!--The pointing noun can be the [manut]{.subs}, and the pointed-to noun can be the [naat]{.subs}.-->
...
In order to point to the [mudafil]{.subs} [ٱَلرَّجُل]{.ar} "the man" with the pointing noun [هَـٰذَا]{.ar} "this-one~m~", we can put the pointing noun either before or after the [mudafil]{.subs}, thus:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-1.south east)
      node [midway, rotate=90, anchor=south, left=0ex] {\scriptsize [naat]{.subs}};

\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, rotate=90, anchor=south, left=0ex] {\scriptsize [manut]{.subs}};
...
In addition to being the [mudafil]{.subs},
[ٱَلرَّجُل]{.ar}
is also a [manut]{.subs}, whose [naat]{.subs} is the pointing noun
[هَـٰذَا]{.ar}.
The literal, word-for-word, translation of this phrase is:
...
Its [naat]{.subs} is the pointing noun
[هَـٰذَا]{.ar}.
The literal, word-for-word, translation of this phrase is:
...
The ambiguity of whether the pointing noun [هَـٰذَا]{.ar} points to the [mudaf]{.subs} 
[كِتَابُ]{.ar}
or the [mudafil]{.subs}
[ٱلرَّجُلِ]{.ar}
...
Because the [mudafil]{.subs} [زَيْد]{.ar} does not begin with [ٱَلْ]{.ar}, any pointing nouns can come only after the entire [idafa]{.subs}, thus:
...
So if we want to add the pointing noun [هَـٰذَا]{.ar} to this [idafa]{.subs} to form a pointing noun phrase,
then we have to place it at the end, after the [idafa]{.subs}, thus:

[كِتَابُهُ هَـٰذَا]{.ar}  

The pointing noun [هَـٰذَا]{.ar}, here, is a [manut]{.subs}. But what is its [naat]{.subs}?
...
## Pointing nouns as [mubtada]{.subs}s

Besides their use in pointing noun phrases, pointing nouns are very often used as the [mubtada]{.subs} of a sentence. For example:
...
The pointing noun is (usually) made to match the [xabar]{.subs} in number and gender. Examples:
...
If the [xabar]{.subs} is a noun that begins with [ٱَلْ]{.ar} then it may be placed after the pointing noun [mubtada]{.subs} in the same manner:
...
### Mismatched pointing noun [mubtada]{.subs}

When the pointing noun is a [mubtada]{.subs} we usually match its number and gender with the number and gender of the [xabar]{.subs}, as we have been doing so far. However, when the pointing noun [mubtada]{.subs} refers to a noun in a previous sentence, then we may prefer to match to the previous noun than to the the following [xabar]{.subs}. Example:
...
Besides their use in pointing noun phrases and as [mubtada]{.subs}s, pointing nouns may be used as other parts of speech as well, typically where one would expect pronouns. Here are some examples:
