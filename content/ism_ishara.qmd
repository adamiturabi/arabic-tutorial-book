...
Remember, however, from section\ \@ref(describers-with-[idafa]{.subs}s-to-pronouns), that pronouns may not be describees.
...
[كِتَاب]{.ar}, here, is both and [mudaf]{.subs} and a describee.
...
We have also learned, in
section\ \@ref(describers-with-[idafa]{.subs}s-to-pronouns)
