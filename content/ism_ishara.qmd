...
The word "book" here is similarly called the _pointed-to noun_ noun. It refers to the object being pointed to.
...
+ Most of the pointing nouns are rigid nouns. That is: their endings are not modified for their case. 

  The dual pointing nouns, however, are flexible nouns, for example: [هَـٰذَانِ]{.ar}  (u-case)   / [هَـٰذَيْنِ]{.ar}  [hApayni]{.trn} (a-case and i-case).
...
Remember, however, from section\ \@ref(attributes-with-annexations-to-pronouns), that pronouns may not be attributees.
Pointing nouns are different from pronouns in this regard. It is allowed to describe a pointing noun with a attribute in a noun phrase.
...
Remember from chapter\ \@ref(adjectival nouns-and-descriptive-noun-phrases) that a descriptive noun-phrase consists of a attribute and a attributee. The attribute follows the attribute and matches it in definiteness, case, gender, and number. 
...
#### The pointed-to noun noun is definite with [ٱَلْ]{.ar} {#phrase-single-pointed-to-noun-with-al}

Just like an adjectival noun, a pointing noun can be a attribute in a noun-phrase. But remember from 
section\ \@ref(definiteness-of-pointing nouns)
above that pointing nouns are definite.
So, if a pointing noun is a attribute in a noun-phrase, the attributee has to be definite too.
Example:
...
In the above example, the pointed-to noun noun [ٱَلْكِتَابَيْنِ]{.ar} is the attributee in a descriptive noun-phrase. It is definite, in the a-case, masculine, and dual.

The pointing noun [هَـٰذَيْنِ]{.ar} is its attribute. It follows the attributee and matches it being dual, in the a-case, masculine, and dual.

As a special case, when the pointed-to noun noun has [ٱَلْ]{.ar} (as in this case: [ٱَلْكِتَابَيْنِ]{.ar}), then the order of the pointing noun and the pointed-to noun noun is permitted to be reversed. 
<!--The pointing noun can be the attributee, and the pointed-to noun noun can be the attribute.-->

The pointing noun is then a replacee (see section\ \@ref(the-replacement)), and the pointed-to noun noun is its replacement.
...
is a replacee. It is definite, in the a-case, masculine, and dual.

The 
pointed-to noun noun [ٱَلْكِتَابَيْنِ]{.ar} 
is its replacement. It follows the replacee and matches it being dual, in the a-case, masculine, and dual.

As a matter of fact, even though both orders are permitted, this reverse order of placing the pointing noun first and following it with the pointed-to noun noun is more common.

Here are some more examples of pointing noun phrases when the pointed-to noun noun is definite with [ٱَلْ]{.ar}:

[هَـٰذَا ٱَلرَّجُلُ ٱلْكَرِيمُ إِمَامٌ.]{.ar}  
[ٱَلرَّجُلُ ٱلْكَرِيمُ هَـٰذَا إِمَامٌ.]{.ar}  
"This noble man is an [imAm]{.trn2}."

#### The pointed-to noun noun is a proper noun
...
If they don't begin with [ٱَلْ]{.ar} then only the [pointed-to noun noun first, then pointing noun] order is permitted.
Example:
...
Note that both the above annexations are definite because their annexed-to nouns are definite.

Indefinite annexations like 
[كِتَاب رَجُلٍ]{.ar} "a man's book"
cannot be used in pointing noun phrases.

#### The definite annexed-to noun begins with [ٱَلْ]{.ar}

We will first consider annexations where the definite annexed-to noun begins with [ٱَلْ]{.ar}, like:

[كِتَابُ ٱلرَّجُلِ]{.ar}  
"the book of the man"

##### Pointing to the annexed-to noun  

We would like to express the phrase:

"the book of this man"

In order to point to the annexed-to noun [ٱَلرَّجُل]{.ar} "the man" with the pointing noun [هَـٰذَا]{.ar} "this-one~m~", we can put the pointing noun either before or after the annexed-to noun, thus:
...
[ٱَلرَّجُل]{.ar} as the annexed-to noun in the annexation.
In addition to being the annexed-to noun,
...
[ٱَلرَّجُل]{.ar}, here, keeps its place as the annexed-to noun in the annexation.
In addition to being the annexed-to noun,
[ٱَلرَّجُل]{.ar}
is also a attributee, whose attribute is the pointing noun
[هَـٰذَا]{.ar}.
The literal, word-for-word, translation of this phrase is:
...
We have already discussed how to point to the annexed-to noun
[ٱَلرَّجُل]{.ar}
in a pointing noun phrase.
Now, we would like to point to the annexed noun 
[كِتَاب]{.ar}
in a pointing noun phrase.
...
[كِتَاب]{.ar}, here, is both and annexed noun and a attributee.
Its attribute is the pointing noun
[هَـٰذَا]{.ar}.
The literal, word-for-word, translation of this phrase is:
...
The ambiguity of whether the pointing noun [هَـٰذَا]{.ar} points to the annexed noun 
[كِتَابُ]{.ar}
or the annexed-to noun
[ٱلرَّجُلِ]{.ar}
only exists because the annexed noun and the annexed-to noun match each other in gender and number: singular masculine.
If the annexed noun and the annexed-to noun were different in gender and number, then there would be no ambiguity. Examples:
...
Here are some more examples of pointing to annexed nouns:

##### The annexed-to noun is a proper noun beginning with [ٱَلْ]{.ar}  
...
We can apply the preceding discussion of pointing to the annexed noun and annexed-to noun to this annexation as well. So we get:
...
#### The definite annexed-to noun does not begin with [ٱَلْ]{.ar}

Consider, now, that the annexed-to noun is definite but does not begin with [ٱَلْ]{.ar}. There are two such types of nouns that we will discuss:

i. Proper nouns not beginning with [ٱَلْ]{.ar}
i. Pronouns

##### The annexed-to noun is a proper noun not beginning with [ٱَلْ]{.ar}  

<!--Consider, now, that the annexed-to noun is a proper noun that does not begin with [ٱَلْ]{.ar}, for example:-->
...
Because the annexed-to noun [زَيْد]{.ar} does not begin with [ٱَلْ]{.ar}, any pointing nouns can come only after the entire annexation, thus:
...
##### The annexed-to noun is a pronoun
...
that a pronoun may be a annexed-to noun in an annexation.
Example:

[كِتَابُهُ]{.ar}  
"his book"

Neither the annexed noun [كِتَاب]{.ar}, nor the attached pronoun [هُ]{.ar} begin with [ٱَلْ]{.ar}.
...
The pointing noun [هَـٰذَا]{.ar}, here, is a attributee. But what is its attribute?

We have also learned, in
section\ \@ref(attributes-with-annexations-to-pronouns)
that pronouns may not be attributees in a descriptive noun phrase.

So, we are left with only one option: the annexed noun [كِتَاب]{.ar} is the desceibee. And the meaning of the phrase is:
...
The pointing noun is (usually) made to match the info in number and gender. Examples:
...
The info may be a single word (as above) or more complex (as below):
...
If the info is a noun that begins with [ٱَلْ]{.ar} then it may be placed after the pointing noun subject in the same manner:
...
we insert a detached pronoun between the subject and the info, thus:
...
Note that the second sentence's subject and info mismatch: 
