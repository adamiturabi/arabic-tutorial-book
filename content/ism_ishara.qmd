...
Remember from chapter\ \@ref(adjectival nouns-and-descriptive-noun-phrases) that a descriptive noun-phrase consists of a attribute and a attributee. The attribute follows the attribute and matches it in definiteness, state, gender, and number. 
...
In the above example, the pointed-to noun noun [ٱَلْكِتَابَيْنِ]{.ar} is the attributee in a descriptive noun-phrase. It is definite, in the a-state, masculine, and dual.

The pointing noun [هَـٰذَيْنِ]{.ar} is its attribute. It follows the attributee and matches it being dual, in the a-state, masculine, and dual.
