...
Some nouns begin with a connecting [hamzah]{.trn2}, for example: [ٱِبْن]{.ar} [Eibn]{.trn} "son". When in the beginning of a sentence, the connecting [hamzah]{.trn2} will be pronounced with an [kasrah]{.trn2} [◌ِ]{.ar}.
...
1. u-state: indicated by a [Dammah]{.trn2} [◌ُ]{.ar} (for definite nouns) and a [tanwIn]{.trn2}ed [Dammah]{.trn2} [◌ٌ]{.ar} (for indefinite nouns) on the final letter of the word.
2. a-state: indicated by an [fatHah]{.trn2} [◌َ]{.ar} (for definite nouns) and a [tanwIn]{.trn2}ed [fatHah]{.trn2} [◌ً]{.ar} (for indefinite nouns) on the final letter of the word.
3. i-state: indicated by an [kasrah]{.trn2} [◌ِ]{.ar} (for definite nouns) and a [tanwIn]{.trn2}ed [kasrah]{.trn2} [◌ٍ]{.ar} (for indefinite nouns) on the final letter of the word.
-->

1. the u-state. This is considered the 'highest' state. It is indicated, for most nouns, by a [Dammah]{.trn2} on the final letter of the noun.
1. the a-state. This is 'lower' than the u-state. It is indicated, for most nouns, by a [fatHah]{.trn2} on the final letter of the noun.
1. the i-state. This is the 'lowest' state. It is indicated, for most nouns, by a [kasrah]{.trn2} on the final letter of the noun.

When a noun is indefinite, then, for most nouns, it<!--s final (state-indicating) vowel--> is also [tanwIn]{.trn2}ed.
...
The u-state is a noun's normal state, and there needs to be a reason to take the noun out of this state into another state.
