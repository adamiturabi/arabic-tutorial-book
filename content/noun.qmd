...
[شَجَرَة]{.ar} _tree_, in isolation, is pronounced [cajarah]{.trn}, not [cajarat]{.trn}.

Some nouns begin with a connecting [hamzah]{.trn2}, for example: [ٱِبْن]{.ar} [Eibn]{.trn} _son_. When in the beginning of a sentence, the connecting [hamzah]{.trn2} will be pronounced with an [kasrah]{.trn2} [◌ِ]{.ar}.

## Definiteness

When talking about nouns it is necessary to introduce a topic called _definiteness_.

A noun is _definite_ when the person or thing it refers to is known. For example, if you say, _the man arrived_, then the usage of the word "the" before "man" tells us that the man is known to us. Therefore the noun "man" is definite in this sentence.

Conversely, if we had said _a man arrived_ then the use of "a" before "man" tells us that the man is unknown to us. Therefore "man" is indefinite in this sentence.
...
|Noun | Definite noun|
|:-----------|:-----------|
|[رَجُل]{.ar} [rajul]{.trn} [man]{.trans} | [ٱَلرَّجُل]{.ar} [Earrajul]{.trn} [the man]{.trans}  |
|[تَاجِر]{.ar} [tAjir]{.trn} [trader]{.trans} | [ٱَلتَّاجِر]{.ar} [EattAjir]{.trn} [the trader]{.trans}  |
|[لُعْبَة]{.ar} [luebah]{.trn} [toy]{.trans} | [ٱَللُّعْبَة]{.ar} [Ealluebah]{.trn} [the toy]{.trans}  |
...
If the definite article [ٱَلْ]{.ar} [Eal]{.trn} is with prefixed to nouns that have an initial connecting [hamzah]{.trn2}, then the [ل]{.ar} shall no longer have an [sukUn]{.trn2} [◌ْ]{.ar}. Instead it shall have an [kasrah]{.trn2} [◌ِ]{.ar}. Example:

(@ex001131) [ٱَلِٱبْن]{.ar}  
    [Eali-bn]{.trn}  
    [the son]{.trans}
...
(@ex001132) [This man gave that boy some food.]{.trans}
...
(@ex001133) [Time is valuable.]{.trans}
...
(@ex001134) [We don't have to leave just yet; we have time.]{.trans}
...
(@ex001135) [This man gave that boy some food.]{.trans}  
...
(@ex001136) [Time is valuable.]{.trans}  
  + "time": definite; Arabic: [ٱَلْوَقْت]{.ar} [Ealwaqt]{.trn}

(@ex001137) [We don't have to leave just yet; we have time.]{.trans}  
  + "time": indefinite; Arabic: [وَقْت]{.ar} [waqt]{.trn}

## Case

Nouns in Arabic have a property called _case_.
The case of a noun is dependent on the function of the noun in a sentence.
The case of a noun is indicated by the noun's ending. 
There are three states that a noun can be in.
They are:

1. the u-case. By default, it is indicated, by a [Dammah]{.trn2} on the final letter of the noun.
1. the a-case. By default, it is indicated, by a [fatHah]{.trn2} on the final letter of the noun.
1. the i-case. By default, it is indicated, by a [kasrah]{.trn2} on the final letter of the noun.

When a noun is indefinite, then, for most nouns, it is also [tanwIn]{.trn2}ed.
Here, for example, is the noun [كِتَاب]{.ar} [kitAb]{.trn} "book" in its three states:

|case         | Indefinite "a book" | Definite "the book"|
|:-------------|:-----------------|:--------------|
|u-case       |[كِتَابٌ]{.ar} [kitAbun]{.trn}  |[ٱَلْكِتَابُ]{.ar} [EalkitAbu]{.trn} |
|a-case       |[كِتَابًا]{.ar} [kitAban]{.trn} |[ٱَلْكِتَابَ]{.ar} [EalkitAba]{.trn} |
|i-case       |[كِتَابٍ]{.ar} [kitAbin]{.trn}  |[ٱَلْكِتَابِ]{.ar} [EalkitAbi]{.trn} |

The u-case is a noun's normal case, and there needs to be a reason to take the noun out of this case into another case.
We will begin to use case more in the next chapter if [#allAh]{.trn2} wills, where we learn how to form sentences.
...
Note that the vowel-mark before the [ة]{.ar} is always an [fatHah]{.trn2}. 
<!--For example, in the case of [كَلْب]{.ar} [kalb]{.trn} "a male dog", in order to get the feminine noun [كَلْبَة]{.ar} [kalbatun]{.trn} "a female dog", [ب]{.ar} gets an [fatHah]{.trn2}.-->
...
[ٱِبْن]{.ar}    [Eibn]{.trn}   (masc.) "a son" is not used to mean "a daughter".
And [ٱِبْنَة]{.ar}   [Eibnah]{.trn}    (fem.) "a daughter" is not used to mean "a son".
...
such nouns adhere to their fixed grammatical gender when used for either male or female persons.^[[[عضو أم عضوة؟ ومسائل أخر]{.ar}](https://archive.org/details/riga2/page/n399mode/2up) in [مجموع مقالات فيصل المنصور]{.ar} 401--410]
