...
1. the [ustate]{.subs}. This is considered the 'highest' state. It is indicated, for most nouns, by a [umark]{.subs} on the final letter of the noun.
1. the [astate]{.subs}. This is 'lower' than the [ustate]{.subs}. It is indicated, for most nouns, by a [amark]{.subs} on the final letter of the noun.
1. the [istate]{.subs}. This is the 'lowest' state. It is indicated, for most nouns, by a [imark]{.subs} on the final letter of the noun.
...
The [ustate]{.subs} is a noun's normal state, and there needs to be a reason to take the noun out of this state into another state.
