...
## Duals in [j_ism]{.subs}s

In [j_ism]{.subs}s, if the [mubtada]{.subs} is a dual, and the [xabar]{.subs} is a [sifah]{.subs}, then the [xabar]{.subs} will typically match the [mubtada]{.subs} in being a dual. For example:
...
The above verbal sentence can be rearranged to be a [j_ism]{.subs}. This gives more emphasis to the [mubtada]{.subs}. In this case, the verb shall follow the [mubtada]{.subs} and will need a doer pronoun after it.
...
The above verbal sentence can be rearranged to be a [j_ism]{.subs}. In that case, all the verbs shall have doer pronouns. The sentence will have the same translation as above, except for an emphasis on the [mubtada]{.subs} of the sentence.
