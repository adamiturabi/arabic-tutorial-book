...
|a-state and i-state | [بَيْتَيْنِ]{.ar} [baytayni]{.trn} | [ٱَلْبَيْتَيْنِ]{.ar} [Ealbaytayni]{.trn}   
...
We learned that when an adjectival noun is a attribute in an descriptive noun-phrase, then it matches the attributee in definiteness, state, and gender.  For example:
...
<!--Note that both [ٱَلْمَرْأَتَانِ]{.ar} [EalmarEatAni]{.trn} "the two women" and [أُمَّانِ]{.ar}  [EummAni]{.trn}  "two mothers" are in the u-state because, just like for sentences with singulars, the subject and info are put in the u-state.-->
