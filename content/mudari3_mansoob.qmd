...
In 
chapter\ \@ref(u-case-[muDArie]{.trn2}-verbs)
we mentioned that [muDArie]{.trn2} verbs have three cases (like nouns). 
...
We introduced the u-case [muDArie]{.trn2} verb in
chapter\ \@ref(u-case-[muDArie]{.trn2}-verbs).
In this chapter we will study the 
a-case
[muDArie]{.trn2} verb.

The u-case [muDArie]{.trn2} verb makes a plain statement.
The a-case [muDArie]{.trn2} verb implies a wish or purpose.
The a-case [muDArie]{.trn2} verb is used after the following articles:
...
## Forming the a-case [muDArie]{.trn2} verb

Here is the u-case [muDArie]{.trn2} verb for the singular masculine absentee participant doer "he":

[يَفْعَلُ]{.ar}  
[yafealu]{.trn}  
"he does"

Note that, because it is in the u-case, the its final letter ends with a [Dammah]{.trn2} [◌ُ]{.ar}.
In order to form the 
a-case
[muDArie]{.trn2} verb,
we change the [Dammah]{.trn2} into a
[fatHah]{.trn2} [◌َ]{.ar}, thus:

[يَفْعَلَ]{.ar}  
[yafeala]{.trn}  

This is done for all participants whose doer pronoun is invisible and u-case verb ends with a [Dammah]{.trn2} [◌ُ]{.ar}.

For participants whose doer pronoun is followed by an extra [ن]{.ar} in the u-case verb, this final [ن]{.ar} is dropped in order to form the 
a-case
[muDArie]{.trn2} verb.
So, for example, the u-case
[muDArie]{.trn2} verb:
...
|Participant|[#muDArie]{.trn2} verb doer pronoun|u-case [muDArie]{.trn2} verb | a-case [muDArie]{.trn2} verb|
|:---|:--|:---|:---|
...
+ The u-case and a-case verbs are the same for the feminine plural absentee and addressee participants: 
  + [يَفْعَلْنَ]{.ar} (they~3f~)
  + [تَفْعَلْنَ]{.ar} (you~3f~)
+ The a-case verbs for the masculine plural absentee and addressee participants have a final silent [alif]{.trn2}: 
...
[muDArie]{.trn2} verb to be in the a-case.
...
### Basic usage of [أَنْ]{.ar} [Ean]{.trn} with the a-case [muDArie]{.trn2} verb
...
[لَا]{.ar} can be used to negate the following a-case [muDArie]{.trn2} verb.
...
[أَنْ]{.ar} must directly precede the following a-case [muDArie]{.trn2} verb and must not be separated from it.

### Grammatical equivalence of [أَنْ]{.ar} clause with a [maSdar]{.trn2}

In grammatical theory,
[أَنْ]{.ar} 
and the following verb form a clause that is equivalent in meaning to the [maSdar]{.trn2} of the verb. So in the example,
[أَمَلَ ٱلطَّالِبُ أَنْ يَنْجَحَ.]{.ar}, the 
[أَنْ]{.ar} clause is
[أَنْ يَنْجَحَ]{.ar}.
It is equivalent to the [maSdar]{.trn2} [ٱلنَّجَاح]{.ar}.
...
In the i-case as the annexed-to noun in an annexation:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below] {\scriptsize i-case annexed-to noun};
...
In the i-case after a preposition:
...
\draw [decoration={brace, mirror}, decorate] 
   (word-2.south west) -- (word-2.south east)
      node [midway, below] {\scriptsize i-case after preposition};
...
### [أَنْ]{.ar} with the [mADI]{.trn2} verb

[أَنْ]{.ar} may also occur before a [mADI]{.trn2} verb. Example:
...
The [أَنْ]{.ar} we have learned here is called the _[maSdar]{.trn2}i [أَنْ]{.ar}_ because of the equivalence of its clause with a [maSdar]{.trn2}.
...
<!--
By the way, this [لِ]{.ar}, which is used with a-case [muDArie]{.trn2} verbs, is different from 
the [لِ]{.ar} we learned in section\ \@ref(indirect-commands), which is used with the ø-case [muDArie]{.trn2} verbs for indirect commands.
-->

By the way, the grammatical equivalence of [أَنْ]{.ar} and a following a-case [muDArie]{.trn2} verb with a [maSdar]{.trn2} applies also to when [لِ]{.ar} is used before (either an expressed or an implied) [أَنْ]{.ar}. So, for example, if we have a sentence:
...
Then, grammatically, [أَنْ]{.ar} and what follows it may be expressed with the [maSdar]{.trn2} [عِلْم]{.ar} thus:
...
There is a specific [لِ]{.ar}, called the [لِ]{.ar} of denial,  which is used with a-case [muDArie]{.trn2} verbs and the verb [كَانَ]{.ar} that we will discuss in section (TODO in [كَانَ]{.ar} chapter).
...
It is also used before the a-case [muDArie]{.trn2} verb.
The difference from [لِ]{.ar} is that, when [لِ]{.ar} is used with the a-case [muDArie]{.trn2} verb, expressing or dropping the [أَنْ]{.ar} was optional.
...
By the way, 
[كَيْ]{.ar} and a following a-case [muDArie]{.trn2} verb are not _directly_ replaced by
a [maSdar]{.trn2}.
...
Then [لِ]{.ar} is to be used in place of [كَيْ]{.ar} if we wish to replace it and what follows with the [maSdar]{.trn2} [عِلْم]{.ar} thus:
...
Therefore,
[رَأْس]{.ar}
is in the i-case, as the noun following a preposition.
...
[رَأْس]{.ar},
here, is in the a-case because it is a direct doee of the verb [أَكَلَ]{.ar} "ate".
The particle
[حَتَّىٰ]{.ar} "even",
...
Now
[رَأْس]{.ar}
is in the u-case because it is actually the subject of a new sentence, whose info is (an either expressed or implied) [أَكَلْتُهَا]{.ar} "I ate it".
[حَتَّىٰ]{.ar},
here, serves as an introductory particle to the second subject and does not affect the case of the following noun.
...
#### [حَتَّىٰ]{.ar} with a following a-case [muDArie]{.trn2} verb

When
[حَتَّىٰ]{.ar}
is used with an expectation or purpose of a future action of the verb following it, then 
the verb following it is an a-case [muDArie]{.trn2} verb. 
<!--
When the verb following
[حَتَّىٰ]{.ar}
signifies the expectation or purpose of a future action, then the verb used is an a-case [muDArie]{.trn2} verb. 
-->
...
2. When [حَتَّىٰ]{.ar} is used with the meaning "to such a purpose that". This is a similar meaning to [كَيْ]{.ar} "in order that".
   ...
   Again, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following [muDArie]{.trn2} verb being in the a-case.
...
[حَتَّىٰ]{.ar}
in this case
may even be a [mADI]{.trn2} verb. For example:

[أَكَلْتُ ٱلطَّعَامَ حَتَّىٰ شَبِعْتُ.]{.ar}  
"I ate the food until I became full."

When used with a following [muDArie]{.trn2} verb, the verb is put in the u-case and the meaning is that the action of the verb _before_
[حَتَّىٰ]{.ar}
...
Compare these examples with the corresponding ones in the previous sub-section that have an a-case [muDArie]{.trn2} verb.


<!--The preposition 
[حَتَّىٰ]{.ar} [HattA]{.trn}
is unusual in that the [muDArie]{.trn2} verb following it may either be in the a-case or the u-case, with slightly different meanings.
When the [muDArie]{.trn2} verb following it is in the u-case then
[حَتَّىٰ]{.ar} gives the meaning "until".
And when the [muDArie]{.trn2} verb following it is in the a-case then
[حَتَّىٰ]{.ar} gives the meaning "for the result that".
A mandatorily unexpressed [أَنْ]{.ar} is assumed with
[حَتَّىٰ]{.ar} 
when the verb following it is in the a-case.
Examples:

[يَأْكُلُ حَتَّىٰ يَشْبَعَ.]{.ar} (a-case, unexpressed [أَنْ]{.ar} assumed)  
"He eats for the result that he be sated."

[يَأْكُلُ حَتَّىٰ يَشْبَعُ.]{.ar} (u-case, no [أَنْ]{.ar})  
"He eats until he is sated."

[حَتَّىٰ]{.ar} 
is also used with [mADI]{.trn2} verbs. Example:

[أَكَلَ حَتَّىٰ شَبِعَ.]{.ar} ([mADI]{.trn2}, no [أَنْ]{.ar})  
"He ate until he was sated."
-->

## After [لَنْ]{.ar} [lan]{.trn}

[لَا]{.ar} and [أَنْ]{.ar} are combined to form [لَنْ]{.ar} [lan]{.trn} with the meaning "shall not". [لَنْ]{.ar} is used with the a-case [muDArie]{.trn2} verb to emphatically negate the future.
...
occur after an a-case [muDArie]{.trn2} verb, then 
a second a-case [muDArie]{.trn2} verb
(that doesn't have its own [أَنْ]{.ar}, etc.)
may be either in the a-case or the u-case.
For example,

[أَرْغَبُ أَنْ أَحْضُرَ ٱلْمَجْلِسَ وَأَسْمَعَ.]{.ar} ([أَسْمَعَ]{.ar} in a-case)  
"I desire that I attend the session and [that] I listen."

or

[أَرْغَبُ أَنْ أَحْضُرَ ٱلْمَجْلِسَ وَأَسْمَعُ.]{.ar} ([أَسْمَعَ]{.ar} in u-case)  
...
[وَ]{.ar}, [فَ]{.ar}, [أَوْ]{.ar}, and [ثُمَّ]{.ar} also cause the following [muDArie]{.trn2} verb to be in the a-case in their own right, not simply as connectors. This is discussed in more detail in chapter TODO.
