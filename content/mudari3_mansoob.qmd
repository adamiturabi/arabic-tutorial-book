...
In 
chapter\ \@ref(u-case-caseful-verbs)
we mentioned that caseful verbs have three cases (like nouns). 
...
We introduced the u-case caseful verb in
chapter\ \@ref(u-case-caseful-verbs).
In this chapter we will study the 
a-case
caseful verb.

The u-case caseful verb makes a plain statement.
The a-case caseful verb implies a wish or purpose.
The a-case caseful verb is used after the following articles:
...
## Forming the a-case caseful verb

Here is the u-case caseful verb for the singular masculine absentee participant doer "he":
...
|Participant|Caseful verb doer pronoun|u-case caseful verb | a-case caseful verb|
|:---|:--|:---|:---|
...
caseful verb to be in the a-case.
...
### Basic usage of [أَنْ]{.ar} [Ean]{.trn} with the a-case caseful verb
...
[لَا]{.ar} can be used to negate the following a-case caseful verb.
...
[أَنْ]{.ar} must directly precede the following a-case caseful verb and must not be separated from it.
...
### [أَنْ]{.ar} with the caseless verb

[أَنْ]{.ar} may also occur before a caseless verb. Example:
...
<!--
By the way, this [لِ]{.ar}, which is used with a-case caseful verbs, is different from 
the [لِ]{.ar} we learned in section\ \@ref(indirect-commands), which is used with the ø-case caseful verbs for indirect commands.
-->

By the way, the grammatical equivalence of [أَنْ]{.ar} and a following a-case caseful verb with a [maSdar]{.trn2} applies also to when [لِ]{.ar} is used before (either an expressed or an implied) [أَنْ]{.ar}. So, for example, if we have a sentence:
...
There is a specific [لِ]{.ar}, called the [لِ]{.ar} of denial,  which is used with a-case caseful verbs and the verb [كَانَ]{.ar} that we will discuss in section (TODO in [كَانَ]{.ar} chapter).
...
It is also used before the a-case caseful verb.
The difference from [لِ]{.ar} is that, when [لِ]{.ar} is used with the a-case caseful verb, expressing or dropping the [أَنْ]{.ar} was optional.
...
By the way, 
[كَيْ]{.ar} and a following a-case caseful verb are not _directly_ replaced by
a [maSdar]{.trn2}.
...
#### [حَتَّىٰ]{.ar} with a following a-case caseful verb

When
[حَتَّىٰ]{.ar}
is used with an expectation or purpose of a future action of the verb following it, then 
the verb following it is an a-case caseful verb. 
<!--
When the verb following
[حَتَّىٰ]{.ar}
signifies the expectation or purpose of a future action, then the verb used is an a-case caseful verb. 
-->
...
1. When [حَتَّىٰ]{.ar} is used to indicate an extreme point at which the action of the following verb would occur, or is meant to occur. Here, 
   ...
   Also, similar to the case of [كَيْ]{.ar}, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following caseful verb being in the a-case.
   In fact, 
   [حَتَّىٰ]{.ar},
...
2. When [حَتَّىٰ]{.ar} is used with the meaning "to such a purpose that". This is a similar meaning to [كَيْ]{.ar} "in order that".
   ...
   Again, there is an assumed (but mandatorily unexpressed) [أَنْ]{.ar} which is the real cause of the following caseful verb being in the a-case.
...
[حَتَّىٰ]{.ar}
in this case
may even be a caseless verb. For example:

[أَكَلْتُ ٱلطَّعَامَ حَتَّىٰ شَبِعْتُ.]{.ar}  
"I ate the food until I became full."

When used with a following caseful verb, the verb is put in the u-case and the meaning is that the action of the verb _before_
[حَتَّىٰ]{.ar}
...
Compare these examples with the corresponding ones in the previous sub-section that have an a-case caseful verb.


<!--The preposition 
[حَتَّىٰ]{.ar} [HattA]{.trn}
is unusual in that the caseful verb following it may either be in the a-case or the u-case, with slightly different meanings.
When the caseful verb following it is in the u-case then
[حَتَّىٰ]{.ar} gives the meaning "until".
And when the caseful verb following it is in the a-case then
...
[حَتَّىٰ]{.ar} 
is also used with caseless verbs. Example:

[أَكَلَ حَتَّىٰ شَبِعَ.]{.ar} (caseless, no [أَنْ]{.ar})  
"He ate until he was sated."
-->

## After [لَنْ]{.ar} [lan]{.trn}

[لَا]{.ar} and [أَنْ]{.ar} are combined to form [لَنْ]{.ar} [lan]{.trn} with the meaning "shall not". [لَنْ]{.ar} is used with the a-case caseful verb to emphatically negate the future.
...
occur after an a-case caseful verb, then 
a second a-case caseful verb
...
[وَ]{.ar}, [فَ]{.ar}, [أَوْ]{.ar}, and [ثُمَّ]{.ar} also cause the following caseful verb to be in the a-case in their own right, not simply as connectors. This is discussed in more detail in chapter TODO.
