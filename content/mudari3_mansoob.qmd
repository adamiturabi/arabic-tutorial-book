...
### [أَنْ]{.ar} with the perfect verb

[أَنْ]{.ar} may also occur before a perfect verb. Example:
...
the [لِ]{.ar} we learned in section\ \@ref(indirect-commands), which is used with the 0-state stateful verbs for indirect commands.
-->
...
[حَتَّىٰ]{.ar}
in this case
may even be a perfect verb. For example:
...
[حَتَّىٰ]{.ar} 
is also used with perfect verbs. Example:

[أَكَلَ حَتَّىٰ شَبِعَ.]{.ar} (perfect, no [أَنْ]{.ar})  
