...
Such sentences, if they are able to be converted to an interjection, may be expressed with the [mubtada]{.subs} itself as a one word sentence:
...
When asking the question, "What happened to a person/thing?" the verbs [فَعَلَ]{.ar} and [صَنَعَ]{.ar} are used and the person or thing asked about is made the [fail]{.subs}.
For example:
