...
When asking the question, "What happened to a person/thing?" the verbs [فَعَلَ]{.ar} and [صَنَعَ]{.ar} are used and the person or thing asked about is made the [fail]{.term}.
For example:
