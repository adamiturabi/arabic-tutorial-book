...
In this chapter we will learn about a class of sentences called _[j_ism]{.subs}s._ 
[#j_ism]{.subs}s consist of two parts:
...
## Forming [j_ism]{.subs}s

Here is a [j_ism]{.subs}:
...
Next we put them both in the [ustate]{.subs}. For [j_ism]{.subs}s, both the [mubtada]{.subs} and the [xabar]{.subs} shall be in the [ustate]{.subs}. Remember that the [ustate]{.subs} is formed by putting a [tanwin]{.subs}ed [umark]{.subs} [◌ٌ]{.ar} at the end of an indefinite noun, and a [umark]{.subs} [◌ُ]{.ar} at the end of a definite noun. Here are the two nouns in the [ustate]{.subs}:
