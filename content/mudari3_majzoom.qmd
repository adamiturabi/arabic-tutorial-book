...
# The [0state]{.subs} [mudarie]{.subs} verb
...
We have already studied the [ustate]{.subs} of [mudarie]{.subs} verbs in 
chapter\ \@ref([ustate]{.subs}-[mudarie]{.subs}-verbs).
And we will defer the study of 
[astate]{.subs} of [mudarie]{.subs} verbs to
chapter\ \@ref([astate]{.subs}-[mudarie]{.subs}-verbs).
...
## Forming the [0state]{.subs} [mudarie]{.subs} verb
...
|Participant|[#mudarie]{.subs} verb [faa3il]{.subs} pronoun|[ustate]{.subs} [mudarie]{.subs} verb | [0state]{.subs} [mudarie]{.subs} verb|
|:---|:--|:---|:---|
...
+ The [ustate]{.subs} and [0state]{.subs} verbs are the same for the feminine plural absentee and addressee participants: 
  + [يَفْعَلْنَ]{.ar} (they~3+,f~)
  + [تَفْعَلْنَ]{.ar} (you~3+,f~)
+ The [ustate]{.subs} and [0state]{.subs} verbs for the masculine plural absentee and addressee participants have a final silent [alif]{.trn2}: 
...
[mudarie]{.subs} verb
ends with a 
[0mark]{.subs} [◌ْ]{.ar}, and the next word begins with a connecting [hamzah]{.trn2} [ٱ]{.ar} then the
[0mark]{.subs} [◌ْ]{.ar} is converted to an [imark]{.subs} [◌ِ]{.ar}. For example:
  + [يَفْعَلْ + ٱلرَّجُلُ = يَفْعَلِ ٱلرَّجُلُ]{.ar}

<!--
## Uses of the [0state]{.subs} [mudarie]{.subs} verb

The [ustate]{.subs} is the default state for [mudarie]{.subs} verbs. The 
[0state]{.subs}
...
The indirect command is only rarely used for the addressee participant.^[[[شرح ابن يعيش على المفصل]{.ar} 4/291--293](https://shamela.ws/book/13301/1655#p1). See also references to [[البحر المحيط لأبي حيان]{.ar}](https://tafsir.app/albahr-almuheet/10/58) for [سورة يونس]{.ar} 10:58 and other [tafsIr]{.trn2}s for the reading [فبذلك فلتفرحوا]{.ar}]

So an example like the following is permissible but rare:

[لِتَجْلِسْ]{.ar}  
"You should sit!"

Instead, the verb of command is more commonly used which we will study in section\ \@ref(verb-of-command) later in this chapter.

The particles [فَ]{.ar} "so" and [وَ]{.ar} "and" are frequently used before this [لِ]{.ar}. 
The [لِ]{.ar} then loses its [imark]{.subs} and gets a
[0mark]{.subs}. Examples:

[فَلْنَأْكُلْ طَعَامَنَا وَلْنَشْرَبْ شَرَابَنَا.]{.ar}  
"So let us eat our food and drink our drink!"

[وَلْيَجْلِسُوا عَلَى ٱلْأَرْضِ.]{.ar}  
"And they should sit on the ground!"

Finally, the [لِ]{.ar} before a [0state]{.subs} [mudarie]{.subs} verb for the indirect command is mandatory.
But it may be dropped by poetic license.^[[[شرح ابن يعيش على المفصل]{.ar} 4/291--292](https://shamela.ws/book/13301/1655#p1)]
...
By the way, [لَا]{.ar} does not force a verb to be in the [ustate]{.subs}
[0state]{.subs}. We have already seen in 
section\ \@ref([ustate]{.subs}-verb-negation-la)
that [لَا]{.ar} can be used to negate a [ustate]{.subs} [mudarie]{.subs} verb for the present and future tense.
Example:
...
section\ \@ref(negating-[madi]{.subs}-verbs) that the [madi]{.subs} verb is negated using the particle [مَا]{.ar}. For example:
...
## Other uses of the [0state]{.subs} [mudarie]{.subs} verb

The [0state]{.subs} [mudarie]{.subs} verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
...
In order to form the verb of command, we remove the initial [ت]{.ar} from the addressee particpant verb. The verb then begins with an [0mark]{.subs} so we place a connecting [hamzah]{.trn2} in front of it.
...
i. When the middle root letter of the verb of command has an [umark]{.subs}\ [◌ُ]{.ar}, then the connecting [hamzah]{.trn2} gets an [umark]{.subs}\ too. Examples:
...
i. Otherwise, when the middle root letter of the verb of command has an [amark]{.subs}\ [◌َ]{.ar} or an [imark]{.subs}\ [◌ِ]{.ar}, then the connecting [hamzah]{.trn2} gets an [imark]{.subs}\ [◌ِ]{.ar}. Examples:
...
Instead, the 
[0state]{.subs} verb is used with [لَا]{.ar}
as described in
...
for the singular masculine addressee [faa3il]{.subs} "he":
