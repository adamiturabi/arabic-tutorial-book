...
We have already studied the u-case of [muDArie]{.trn2} verbs in 
chapter\ \@ref(u-case-[muDArie]{.trn2}-verbs).
And we will defer the study of 
a-case of [muDArie]{.trn2} verbs to
chapter\ \@ref(a-case-[muDArie]{.trn2}-verbs).
...
## Forming the ø-case [muDArie]{.trn2} verb
...
|Participant|[#muDArie]{.trn2} verb doer pronoun|u-case [muDArie]{.trn2} verb | ø-case [muDArie]{.trn2} verb|
|:---|:--|:---|:---|
...
+ The u-case and ø-case verbs are the same for the feminine plural absentee and addressee participants: 
  + [يَفْعَلْنَ]{.ar} (they~3+,f~)
  + [تَفْعَلْنَ]{.ar} (you~3+,f~)
+ The u-case and ø-case verbs for the masculine plural absentee and addressee participants have a final silent [alif]{.trn2}: 
...
[muDArie]{.trn2} verb
ends with a 
[sukUn]{.trn2} [◌ْ]{.ar}, and the next word begins with a connecting [hamzah]{.trn2} [ٱ]{.ar} then the
[sukUn]{.trn2} [◌ْ]{.ar} is converted to an [kasrah]{.trn2} [◌ِ]{.ar}. For example:
  + [يَفْعَلْ + ٱلرَّجُلُ = يَفْعَلِ ٱلرَّجُلُ]{.ar}

<!--
## Uses of the ø-case [muDArie]{.trn2} verb

The u-case is the default case for [muDArie]{.trn2} verbs. The 
ø-case
...
The indirect command is only rarely used for the addressee participant.^[[[شرح ابن يعيش على المفصل]{.ar} 4/291--293](https://shamela.ws/book/13301/1655#p1). See also references to [[البحر المحيط لأبي حيان]{.ar} for [سورة يونس]{.ar} 10:58](https://tafsir.app/albahr-almuheet/10/58) and other [tafsIr]{.trn2}s for the reading [فبذلك فلتفرحوا]{.ar}]
...
The [لِ]{.ar} then loses its [kasrah]{.trn2} and gets a
[sukUn]{.trn2}. Examples:
...
Finally, the [لِ]{.ar} before a ø-case [muDArie]{.trn2} verb for the indirect command is mandatory.
...
By the way, [لَا]{.ar} does not force a verb to be in the u-case
ø-case. We have already seen in 
section\ \@ref(u-case-verb-negation-la)
that [لَا]{.ar} can be used to negate a u-case [muDArie]{.trn2} verb for the present and future tense.
Example:
...
section\ \@ref(negating-[mADI]{.trn2}-verbs) that the [mADI]{.trn2} verb is negated using the particle [مَا]{.ar}. For example:
...
## Other uses of the ø-case [muDArie]{.trn2} verb

The ø-case [muDArie]{.trn2} verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
...
In order to form the verb of command, we remove the initial [ت]{.ar} from the addressee particpant verb. The verb then begins with an [sukUn]{.trn2} so we place a connecting [hamzah]{.trn2} in front of it.
...
i. When the middle root letter of the verb of command has an [Dammah]{.trn2}\ [◌ُ]{.ar}, then the connecting [hamzah]{.trn2} gets an [Dammah]{.trn2}\ too. Examples:
...
i. Otherwise, when the middle root letter of the verb of command has an [fatHah]{.trn2}\ [◌َ]{.ar} or an [kasrah]{.trn2}\ [◌ِ]{.ar}, then the connecting [hamzah]{.trn2} gets an [kasrah]{.trn2}\ [◌ِ]{.ar}. Examples:
...
Instead, the 
ø-case verb is used with [لَا]{.ar}
as described in
...
@sec-hamzarules details the rules for speeling words that contain [hamzah]{.trn2} generally.
