...
We have already studied the u-case of caseful verbs in 
chapter\ \@ref(u-case-caseful-verbs).
And we will defer the study of 
a-case of caseful verbs to
chapter\ \@ref(a-case-caseful-verbs).
...
## Forming the ø-case caseful verb
...
|Participant|Caseful verb doer pronoun|u-case caseful verb | ø-case caseful verb|
|:---|:--|:---|:---|
...
<!--
## Uses of the ø-case caseful verb

The u-case is the default case for caseful verbs. The 
ø-case
...
Finally, the [لِ]{.ar} before a ø-case caseful verb for the indirect command is mandatory.
...
that [لَا]{.ar} can be used to negate a u-case caseful verb for the present and future tense.
Example:
...
section\ \@ref(negating-caseless-verbs) that the caseless verb is negated using the particle [مَا]{.ar}. For example:
...
## Other uses of the ø-case caseful verb

The ø-case caseful verb is also used for _consequential actions_ and in _conditional statements_. We will deal with these in
