...
Arabic expresses this meaning using a construction called _[idafa]{.term}_. In this chapter we will learn about this construction.

## Forming the [idafa]{.term}

The word "[idafa]{.term}" means the addition of a new _annexed_ item to an existing _base_ item. We use the term _[idafa]{.term}_ in Arabic grammar when an _annexe_ noun is annexed to a _base_ noun by being placed right before it. Here is an example of an [idafa]{.term}:
...
\draw [decoration={brace}, decorate] 
   (word-2.north west) -- (word-2.north east)
      node [midway, rotate=90, anchor=south, right=0ex] {\scriptsize [mudaf]{.term}};

\draw [decoration={brace}, decorate] 
   (word-1.north west) -- (word-1.north east)
      node [midway, rotate=90, anchor=south, right=0ex] {\scriptsize [mudafil]{.term}};

\draw [decoration={brace, mirror}, decorate] 
   (word-1.south west) -- (word-2.south east)
      node [midway, below] {\scriptsize [idafa]{.term}};
...
The [idafa]{.term} construction consists of two nouns:

1. The _annexe_ noun: This is the first noun in the [idafa]{.term}.
1. The _base_ noun: This is the second noun in the [idafa]{.term}.

The [mudaf]{.term} [كِتَاب]{.ar} is annexed to, and belongs to, the [mudafil]{.term} [ٱَلْغُلَام]{.ar}. 
You can use the alphabetical  order (A,\ B) to help you remember that the **a**nnexe noun comes before the **b**ase noun.

<!--
Take note of the following points regarding the [idafa]{.term} construction:

+ The [mudafil]{.term} in an [idafa]{.term} shall always be in the i-state.
+ The state of the [mudaf]{.term} is variable and shall depend on its function in the sentence.
+ The [mudaf]{.term} in an [idafa]{.term} shall neither have an [n]{.trn}-mark nor the prefix [ٱَلْ]{.ar}.
...
-->
## State of the annexe and [mudafil]{.term}s

The [mudafil]{.term} in an [idafa]{.term} is always in the i-state. The [mudaf]{.term} may be in any state, depending on its function in the sentence. For example,
<!--
...
(The [mudaf]{.term} is in the u-state.)

[أَخَذَتِ ٱلْجَارِيَةُ كِتَابَ ٱلْغُلَامِ.]{.ar}  
"The girl took the boy's book."  
(The [mudaf]{.term} is in the a-state.)

[كَتَبَ ٱلْمُعَلِّمُ فِي كِتَابِ ٱلْغُلَامِ.]{.ar}  
"The teacher~m~ wrote in the boy's book."  
(The [mudaf]{.term} is in the i-state.)

## Definiteness of the [idafa]{.term}

Consider again the [idafa]{.term} expression we have been using so far:

[كِتَابُ ٱلْغُلَامِ]{.ar}  
"the boy's book"  

The [mudafil]{.term} [ٱَلْغُلَام]{.ar} is definite because it is prefixed by [ٱَلْ]{.ar} "the".
Therefore we have translated it as "the boy".
The [mudaf]{.term} [كِتَاب]{.ar} is not made definite by [ٱَلْ]{.ar}.
Nor is it made indefinite by [nUn]{.trn2}ation. 
<!--Its definiteness is determined by the [mudafil]{.term}. -->
Rather, its definiteness is determined by the [mudafil]{.term}.
Because the [mudafil]{.term} [ٱَلْغُلَام]{.ar} is definite, therefore the [mudaf]{.term} [كِتَاب]{.ar} is also definite.
The entire [idafa]{.term} is definite.
<!--If the [mudafil]{.term} is definite (as it is above) then the [mudaf]{.term} shall also be definite.
And if the [mudafil]{.term} is indefinite (as below) then the [mudaf]{.term} shall also be indefinite.-->

Consider now the case when the [mudafil]{.term} is indefinite.

[كِتَابُ غُلَامٍ]{.ar}  
"a boy's book"  

In the above example, the [mudafil]{.term} [غُلَامٍ]{.ar} is indefinite because it is [nUn]{.trn2}ated and because it does not prefixed by [ٱَلْ]{.ar}. Therefore we have translated it as "a boy".
The [mudaf]{.term} [كِتَاب]{.ar} is neither [nUn]{.trn2}ated, nor does it have [ٱَلْ]{.ar}.
Its definiteness is, again, determined by the [mudafil]{.term}.
Because the [mudafil]{.term} [غُلَامٍ]{.ar} is indefinite, therefore the [mudaf]{.term} [كِتَاب]{.ar} is also indefinite.
The entire [idafa]{.term} is indefinite.

We will see soon, if [_allAh]{.trn2} wills, why the definiteness of the [mudaf]{.term} is important.

<!--

As you can see above English has two constructs to translate the [idafa]{.term}:
...
The [mudaf]{.term} in an [idafa]{.term} can have neither an [n]{.trn} mark, nor an [ٱَلْ]{.ar}. 
The [mudafil]{.term} is permitted to have an [n]{.trn} mark or an [ٱَلْ]{.ar} prefix. 
The definiteness of the [mudafil]{.term} then determines the definiteness of the [idafa]{.term}. If the second noun is definite, then both the annexe and the [mudafil]{.term}s be definite. And if the [mudafil]{.term} is indefinite, then both the nouns in the chain will be indefinite. 
...
Here are some examples of definite and indefinite [idafa]{.term}s.
...
### Translating the [idafa]{.term} using "of"

So far we have been using the English "'s" to translate the Arabic [idafa]{.term}. Examples:
...
Note that the [mudaf]{.term} "house" may be prefixed with either "a" or "the". This will depend on what is more natural in English. Often time both will fit. Here are some examples:
...
It is important to understand that translating the [mudaf]{.term} into English with "a" or "the" is purely for the reason of obtaining a natural translation. This does not affect whether or not the [mudaf]{.term} is grammatically considered definite in Arabic.

As we mentioned earlier, the definiteness of the [mudaf]{.term} in Arabic depends only on the definiteness of the [mudafil]{.term}. 
If the [mudafil]{.term} is definite then the [mudaf]{.term} shall be considered definite as well.
And if the [mudafil]{.term} is indefinite then the [mudaf]{.term} shall be considered indefinite as well.

The need to maintain this distinction will become apparent in the next section.

If the [mudafil]{.term} is definite, and it is desired to make the [mudaf]{.term} grammatically indefinite, then it is necassary to break the [idafa]{.term}, and use a prepositional phrase instead, usually with the preposition [لِ]{.ar}, which, here, will mean "of". Example:
...
## Broken plurals and [At]{.trn} sound plurals in [idafa]{.term}s {#broken-plurals-and-at-sound-plurals-in-[idafa]{.term}s}

There is no special rules for broken plurals and [At]{.trn} sound plurals in [idafa]{.term}s. They behave just like singular nouns. Remember only that [At]{.trn} plurals end with [◌ٍ]{.ar} and [◌ِ]{.ar} in the a-state. Here are some examples:
...
Contrary to broken plurals and [At]{.trn} plurals, duals and [Un]{.trn} sound plurals behave differently in [idafa]{.term}s. We will deal with them in section\ \@ref(duals-and-sound-un-plurals-in-[idafa]{.term}s)

## Describers in an [idafa]{.term}

### Describing the [mudafil]{.term}
...
Basically, we want to describe the [mudafil]{.term} [ٱَلْجَارِيَة]{.ar} "the girl" with the adjectival noun [صَغِير]{.ar} "a small one". 
...
Similarly, if we had an indefinite [idafa]{.term}, we would get:
...
### Describing the [mudaf]{.term}

Consider, again, the same [idafa]{.term}:

[كِتَابُ ٱلْجَارِيَةِ]{.ar}  
"the girl's book"

Say, now, that we want to describe the [mudaf]{.term} [كِتَاب]{.ar} "book" with the adjectival noun [صَغِير]{.ar} "a small one". Normally, nothing can come between the [mudaf]{.term} and the [mudafil]{.term} in an [idafa]{.term}. So, the describer needs to be placed, again, after the [mudafil]{.term}.
However, this time it will match the [mudaf]{.term}, not the [mudafil]{.term}, in state, definiteness, gender, and number. So we get:

[كِتَابُ ٱلْجَارِيَةِ ٱلصَّغِيرُ]{.ar}  
"the girl's small book"

Note how the describer 
[ٱَلصَّغِيرُ]{.ar} matches the [mudaf]{.term} [كِتَابُ]{.ar} in state and gender.
Note also how the describer is definite with an [ٱَلْ]{.ar}. This is because it is matching the [mudaf]{.term} [كِتَابُ]{.ar} in definiteness.
The [mudaf]{.term} [كِتَاب]{.ar} is definite, not with [ٱَلْ]{.ar}, but rather because of the definite [mudafil]{.term} [ٱَلْجَارِيَةِ]{.ar} "the girl".
We've already learned this rule in 
section\ \@ref(definiteness-of-the-[idafa]{.term})
above.

Similarly, if we describe the [mudaf]{.term} [كِتَاب]{.ar} in an indefinite [idafa]{.term}, we get:
...
This is because 
the [mudaf]{.term} [كِتَابُ]{.ar} is indefinite. It is indefinite because [mudafil]{.term} [جَارِيَةٍ]{.ar} "a girl" is indefinite.

Now, you might be foreseeing a problem. What if the [mudaf]{.term} and the [mudafil]{.term} have the same gender, and the annexe too is in the i-state? For example, in the sentence:
...
How do we know whether the describer [كَبِير]{.ar} is meant to describe the [mudaf]{.term} [بَيْتِ]{.ar} or the [mudafil]{.term} [ٱَلرَّجُل]{.ar}?
The [mudaf]{.term} [بَيْتِ]{.ar} and the [mudafil]{.term} [ٱَلرَّجُل]{.ar} are both masculine, singular, definite, and in the i-state.
...
If, however, the context is not clear, and the meaning of the describer can apply to both the [mudaf]{.term} and the [mudafil]{.term}, then the describer is likely to apply to the [mudafil]{.term} and not to the [mudaf]{.term}. So then, this interpretation is more likely:

[ذَهَبَ ٱلْغُلَامُ إِلَىٰ بَيْتِ ٱلرَّجُلِ ٱلْكَبِيرِ.]{.ar}  
"The boy went to the big/old man's house."  

In order to apply a describer to the [mudaf]{.term} in such a case, it is better to break the [idafa]{.term} and form a prepositional phrase instead, usually with the preposition [لِ]{.ar}, which, here, will mean "of". Example:
...
## Semi-flexible nouns in an [idafa]{.term}
...
We will now see how semi-flexible nouns behave in an [idafa]{.term}.

### A semi-flexible noun as the [mudafil]{.term}

Here are examples of the semi-flexible noun ^2^[صَحْرَاء]{.ar} "a desert" as the [mudafil]{.term} in an [idafa]{.term}:
...
### A semi-flexible noun as the [mudaf]{.term}

Contrary from expected behavior, a semi-flexible [mudaf]{.term}, even when indefinite, takes an [i]{.trn}-mark\ [◌ِ]{.ar} in the i-state instead of an [a]{.trn}-mark\ [◌َ]{.ar}. Example,

[قَدِمَ ٱلْأَعْرَابِيُّ مِنْ صَحْرَاءِ أَرْضٍ بَعِيدَةٍ.]{.ar}  
"The bedouin came from the desert of a far land."

In the above example,
^2^[صَحْرَاء]{.ar} "a desert" is indefinite because it is the [mudaf]{.term} to an indefinite [mudafil]{.term} [أَرْض]{.ar} "a land". 
...
## [_idafa]{.term}s with more than two nouns

So far we have seen [idafa]{.term}s with two nouns. [_idafa]{.term}s may be arbitrarily long. Here is an example of a noun-chain with more than two nouns:
...
%   (word-1.south west) -- (word-2.south east)
%      node [midway, below=3ex] {[idafa]{.term}};
\end{tikzpicture}
```

The above [idafa]{.term} consists of three nouns. It may be divided into two sub-[idafa]{.term}s:

i. [مِفْتَاحُ بَابِ]{.ar} "door's key". Its [mudaf]{.term} $a_1$\ is [مِفْتَاح]{.ar} and its [mudafil]{.term}\ $b_1$ is [بَابِ]{.ar}.
i. [بَابِ ٱلْبَيْتِ]{.ar} "the house's door". Its [mudaf]{.term} $a_2$\ is [بَابِ]{.ar} and its [mudafil]{.term}\ $b_2$ is [ٱلْبَيْتِ]{.ar}.

The noun [بَاب]{.ar} "door" is common to both sub-[idafa]{.term}s. It is the [mudafil]{.term} of the first sub-[idafa]{.term}
[مِفْتَاحُ بَابِ]{.ar} "door's key".
At the same time, it is also the [mudaf]{.term} of the second sub-[idafa]{.term}
[بَابِ ٱلْبَيْتِ]{.ar} "the house's door".

Only the final [mudafil]{.term} may have [ٱَلْ]{.ar} or be [nUn]{.trn2}ated. If the final [mudafil]{.term} has [ٱَلْ]{.ar} (as above) then all the nouns in the [idafa]{.term} are definite. 

And if the final [mudafil]{.term} is indefinite, as in the example below, then all the nouns in the [idafa]{.term} are indefinite.

[مِفْتَاحُ بَابِ بَيْتٍ]{.ar}  
"a house's door's key"

All the nouns except the first [mudaf]{.term} must be in the i-state. Consistent with 
section\ \@ref(a-semi-flexible-noun-as-the-annexe-noun)
if a semi-flexible noun is any of the [mudaf]{.term}s and is in the i-state, then its i-state is indicated by an [a]{.trn}-mark [◌َ]{.ar}. Example:

[مِنْ بِئْرِ صَحْرَاءِ أَرْضٍ]{.ar}  
"from the well of the desert of a land"

## Pronouns as [mudafil]{.term}s

Consider the expression:

"his book"

This expression is very similar to the [idafa]{.term}:

[كِتَابُ ٱلْغُلَامِ]{.ar}  
"the boy's book" 

The difference is that we would like to replace the [mudafil]{.term} [ٱَلْغُلَام]{.ar} "the boy" with the pronoun "his". For this we use the attached pronoun [هُ]{.ar}. When we place this pronoun as the [mudafil]{.term}, we get:

[كِتَابُهُ]{.ar}  
"his book"

This [idafa]{.term} follows the same rules as the other [idafa]{.term}s we have been studying so far:

+ The [mudaf]{.term} may be in any state, depending on its function in the sentence.
+ The [mudafil]{.term} is in the i-state. But because the [mudafil]{.term} is a pronoun, and pronouns are rigid nouns (see section\ \@ref(rigidity-of-pronouns) that don't change their ending based on their state, therefore it's i-state will not be apparent.

Here are some examples of this [idafa]{.term} used in sentences:
...
If the [mudaf]{.term} ends with [ة]{.ar} then it is converted to a [ت]{.ar} when annexing it to an attached pronoun. For example:
...
If the [mudaf]{.term} is semi-flexible then it gets a [◌ِ]{.ar} in the i-state, as we've already learned. Example with the semi-flexible broken plural ^2^[حَدَائِق]{.ar} "gardens".

[لَعِبْنَ فِي حَدَائِقِهِنَّ.]{.ar}  
"They~3,f~ played in their~3,f~ gardens."

If an [mudaf]{.term} ends with [ىٰ]{.ar} then it gets converted to an [alif]{.trn2} when annexing it to an attached pronoun. Example with ^2^[فَتَاوَىٰ]{.ar} "legal opinions":
...
If, however, the [mudaf]{.term} ends in a long vowel or a semi-vowel then 
...
### Describers with [idafa]{.term}s to pronouns

Consider the [idafa]{.term}:

[كِتَابُهُ]{.ar}  
"his book"

The [mudaf]{.term} is [كِتَاب]{.ar} and the [mudafil]{.term} is the pronoun [ه]{.ar}.
We would like add a describer to this expression.
Remember from section\ \@ref(definiteness-of-pronouns) that pronouns are definite nouns. That makes the [mudaf]{.term} [كِتَاب]{.ar} also definite.
Therefore, any describer for this [idafa]{.term} will need to be definite too.
...
So, any describers for the [idafa]{.term} must necessarily only describe the [mudaf]{.term}, not the base pronoun. Example:
...
## Duals and [Un]{.trn} sound plurals in [idafa]{.term}s {#duals-and-sound-un-plurals-in-[idafa]{.term}s}

We have already dealt with broken plurals and [At]{.trn} sound plurals in [idafa]{.term}s in 
section\ \@ref(broken-plurals-and-at-sound-plurals-in-[idafa]{.term}s).

In this section we will deal with 
duals and [Un]{.trn} sound plurals in [idafa]{.term}s.

### Duals and [Un]{.trn} sound plurals as [mudafil]{.term}s

As [mudafil]{.term}, duals and [Un]{.trn} sound plurals behave no differently than other nouns. Being [mudafil]{.term}s they will be in the i-state and this shall be indicated by:
...
### Duals and [Un]{.trn} sound plurals as [mudaf]{.term}s

When duals and [Un]{.trn} sound plurals are [mudaf]{.term}s, then their final [ن]{.ar} is treated as a sort of [nUn]{.trn2}ation and is, therefore, deleted before annexing them to a [mudafil]{.term}. For example:
...
Note, also, that because the [mudafil]{.term} [ٱَلرَّجُلِ]{.ar} begins with a connecting [hamzah]{.trn2} [ٱ]{.ar}, therefore the long vowel [A]{.trn} at the end of [بَيْتَا]{.ar} is pronounced as a short vowel [a]{.trn}, thus:

[bayta -rrajuli]{.trn}  
not  
$\times$\ [baytA -rrajuli]{.trn}

If the dual [mudaf]{.term} were in the i-state then the final [ي]{.ar} gets an [i]{.trn}-mark [◌ِ]{.trn} if there is following connecting [hamzah]{.trn2}. Example:
...
(Note that there is no silent [alif]{.trn2} after [مُعَلِّمُو]{.ar} as there is after a verb with a plural absentee-participant [fail]{.term} pronoun, e.g. [لَعِبُوا]{.ar} "they~3,m~ played")
...
When an [Un]{.trn} sound plural is annexed to the singular speaker participant pronoun, then again, only the [يَ]{.ar} variant can be used. However, in addition, the expression will appear the same regardless of the state of the [mudaf]{.term}. So for all states (u-state, a-state, and i-state), we will get:
...
<!-- see فقد صغت قلوبكما-->
When a dual noun is to be annexed to a dual pronoun, then the dual [mudaf]{.term} is often converted to a plural. For example, instead of saying 
...
Although the former is also correct. This is because the [idafa]{.term} of a dual to a dual is considered burdensome upon the tongue to utter, and so the plural is prefered.

<!--

Compare this with describing the [mudafil]{.term} with the same adjectival noun.
...
The definiteness, however, is the same in the two expressions because the [mudaf]{.term} has the same definiteness as the [mudafil]{.term}.
...
## [_idafa]{.term}s with "and"

### Multiple [mudaf]{.term}s and one [mudafil]{.term}

In English we can have an expression like "the pen and the book of the boy" = "the boy's pen and book". In this sentence there are two [mudaf]{.term}s and one [mudafil]{.term}.
...
Note that the [idafa]{.term} is not broken by the insertion of [وَ]{.ar} [wa]{.trn} "and". Rather a second [idafa]{.term} is used and the two are separated by [وَ]{.ar} [wa]{.trn} "and". This is the preferred way of expressing such expressions.

There is another, less preferred way of expressing this. And this is by breaking the first [idafa]{.term} and inserting [وَ]{.ar} [wa]{.trn} "and":
...
If the [mudafil]{.term} in the first [idafa]{.term} is replaced with a pronoun then only the first method is allowed. For example,

[قَلَمُهُ وَكِتَابُهُ]{.ar}  
[qalamuhu wakitAbuhu]{.trn}  
"his pen and his book"

### One [mudaf]{.term} and multiple [mudafil]{.term}s

We can also have expressions like "the house of the boy and the girl". In this sentence there is one [mudaf]{.term} and two [mudafil]{.term}s.
...
Note that both 
[ٱلْغُلَامِ]{.ar} [EalgulAmi]{.trn} and [ٱَلْجَارِيَةِ]{.ar} [EaljAriyati]{.trn} are in the i-state because they are both [mudafil]{.term}s in the [idafa]{.term}.

#### With pronouns

If one or both of the [mudafil]{.term}s in the [idafa]{.term} is replaced with a pronoun then the first noun must be repeated. For example,
...
## [_idafa]{.term} to a sentence

So far we have studied the [idafa]{.term} of an [mudaf]{.term} to a [mudafil]{.term}.
It is also possible to have an annnexation where the [mudafil]{.term} is replaced by a sentence or a clause.
For example,
...
\draw [decoration={brace}, decorate] 
   (word-1.north west) -- (word-1.north east)
      node [midway, rotate=90, anchor=south, right=0ex] {\scriptsize sentence in place of [mudafil]{.term}};
...
The word [يَوْم]{.ar} is the [mudaf]{.term} and is used as an adverb or time.
The entire sentence
[خَرَجْنَا مِنَ ٱلْمَدِينَةِ.]{.ar}
occupies the place of the [mudafil]{.term}.
We will study the adverb of time in chapter\ (give ref),
if [_allAh]{.trn2} wills,
where such [idafa]{.term}s are common.

[_idafa]{.term} to a sentence also occurs besides adverbs.^[[https://ar.wikipedia.org/wiki/[الجملة_الفعلية_الواقعة_مضافا_إليه]{.ar}](https://ar.wikipedia.org/wiki/%D8%A7%D9%84%D8%AC%D9%85%D9%84%D8%A9_%D8%A7%D9%84%D9%81%D8%B9%D9%84%D9%8A%D8%A9_%D8%A7%D9%84%D9%88%D8%A7%D9%82%D8%B9%D8%A9_%D9%85%D8%B6%D8%A7%D9%81%D8%A7_%D8%A5%D9%84%D9%8A%D9%87)]
...
But they are more often used as [mudaf]{.term}s.
