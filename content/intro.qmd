...
and ask Allāh to confer blessing upon and grant peace to the Prophet [pbuh]{.subs}
...
When quoting an [ayah]{.subs} from the [#qurEAn]{.trn2},
strict
[sca]{.smallcaps}
would be employed,
even if not reciting the [ayah]{.subs}.
...
[sca]{.smallcaps} fluently does not detract, [ia]{.subs},
