...
<!--They may occur as a subject, an information, a [fail]{.term}, a [mafulb]{.term}, following a preposition, and as a [mudafil]{.term} in an [idafa]{.term}.-->
...
As a [mudafil]{.term} in an [idafa]{.term}:
...
refer-back pronoun: the plural masculine [fail]{.term} pronoun [و]{.ar} in [يَكْنِزُونَ]{.ar}

[خِيَارُ أَئِمَّتِكُمُ الَّذِينَ تُحِبُّونَهُمْ]{.ar}  
"The best of your rulers are the ones whom you love and who love you"  
refer-back pronoun: the plural masculine [mafulb]{.term} attached pronoun [هُمْ]{.ar} in [تُحِبُّونَهُمْ]{.ar}

[قَدْ بَلَغَنَا ٱلَّذِي قُلْتُمُوهُ.]{.ar}  
"The [specific] one (thing) that you said has reached us."  
refer-back pronoun: the singular masculine [mafulb]{.term} attached pronoun [هُ]{.ar} in [قُلْتُمُوهُ]{.ar}

[رَبَّنَا أَرِنَا ٱللَّذَيْنِ أَضَلَّانَا مِنَ ٱلْجِنِّ وَٱلْإِنْسِ]{.ar}  
"Our Lord, show us those who misled us of the jinn and men"  
refer-back pronoun: the dual masculine [fail]{.term} pronoun [ا]{.ar} in [أَضَلَّانَا]{.ar}

[أَوْ كَٱلَّذِي مَرَّ عَلَىٰ قَرْيَةٍ]{.ar}  
"Or [consider such an example] as the one who passed by a township"  
refer-back pronoun: the implied singular masculine [fail]{.term} pronoun "he" in [مَرَّ]{.ar}

[قَدْ سَمِعَ ٱللَّـٰهُ قَوْلَ ٱلَّتِي تُجَادِلُكَ فِي زَوْجِهَا]{.ar}  
"Certainly has Allāh heard the speech of the one who argues [i.e., pleads] with you, [O Muḥammad]"  
refer-back pronoun: the implied singular feminine [fail]{.term} pronoun "she" in [تُجَادِلُكَ]{.ar}
...
[وَالَّذِينَ يَكْنِزُونَ ٱلذَّهَبَ وَٱلْفِضَّةَ]{.ar}
"And those who hoard gold and silver,"
the refer-back pronoun is the plural masculine absent-person [fail]{.term} pronoun [و]{.ar} "they" in [يَكْنِزُونَ]{.ar} "they hoard".
...
refer-back pronoun: the singular masculine [fail]{.term} pronoun for the speaker [تُ]{.ar} in [حَضَرْتُ]{.ar}  
or  
[أَنَا ٱلَّذِي حَضَرَ.]{.ar}  
refer-back pronoun: the implied singular masculine [fail]{.term} pronoun for the absent person "he" in [حَضَرَ]{.ar}  
...
(The refer-back pronoun is the speaker person's [mafulb]{.term} pronoun in [سَمَّتْنِ]{.ar}, which is an abbreviation of [سَمَّتْنِي]{.ar} "she named me".)
...
(The refer-back pronoun is the addressed person's [mafulb]{.term} pronoun [كَ]{.ar} in [خَلَقَكَ]{.ar}.)
...
Their refer-back pronouns can then, optionally:
 ...
 i. Either match the gender and number of the persons or things meant by the connected noun. For example:
    ...
    Note also how, in this example how, in addition to the feminine refer-back [fail]{.term} pronouns in [فَعَلَتْ]{.ar} and [خَسِرَتْ]{.ar},
    the feminine gender of the person signified by [مَنْ]{.ar} has also caused the [تْ]{.ar} of femininity to be added to the verb [خَابَ]{.ar} (of which [مَنْ]{.ar} is the [fail]{.term} noun).
...
<!--
[ٱُشْكُرْ مَنْ أَحْسَنَ إِلَيْكَ.]{.ar} (refer-back pronoun is the implied sing. masc. [fail]{.term} pronoun of the verb [أَحْسَنَ]{.ar}.)  
or  
[ٱُشْكُرْ مَنْ أَحْسَنُوا إِلَيْكَ.]{.ar} (refer-back pronoun is the implied pl. masc. [fail]{.term} pronoun of the verb [أَحْسَنُوا]{.ar}.)  
...
(The connected noun [مَا]{.ar} is the [mafulb]{.term} of the verb of command [اقْسِمْ]{.ar}.)
...
(b) When the refer-back pronoun is an attached pronoun for the [mafulb]{.term} it is permissible to delete it. For example:
...
(c) When the refer-back pronoun is in the i-state, it is permissible to delete it:
    ...
    (i) When the refer-back pronoun is the [mudafil]{.term} in an [idafa]{.term} whose [mudaf]{.term} is a [ismfail]{.term} or the [mafulb]{.term} implying a present or future meaning. For example:
...
and the refer-back pronoun is the a-state [mafulb]{.term} pronoun [ه]{.ar} "him".
...
Secondly,
[أيّ]{.ar}
can be, and, in fact, properly is, the [mudaf]{.term} in an [idafa]{.term}.
Whereas [مَا]{.ar} and [مَنْ]{.ar} cannot be [mudaf]{.term}s.
For example,
...
But a feminine version [أَيَّة]{.ar} does exist and can be used with feminine [mudafil]{.term}s.
It is, however, only commonly used if its [mudafil]{.term} is a feminine pronoun.
For example,
...
### The connected noun [أَيّ]{.ar} without a [mudafil]{.term}

[أيّ]{.ar}
can sometimes occur without a [mudafil]{.term}.
Technically, it will then be indefinite, and thus [nUn]{.trn2}ated.
However, it will carry the meaning of an implied [idafa]{.term}.
For example,
