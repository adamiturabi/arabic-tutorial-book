...
|[ٱَللَّذَانِ]{.ar} [EallapAnI]{.trn}|Dual masculine. For both intelligent and non-intelligent beings. Flexible: [ٱَللَّذَيْنِ]{.ar} [Eallapayni]{.trn} in the a-case and i-case. Two [ل]{.ar}'s in its spelling.|
|[ٱَللَّتَانِ]{.ar} [EallatAnI]{.trn}|Dual feminine. For both intelligent and non-intelligent beings. Flexible: [ٱَللَّتَيْنِ]{.ar} [Eallatayni]{.trn} in the a-case and i-case. Two [ل]{.ar}'s in its spelling.|
...
is a attribute (in the a-case) to the described noun
<!--
[ٱلرَّجُل]{.ar}.
[ٱَلَّذِي]{.ar} 
is in the a-case to match the described noun
-->
[ٱلرَّجُلَ]{.ar}.
Because 
[ٱَلَّذِي]{.ar} 
is a rigid noun, it will appear the same in all cases without any change to its ending.

As a attribute, the connected noun may also come as the last in a series of attributes, and can also be combined with a pointing noun. 
For example:

[رَأَيْتُ ذَ ٰلِكَ ٱلرَّجُلَ ٱلطَّوِيلَ ٱلَّذِي لَقِيتُهُ بِٱلْأَمْسِ.]{.ar}  
"I saw that [specific] tall man whom I met yesterday."

But connected nouns need not only occur as attributes.
<!--They may occur as a subject, an information, a doer, a direct doee, following a preposition, and as a annexed-to noun in an annexation.-->
...
As a annexed-to noun in an annexation:
...
[[[سنن الدارمي]{.ar} :36](https://hadithunlocked.com/darimi:36)]{.aside}  
...
"The best of your rulers are the ones whom you love and who love you"  
refer-back pronoun: the plural masculine direct doee attached pronoun [هُمْ]{.ar} in [تُحِبُّونَهُمْ]{.ar}

[قَدْ بَلَغَنَا ٱلَّذِي قُلْتُمُوهُ.]{.ar}  
"The [specific] one (thing) that you said has reached us."  
refer-back pronoun: the singular masculine direct doee attached pronoun [هُ]{.ar} in [قُلْتُمُوهُ]{.ar}
...
(The refer-back pronoun is the speaker person's direct doee pronoun in [سَمَّتْنِ]{.ar}, which is an abbreviation of [سَمَّتْنِي]{.ar} "she named me".)
...
(The refer-back pronoun is the addressed person's direct doee pronoun [كَ]{.ar} in [خَلَقَكَ]{.ar}.)
...
Their refer-back pronouns can then, optionally:
 ...
 i. Either match the gender and number of the persons or things meant by the connected noun. For example, for [مَنْ]{.ar}:
...
([ٱَلَّذِي]{.ar}, etc),
the general connected nouns do not occur as attributes.
So while we can say:
...
Some conditions are specific to the case of the refer-back pronoun. These are:

(a) When the refer-back pronoun is the subject of a nounal sentence, then it may be deleted, and its meaning will be implied.
    ...
    ^[See also [[صحيح مسلم]{.ar} :2963c](https://sunnah.com/muslim:2963c) and [[سنن ابن ماجه]{.ar} :4142](https://sunnah.com/ibnmajah:4142) for variants with the refer-back pronoun.]  
...
(c) When the refer-back pronoun is in the i-case, it is permissible to delete it:

    (i) When the refer-back pronoun is the annexed-to noun in an annexation whose annexed noun is a doer participle or the direct doee implying a present or future meaning. For example:
        ...
        (@) [قَالَ أَتَبْعَثُ إِلَيَّ مَا لَسْتَ آكِلًا]{.ar}
	          [[[مسند أحمد]{.ar} :21023](https://hadithunlocked.com/ahmad:21023)]{.citex}  
...
In addition to the above conditions that are specific to the case of the refer-back pronoun,
...
and the refer-back pronoun is the a-case direct doee pronoun [ه]{.ar} "him".
If we delete this pronoun, the sentence becomes

[جاء الذي ضربت في داره.]{.ar}  
"The one who I beat in his house, came.

Now the meaning of the sentence is markedly different. The connecting sentence [ضربت فِي دَارِهِ]{.ar} is valid on its own right but it gives a different meaning from the original.
...
[أَيّ]{.ar} [Eayy]{.trn} "which/whichever" is a general connected noun similar to [مَا]{.ar} "what" and [مَنْ]{.ar} "who".
But it differs from 
...
Secondly,
[أيّ]{.ar}
can be, and, in fact, properly is, the annexed noun in an annexation.
Whereas [مَا]{.ar} and [مَنْ]{.ar} cannot be annexed nouns.
For example,

[يُعْجِبُنِي أَيُّ ٱلتَّلَامِذَةِ يَجْتَهِدُ.]{.ar}  
"Whichever of the students strives, pleases me."  
([أيّ]{.ar} is in the u-case)
...
But a feminine version [أَيَّة]{.ar} does exist and can be used with feminine annexed-to nouns.
It is, however, only commonly used if its annexed-to noun is a feminine pronoun.
For example,
...
### The connected noun [أَيّ]{.ar} without a annexed-to noun

[أيّ]{.ar}
can sometimes occur without a annexed-to noun.
Technically, it will then be indefinite, and thus [tanwIn]{.trn2}ed.
...
And therefore they may not be a attribute to an indefinite noun.
So while we can say:
...
In this case a qualifying sentence may directly follow it without any intermediate connected noun used as a attribute.^[Wright 2/318C]
...
If a sentence has a definite noun which is to be qualified by a prepositional or adverbial phrase, then in many cases, that phrase may directly follow the definite noun without any intermediate connected noun used a attribute.
...
## Tense of the connecting sentence
...
[[[شرح الرضي على الكافية]{.ar} 1/268--269](https://ketabonline.com/ar/books/23090/read?page=256&part=1#p-23090-256-15)]{.citex}
