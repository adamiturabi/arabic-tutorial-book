...
As a [naat]{.subs}, the connected noun may also come as the last in a series of [naat]{.subs}s, and can also be combined with a pointing noun. 
For example:

[رَأَيْتُ ذَ ٰلِكَ ٱلرَّجُلَ ٱلطَّوِيلَ ٱلَّذِي لَقِيتُهُ بِٱلْأَمْسِ.]{.ar}  
"I saw that [specific] tall man whom I met yesterday."

But connected nouns need not only occur as [naat]{.subs}s.
...
refer-back pronoun: the plural masculine [fail]{.subs} pronoun [و]{.ar} in [يَكْنِزُونَ]{.ar}

[خِيَارُ أَئِمَّتِكُمُ الَّذِينَ تُحِبُّونَهُمْ]{.ar}  
"The best of your rulers are the ones whom you love and who love you"  
refer-back pronoun: the plural masculine [mafulb]{.subs} attached pronoun [هُمْ]{.ar} in [تُحِبُّونَهُمْ]{.ar}

[قَدْ بَلَغَنَا ٱلَّذِي قُلْتُمُوهُ.]{.ar}  
"The [specific] one (thing) that you said has reached us."  
refer-back pronoun: the singular masculine [mafulb]{.subs} attached pronoun [هُ]{.ar} in [قُلْتُمُوهُ]{.ar}

[رَبَّنَا أَرِنَا ٱللَّذَيْنِ أَضَلَّانَا مِنَ ٱلْجِنِّ وَٱلْإِنْسِ]{.ar}  
"Our Lord, show us those who misled us of the jinn and men"  
refer-back pronoun: the dual masculine [fail]{.subs} pronoun [ا]{.ar} in [أَضَلَّانَا]{.ar}

[أَوْ كَٱلَّذِي مَرَّ عَلَىٰ قَرْيَةٍ]{.ar}  
"Or [consider such an example] as the one who passed by a township"  
refer-back pronoun: the implied singular masculine [fail]{.subs} pronoun "he" in [مَرَّ]{.ar}

[قَدْ سَمِعَ ٱللَّـٰهُ قَوْلَ ٱلَّتِي تُجَادِلُكَ فِي زَوْجِهَا]{.ar}  
"Certainly has Allāh heard the speech of the one who argues [i.e., pleads] with you, [O Muḥammad]"  
refer-back pronoun: the implied singular feminine [fail]{.subs} pronoun "she" in [تُجَادِلُكَ]{.ar}
...
[وَالَّذِينَ يَكْنِزُونَ ٱلذَّهَبَ وَٱلْفِضَّةَ]{.ar}
"And those who hoard gold and silver,"
the refer-back pronoun is the plural masculine absent-person [fail]{.subs} pronoun [و]{.ar} "they" in [يَكْنِزُونَ]{.ar} "they hoard".
...
refer-back pronoun: the singular masculine [fail]{.subs} pronoun for the speaker [تُ]{.ar} in [حَضَرْتُ]{.ar}  
or  
[أَنَا ٱلَّذِي حَضَرَ.]{.ar}  
refer-back pronoun: the implied singular masculine [fail]{.subs} pronoun for the absent person "he" in [حَضَرَ]{.ar}  
...
"I am the one whom my mother named [_Haydarah]{.trn2}"  
(The refer-back pronoun is the speaker person's [mafulb]{.subs} pronoun in [سَمَّتْنِ]{.ar}, which is an abbreviation of [سَمَّتْنِي]{.ar} "she named me".)

[فَقَالَ مُوسَى يَا آدَمُ أَنْتَ الَّذِي خَلَقَكَ اللَّهُ بِيَدِهِ]{.ar}
[<https://sunnah.com/tirmidhi:2134>]{.aside}  
"[_mUsA]{.trn2} said: O [_Adam]{.trn2}, you are the one whom [_allAh]{.trn2} created with His Hand"  
(The refer-back pronoun is the addressed person's [mafulb]{.subs} pronoun [كَ]{.ar} in [خَلَقَكَ]{.ar}.)
...
But we will see, if [_allAh]{.trn2} wills, in chapter\ \@ref(questions), that [مَا]{.ar} and [مَنْ]{.ar} are also used as question nouns, in which case the rules of joining prepositions to them will differ.
...
<!--
[ٱُشْكُرْ مَنْ أَحْسَنَ إِلَيْكَ.]{.ar} (refer-back pronoun is the implied sing. masc. [fail]{.subs} pronoun of the verb [أَحْسَنَ]{.ar}.)  
or  
[ٱُشْكُرْ مَنْ أَحْسَنُوا إِلَيْكَ.]{.ar} (refer-back pronoun is the implied pl. masc. [fail]{.subs} pronoun of the verb [أَحْسَنُوا]{.ar}.)  
...
([ٱَلَّذِي]{.ar}, etc),
the general connected nouns do not occur as [naat]{.subs}s.
So while we can say:
...
"And the Muslims, who follow the Messenger of [_allAh]{.trn2}, are many"
...
O [_allAh]{.trn2}, apportion for us, from the fear of You, (that) what shall come between us and disobedience of You  
(The connected noun [مَا]{.ar} is the [mafulb]{.subs} of the verb of command [اقْسِمْ]{.ar}.)
...
(a) When the refer-back pronoun is the [mubtada]{.subs} of a [mubtada]{.subs}-[xabar]{.subs} sentence, then it may be deleted, and its meaning will be implied.
    ...
    ^[See also <https://sunnah.com/muslim:2963c> and <https://sunnah.com/ibnmajah:4142> for variants with the refer-back pronoun.]  
    ...
    If the connecting sentence is very short, the deleting the refer-back pronoun [mubtada]{.subs} is permissible, though rare. For example:
...
(b) When the refer-back pronoun is an attached pronoun for the [mafulb]{.subs} it is permissible to delete it. For example:
...
(c) When the refer-back pronoun is in the [istate]{.subs}, it is permissible to delete it:

    (i) When the refer-back pronoun is the [mudafil]{.subs} in an [idafa]{.subs} whose [mudaf]{.subs} is a [ismfail]{.subs} or the [mafulb]{.subs} implying a present or future meaning. For example:
    ...
    (ii) When the refer-back pronoun is attached to a preposition or adverb, and the same preposition or adverb has already been used (with the same meaning) with the connecting noun or its described noun. The preposition/adverb is deleted along with its attached pronoun. For example:
         ...
         "I passed by the (same) one that [_sulaymAn]{.trn2} did."  
...
and the refer-back pronoun is the [astate]{.subs} [mafulb]{.subs} pronoun [ه]{.ar} "him".
...
### The connected noun [أَيّ]{.ar} without a [mudafil]{.subs}
...
ii. The refer-back pronoun to [أَيّ]{.ar} is the [mubtada]{.subs} of the connecting sentence and it is deleted.
...
However, the connecting sentence may be separated from the connected noun by one of the following:
  ...
  i. An oath. For example:
     ...
     "The one who - by [_allAh]{.trn2} - overpowered the enemies has come."
...
Instead, we put the qualifying sentence directly after the indefinite noun. The qualifying sentence will then not be a connecting sentence, but will itself be the [naat]{.subs} to the described noun:
...
In this case a qualifying sentence may directly follow it without any intermediate connected noun used as a [naat]{.subs}.^[Wright vol.\ ii, §172, p.\ 318C]
...
If a sentence has a definite noun which is to be qualified by a prepositional or adverbial phrase, then in many cases, that phrase may directly follow the definite noun without any intermediate connected noun used a [naat]{.subs}.
