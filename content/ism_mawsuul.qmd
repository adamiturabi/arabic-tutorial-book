...
<!--They may occur as a subject, an information, a doer, a direct doee, following a preposition, and as a base noun in an annexation.-->
...
(c) When the refer-back pronoun is in the i-case, it is permissible to delete it:
    ...
    (i) When the refer-back pronoun is the base noun in an annexation whose annexe noun is a doer participle or the direct doee implying a present or future meaning. For example:
...
Secondly,
[أيّ]{.ar}
can be, and, in fact, properly is, the annexe noun in an annexation.
Whereas [مَا]{.ar} and [مَنْ]{.ar} cannot be annexe nouns.
For example,
...
But a feminine version [أَيَّة]{.ar} does exist and can be used with feminine base nouns.
It is, however, only commonly used if its base noun is a feminine pronoun.
For example,
