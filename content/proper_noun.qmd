...
+ Their [na3t]{.subs}s ([ٱلْكَرِيمِ]{.ar} and [ٱلطَّيِّبَةِ.]{.ar}, respectively) have [ٱَلْ]{.ar} to match the definiteness of the definite proper noun [manut]{.subs}s. Furthermore, they both end with [◌ِ]{.ar} because they match the [istate]{.subs} of their [manut]{.subs}s.
...
Sentence word order is usually pretty flexible. For stylistic reasons, it is permissible for a [mafulb]{.subs} to precede the [faa3il]{.subs}.
For example,
...
<!--
Interestingly, the fully-flexible name [#eamr]{.trn2} is written with a silent [و]{.ar} at its end: [عَمْرو]{.ar} when in the [ustate]{.subs} and [istate]{.subs} in order to distinguish it from the more common name [#eumar]{.trn2}. Otherwise, both names would appear identical when written without vowel marks, thus: [عمر]{.ar}.
...
Irregularly, the fully-flexible name [#eamr]{.trn2} is written with a unpronounced [و]{.ar} at its end: [عَمْرو]{.ar} when in the [ustate]{.subs} and [istate]{.subs}.
...
So far we have only dealt with proper nouns that are single words. There are some proper nouns that may be formed from two words that are in an [idaafah]{.subs}. These belong to different categories:
...
^2^[بَنُو إِسْرَائِيل]{.ar} [#banU #isrAEIl]{.trn2} "the children of [#isrAEIl]{.trn2}". In the [astate]{.subs} and [istate]{.subs}, this becomes
...
If the tribe name is the [faa3il]{.subs} of a verb then it is usually treated as singular feminine.
...
Some titles are formed from [idaafah]{.subs}s. Examples:
...
In Arabic, the titles for these objects usually don't occur as replacees as they do for persons. Rather, the title is annexed to the proper noun in an [idaafah]{.subs}. Examples:
...
"[#sulaymAn]{.trn2} the weak-sighted read the [quran]{.subs}."
