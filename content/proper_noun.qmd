...
+ A proper noun which does not begin with [ٱَلْ]{.ar}, and which is fully-flexible, shall be [tanwIn]{.trn2}ed, despite being definite.
...
+ [مُحَمَّدٍ]{.ar} is fully-flexible so it has a [tanwIn]{.trn2}ed [kasrah]{.trn2} [◌ٍ]{.ar} in the i-case.
+ [زَيْنَبَ]{.ar} is semi-flexible so it is not [tanwIn]{.trn2}ed, and instead has an [fatHah]{.trn2} [◌َ]{.ar} in the i-case.
+ The proper nouns [مُحَمَّد]{.ar} and [زَيْنَب]{.ar} are attributees in descriptive noun phrases.
+ Their attributes ([ٱلْكَرِيمِ]{.ar} and [ٱلطَّيِّبَةِ.]{.ar}, respectively) have [ٱَلْ]{.ar} to match the definiteness of the definite proper noun attributees. Furthermore, they both end with [◌ِ]{.ar} because they match the i-case of their attributees.
...
This is because [جَمِيلَة]{.ar} is semi-flexible as a proper noun and fully-flexible as an adjectival noun or common noun. If [جَمِيلَة]{.ar} were intended to be used with its adjectival noun or common noun meaning then it would have a [tanwIn]{.trn2}ed [Dammah]{.trn2} [◌ٌ]{.ar} and the sentence would be:
...
Sentence word order is usually pretty flexible. For stylistic reasons, it is permissible for a direct doee to precede the doer.
For example,
...
<!--
Interestingly, the fully-flexible name [#eamr]{.trn2} is written with a silent [و]{.ar} at its end: [عَمْرو]{.ar} when in the u-case and i-case in order to distinguish it from the more common name [#eumar]{.trn2}. Otherwise, both names would appear identical when written without vowel marks, thus: [عمر]{.ar}.

Name|u-case|a-case|i-case
:-|:--|:--|:--
...
Their origin as verbs will be apparent when we study [muDArie]{.trn2} verbs.
...
The only exception to this rule is a masculine name of foreign origin that comprises of only three letters, and whose middle letter has an [sukUn]{.trn2}. Such a name will be fully-flexible. Example:
...
The only exception to this rule is a feminine name of native Arabic origin, that comprises of only three letters, and whose middle letter has an [sukUn]{.trn2}. Such a name is permitted to be optionally fully-flexible or semi-flexible. Examples:
...
Irregularly, the fully-flexible name [#eamr]{.trn2} is written with a unpronounced [و]{.ar} at its end: [عَمْرو]{.ar} when in the u-case and i-case.
In the a-case, the [و]{.ar} is not added.
...
Or it could be the remnant of an older (pre-Islāmic) practice of appending a final [و]{.ar} to personal names.^[Al-Jallad, "One wāw to rule them all: The origins and fate of wawation in Arabic and its orthography"]
...
[شَيْـًٔا]{.ar} "something". Therefore, it is put in the same a-case.
...
As usual, the annexed-to noun shall always be in the i-case. And the case of the annexed noun [عَبْد]{.ar} is variable, depending on it's function in the sentence. Example:
...
(Note how [زَيْدٍ]{.ar} has a [tanwIn]{.trn2}ed [kasrah]{.trn2} [◌ٍ]{.ar} in the i-case because it is fully-flexible.)
...
(Note how [رُقَيَّةَ]{.ar} has an [fatHah]{.trn2} [◌َ]{.ar} in the i-case because it is semi-flexible.)
...
+ The name [زَيْد]{.ar} "Zayd" has lost its [tanwIn]{.trn2}.
...
In the above example, the name [زَيْدٌ]{.ar} is [tanwIn]{.trn2}ed and [ٱبْن]{.ar} is written with its connecting [hamzah]{.trn2} [ٱ]{.ar}. Therefore this is not an expression of the full name in a replacee-replacement format. Rather, [ٱبْنُ أَحْمَدَ]{.ar} here is the info of the sentence.
...
(Note that the second [بْنِ]{.ar} is in the i-case to match the case of the annexed noun [عَبْدِ]{.ar} in [عَبْدِ ٱللّـٰه]{.ar}.)
...
^2^[بَنُو إِسْرَائِيل]{.ar} [#banU #isrAEIl]{.trn2} "the children of [#isrAEIl]{.trn2}". In the a-case and i-case, this becomes
...
"[#sulaymAn]{.trn2} the weak-sighted read the Qurʾān."
...
(Note how the second [بْنِ]{.ar} is in the i-case because it is a replacement of [عُمَرَ]{.ar} which is in the i-case because it is a annexed-to noun of the first [بْنُ]{.ar}.)
