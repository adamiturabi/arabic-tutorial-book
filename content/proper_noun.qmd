...
As usual, the base noun shall always be in the i-case. And the case of the annexe noun [عَبْد]{.ar} is variable, depending on it's function in the sentence. Example:
...
(Note that the second [بْنِ]{.ar} is in the i-case to match the case of the annexe noun [عَبْدِ]{.ar} in [عَبْدِ ٱللّـٰه]{.ar}.)
...
(Note how the second [بْنِ]{.ar} is in the i-case because it is a replacement of [عُمَرَ]{.ar} which is in the i-case because it is a base noun of the first [بْنُ]{.ar}.)
