...
+ [مُحَمَّدٍ]{.ar} is fully-flexible so it has a [tanwIn]{.trn2}ed [kasrah]{.trn2} [◌ٍ]{.ar} in the i-state.
+ [زَيْنَبَ]{.ar} is semi-flexible so it is not [tanwIn]{.trn2}ed, and instead has an [fatHah]{.trn2} [◌َ]{.ar} in the i-state.
+ The proper nouns [مُحَمَّد]{.ar} and [زَيْنَب]{.ar} are attributees in descriptive noun phrases.
+ Their attributes ([ٱلْكَرِيمِ]{.ar} and [ٱلطَّيِّبَةِ.]{.ar}, respectively) have [ٱَلْ]{.ar} to match the definiteness of the definite proper noun attributees. Furthermore, they both end with [◌ِ]{.ar} because they match the i-state of their attributees.
...
<!--
Interestingly, the fully-flexible name [#eamr]{.trn2} is written with a silent [و]{.ar} at its end: [عَمْرو]{.ar} when in the u-state and i-state in order to distinguish it from the more common name [#eumar]{.trn2}. Otherwise, both names would appear identical when written without vowel marks, thus: [عمر]{.ar}.
...
Their origin as verbs will be apparent when we study stateful verbs.
...
Irregularly, the fully-flexible name [#eamr]{.trn2} is written with a unpronounced [و]{.ar} at its end: [عَمْرو]{.ar} when in the u-state and i-state.
...
(Note how [زَيْدٍ]{.ar} has a [tanwIn]{.trn2}ed [kasrah]{.trn2} [◌ٍ]{.ar} in the i-state because it is fully-flexible.)
...
(Note how [رُقَيَّةَ]{.ar} has an [fatHah]{.trn2} [◌َ]{.ar} in the i-state because it is semi-flexible.)
...
^2^[بَنُو إِسْرَائِيل]{.ar} [#banU #isrAEIl]{.trn2} "the children of [#isrAEIl]{.trn2}". In the a-state and i-state, this becomes
