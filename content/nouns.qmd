...
1. u-state: indicated by a [umark]{.subs} [◌ُ]{.ar} (for definite nouns) and a [tanwin]{.subs}ed [umark]{.subs} [◌ٌ]{.ar} (for indefinite nouns) on the final letter of the word.
2. a-state: indicated by an [amark]{.subs} [◌َ]{.ar} (for definite nouns) and a [tanwin]{.subs}ed [amark]{.subs} [◌ً]{.ar} (for indefinite nouns) on the final letter of the word.
3. i-state: indicated by an [imark]{.subs} [◌ِ]{.ar} (for definite nouns) and a [tanwin]{.subs}ed [imark]{.subs} [◌ٍ]{.ar} (for indefinite nouns) on the final letter of the word.
-->
...
The choice of which state a noun is in depends on its function in a sentence. For example, if the noun is a [mubtada]{.subs} of a sentence, it will usually be in the u-state. And if it is used adverbially, it will often be in the a-state. And if it occurs after a preposition, it will be in the i-state. We will learn more about putting nouns in their different states throughout this book. 
