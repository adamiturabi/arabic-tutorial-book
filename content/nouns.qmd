...
If the definite article [ٱَلْ]{.ar} [Eal]{.trn} is with prefixed to nouns that have an initial connecting [hamzah]{.trn2}, then the [ل]{.ar} shall no longer have an 0-mark [◌ْ]{.ar}. Instead it shall have an [i]{.trn}-mark [◌ِ]{.ar}. Example:
...
Note that the vowel-mark before the [ة]{.ar} is always an [a]{.trn}-mark. 
