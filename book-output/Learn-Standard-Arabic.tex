...
\fancyfoot[RE, RO]{\phantom{xxx}\\\phantom{xxx}\\\phantom{xxx}\\\phantom{xxx}\\\textcolor{gray}{\scriptsize{Author Names, \textit{Learn Standard Arabic}, \texttt{\gitTag}\\\texttt{www.book-url.com}}}}
...
\bottomrule\noalign{}
\endlastfoot
1 & \foreignlanguage{arabic}{ا} & \emph{ā} & \foreignlanguage{arabic}{أَلِف} \emph{ʾalif} & A vowel like in English \enquote{man}. But after these letters (\foreignlanguage{arabic}{خ،ر،ص،ض،غ،ق}) it sounds like \enquote{awe} in English \enquote{awesome}. \\
...
When we discuss nouns in isolation we shall pronounce the looped \foreignlanguage{arabic}{ة} as a \emph{h}. Therefore,
...
\subsection{Indefinite nouns}\label{indefinite-nouns}

In English, nouns that start with the word \enquote{a} are called indefinite nouns. For example: \enquote{a book}. The word \enquote{a} is called the \emph{indefinite article}.

There are three options to express the indefinite \enquote{a book} in Arabic:

\begin{itemize}
\tightlist
\item
  \foreignlanguage{arabic}{کِتَابٌ} \emph{kitābun}
\item
  \foreignlanguage{arabic}{کِتَابًا} \emph{kitāban}
\item
  \foreignlanguage{arabic}{کِتَابٍ} \emph{kitābin}
\end{itemize}

In order to make a noun indefinite in Arabic, i.e., to say \enquote{\emph{a} book}, we need put an \emph{n}-mark to the final letter of the word. There are three \emph{n}-marks: the \emph{un}-mark \foreignlanguage{arabic}{◌ٌ}, the \emph{an}-mark \foreignlanguage{arabic}{◌ً}, and the \emph{in}-mark \foreignlanguage{arabic}{◌ٍ}. Putting any of these on the final letter of word gives it the meaning \enquote{a book}.

\subsection{Definite nouns}\label{definite-nouns}

In English, nouns that start with \enquote{the} are called definite nouns. For example: \enquote{the book}.

There are three options to express the definite \enquote{the book} in Arabic:

\begin{itemize}
\tightlist
\item
  \foreignlanguage{arabic}{ٱَلْکِتَابُ} \emph{ʾalkitābu}
\item
  \foreignlanguage{arabic}{ٱَلْکِتَابَ} \emph{ʾalkitāba}
\item
  \foreignlanguage{arabic}{ٱَلْکِتَابِ} \emph{ʾalkitābi}
\end{itemize}

In order to make a noun definite in Arabic, i.e., to say \enquote{\emph{the} book}, we take away the \emph{n}-mark from the final letter of the indefinite noun, but leave the short vowel marks \foreignlanguage{arabic}{◌ُ}, \foreignlanguage{arabic}{◌َ}, and \foreignlanguage{arabic}{◌ِ}. Also, we add \foreignlanguage{arabic}{ٱَلْ} \emph{ʾal} \enquote{the} to the beginning of the word.
The prefix \foreignlanguage{arabic}{ٱَلْ} \emph{al} is called the \emph{definite article}.
It begins with a connecting \emph{hamzah} so the \emph{hamzah} will be pronounced only in the beginning of a sentence. And when it occurs in the beginning of a sentence, the \emph{hamzah} is pronounced with a \foreignlanguage{arabic}{◌َ} a-mark.

\subsection{Discussing indefinite and definite nouns in isolation}\label{discussing-indefinite-and-definite-nouns-in-isolation}

In Arabic, nouns can only be either definite or indefinite. For example, in an Arabic sentence, you have to say either \enquote{a book} or \enquote{the book}. You can't say \enquote{book} without \enquote{a} or \enquote{the}. We will discuss this in more detail in section~\ref{usage-of-definite-and-indefinite-nouns} below.

So, for convenience, when talking about the indefinite noun in isolation, and not in a sentence, we will often write it without the final \emph{n}-mark thus: \foreignlanguage{arabic}{کِتَاب} \emph{kitāb} \enquote{a book}. And it will be understood, that when in a sentence, the noun shall have a final \emph{n}-mark.

Similarly, for convenience, when discussing the definite noun in isolation, and not in a sentence, we may write it without the final short vowel thus: \foreignlanguage{arabic}{ٱَلْکِتَاب} \emph{ʾalkitāb} \enquote{the book}.
And it will be understood, that when in a sentence, the noun shall have a final short vowel mark.

\subsection{Sun letters and moon letters}\label{sun-letters-and-moon-letters}

The noun \enquote{man} in Arabic is \foreignlanguage{arabic}{رَجُل} \emph{rajul}. To make this noun definite, we add \foreignlanguage{arabic}{ٱَلْ} \emph{al} to the beginning of the word. But instead of becoming \foreignlanguage{arabic}{ٱَلْرَجُل} \emph{alrajul} the word becomes \foreignlanguage{arabic}{ٱَلرَّجُل} \emph{arrajul}. The \foreignlanguage{arabic}{ل} in \foreignlanguage{arabic}{ٱَلْ} becomes silent and the \foreignlanguage{arabic}{ر} gets doubled. This happens because the first letter \foreignlanguage{arabic}{ر} in the word \foreignlanguage{arabic}{رَجُل} \emph{rajul} is from a group of letters called \enquote{sun letters}. For all nouns beginning with sun letters, when \foreignlanguage{arabic}{ٱَلْ} \emph{al} is put in the beginning, the \foreignlanguage{arabic}{ل} in \foreignlanguage{arabic}{ٱَلْ} becomes silent and the sun letter becomes doubled.

The rest of the letters in the alphabet are called \enquote{moon letters} and for words that begin with moon letters, the \foreignlanguage{arabic}{ل} in \foreignlanguage{arabic}{ٱَلْ} does not become silent and the moon letter does not become doubled. For example, \foreignlanguage{arabic}{ک} is a moon letter and we have already seen that \foreignlanguage{arabic}{کِتَاب} \emph{kitāb} \enquote{book} becomes \foreignlanguage{arabic}{ٱَلْکِتَاب} \emph{alkitāb} \enquote{the book}.
...
The names \enquote{sun letters} and \enquote{moon letters} were given because of the Arabic words for \enquote{sun} and \enquote{moon} respectively. \enquote{The sun} in Arabic is \foreignlanguage{arabic}{ٱَلشَّمْس} \emph{as͟hs͟hams} which begins with \foreignlanguage{arabic}{ش} which causes the \foreignlanguage{arabic}{ل} in \foreignlanguage{arabic}{ٱَلْ} to be silent. \enquote{The moon} is \foreignlanguage{arabic}{ٱَلْقَمَر} \emph{alqamar} which begins with \foreignlanguage{arabic}{ق} which does not cause the \foreignlanguage{arabic}{ل} in \foreignlanguage{arabic}{ٱَلْ} to be silent. Thus \foreignlanguage{arabic}{ش} represents the sun letters and \foreignlanguage{arabic}{ق} represents the moon letters.
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{رَجُل} \emph{rajul} \enquote{man} & \foreignlanguage{arabic}{ٱَلرَّجُل} \emph{arrajul} \enquote{the man} \\
\foreignlanguage{arabic}{تَاجِر} \emph{tājir} \enquote{trader} & \foreignlanguage{arabic}{ٱَلتَّاجِر} \emph{attājir} \enquote{the trader} \\
\foreignlanguage{arabic}{لُعْبَة} \emph{luɛbah} \enquote{toy} & \foreignlanguage{arabic}{ٱَللُّعْبَة} \emph{alluɛbah} \enquote{the toy} \\
\end{longtable}

\subsection{\texorpdfstring{The definite article \foreignlanguage{arabic}{ٱَلْ} \emph{al} with nouns with an initial connecting \emph{hamzah}}{The definite article ٱَلْ al with nouns with an initial connecting hamzah}}\label{the-definite-article-with-nouns-with-an-initial-connecting-hamzah}

If the definite article \foreignlanguage{arabic}{ٱَلْ} \emph{al} is with prefixed to nouns that have an initial connecting \emph{hamzah}, then the \foreignlanguage{arabic}{ل} shall no longer have an \(\emptyset\)-mark \foreignlanguage{arabic}{◌ْ}. Instead it shall have an \emph{i}-mark \foreignlanguage{arabic}{◌ِ}. Example:
...
\tightlist
\item
  u-state: demarked by a \emph{u}-mark \foreignlanguage{arabic}{◌ُ} or a \emph{un}-mark \foreignlanguage{arabic}{◌ٌ} at the end of the word.
\item
  a-state: demarked by a \emph{a}-mark \foreignlanguage{arabic}{◌َ} or a \emph{an}-mark \foreignlanguage{arabic}{◌ً} at the end of the word.
\item
  i-state: demarked by a \emph{i}-mark \foreignlanguage{arabic}{◌ِ} or a \emph{in}-mark \foreignlanguage{arabic}{◌ٍ} at the end of the word.
\end{enumerate}

Here are the words \enquote{a book} and \enquote{the book} in their three states:
...
\bottomrule\noalign{}
\endlastfoot
u-state & \foreignlanguage{arabic}{کِتَابٌ} \emph{kitābun} & \foreignlanguage{arabic}{ٱَلْکِتَابُ} \emph{alkitābu} \\
a-state & \foreignlanguage{arabic}{کِتَابًا} \emph{kitāban} & \foreignlanguage{arabic}{ٱَلْکِتَابَ} \emph{alkitāba} \\
i-state & \foreignlanguage{arabic}{کِتَابٍ} \emph{kitābin} & \foreignlanguage{arabic}{ٱَلْکِتَابِ} \emph{alkitābi} \\
\end{longtable}
...
\section{Flexibility of nouns}\label{flexibility-of-nouns}

Most nouns behave as described above: their endings change with their state. These nouns are called \emph{flexible} nouns. In later chapters, we will learn about some nouns whose endings only partially change, or don't change at all, with their state. They will be called \emph{semi-flexible} nouns and \emph{rigid} nouns respectively.

\section{Usage of definite and indefinite nouns}\label{usage-of-definite-and-indefinite-nouns}

Consider the noun \enquote{time}. In English we can make this noun definite using the definite article \enquote{the}, for example, \enquote{The time to act is now.} When translating this sentence to Arabic, we will correspondingly use the definite noun: \foreignlanguage{arabic}{ٱَلْوَقْت} \emph{ʾalwaqt} \enquote{the time}.

In English, we can make \enquote{time} indefinite using indefinite articles like \enquote{a} or \enquote{some}. For example, \enquote{There is a time for work and a time for play.} and \enquote{We have some time before we need to leave.} When translating these sentences to Arabic we will correspondingly use the indefinite noun in both these sentences: \foreignlanguage{arabic}{وَقْت} \emph{waqt} \enquote{a time}.

Consider now a third scenario: in English we can also use the word \enquote{time} with a general meaning without a definite or indefinite article. For example, \enquote{Time is money.} However, in Arabic, a noun must be either definite or indefinite. So we must choose between \foreignlanguage{arabic}{ٱَلْوَقْت} \emph{ʾalwaqt} \enquote{the time} and \foreignlanguage{arabic}{وَقْت} \emph{waqt} \enquote{a time}. In Arabic, \foreignlanguage{arabic}{وَقْت} \emph{waqt}, being indefinite, can only mean \enquote{a time} or \enquote{some time}. So \foreignlanguage{arabic}{ٱَلْوَقْت} \emph{ʾalwaqt} is then used when we wish to say \enquote{time} with a general meaning. This means that, in Arabic the definite noun is used in two ways:

\begin{enumerate}
\def\labelenumi{\roman{enumi}.}
\tightlist
\item
  When the definite meaning is desired. For example, \enquote{We met at the time we had agreed upon.} (Use \foreignlanguage{arabic}{ٱَلْوَقْت} \emph{ʾalwaqt} \enquote{the time}.)
\item
  When a general meaning is desired. For example, \enquote{There is nothing more valuable than time.} (Again, use \foreignlanguage{arabic}{ٱَلْوَقْت} \emph{ʾalwaqt} \enquote{the time}.)
\end{enumerate}

Conversely, the indefinite nouns is used only when an indefinite meaning is desired. For example, \enquote{We agreed to meet at a certain time.}(Use \foreignlanguage{arabic}{وَقْت} \emph{waqt} \enquote{a time}.)

In a similar manner, the nouns \enquote{home} or \enquote{school} are often used in English without either \enquote{the} or \enquote{a}. For example, \enquote{He goes to school.} and \enquote{She went home.}. In these cases, we will us the definite article \foreignlanguage{arabic}{ٱَلْ} in Arabic. So we will say \foreignlanguage{arabic}{ٱَلْبَيْت} \emph{ʾalbayt} \enquote{the home} for English \enquote{home} and \foreignlanguage{arabic}{ٱَلْمَدْرَسَة} \emph{ʾalmadrasah} \enquote{the school} for English \enquote{school}.

But there is an additional complication: note that English often does not use an indefinte article, even when an indefinite meaning is intended. For example, \enquote{We don't need to leave right now; we have time.} meaning \enquote{we have {[}\emph{some}{]} time.} Because of the indefinite meaning intended we will use \foreignlanguage{arabic}{وَقْت} \emph{waqt} \enquote{a time} here.

This English usage of an indefinite meaning without an indefnite article is especially true with plurals. For example, \enquote{There are books in the bag.} Here the intended meaning is \enquote{There are {[}some{]} books in the bag.} Consequently, in Arabic, we will use the indefinite noun here: \foreignlanguage{arabic}{کُتُب} \emph{kutub} \enquote{{[}some{]} books} not \foreignlanguage{arabic}{ٱَلْکُتُب} \emph{ʾalkutub} \enquote{the books}.

However, there are times when English uses a plural without a definite or indefinite article, and a general meaning is intended. For example, \enquote{Books contain knowledge.} In this case, in Arabic we will use the definite noun \foreignlanguage{arabic}{ٱَلْکُتُب} \emph{ʾalkutub} \enquote{the books}.
...
Some nouns designate animate beings like \enquote{a man}, \enquote{a woman}, \enquote{a boy}, \enquote{a girl}, \enquote{a dog}, \enquote{a cow}, etc.
Other nouns designate inanimate objects like \enquote{a book}, \enquote{a house}, \enquote{a hand}, \enquote{a tree}, \enquote{a city}, \enquote{a food}.
...
As for nouns that designate inanimate objects and animals, these, too, are assigned either a masculine or a feminine gender. For example, \foreignlanguage{arabic}{کِتَاب} \emph{kitāb} \enquote{a book} in Arabic is masculine. And \foreignlanguage{arabic}{شَجَرَة} \emph{s͟hajarah} \enquote{tree} in Arabic is feminine.
...
\tightlist
\item
  The nouns for male and female animate beings are separate but related.
\item
  The nouns for male and female animate beings are separate and unrelated.
\item
...
\subsubsection{Related nouns for male and female animate beings}\label{related-nouns-for-male-and-female-animate-beings}
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{ٱِبْن} \emph{ʾibn} & masc. & a son \\
\foreignlanguage{arabic}{ٱِبْنَة} \emph{ʾibnah} & fem. & a daughter \\
\foreignlanguage{arabic}{طِفْل} \emph{ṭifl} & masc. & a child \\
\foreignlanguage{arabic}{طِفْلَة} \emph{ṭiflah} & fem. & a (female) child \\
\foreignlanguage{arabic}{إِنْسَان} \emph{ʾinsān} & masc. & a human being \\
\foreignlanguage{arabic}{إِنْسَانَة} \emph{ʾinsānah} & fem. & a (female) human being \\
\foreignlanguage{arabic}{حُرّ} \emph{ḥurr} & masc. & a free man \\
\foreignlanguage{arabic}{حُرَّة} \emph{ḥurrah} & fem. & a free woman \\
\foreignlanguage{arabic}{کَلْب} \emph{kalb} & masc. & a (male) dog \\
\foreignlanguage{arabic}{کَلْبَة} \emph{kalbah} & fem. & a (female) dog \\
\foreignlanguage{arabic}{هِرّ} \emph{hirr} & masc. & a (male) cat \\
\foreignlanguage{arabic}{هِرَّة} \emph{hirrah} & fem. & a (female) cat \\
-- & -- & -- \\
\foreignlanguage{arabic}{مُعَلِّم} \emph{muɛallim} & masc. & a (male) teacher \\
\foreignlanguage{arabic}{مُعَلِّمَة} \emph{muɛallimah} & fem. & a (female) teacher \\
\foreignlanguage{arabic}{طَالِب} \emph{ṭālib} & masc. & a (male) student \\
\foreignlanguage{arabic}{طَالِبَة} \emph{ṭālibah} & fem. & a (female) student \\
\foreignlanguage{arabic}{صَاحِب} \emph{ṣāḥib} & masc. & a (male) companion \\
\foreignlanguage{arabic}{صَاحِبَة} \emph{ṣāḥibah} & fem. & a (female) companion \\
\foreignlanguage{arabic}{صَدِيق} \emph{ṣadīq} & masc. & a (male) friend \\
\foreignlanguage{arabic}{صَدِيقَة} \emph{ṣadīqah} & fem. & a (female) friend \\
\end{longtable}
...
As a matter of fact, the looped \emph{tāʾ} \foreignlanguage{arabic}{ة} is called a feminine marker for singular nouns. There are a couple of other feminine markers besides looped \emph{tāʾ} but they are not as common and we will learn them later, if Allāh wills.

Note that the vowel-mark before the looped \emph{tāʾ} \foreignlanguage{arabic}{ة} is always an \emph{a}-mark.

Note that we have divided the table above into two groups. The first group contains nouns that refer to refer to entities, without an primary adjectival or verbal quality in the meaning, for example \enquote{human} \enquote{cat}, etc.
The second group contains nouns that have an adjectival or verbal quality. For example, \enquote{a teacher} is someone who teaches. \enquote{A friend} is someone who is friendly. And so on.

This grouping will become important when, if Allāh wills, you study morphology, and the classification of nouns into primitive and derived nouns. But we can give a short preview here: Basically, for the second group (the one that has adjectival or verbal meanings), the formation of the feminine noun by adding a feminine marker (like \foreignlanguage{arabic}{ة}) to the masculine noun is normal and expected. Whereas, for the first group (the one that refers to entities without a verbal or adjectival meaning), the fact that the feminine and masuline nouns are similar and differ only by the feminine marker \foreignlanguage{arabic}{ة} is something that, although fairly common, is more of a coincidence.
...
And \foreignlanguage{arabic}{کَلْبَة} \emph{kalbah} (fem.) \enquote{a female dog} is typically only used when the gender of the animal is relevant to the sentence.
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{أَب} \emph{ʾab} & masc. & a father \\
\foreignlanguage{arabic}{أُمّ} \emph{ʾumm} & fem. & a mother \\
\foreignlanguage{arabic}{غُلَام} \emph{g͟hulām} & masc. & a boy \\
\foreignlanguage{arabic}{جَارِيَة} \emph{jāriyah} & fem. & a girl \\
\foreignlanguage{arabic}{عَبْد} \emph{ɛabd} & masc. & a male slave \\
\foreignlanguage{arabic}{أَمَة} \emph{ʾamah} & fem. & a female slave \\
\foreignlanguage{arabic}{أَسَد} \emph{ʾasad} & masc. & a lion \\
\foreignlanguage{arabic}{لَبْوَة} \emph{labwah} & fem. & a lioness \\
\foreignlanguage{arabic}{ثَوْر} \emph{t͟hawr} & masc. & a bull \\
\foreignlanguage{arabic}{بَقَرَة} \emph{baqarah} & fem. & a cow \\
\end{longtable}

Even in these nouns you can see that the feminine noun usually ends with a looped \emph{tāʾ} \foreignlanguage{arabic}{ة} feminine marker. There are only a few commonly used feminine nouns that don't end with a feminine marker like looped \emph{tāʾ}. \foreignlanguage{arabic}{أُمٌّ} \emph{ʾummun} \enquote{a mother} is one of these exceptions.
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{شَخْص} \emph{s͟hak͟hṣ} & masc. & a person \\
\foreignlanguage{arabic}{نَفْس} \emph{nafs} & fem. & a self \\
\foreignlanguage{arabic}{عَدُوّ} \emph{ɛaduww} & masc. & an enemy \\
\foreignlanguage{arabic}{حَيَوَان} \emph{ḥayawān} & masc. & an animal \\
\foreignlanguage{arabic}{طَائِر} \emph{ṭāʾir} & masc. & a bird \\
\foreignlanguage{arabic}{قِرْد} \emph{qird} & masc. & a monkey \\
\foreignlanguage{arabic}{حَمَامَة} \emph{ḥamāmat} & fem. & a dove \\
\foreignlanguage{arabic}{نَمْلَة} \emph{namlah} & fem. & an ant \\
\end{longtable}

So for example \foreignlanguage{arabic}{قِرْد} \emph{qirdun} \enquote{a monkey} is grammatically masculine but it will be used for both a male and a female monkey.
Similarly, \foreignlanguage{arabic}{شَخْص} \emph{s͟hak͟hṣ} is a masculine noun meaning \enquote{a person}. While remaining grammatically masculine, it can be used to refer to persons of male or female persons.

Note also that \foreignlanguage{arabic}{نَفْس} \emph{nafsun} \enquote{a self} is a feminine noun but it does not end in a looped \emph{tāʾ} \foreignlanguage{arabic}{ة}. It is one of the small number of feminine nouns that don't have a female marker, like \foreignlanguage{arabic}{أُمٌّ} \emph{ʾummun} (fem.) \enquote{a mother}.
Notably, \foreignlanguage{arabic}{نَفْس} \emph{nafs} is treated as feminine when it refers to the soul of a person. However, in constructions like \enquote{yourself}, \enquote{himself}, etc. it will conform to the gender of the person it is referring to. We shall see this in later chapters, if Allāh wills.
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{کِتَاب} \emph{kitāb} & masc. & a book \\
\foreignlanguage{arabic}{بَيْت} \emph{bayt} & masc. & a house \\
\foreignlanguage{arabic}{قَلَم} \emph{qalam} & masc. & a pen \\
\foreignlanguage{arabic}{طَعَام} \emph{ṭaɛām} & masc. & a food \\
\foreignlanguage{arabic}{مَاء} \emph{māʾ} & masc. & a water \\
\foreignlanguage{arabic}{مَدْرَسَة} \emph{madrasah} & fem. & a school \\
\foreignlanguage{arabic}{مَدِينَة} \emph{madīnah} & fem. & a city \\
\foreignlanguage{arabic}{غُرْفَة} \emph{g͟hurfah} & fem. & a room \\
\foreignlanguage{arabic}{شَجَرَة} \emph{s͟hajarah} & fem. & a tree \\
\foreignlanguage{arabic}{شَمْس} \emph{s͟hams} & fem. & a sun \\
\foreignlanguage{arabic}{قَمَر} \emph{qamar} & masc. & a moon \\
\foreignlanguage{arabic}{عِلْم} \emph{ɛilm} & masc. & a knowledge \\
\foreignlanguage{arabic}{قُوَّة} \emph{quwwah} & fem. & a strength \\
\foreignlanguage{arabic}{حَيَاة} \emph{ḥayāh} & fem. & a life \\
\foreignlanguage{arabic}{مَوْت} \emph{mawt} & masc. & a death \\
\end{longtable}
...
\foreignlanguage{arabic}{شَمْسٌ} \emph{s͟hamsun} \enquote{a sun} which is feminine but does not end with a feminine marker.
...
\bottomrule\noalign{}
\endlastfoot
\foreignlanguage{arabic}{رَهِينَة} \emph{rahīnah} & fem. & a pledge \\
\foreignlanguage{arabic}{عُضْو} \emph{ɛuḍw} & masc. & a member \\
\end{longtable}

\foreignlanguage{arabic}{رَهِينَة} \emph{rahīnah} is a feminine noun meaning \enquote{a pledge}. For inanimate objects it refers to something that is held as a security or a collateral. With its animate meaning is used to refer to a human hostage.

Similarly,
\foreignlanguage{arabic}{عُضْو} \emph{ɛuḍw} is a masculine noun meaning \enquote{a member}. For inanimate objects it refers to a limb which is the member of a body. With its animate meaning it refers to a person who is a member of a professional organization.
...
\section{Nouns with mismatched gender}\label{nouns-with-mismatched-gender}

We saw that there are some nouns that are feminine, but do not end with with a feminine marker like \emph{ة}. These were:

\begin{itemize}
\tightlist
\item
  \foreignlanguage{arabic}{أُمّ} \emph{ʾumm} (fem.) \enquote{a mother}
\item
  \foreignlanguage{arabic}{نَفْس} \emph{nafs} (fem.) \enquote{a self}
\item
  \foreignlanguage{arabic}{شَمْس} \emph{s͟hams} (fem.) \enquote{a sun}
\end{itemize}
...
\tightlist
\item
  \foreignlanguage{arabic}{يَد} \emph{yad} (fem.) \enquote{a hand} (sometimes \enquote{an arm})
\item
  \foreignlanguage{arabic}{عَيْن} \emph{ɛayn} (fem.) \enquote{an eye}
\item
  \foreignlanguage{arabic}{أُذُن} \emph{ʾuẕun} (fem.) \enquote{an ear}
\item
  \foreignlanguage{arabic}{قَدَم} \emph{qadam} (fem.) \enquote{a foot}
\item
  \foreignlanguage{arabic}{رِجْل} \emph{rijl} (fem.) \enquote{a leg} (sometimes \enquote{a foot})
\item
  \foreignlanguage{arabic}{إِبْهَام} \emph{ʾibhām} (fem.) \enquote{a thumb}
\item
  \foreignlanguage{arabic}{إِصْبَع} \emph{ʾiṣbaɛ} (fem.) \enquote{a finger, a toe}
\item
  \foreignlanguage{arabic}{سِنّ} \emph{sinn} (fem.) \enquote{a tooth}
\item
  \foreignlanguage{arabic}{رُکْبَة} \emph{rukbah} (fem.) \enquote{a knee}
\end{itemize}
...
\tightlist
\item
  \foreignlanguage{arabic}{رَأْس} \emph{raʾs} (masc.) \enquote{a head}
\item
  \foreignlanguage{arabic}{أَنْف} \emph{ʾanf} (masc.) \enquote{a nose}
\item
  \foreignlanguage{arabic}{بَطْن} \emph{baṭn} (masc.) \enquote{a belly}
\item
  \foreignlanguage{arabic}{لِحْيَة} \emph{liḥyah} (fem.) \enquote{a beard}
\end{itemize}
...
\tightlist
\item
  \foreignlanguage{arabic}{مَنْخَر} \emph{mank͟har} (masc.) \enquote{a nostril}
\item
  \foreignlanguage{arabic}{مِرْفَق} \emph{mirfaq} (masc.) \enquote{an elbow}
\end{itemize}

There are other such exceptions as well.

Conversely, nouns that end with a feminine marker like \foreignlanguage{arabic}{ة}, yet are masculine are very rare. The most common of them are:

\begin{itemize}
\tightlist
\item
  \foreignlanguage{arabic}{خَلِيفَة} \emph{k͟halīfah} (masc.) \enquote{a caliph}
\item
  \foreignlanguage{arabic}{عَلَّامَة} \emph{ɛallāmah} (masc.) \enquote{a great scholar}
\item
  \foreignlanguage{arabic}{دَاعِيَة} \emph{dāɛiyah} (masc.) \enquote{a great preacher}
\end{itemize}
...
\tightlist
\item
  \foreignlanguage{arabic}{سُوق} \emph{sūq} (masc. or fem.) \enquote{a market}
\item
  \foreignlanguage{arabic}{طَرِيق} \emph{ṭarīq} (masc. or fem.) \enquote{a path}
\end{itemize}
...
\includegraphics{Learn-Standard-Arabic_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\tightlist
\item
  The \emph{speaker-participant}. This is the participant who is speaking. When the participant who is speaking refers to himself or herself (or themselves if plural) in English, then he/she/they use the pronouns \enquote{I}, \enquote{me}, \enquote{we}, and \enquote{us}.
\item
  The \emph{addressee-participant}. This is the participant whom the speaker-participant is directly speaking to. When the speaker-participant refers to the participant he is speaking to in English, he uses the \enquote{you} pronoun.
\item
  The \emph{absentee-participant}. This is the participant who is not being directly spoken to. Their only participation in the speech is that they are being referred to. When the speaker-participant refers to this participant in English, he uses the pronouns \enquote{he}, \enquote{him}, \enquote{she}, \enquote{her}, \enquote{it}, \enquote{they}, and \enquote{them}.
\end{enumerate}
...
\chapter{Form 1 completed-action verbs}\label{form-1-completed-action-verbs}
...
\item
  ...
  \bottomrule\noalign{}
  \endlastfoot
  \foreignlanguage{arabic}{صَاحِبَة: صَوَاحِب\textsuperscript{2}} & a companion\textsubscript{f} & \foreignlanguage{arabic}{عَامِل: عَوَامِل\textsuperscript{2}} & a factor \\
  \foreignlanguage{arabic}{جَارِيَة: جَوَارٍ\textsuperscript{2}} & a girl & \foreignlanguage{arabic}{شَاهِد: شَوَاهِد\textsuperscript{2}} & a corroborating evidence \\
  \foreignlanguage{arabic}{أَمْر: أَوَامِر\textsuperscript{2}} & a command & \foreignlanguage{arabic}{خَاتَم: خَوَاتِم\textsuperscript{2}} & a ring (jewelry) \\
  \foreignlanguage{arabic}{نَادِرَة: نَوَادِر\textsuperscript{2}} & a joke, a witticism & \foreignlanguage{arabic}{فَارِس: فَوَارِس\textsuperscript{2}} & a horseman \\
  \end{longtable}
\item
  \textbf{\foreignlanguage{arabic}{فَعَائِل\textsuperscript{2}} \emph{faɛāʾil\textsuperscript{2}}}. (Semi-flexible because of \foreignlanguage{arabic}{فَفَافِف\textsuperscript{2}} pattern.) Examples:
...
\item
  ...
  \bottomrule\noalign{}
  \endlastfoot
  \foreignlanguage{arabic}{سُلْطَان: سَلَاطِين\textsuperscript{2}} & a sultan & \foreignlanguage{arabic}{إِعْصَار: أَعَاصِير\textsuperscript{2}} & a whirlwind \\
  \foreignlanguage{arabic}{شَيْطَان: شَيَاطِين\textsuperscript{2}} & a devil & \foreignlanguage{arabic}{تَأْرِيخ: تَوَارِيخ\textsuperscript{2}} & a history \\
  \foreignlanguage{arabic}{سِکِّين: سَکَاکِين\textsuperscript{2}} & a knife & \foreignlanguage{arabic}{تَصْوِير: تَصَاوِير\textsuperscript{2}} & a picture \\
  \foreignlanguage{arabic}{دِينَار: دَنَانِير\textsuperscript{2}} & a dīnār & \foreignlanguage{arabic}{مِفْتَاح: مَفَاتِيح\textsuperscript{2}} & a key \\
  \foreignlanguage{arabic}{مِسْکِين: مَسَاکِين\textsuperscript{2}} & a needy person & \foreignlanguage{arabic}{مَلْعُون: مَلَاعِين\textsuperscript{2}} & an accursed one\textsubscript{m} \\
  \foreignlanguage{arabic}{کُرْسِيّ: کَرَاسِيّ\textsuperscript{2}} & a chair & \foreignlanguage{arabic}{يُنْبُوع: يَنَابِيع\textsuperscript{2}} & a (water) spring \\
  \foreignlanguage{arabic}{أُمْنِيَّة: أَمَانِيّ\textsuperscript{2}} & a wish & \foreignlanguage{arabic}{جَامُوس: جَوَامِيس\textsuperscript{2}} & a buffalo \\
  \end{longtable}
\item
...
\item
  ...
  \item
    ...
    \bottomrule\noalign{}
    \endlastfoot
    \foreignlanguage{arabic}{صَاحِبَة} \enquote{a companion\textsubscript{f}} & \foreignlanguage{arabic}{صَوَاحِب\textsuperscript{2}} \\
    \foreignlanguage{arabic}{عَامِل} \enquote{a factor} & \foreignlanguage{arabic}{عَوَامِل\textsuperscript{2}} \\
    \end{longtable}

    \foreignlanguage{arabic}{فَارِس} \emph{fāris} \enquote{a horseman} with the plural \foreignlanguage{arabic}{فَوَارِس\textsuperscript{2}} is one of a number of exceptions.
  \end{itemize}
\item
  ...
  \item
    ...
    \bottomrule\noalign{}
    \endlastfoot
    \foreignlanguage{arabic}{«شدّ»} & \foreignlanguage{arabic}{أَفْعِلَاء\textsuperscript{2}} & \(\times\)~\foreignlanguage{arabic}{أَشْدِدَاء\textsuperscript{2}} & \foreignlanguage{arabic}{أَشِدَّاء\textsuperscript{2}} \\
    \foreignlanguage{arabic}{«حلّ»} & \foreignlanguage{arabic}{مَفَاعِل\textsuperscript{2}} & \(\times\)~\foreignlanguage{arabic}{مَحَالِل\textsuperscript{2}} & \foreignlanguage{arabic}{مَحَالّ\textsuperscript{2}} \\
    \foreignlanguage{arabic}{«صمّ»} & \foreignlanguage{arabic}{أَفْعَل\textsuperscript{2}} & \(\times\)~\foreignlanguage{arabic}{أَصْمَم\textsuperscript{2}} & \foreignlanguage{arabic}{أَصَمّ\textsuperscript{2}} \\
    \end{longtable}
  \end{itemize}
\item
...
\item
  ...
  \item
    ...
    \foreignlanguage{arabic}{«جري»} & \foreignlanguage{arabic}{فَوَاعِل\textsuperscript{2}} & \(\times\)~\foreignlanguage{arabic}{جَوَارِي\textsuperscript{2}} & \foreignlanguage{arabic}{جَوَارٍ\textsuperscript{2}} \\
    \foreignlanguage{arabic}{«ليل»} & \foreignlanguage{arabic}{فَعَالِي\textsuperscript{2}} & \(\times\)~\foreignlanguage{arabic}{لَيَالِي\textsuperscript{2}} & \foreignlanguage{arabic}{لَيَالٍ\textsuperscript{2}} \\
    \end{longtable}
  \item
...
It is defined by the base noun. Because the base noun \foreignlanguage{arabic}{غُلَامٍ} is indefinite, therefore the annexe noun \foreignlanguage{arabic}{کِتَاب} is also indefinite.
...
\enquote{this book of al-Zubayr}
...
\chapter{Form 1 incomplete-action verbs-- u-state}\label{form-1-incomplete-action-verbs-u-state}
...
you\textsubscript{sing.~masc.} & \foreignlanguage{arabic}{تَ} \emph{-ta} & \foreignlanguage{arabic}{فَعَلْتَ} \emph{faɛalta} & \emph{invisible} & \foreignlanguage{arabic}{تَفْعَلُ} \emph{tafɛalu} \\
you\textsubscript{sing.~fem.} & \foreignlanguage{arabic}{تِ} \emph{-ti} & \foreignlanguage{arabic}{فَعَلْتِ} \emph{faɛalti} & \foreignlanguage{arabic}{ي} \emph{-ī} & \foreignlanguage{arabic}{تَفْعَلِينَ} \emph{tafɛalīna} \\
...
they\textsubscript{dual~masc.} & \foreignlanguage{arabic}{ا} \emph{-ā} & \foreignlanguage{arabic}{فَعَلَا} \emph{faɛalā} & \foreignlanguage{arabic}{ا} \emph{-ā} & \foreignlanguage{arabic}{يَفْعَلَانِ} \emph{yafɛalāni} \\
they\textsubscript{dual~fem.} & \foreignlanguage{arabic}{ا} \emph{-ā} & \foreignlanguage{arabic}{فَعَلَتَا} \emph{faɛalatā} & \foreignlanguage{arabic}{ا} \emph{-ā} & \foreignlanguage{arabic}{تَفْعَلَانِ} \emph{tafɛalāni} \\
you\textsubscript{dual} & \foreignlanguage{arabic}{تُمَا} \emph{-tumā} & \foreignlanguage{arabic}{فَعَلْتُمَا} \emph{faɛaltumā} & \foreignlanguage{arabic}{ا} \emph{-ā} & \foreignlanguage{arabic}{تَفْعَلَانِ} \emph{tafɛalāni} \\
they\textsubscript{pl.~masc.} & \foreignlanguage{arabic}{و} \emph{-ū} & \foreignlanguage{arabic}{فَعَلُوا} \emph{faɛalū} & \foreignlanguage{arabic}{و} \emph{-ū} & \foreignlanguage{arabic}{يَفْعَلُونَ} \emph{yafɛalūna} \\
they\textsubscript{pl.~fem.} & \foreignlanguage{arabic}{نَ} \emph{-na} & \foreignlanguage{arabic}{فَعَلْنَ} \emph{faɛalna} & \foreignlanguage{arabic}{نَ} \emph{-na} & \foreignlanguage{arabic}{يَفْعَلْنَ} \emph{yafɛalna} \\
you\textsubscript{pl.~masc.} & \foreignlanguage{arabic}{تُمْ} \emph{-tumā} & \foreignlanguage{arabic}{فَعَلْتُمْ} \emph{faɛaltum} & \foreignlanguage{arabic}{و} \emph{-ū} & \foreignlanguage{arabic}{تَفْعَلُونَ} \emph{tafɛalūna} \\
you\textsubscript{pl.~fem.} & \foreignlanguage{arabic}{تُنَّ} \emph{-tunna} & \foreignlanguage{arabic}{فَعَلْتُنَّ} \emph{faɛaltunna} & \foreignlanguage{arabic}{نَ} \emph{na} & \foreignlanguage{arabic}{تَفْعَلْنَ} \emph{tafɛalna} \\
...
\subsection{\texorpdfstring{Negation using \foreignlanguage{arabic}{لَا} \emph{lā}}{Negation using لَا lā}}\label{negation-using-ux644ux627-la}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      If the \emph{hamzaḧ} is after a long-\emph{ī} vowel or \emph{ay} semi-vowel, then the hamzao will be written unseated. Examples:\\
      \foreignlanguage{arabic}{هَيْـَٔةُ} \emph{hayʾatu}, \foreignlanguage{arabic}{خَطِيـَٔةُ} \emph{k͟haṭīʾatu}\\
      \foreignlanguage{arabic}{مُسِيـُٔونَ} \emph{musīʾūna}, \foreignlanguage{arabic}{مُسِيـَٔانِ} \emph{musīʾāni}, \foreignlanguage{arabic}{مُسِيـِٔينَ} \emph{musīʾīna}, \foreignlanguage{arabic}{مُسِيـَٔيْنِ} \emph{musīʾayni}\\
      \foreignlanguage{arabic}{شَيْـُٔهُ} \emph{s͟hayʾuhu}, \foreignlanguage{arabic}{شَيْـَٔهُ} \emph{s͟hayʾahu}, \foreignlanguage{arabic}{شَيْـِٔهِ} \emph{s͟hayʾihi}, \foreignlanguage{arabic}{شَيْـَٔانِ} \emph{s͟hayʾāni}, \foreignlanguage{arabic}{شَيْـَٔيْنِ} \emph{s͟hayʾayni}\\
      \foreignlanguage{arabic}{مَجِيـُٔهُ} \emph{majīʾuhu}, \foreignlanguage{arabic}{مَجِيـَٔهُ} \emph{majīʾahu}, \foreignlanguage{arabic}{مَجِيـِٔهِ} \emph{majīʾihi}\\
    \item
      If the \emph{hamzaḧ} is after a long-\emph{ū} vowel or \emph{aw} semi-vowel, then:\\
      If the \emph{hamzaḧ} has an \emph{i}-mark it is written seated on \emph{yāʾ}. Examples:
      \foreignlanguage{arabic}{سُوئِهِ} \emph{sūʾihi}, \foreignlanguage{arabic}{ضَوْئِهِ} \emph{ḍawʾihi}\\
      Otherwise, the \emph{hamzaḧ} is written unseated. Examples:
      \foreignlanguage{arabic}{سُوءَه} \emph{sūʾahu}, \foreignlanguage{arabic}{سُوءَانِ} \emph{sūʾāni}, \foreignlanguage{arabic}{تَوْءَمُ} \emph{tawʾamu}, \foreignlanguage{arabic}{ضَوْءَهُ} \emph{ḍawʾahu}, \foreignlanguage{arabic}{ضَوْءَانِ} \emph{ḍawʾāni}, \foreignlanguage{arabic}{سُوءُهُ} \emph{sūʾuhu}, \foreignlanguage{arabic}{يَسُوءُونَ} \emph{yasūʾūna}\\
    \item
      If the \emph{hamzaḧ} is after a long \emph{ā}-vowel, then:
      If the \emph{hamzaḧ} has an \emph{i}-mark it is written seated on \emph{yāʾ}. Example:
      \foreignlanguage{arabic}{سَائِلُ} \emph{sāʾilu}.\\
      If the \emph{hamzaḧ} has an \emph{u}-mark it is written seated on \emph{wāw}. Example: \foreignlanguage{arabic}{تَسَاؤُلُ} \emph{tasāʾulu}.\\
      Otherwise, when the \emph{hamzaḧ} has an \emph{a}-mark, it is written unseated. Example: \foreignlanguage{arabic}{سَاءَلَ} \emph{sāʾala}, \foreignlanguage{arabic}{قِرَاءَاتُ} \emph{qirāʾātu}.
    \end{enumerate}
  \item
    If the letter before the \emph{hamzaḧ} has a \(\emptyset\)-mark and is not \emph{wāw} or \emph{yāʾ}, then:

    \begin{enumerate}
    \def\labelenumiii{\roman{enumiii}.}
    \tightlist
    \item
      If the \emph{hamzaḧ} was originally at the end of the word, but a suffix has been attached to the word, then the \emph{hamzaḧ} will be written unseated. Examples: \foreignlanguage{arabic}{عِبْـَٔانِ} \emph{ɛibʾāni}, \foreignlanguage{arabic}{عِبْـَٔييْنِ} \emph{ɛibʾayni}, \foreignlanguage{arabic}{بُطْـَٔهُ} \emph{buṭʾahu}, \foreignlanguage{arabic}{بُطْـُٔهُ} \emph{buṭʾuhu}, \foreignlanguage{arabic}{بُطْـِٔهِ} \emph{buṭʾihi}. (\foreignlanguage{arabic}{انِ}, \foreignlanguage{arabic}{يْنِ}, \foreignlanguage{arabic}{هُ}, and \foreignlanguage{arabic}{هِ} are suffixes).
    \item
      Otherwise, if the \emph{hamzaḧ} is originally at the middle of the word, then it is written seated on \emph{wāw} if it has an \emph{u}-mark and \emph{yāʾ} if it has an \emph{i}-mark. Examples: \foreignlanguage{arabic}{مَسْؤُولُ} \emph{masʾūlu}, \foreignlanguage{arabic}{تَرْئِيسُ} \emph{tarʾīsu}.\\
      If the \emph{hamzaḧ} has an \emph{a} mark then:\\
      If it is followed by a long-\emph{ā} vowel represented by an \emph{ʾalif}, the \emph{hamzaḧ} is unseated followed by the \emph{ʾalif} and the combination is written as \foreignlanguage{arabic}{آ}. Example: \foreignlanguage{arabic}{مِرْآةُ} \emph{mirʾātu}, \foreignlanguage{arabic}{ظَمْآنُ} \emph{ẓamʾānu}.\\
      Otherwise, if there is no \emph{ʾalif} after the \emph{hamzaḧ}, the \emph{hamzaḧ} is written seated on \emph{ʾalif}. Examples: \foreignlanguage{arabic}{مَسْأَلَةُ} \emph{masʾalatu}, , \foreignlanguage{arabic}{مَرْأَةُ} \emph{marʾatu}.
    \end{enumerate}
  \item
    If the \emph{hamzaḧ} has a \(\emptyset\)-mark, then it is written seated on \emph{ʾalif} if it has an \emph{a}-mark, \emph{wāw} if it has an \emph{u}-mark, and \emph{yāʾ} if it has an \emph{i}-mark. Examples: \foreignlanguage{arabic}{کَأْسُ} \emph{kaʾsu}, \foreignlanguage{arabic}{بِئْسَ} \emph{biʾsa}, \foreignlanguage{arabic}{سُؤْلَکَ} \emph{suʾlaka}.
  \item
    Otherwise, only if the above conditions are not satisfied, then compare the vowel marks of the \emph{hamzaḧ} and the letter before it:

    \begin{enumerate}
    \def\labelenumiii{\roman{enumiii}.}
    \tightlist
    \item
      If either vowel mark is an \emph{i}-mark then the \emph{hamzaḧ} will be written on a \emph{yāʾ}. Examples: \foreignlanguage{arabic}{سُئِلَ} \emph{suʾila}, \foreignlanguage{arabic}{يَئِسَ} \emph{yaʾisa}, \foreignlanguage{arabic}{مُتَّکِئِينَ} \emph{muttakiʾīna}.
    \item
      If neither vowel mark is an \emph{i}-mark, and at least one of the vowel marks is a \emph{u}-mark, then the \emph{hamzaḧ} will be written on a \emph{wāw}. Examples: \foreignlanguage{arabic}{سُؤَالُ} \emph{suʾālu}, \foreignlanguage{arabic}{رُؤُوسُ} \emph{ruʾūsu}, \foreignlanguage{arabic}{لُؤَيُّ} \emph{luʾayyu}.
    \item
      Otherwise, if both of the vowel marks are \emph{a}-marks, then:\\
      If the \emph{hamzaḧ} is followed by a long-\emph{ā} vowel represented by an \emph{ʾalif}, the \emph{hamzaḧ} is written unseated. Examples: \foreignlanguage{arabic}{شَنَآنُ} \emph{s͟hanaʾānu}.\\
      Otherwise the \emph{hamzaḧ} will be written on an \emph{ʾalif}. Examples: \foreignlanguage{arabic}{سَأَلَ} \emph{saʾala}, \foreignlanguage{arabic}{رَأَىٰ} \emph{raʾā}.
    \end{enumerate}

    These set of rules apply even if the \emph{hamzaḧ} or the previous letter is doubled. Examples \foreignlanguage{arabic}{رَأَّسَ} \emph{raʾʾasa} \foreignlanguage{arabic}{يُرَئِّسُ} \emph{yuraʾʾisu} \foreignlanguage{arabic}{رُئِّسَ} \emph{ruʾʾisa} \foreignlanguage{arabic}{تَفَؤُّلُ} \emph{tafaʾʾulu} \foreignlanguage{arabic}{يُبَرِّئُونَ} \emph{yubarriʾūna} \foreignlanguage{arabic}{يُبَرَّؤُونَ} \emph{yubarraʾūna}.
  \end{enumerate}
\item
  If \emph{hamzaḧ} is at the end of a word, disregard the vowel mark on it and consider only the letter before the \emph{hamzaḧ}.
