...
rmd_file_list <- c("intro.Rmd", "script.Rmd", "nouns.Rmd", "gender.Rmd", "simple_sentences.Rmd", "prepositions.Rmd", "past_verbs.Rmd", "describing_nouns.Rmd", "diptotes.Rmd", "duals.Rmd", "sound_plurals.Rmd", "broken_plurals.Rmd", "idafa.Rmd", "ism_ishara.Rmd", "elatives.Rmd", "five_nouns.Rmd", "imperfect_verb_indic.Rmd", "imperfect_verb_subj.Rmd", "kana_sisters.Rmd", "ideas.Rmd", "appendix.Rmd", "hamzarules.Rmd", "further.Rmd")
