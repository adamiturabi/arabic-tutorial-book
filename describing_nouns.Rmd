...
English uses  adjectives to describe nouns. For example, we can say "a big man". "Big" is the adjective, and "man" is the _described noun_. Together, the adjective and the described noun are called a _noun-phrase_.

Arabic does not technically have adjectives. In Arabic we use descriptive nouns instead to give the meaning of the adjective. When a descriptive noun is used to give the meaning of an adjective as part of a noun-phrase, it is placed after the described noun and matches the described noun in state, definiteness, and gender. For example, in order to express "a big man", we put the described noun [رَجُلٌ]{.ar} [rajulun]{.trn} "a man" first, and place the descriptive noun [كَبِيرٌ]{.ar} [kabIrun]{.trn} (masc.) "a big one" after it. Then the descriptive noun "a big one" gives the meaning of the adjective "big":
...
See how in this last example, the described noun [ٱلْبَقَرَةَ]{.ar} [albaqarata]{.trn} is the object of a verb and is therefore in the a-state. Therefore the descriptive noun [ٱلْكَبِيرَةَ]{.ar} [alkabIrata]{.trn} "big" is also in the a-state.
