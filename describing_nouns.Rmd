...
Arabic does not technically have adjectives. In Arabic we use descriptive nouns instead. When descriptive nouns are used as adjectives, they are placed after the described noun and match the described noun in state, definiteness, and gender. For example, in order to express "a big man", we put the described noun [رَجُلٌ]{.ar} [rajulun]{.trn} "a man" first, and place the descriptive noun [كَبِيرٌ]{.ar} [kabIrun]{.trn} (masc.) "a big one" after it. Then the descriptive noun "a big one" gives the meaning of the adjective "big":

[رَجُلٌ كَبِيرٌ]{.ar}  
[rajulun kabIrun]{.trn}  
"a big man"

Here the described noun [رَجُلٌ]{.ar} [rajulun]{.trn} "a man" is masculine, indefinite, and in the u-state. Therefore, the descriptive noun [كَبِيرٌ]{.ar} [kabIrun]{.trn} "big" is also is also masculine, indefinite, and in the u-state. 
...
Here too the descriptive noun [ٱلْكَبِيرَةُ]{.ar} [alkabIratu]{.trn} "big" matches the described noun [ٱَلشَّجَرَةُ]{.ar} [accajaratu]{.trn} "the tree" in being feminine, definite, and in the u-state.

Adjectives can describe nouns which are in sentences. Examples:

[ٱلرَّجُلُ ٱلْكَبِيرُ أَبٌ حَسَنٌ]{.ar}  
[Earrajulu -lkabIru Eabun Hasanun]{.trn}  
"The big man is a good father."

[أَكَلَ ٱلْأَسَدُ ٱلْقَوِيُّ ٱلْبَقَرَةَ ٱلْكَبِيرَةَ]{.ar}  
[Eakala -lEasadu -lqawiyyu -lbaqarata -lkabIrata]{.trn}  
"The strong lion ate the big cow."

Note that in this last example, the described noun [ٱلْبَقَرَةَ]{.ar} [albaqarata]{.trn} is the object of a verb and is therefore in the a-state. Therefore the descriptive noun [ٱلْكَبِيرَةَ]{.ar} [alkabIrata]{.trn} "big" is also in the a-state.
...
+ The state of the descriptive noun  will match the state of the described noun. "A big man" is [رَجُلٌ كَبِيرٌ]{.ar} [rajulun kabIrun]{.trn}. The described noun [رَجُلٌ]{.ar} [rajulun]{.trn} "man" is in the u-state. Therefore, the descriptive noun [كَبِيرٌ]{.ar} [kabIrun]{.trn} "big" is also in the u-state. 
If the described noun were the object of a verb and therefore in the a-state [رَجُلًا]{.ar} [rajulan]{.trn}, then the descriptive noun would be in the a-state as well [رَجُلًا كَيِيرًا]{.ar}.

We haven't seen nouns in other states yet but if the described noun were in the a-state [رَجُلًا]{.ar} [rajulan]{.trn} " man", we would put the descriptive noun in the a-state as well [كَبِيرًا]{.ar} [kabIran]{.trn} "big": [رَجُلًا كَيِيرًا]{.ar} [rajulan kabIran]{.trn}.
