...
Unfinished-action verbs can, in general, give the meaning of both an action which is habitually done, like "He goes to school." or an action which is being done right now "He is going to school." Both of these can be expressed with [يَذْهَبُ إِلَى ٱلْمَدْرَسَةِ.]{.ar}. But depending on the meaning of the verb and the context, placing the doer before the verb can sometimes indicate that the action is taking place right now.
