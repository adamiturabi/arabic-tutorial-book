# Incomplete-action verbs-- Form 1, u-state
...
Arabic does provide a mechanism for specifying that the use of an incomplete-action verb is solely to intend a future action. This is by means of the particles [سَـ]{.ar} [sa-]{.trn} and [سَوْفَ]{.ar} [sawfa]{.trn} that can be be placed before the verb. They provide a meaning of "will" or "will soon". [سَـ]{.ar} [sa-]{.trn}, being a single letter particle, is attached to the verb.
...
can't do sa/sawfa + negation. la can give meaning or use lan
