...
We have learned detached pronouns, past-tense verb doer-modifications, and attached pronouns for the singular and the dual. Here we will add the corresponding pronouns for the plural. We use the root [فعلل]{.arroot} as a template to show the verb doer-modifications.
...
+ The attached and past-tense verb doer-modifications for the dual/plural speaker "we/us" are the same: [نَا]{.ar} [nA]{.trn}.
...
+ The plural masculine past-tense verb doer-modification for the non-participator "they~pl.\ masc.~" [ـُوا]{.ar} [U]{.trn} has a silent [Ealif]{.trn} which is written only and not pronounced. This [Ealif]{.trn} is dropped when a doee pronoun is attached. For example: 
...
+ The plural masculine past-tense verb doer-modification for the addressee "you~pl.\ masc.~" [ـتُمْ]{.ar} [-tum]{.trn} becomes [تُمُو]{.ar} [tumU]{.trn} when a doee pronoun is attached. For example:
