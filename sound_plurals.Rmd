...
It is not just designative nouns that have plurals. Descriptive nouns may be pluralized as well. For example, [طَيِّبٌ]{.ar} [Tayyibun]{.trn} has the [Un]{.trn} plural [طَيِّبُونَ]{.ar} [TayyibUna]{.trn} and the [At]{.trn} plural [طَيِّبَاتٌ]{.ar} [TayyibAtun]{.trn}. In using plurals of descriptive nouns, Arabic distinguishes between rational beings and non-rational beings.

### Usage of plurals of descriptive nouns with rational beings
...
Note that in the above sentence, it is not just the descriptive nouns [ٱلصَّعْبَةُ]{.ar} and [ٱلطَّوِيلَةُ]{.ar} which are feminine singular. So too is the pronoun [هِيَ]{.ar}. We will learn the rule for pronouns in the next section.
