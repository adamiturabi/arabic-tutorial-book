...
Note that this rule of changing the vowel mark is only true for designative nouns. Qualitative nouns will retain the ∅-mark when forming the [At]{.trn} plural. So [صَعْب]{.ar} [Saeb]{.trn} and [صَعْبَة]{.ar} [Saebah]{.trn} become only [صَعْبَات]{.ar} [SaebAt]{.trn}, not [صَعَبَات]{.ar} [SaeabAt]{.trn}.
