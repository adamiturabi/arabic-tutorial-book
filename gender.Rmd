...
+ Even when there are different words for the male and female living beings, one of them is often commonly used to refer to both the male and female animal. For example, [كَلْبٌ]{.ar} [kalbun]{.trn} is "a male dog" and  [كَلْبَةٌ]{.ar} [kalbatun]{.trn} is "a female dog". But commonly, [كَلْبٌ]{.ar} [kalbun]{.trn} is used to refer to both a male and a female dog. This is done especially when we just want to say "a dog" and we are not concerned wither whether it is a male or female dog.
  ...
  So how do we know when a rigid noun of one gender is commonly used to refer to both male and female living beings, even though the noun exists in both genders? Many nouns that designate animals behave like this. As for nouns that designate humans, there are not very many of these and we have already listed the most common ones. When we come across nouns like these, we will note it in the vocabulary.
...
[ٱَلْمَرْأَةُ]{.ar} [almarEatu]{.trn}.
  ...
  There is another more strange behavior of the indefinite noun [ٱِمْرَؤٌ]{.ar} [imraEun]{.trn}. Usually if we put it in the a-state and i-state it will become
...
Flexible nouns can refer to living beings as well as inanimate objects. Description words are also nearly always flexible nouns. Description words can usually be feminized by adding a feminine marker to them. The most common feminine marker for singular nouns, as we've noted already, is looped [tAE]{.trn}.

Here are some examples of flexible nouns:
...
+ In the previous chapter we noted that a description word has to match the described noun in definiteness and state. For example:
  ...
  [ٱَلْمَرْأَةُ]{.ar} [almarEatu]{.trn} is feminine "the man" is definite and in the u-state so its description word [السَّعِيدُ]{.ar} [assaeIdu]{.trn} will also be definite and in the u-state.

  Similarly, [بَيْتٍ]{.ar} [baytin]{.trn} is indefinite and in the i-state so its description word [كَبِيرٍ]{.ar} [kabIrin]{.trn} will also be indefinite and in the i-state.

  As we mentioned, description words are usually flexible nouns so it is easy to make them feminine by adding a feminine marker to them. However, there are a few flexible nouns that are used as description words for feminine described nouns without modifying them by adding a feminine marker. Also, rarely, a rigid noun might be used as a description word. In this case as well, the rigid noun may not be modified by adding a feminine marker to it. We will deal with these cases later, if Allah wills, but for now we will just note that these cases do occur.
