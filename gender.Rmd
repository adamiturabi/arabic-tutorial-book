...
For other nouns that designate animate beings, the masculine and feminine nouns are completely different. Or sometimes one noun is used for both sexes. Here are some examples:
...
Other animals have the same noun for both the male and the female animal. In this case the noun is either masculine or feminine but it can still be applied to animals of both sexes. Examples are
[قِرْدٌ]{.ar} [qirdun]{.trn} (masc.) "a monkey"
and
[حَمَامَةٌ]{.ar} [HamAmatun]{.trn} (fem.) "a pigeon".

Even when the male and female animal have different words, usually one of them is used commonly for animals of either sexwhen we are not concerned with the actual sex of the animal. For example 
...
In the previous chapter that adjectives can be used by themselves as descriptive nouns. So for example
## Rework:
