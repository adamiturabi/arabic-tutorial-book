...
This category is more complicated than the previous ones. The following conditions must be satisfied for a word to be a non-fully-changing noun:
...
Names are also often originally qualitative nouns with a good meaning. For example, [سَعِيدٌ]{.ar} [saeIdun]{.trn} "[#saeId]{.trn2}" is a qualitative noun meaning "happy".
...
1. The male name ends with an [ان]{.ar} which is external to the word's root. This is regardless of whether or not the word was originally a qualitative noun. A name that falls under this category is [عُثْمَانُ]{.ar} [euvmAnu]{.trn} [e#uvmAn]{.trn2}.
2. The male name is on the pattern [أَفْعَل]{.ar}, e.g. [أَسْعَدُ]{.ar} [Easeadu]{.trn} [E#asead]{.trn2}.
...
5. The male name is of the pattern [فُعَل]{.ar}. The only common name that falls in this category is [عُمَرُ]{.ar} [eumaru]{.trn} [e#umar]{.trn2}.
