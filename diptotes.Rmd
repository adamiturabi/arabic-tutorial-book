...
Native Arabic words are generally derived from roots. Most roots are comprised of three letters. A smaller number are comprised of four or more letters. Words derived from the same root often share some basic meaning (although this is not always obvious). Words are derived from their roots according to patterns. In traditional Arabic grammar studies, the root [فعل]{.arroot} is used as a template to showcase word and meaning patterns.

Here is an example of some words and their patterns that are derived from the root  [كتب]{.ar} [ktb]{.trn}.
...
Word | Root | Note
:--------------|:---------------|:------------------
[دُعَاءٌ]{.ar} [dueAEun]{.trn}  | [دعو]{.arroot} | [و]{.ar} [w]{.trn} substituted with [ء]{.ar} [E]{.trn}
[ٱَلْهُدَىٰ]{.ar} [EalhudA]{.trn} | [هدي]{.arroot} | [ي]{.ar} [y]{.trn} substituted with [ىٰ]{.ar} [A]{.trn}
...
"The generous [#muHammad]{.trn2} came."
