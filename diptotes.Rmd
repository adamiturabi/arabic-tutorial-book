...
For convenience, henceforth, when we discuss nouns outside of a sentence, we will generally write them without final vowel marks (like [n]{.trn}-marks) and translate them without any indefinite article, e.g. [جَارِيَة]{.ar} [jAriyah]{.trn} "girl".
