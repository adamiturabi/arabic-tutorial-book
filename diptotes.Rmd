...
+ [عُثْمَانُ]{.ar} [euvmAnu]{.trn} "[#euvmAn]{.trn2}"
+ [طَلْحَةُ]{.ar} [Talhatu]{.trn} "[#Talhah]{.trn2}"

Male names usually have an [n]{.trn}-mark even though they are definite. Some male names have al. Most are fully-changing but they can be non-fully-changing if:

1. They conform to a non-fully-changing pattern.
2. They end with [ة]{.ar}. Although [ة]{.ar} is a usually a feminine marker, it is found in some male names, in which case it will not be a feminine marker.

Names are also often originally descriptive nouns with a good meaning. For example, [سَعِيدٌ]{.ar} [saeIdun]{.trn} "[#saeId]{.trn2}" is a descriptive noun meaning "happy".
