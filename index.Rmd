...
```{r,engine='tikz', engine.opts = list(template = "srctex/tikz2pdf-lua.tex")}
\usetikzlibrary{decorations.text, decorations.pathreplacing}
\begin{tikzpicture}
\path [decoration={text effects along path, 
  text=The quick brown fox jumps over the lazy \arb{.hurUf-u 'l-hijA'-i},
  text effects/.cd, 
...
\draw [decoration={brace, mirror, raise=3ex}, decorate] 
   (word-1.south west) -- (word-9.south east)
      node [midway, below=3ex] {Full sentence};
\end{tikzpicture}
```
